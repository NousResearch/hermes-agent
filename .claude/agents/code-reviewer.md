<!--
Adapted from: personas/code-reviewer.md (tanner-stack v0.2.0)
...
**Expected invocation posture:** high effort, moderate runs (design for ~30 turns). Single-pass review of a specific diff.
