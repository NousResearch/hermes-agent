...
.FF........                                                              [100%]
=================================== FAILURES ===================================
____________________ test_quota_manager_spend_calculations _____________________

temp_db = PosixPath('/tmp/tmpw_hkas7r/test_quota.db')
...
E       assert 0.0 == 0.035
E        +  where 0.0 = get_daily_spend()
E        +    where get_daily_spend = <provider_gateway.quota_manager.QuotaManager object at 0x752a39722510>.get_daily_spend

tests/provider_gateway/test_quota_manager.py:128: AssertionError
_______________________ test_quota_manager_within_limits _______________________

mock_stale = <MagicMock name='get_provider_stale_timeout' id='128824212852752'>
mock_timeout = <MagicMock name='get_provider_request_timeout' id='128824194256240'>
mock_local = <MagicMock name='is_local_endpoint' id='128824194254224'>
temp_db = PosixPath('/tmp/tmpcpsdbu6w/test_quota.db')
...
agent = <test_quota_manager.MockAgent object at 0x752a385642f0>
api_kwargs = {'messages': []}
...
mock_stale = <MagicMock name='get_provider_stale_timeout' id='128824194259936'>
mock_timeout = <MagicMock name='get_provider_request_timeout' id='128824194259264'>
mock_local = <MagicMock name='is_local_endpoint' id='128824194259600'>
temp_db = PosixPath('/tmp/tmp5qic9iye/test_quota.db')
...
agent = <test_quota_manager.MockAgent object at 0x752a385b4b90>
api_kwargs = {'messages': []}
...
mock_stale = <MagicMock name='get_provider_stale_timeout' id='128824194261616'>
mock_timeout = <MagicMock name='get_provider_request_timeout' id='128824194260944'>
mock_local = <MagicMock name='is_local_endpoint' id='128824194261280'>
temp_db = PosixPath('/tmp/tmp7xutpvdq/test_quota.db')
...
agent = <test_quota_manager.MockAgent object at 0x752a385b5090>
api_kwargs = {'messages': []}
...
mock_stale = <MagicMock name='get_provider_stale_timeout' id='128824194268000'>
mock_timeout = <MagicMock name='get_provider_request_timeout' id='128824194267664'>
mock_local = <MagicMock name='is_local_endpoint' id='128824194268336'>
temp_db = PosixPath('/tmp/tmp1nqmmozt/test_cache.db')
...
agent = <test_semantic_cache.MockAgent object at 0x752a380d0050>
...
mock_stale = <MagicMock name='get_provider_stale_timeout' id='128824189455056'>
mock_timeout = <MagicMock name='get_provider_request_timeout' id='128824189454384'>
mock_local = <MagicMock name='is_local_endpoint' id='128824189454720'>
temp_db = PosixPath('/tmp/tmp3hb2oua8/test_cache.db')
...
mock_stale = <MagicMock name='get_provider_stale_timeout' id='128824189454048'>
mock_timeout = <MagicMock name='get_provider_request_timeout' id='128824189455392'>
mock_local = <MagicMock name='is_local_endpoint' id='128824189455728'>
temp_db = PosixPath('/tmp/tmpfb5l1ihq/test_cache.db')
...
mock_stale = <MagicMock name='get_provider_stale_timeout' id='128824092045200'>
mock_timeout = <MagicMock name='get_provider_request_timeout' id='128824092044528'>
mock_local = <MagicMock name='is_local_endpoint' id='128824092044864'>
...
mock_stale = <MagicMock name='get_provider_stale_timeout' id='128824092048560'>
mock_timeout = <MagicMock name='get_provider_request_timeout' id='128824092048896'>
mock_local = <MagicMock name='is_local_endpoint' id='128824092048224'>
...
FAILED tests/provider_gateway/test_quota_manager.py::test_quota_manager_spend_calculations
