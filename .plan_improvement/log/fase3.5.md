...
mock_stale = <MagicMock name='get_provider_stale_timeout' id='126529145905776'>
mock_timeout = <MagicMock name='get_provider_request_timeout' id='126529145906784'>
mock_local = <MagicMock name='is_local_endpoint' id='126529145906448'>
...
tests/provider_gateway/test_stream_tracking.py:126: AssertionError
------------------------------ Captured log call -------------------------------
WARNING  agent.chat_completion_helpers:chat_completion_helpers.py:2285 Streaming failed after partial delivery, not retrying: 'types.SimpleNamespace' object has no attribute 'tool_calls'
WARNING  agent.chat_completion_helpers:chat_completion_helpers.py:2576 Partial stream delivered before error; returning length-truncated stub with 0 chars of recovered content so the loop can continue from where the stream died: 'types.SimpleNamespace' object has no attribute 'tool_calls'
____________________ test_streaming_api_call_records_error _____________________

mock_stale = <MagicMock name='get_provider_stale_timeout' id='126529061117904'>
mock_timeout = <MagicMock name='get_provider_request_timeout' id='126529061119920'>
mock_local = <MagicMock name='is_local_endpoint' id='126529061120256'>
...
E       assert 17 == 1
E        +  where 17 = <provider_gateway.circuit_breaker.ProviderHealth object at 0x7313dee3e0f0>.total_requests

tests/provider_gateway/test_stream_tracking.py:179: AssertionError
