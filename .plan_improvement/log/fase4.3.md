...
temp_secrets_dir = PosixPath('/tmp/tmpmxf2vbm7')
...
E        +    where get_credential = <provider_gateway.secure_store.DynamicCredentialStore object at 0x7f10b29cf610>.get_credential
...
temp_secrets_dir = PosixPath('/tmp/tmp0cg957u6')
...
E            +    where get_credential = <provider_gateway.secure_store.DynamicCredentialStore object at 0x7f10b29d2780>.get_credential
