...
temp_secrets_dir = PosixPath('/tmp/tmpu2crmiwv')
...
E        +    where get_credential = <provider_gateway.secure_store.DynamicCredentialStore object at 0x7da836faf610>.get_credential
...
temp_secrets_dir = PosixPath('/tmp/tmp6mxty2i4')
...
E            +    where get_credential = <provider_gateway.secure_store.DynamicCredentialStore object at 0x7da836fb2780>.get_credential
