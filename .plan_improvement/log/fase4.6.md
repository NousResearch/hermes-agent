...
temp_secrets_dir = PosixPath('/tmp/tmpz8872lmw')
...
E        +    where get_credential = <provider_gateway.secure_store.DynamicCredentialStore object at 0x71f6babe7610>.get_credential
...
temp_secrets_dir = PosixPath('/tmp/tmp6s_5al6t')
...
E            +    where get_credential = <provider_gateway.secure_store.DynamicCredentialStore object at 0x71f6babf6780>.get_credential
