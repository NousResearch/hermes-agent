...
|  `nova/`, `deploy/`, `docs/platform/` | `nova/AGENTS.md` | Platform layer boundaries: upstream-owned vs platform-owned, protected identifiers (never rename), branding as compiled config, control-plane boundary, core patch budget |
