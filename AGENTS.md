...
For details on CLI/TUI architecture, adding tools, config, plugins, skills, cron, kanban, and delegation, please refer to [docs/system-architecture.md](docs/system-architecture.md).
