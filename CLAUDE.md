...
This project is indexed by GitNexus as **KenseiAgent** (297851 symbols, 456882 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
