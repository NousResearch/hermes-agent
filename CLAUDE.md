...
This project is indexed by GitNexus as **KenseiAgent** (300701 symbols, 462668 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
