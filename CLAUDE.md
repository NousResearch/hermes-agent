...
This project is indexed by GitNexus as **KenseiAgent** (307623 symbols, 477313 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
