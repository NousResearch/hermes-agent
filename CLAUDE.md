...
This project is indexed by GitNexus as **hermes-agent** (126306 symbols, 226132 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
