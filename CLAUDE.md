...
This project is indexed by GitNexus as **KenseiAgent** (299162 symbols, 435790 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
