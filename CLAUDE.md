...
This project is indexed by GitNexus as **hermes-agent** (141032 symbols, 261206 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
