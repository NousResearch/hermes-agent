...
When the user invokes `Use Act-As`, `Use Comply`, `Use Business Plan`, `Use Viber Structure`, `Use WOW Resource`, `Go to Sleep`, `Review Chat`, or an alias, read `/Users/rattanasak/ObsidianVault/HermesAgent/ai-context/prompt-shortcut-registry.md` and then open the mapped prompt file. Do not guess or summarize the shortcut from memory.
