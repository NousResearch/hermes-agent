...
| [Database Retrieval](https://hermes-agent.nousresearch.com/docs/user-guide/features/database-retriever) | Read-only SQL retrieval, dialect transpilation, and database connection examples |
