...
支持任意模型——[Nous Portal](https://portal.nousresearch.com)、OpenRouter、OpenAI、你自己的端点，以及[更多其他](https://hermes-agent.nousresearch.com/docs/integrations/providers)。使用 `hermes model` 即可切换——无需改代码，无锁定。
