...
<tr><td><b>随处运行</b></td><td>七种终端后端——本地、Docker、SSH、Daytona、Singularity、Modal 和 Vercel Sandbox。Daytona 和 Modal 提供 Serverless 持久化——代理环境空闲时休眠、按需唤醒，空闲期间几乎零成本。$5 VPS 或 GPU 集群都能跑。</td></tr>
