...
- **Adaptadores de plataforma del gateway.** Integraciones de mensajería empaquetadas en
  `plugins/platforms/` (Telegram, Discord, Slack, email, SMS, etc.),
  más el base compartido / adaptadores legados directos en `gateway/platforms/`
  (Signal, servidor API, webhooks y similares).
