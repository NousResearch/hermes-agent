...
def _codex_window_label(window: dict[str, Any], fallback: str) -> str:
    """Name Codex quota windows by duration, with positional fallback."""
...
def _fetch_codex_account_usage(
    ...
    windows: list[AccountUsageWindow] = []
    # The API's primary/secondary slots are not reliably semantic: classify
    # known windows by duration, while retaining the positional fallback for
    # older or incomplete payloads.
