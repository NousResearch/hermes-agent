...
_CALLBACK_PARAMS = (
    ...
    "read_window_below_callback", "setup_mcp_callback", "workflow_callback", "tour_callback",
...
def init_agent(
    ...
    workflow_callback: callable = None, tour_callback: callable = None, step_callback: callable = None,
