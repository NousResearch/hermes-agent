...
_CALLBACK_PARAMS = (
    ...
    "read_window_below_callback", "connection_callback", "pen_canvas_callback", "tour_callback",
...
def init_agent(
    ...
    pen_canvas_callback: callable = None, tour_callback: callable = None, step_callback: callable = None,
