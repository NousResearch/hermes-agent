...
def init_agent(
    ...
    # Authoritative mode state. The prompt is an instruction payload, not a
    # state store; quoted mode text must never change the status badge.
    agent.agent_mode = "auto"
