...
def anthropic_prompt_cache_policy(
    ...
    *,
    ...
    # (native_anthropic=False), matching the other OpenRouter entries. Without
    # this our prod default deepseek/deepseek-v4-flash falls through to
    # (False, False) and serves 0% cache hits. Ported from PR #20945.
