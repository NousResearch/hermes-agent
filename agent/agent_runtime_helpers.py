...
def anthropic_prompt_cache_policy(
    ...
    *,
    ...
    if is_anthropic_wire:
        is_ark_provider = provider_lower in {"volcengine-ark", "ark", "volcengine", "byteplus"}
        is_ark_host = base_url_host_matches(eff_base_url, "ark.cn-beijing.volces.com") or base_url_host_matches(eff_base_url, "ark.ap-southeast.bytepluses.com")
