...
# Opus 5.5 (and Fable 5.1) 400 on ``thinking.type.disabled`` — "thinking is always on"
# (platform.claude.com/docs/en/models/opus-5-5/whats-new-opus-5-5#thinking-cant-be-disabled).
