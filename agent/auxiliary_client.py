    ...
    if provider == "custom":
        ...
        if explicit_base_url:
            ...
            if _main_base and _main_key:
                ...
                # Bind wrap_base on this branch too: our anthropic_messages fix
                # (#16254) only set it in the explicit_base_url branch above, so
                # without this the _wrap_if_needed() call below would hit an
                # unbound wrap_base when reusing the main runtime's base.
                wrap_base = _main_base
