...
def _pool_credential_digest(pool: Any, entry: Any = None) -> str:
    ...
    changes the digest too (#113022 point 5). Only the PBKDF2 fingerprint of the keys enters the cache key.
    """
    ...
    return stable_fingerprint(json.dumps(keys, ensure_ascii=True, separators=(",", ":")), length=32)
