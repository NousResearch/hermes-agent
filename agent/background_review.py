...
_SKILL_REVIEW_PROMPT = (
    ...
    "new learning, FIRST call skill_view(name) to load its SKILL.md, "
    "THEN patch it. This is required by the read-before-write guard. "
    "Use the content returned by skill_view as the base for your "
    "patch. It is the skill that was in play, so it's the right one "
    "to extend.\n"
...
_COMBINED_REVIEW_PROMPT = (
    ...
    "of them covers the learning, FIRST call skill_view(name) to load "
    "its SKILL.md, THEN patch it. This is required by the "
    "read-before-write guard. Use the content returned by skill_view "
    "as the base for your patch. It was in play; it's the right place.\n"
