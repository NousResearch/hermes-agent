...
def try_activate_fallback(
    ...
    *,
    ...
    try:
        ...
        # Preserve fork behavior: a fallback entry without reasoning_effort
        # keeps the active primary/global effort, while an explicit per-entry
        # value wins for the fallback tier. Do not re-resolve from config here;
...
def interruptible_streaming_api_call(agent, api_kwargs: dict, *, on_first_delta=None):
    ...
    def _call_anthropic():
        ...
        with agent._anthropic_client.messages.stream(**api_kwargs) as stream:
            ...
            # If the stream was interrupted, do NOT call get_final_message() — on a
            # partially-consumed stream the SDK may hang or return incomplete tool_use.
            if agent._interrupt_requested:
                return None
            ...
            return _repair_anthropic_message_surrogates(_final_message)
