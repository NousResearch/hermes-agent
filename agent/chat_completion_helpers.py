...
def interruptible_streaming_api_call(agent, api_kwargs: dict, *, on_first_delta=None):
    ...
    def _call_chat_completions():
        ...
        has_invalid_tool_args_sentinel = False
        if tool_calls_acc:
            mock_tool_calls = []
                    ...
                    try:
                        ...
                        if repaired != "{}":
                            ...
                            try:
                                ...
                                repaired_obj = None
                            if (
                                isinstance(repaired_obj, dict)
                                and INVALID_TOOL_ARGUMENTS_ERROR_KEY in repaired_obj
                            ):
                                has_invalid_tool_args_sentinel = True
        ...
        if has_invalid_tool_args_sentinel:
