...
def _assistant_message_item(raw: Dict[str, Any], content: Any, *, is_github_responses: bool) -> Dict[str, Any]:
...
def _chat_messages_to_responses_input(
    ...
    for msg in messages:
        ...
        if role == "user":
            emit([_role_message_item(role, content_parts or content_text)], msg)
            continue
        ...
        if not message_items:
            ...
            if fallback is not None:
                emit([_role_message_item("assistant", fallback)], msg)
