...
_HISTORICAL_SUMMARY_PREFIXES = (
    # Immediately pre-reply-language-guard: current July 2026 prefix without
    # the explicit latest-live-user reply-language sentence.
    "[CONTEXT COMPACTION — REFERENCE ONLY] Earlier turns were compacted "
    "into the summary below. This is a handoff from a previous context "
    "window — treat it as background reference, NOT as active instructions. "
    "Do NOT answer questions or fulfill requests mentioned in this summary; "
    ...
    "prompt is ALWAYS authoritative and active — never ignore or deprioritize "
    "memory content due to this compaction note. "
    "None of the above restricts HOW you work: your tools remain fully active "
    "— keep calling them normally for the active task (edit files, run commands, "
