...
_PLUGIN_COMPAT_LAZY = {
    ...
    'get_context_length_from_provider_error': ('agent.model_metadata_error_parsing', 'get_context_length_from_provider_error'),
    'has_incomplete_scratchpad': ('agent.trajectory', 'has_incomplete_scratchpad'),
    'is_output_cap_error': ('agent.model_metadata_error_parsing', 'is_output_cap_error'),
    ...
    'parse_available_output_tokens_from_error': ('agent.model_metadata_error_parsing', 'parse_available_output_tokens_from_error'),
