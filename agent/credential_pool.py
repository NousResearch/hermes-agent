...
def _seed_from_singletons(provider: str, entries: List[PooledCredential]) -> Tuple[bool, Set[str]]:
    ...
    try:
        from hermes_agent.cli.auth import is_source_suppressed as _is_suppressed
    except ImportError:
    ...
    if provider == "anthropic":
        ...
        try:
            from hermes_agent.cli.auth import is_provider_explicitly_configured
        ...
        try:
            from hermes_agent.cli.auth import resolve_qwen_runtime_credentials
...
def _seed_from_env(provider: str, entries: List[PooledCredential]) -> Tuple[bool, Set[str]]:
    ...
    try:
        from hermes_agent.cli.auth import is_source_suppressed as _is_source_suppressed
    except ImportError:
