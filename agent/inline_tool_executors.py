...
INLINE_TOOL_EXECUTORS: Dict[str, InlineToolExecutor] = {
    ...
    # Multi-question clarify card (one round-trip for several questions);
    # answered through the GUI's clarify_form.respond bridge.
    "clarify_form": _callback_tool(
        "tools.clarify_form_tool", "clarify_form_tool", "clarify_form_callback",
        ("questions", "questions"),
    ),
