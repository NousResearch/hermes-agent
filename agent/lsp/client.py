...
class LSPClient:
    ...
    def _workspace_folders(self) -> List[Dict[str, Any]]:
        return [
            {"name": "workspace", "uri": file_uri(r)} for r in self.workspace_folders
        ]
    ...
    async def add_workspace_folder(self, root: str) -> None:
        ...
        await self._send_notification(
            ...
            {"event": {"added": [{"name": "workspace", "uri": file_uri(root)}], "removed": []}},
        )
