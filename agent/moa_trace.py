...
def _slot_trace(acct: Any, label: str) -> dict[str, Any]:
    ...
    return {
        ...
        "started_at": getattr(acct, "started_at", None),
        "ended_at": getattr(acct, "ended_at", None),
        "duration_ms": getattr(acct, "duration_ms", None),
...
def save_moa_turn(
    *,
    ...
    aggregator_started_at: float | None = None,
    aggregator_ended_at: float | None = None,
    aggregator_duration_ms: int | None = None,
    ...
    try:
        ...
        record = {
            ...
            "aggregator": {
                ...
                "started_at": aggregator_started_at,
                "ended_at": aggregator_ended_at,
