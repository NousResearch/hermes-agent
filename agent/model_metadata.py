...
# aren't routable on Codex); ``gpt-5.4`` is EXACT because gpt-5.4-mini enforces 272K. Only
# released GPT-6 Sol/Luna inherit the 5.6 tier verdict; there is no GPT-6 Terra. The live
