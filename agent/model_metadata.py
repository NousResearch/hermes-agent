...
_PROVIDER_PREFIXES: frozenset[str] = frozenset({
    ...
    "gemini", "ollama-cloud", "zai", "kimi-coding", "kimi-coding-cn", "kimi-coding-b", "kimi-coding-c", "stepfun", "minimax", "minimax-oauth", "minimax-cn", "anthropic", "deepseek",
...
DEFAULT_CONTEXT_LENGTHS = {
    ...
    "qwen3.7-plus": 1048576,      # 1M context (OpenCode Go, 2026-06 confirmed)
    "qwen3.7-max": 1048576,       # 1M context (OpenCode Go, 2026-06 confirmed)
