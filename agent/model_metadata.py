...
# Provider-error limit parsing (quoted context limits, output caps) lives in
# agent/model_metadata_error_parsing.py; not re-exported — internal paths are not API.
...
_PLUGIN_COMPAT_LAZY = {
    ...
    'parse_context_limit_from_error': ('agent.model_metadata_error_parsing', 'parse_context_limit_from_error'),
}
