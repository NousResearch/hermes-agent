...
def busy_input_hint_gateway(mode: str) -> str:
    ...
    """
    if mode == "queue":
        return t("gateway.onboarding_busy_queue")
    if mode == "steer":
        return t("gateway.onboarding_busy_steer")
    return t("gateway.onboarding_busy_interrupt")
...
def tool_progress_hint_gateway() -> str:
    return t("gateway.onboarding_tool_progress")
