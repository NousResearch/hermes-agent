...
KANBAN_GUIDANCE = (
    ...
    "Keep notes short: current step + evidence/blocker, no technical rambling. "
    ...
    "metadata=...)`. `summary` is 1–3 short human-readable sentences naming concrete "
    "outcome, evidence, and remaining risk only. `metadata` is machine-readable facts "
...
PLATFORM_HINTS = {
    ...
    "webui": (
        ...
        "Prefer structured, readable final answers when the task has a result: "
        "start with a short conclusion heading or sentence, then use concise "
        "sections, paragraphs, bullet/numbered lists, inline code for identifiers "
        "and fenced code blocks for commands or snippets. Do not flatten multi-step "
        "results into a dense plain-text paragraph. "
