...
KANBAN_GUIDANCE = (
    ...
    "For GitHub issue or pull-request intake, use `gh issue/pr list/view --json`; "
    "in protected remote workers, do not use raw `curl`, GitHub API URLs, or "
    "inline Python/JQ fetch scripts.\n"
