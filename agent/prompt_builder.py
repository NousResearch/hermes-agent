...
KANBAN_GUIDANCE = (
    ...
    "the open PR URL, repository, PR number, exact 40-character head SHA, "
    "verification evidence, deployment implications, and original implementer. "
    "It preserves implementation evidence and routes the card to the Review "
    "lane; `kanban_block` remains only for genuine human input, credentials, "
