...
KANBAN_GUIDANCE = (
    ...
    "Exception: if your output is a code change/PR that needs review "
    "before counting as merged/done (most coding tasks), call "
    "`kanban_review(summary=..., metadata={pr_url, branch, commit, changed_files, tests_run, ...})`. "
    "This moves the task to the Review column and assigns it to the default "
    "reviewer profile; do NOT use `kanban_block` merely because a PR exists. "
    "Block only for genuine missing input or non-executable judgment.\n"
