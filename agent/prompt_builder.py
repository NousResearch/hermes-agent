...
def build_skills_system_prompt() -> str:
    ...
    return (
        ...
        "Only promise skill-backed actions when the matching skill is listed below and "
        "its prerequisites are available. Skills are optional capabilities, not built-in tools. "
        "If a needed skill or dependency is missing, say so plainly instead of implying the action is built in.\n"
        "\n"
        "<available_skills>\n"
        + "\n".join(index_lines) + "\n"
        "</available_skills>\n"
