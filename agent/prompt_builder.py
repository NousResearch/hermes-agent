...
KANBAN_GUIDANCE = (
    ...
    "For GitHub PR intake, including PRs by Codex, Claude, or Hermes workers, use host Hermes: `hermes "
    "github-pr-feedback inspect-pr --repository OWNER/REPO --pr-number N`; paginate issue comments, review "
