...
KANBAN_GUIDANCE = (
    ...
    "This must be a real tool call. Do not write `kanban_complete(...)` or "
    "`kanban_block(...)` in Markdown, prose, or code fences; text does not "
    "update the board. Your final worker action is the structured tool call "
    "itself, not an explanation that you are about to call it. "
