...
def _build_skills_system_prompt_inner(
    ...
    if not skills_by_category:
        ...
        result = (
            ...
            "Before calling skill_view, check whether that skill has already been loaded in the current "
            "conversation. For efficiency, load each matching skill at most once per conversation and "
            "reuse the content already in the conversation. Reload only if the earlier result was "
            "unavailable, pruned, or the skill changed. "
