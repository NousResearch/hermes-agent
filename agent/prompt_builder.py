...
KANBAN_GUIDANCE = (
    ...
    "If your output is complete but needs human or configured-agent review "
    "before counting as merged/done (most coding tasks), call "
    "`kanban_review(summary=..., metadata=..., pr_url=..., head_sha=...)`. "
    "This closes your implementation run and moves the card to Review without "
    "marking it Done or misclassifying successful work as Blocked. Reserve "
    "`kanban_block` for a genuine condition that prevents progress.\n"
