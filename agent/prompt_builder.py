...
KANBAN_GUIDANCE = (
    ...
    "\n"
    "- **PR merge authority.** Immediately before merging, call "
    "`kanban_authority()` and merge only when `allowed` is exactly true. "
    "Authority does not waive CI or security gates.\n"
