...
def build_skills_system_prompt(
    ...
    if not skills_by_category:
        ...
        result = (
            ...
            "loading a skill. Before creating a skill, inspect the catalog and patch an existing "
            "directly scoped skill instead of creating an overlapping alias. Keep each main SKILL.md "
            "compact and procedural; move bulky evidence, chronology, and branch-specific material "
            "to linked references, and keep live project state in project docs.\n"
