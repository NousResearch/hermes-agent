...
KANBAN_GUIDANCE = (
    ...
    "scope-creeping into the next thing. **Security re-review cards are the "
    "priority-preserving special case:** when you spawn one inside a builder "
    "chain, pass `parents=[your-task-id], inherit_parent_priority=true`. This "
    "copies the builder card's priority so an urgent chain stays urgent; do "
    "not apply it to generic follow-up cards.\n"
    "\n"
    "## Orchestrator mode\n"
    "\n"
