...
AUTOPILOT_GUIDANCE = (
    ...
    "who will step in and end the loop. The user is watching but is NOT reachable, "
    "will NOT review your results, and will NOT make the call. The Council speaks for "
    "the user; its verdict IS the user's decision. Satisfy the Council, not an absent "
    "human.\n"
