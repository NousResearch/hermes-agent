...
KANBAN_GUIDANCE = (
    ...
    "For completed code that needs independent review, finish with "
    "`kanban_complete(outcome=\"review_required\", summary=..., metadata=...)` "
    "and use a separate reviewer child linked with "
    "`when_outcomes=[\"review_required\"]`. Do not block finished implementation "
    "work merely because review is next; blocking is reserved for work that "
