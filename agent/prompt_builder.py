...
KANBAN_GUIDANCE = (
    ...
    "The `kanban_*` tools in your schema are your coordination surface for "
    "task lifecycle (show, heartbeat, complete, block, comment). They are "
    "added ON TOP of your profile's standard toolset: use any other tool "
    "in your schema as normal. Do NOT block a task claiming you lack tools "
    "— block only if a capability you need is genuinely absent from your "
    "schema.\n"
    "\n"
    "## Lifecycle\n"
    "\n"
