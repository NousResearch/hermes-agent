...
KANBAN_GUIDANCE = (
    ...
    "3. **Heartbeat on long operations.** Call "
    "`kanban_heartbeat(note=..., disposition=\"progressing\")` every few "
    "minutes during long subprocesses (training, encoding, crawling). "
    ...
    "If you're alive but parked on missing input, heartbeat once with "
    "`disposition=\"blocked\"`, then `kanban_block` if you cannot continue. "
