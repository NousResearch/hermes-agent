...
KANBAN_GUIDANCE = (
    ...
    "If `kanban_show()` lists child IDs, inspect those cards with "
    ...
    "reviewer=<optional-profile>)` instead of `kanban_complete`. The reviewer "
    "approves with `kanban_complete`, returns actionable rework with "
