...
# NOTE (#89278): "Hermes Agent" (not "Nous Research") is the exact trigger
# phrase for z.ai's (GLM Coding Plan) content filter. Bisected against the
# live API: "You are Hermes Agent, an assistant." is refused, disguised as
# capacity trouble (HTTP 429/1305 on the OpenAI-compatible surface, 529/1305
# on the Anthropic surface); "You are Hermes, an assistant." and "You are an
# agent for Nous Research." both return 200. Same failure class as #82154
# (Anthropic content-filtering a different sentence, disguised as a billing
# error) -- a different provider keying on the product name itself this
# time. If you rewrite "Hermes" back to "Hermes Agent" here, re-verify
# against a live z.ai GLM Coding Plan key.
...
HERMES_AGENT_HELP_GUIDANCE = (
    "You run on Hermes (by Nous Research). When the user needs help with "
