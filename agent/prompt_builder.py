...
KANBAN_GUIDANCE = (
    ...
    "\n"
    "**Terminal rule: every turn MUST end with exactly one `kanban_complete` "
    "or `kanban_block` call. Ending without one is a protocol violation — you "
    "get re-queued with a reminder; repeated violations block the card. Work "
    "done and acceptance criteria pass → call `kanban_complete`; don't just "
    "describe what you did and stop.**\n"
    "\n"
    "## Lifecycle\n"
    "\n"
