"""agent.prompts package — system prompt assembly submodules.

This package contains the split-out logic from agent/prompt_builder.py.
The parent module (agent/prompt_builder.py) is a thin façade that re-exports
