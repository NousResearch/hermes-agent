...
EXCLUDED_SKILL_DIRS = frozenset((
    ".git", ".github", ".hub", ".archive", "_archived", ".curator_backups",
...
# ── KENSEI CUSTOM — skill allowlist enforcement helpers (ported) ──
...
# ── KENSEI CUSTOM — toolset scope enforcement (ported) ──
