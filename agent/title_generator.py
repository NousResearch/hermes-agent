...
def generate_title(
    ...
    ``assistant_response`` is accepted for call-compatibility and is no longer
    used: titling now fires before the assistant has answered, and every
    surveyed implementation that titles well (Claude Code, OpenCode, Cursor,
    OpenClaw) titles from the user's message alone.
