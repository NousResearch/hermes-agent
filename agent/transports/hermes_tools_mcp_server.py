...
EXPOSED_TOOLS: tuple[str, ...] = (
    ...
    "kanban_show",
    "kanban_list",
    # Routing tools remain listed for authorized Codex-runtime orchestrators;
    # their normal Kanban check_fn/runtime guards enforce
    # HERMES_KANBAN_ROUTING_AUTHORITY for dispatched workers.
    "kanban_create",
    "kanban_unblock",
    "kanban_link",
)
