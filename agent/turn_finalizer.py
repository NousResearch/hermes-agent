...
from agent.prompt_cache_warmer import settle_prompt_cache_warming
...
def finalize_turn(
    ...
    # Streaming-mode warming ends with the run; idle mode keeps the entry warm between turns.
    settle_prompt_cache_warming(agent)
