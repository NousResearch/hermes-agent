...
def resolve_billing_route(
    ...
    # Normalize every Google-flavoured provider and endpoint to the pricing
    # table's canonical ``google`` key.
    if (
        provider_name in {
            "google", "gemini", "vertex", "google-gemini",
            "google-ai-studio", "google-vertex", "vertex-ai",
        }
