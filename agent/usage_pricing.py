...
class PricingEntry:
    ...
    cache_write_cost_per_million_1h: Optional[Decimal] = None
...
_OFFICIAL_DOCS_PRICING: Dict[tuple[str, str], PricingEntry] = {
    ...
    (
        ...
        cache_write_cost_per_million_1h=Decimal("20.00"),
        source="official_docs_snapshot",
    ...
    (
        ...
        cache_write_cost_per_million_1h=Decimal("6.00"),
        source="official_docs_snapshot",
        source_url="https://platform.claude.com/docs/en/about-claude/pricing",
        pricing_version="anthropic-pricing-2026-05",
    ),
    ...
    (
        ...
        cache_write_cost_per_million_1h=Decimal("2.00"),
        source="official_docs_snapshot",
        source_url="https://platform.claude.com/docs/en/about-claude/pricing",
        pricing_version="anthropic-pricing-2026-05",
    ),
    ...
    (
        ...
        cache_write_cost_per_million_1h=Decimal("30.00"),
        source="official_docs_snapshot",
        source_url="https://platform.claude.com/docs/en/about-claude/pricing",
        pricing_version="anthropic-pricing-2026-05",
    ),
    ...
    (
        ...
        cache_write_cost_per_million_1h=Decimal("1.60"),
        source="official_docs_snapshot",
        source_url="https://platform.claude.com/docs/en/about-claude/pricing",
        pricing_version="anthropic-pricing-2026-05",
    ),
    ...
    (
        ...
        cache_write_cost_per_million_1h=Decimal("0.48"),
        source="official_docs_snapshot",
        source_url="https://platform.claude.com/docs/en/about-claude/pricing",
        pricing_version="anthropic-pricing-2026-05",
    ),
...
def estimate_usage_cost(
    ...
    *,
    ...
    # Note: cache_write_cost_per_million uses the standard 5-minute tier.
    # Anthropic models also have cache_write_cost_per_million_1h (1-hour tier)
    # but the API usage payload does not expose cache TTL, so we cannot
    # determine which tier applies.  See PricingEntry.cache_write_cost_per_million_1h.
