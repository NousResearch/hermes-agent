// North Forge Setup — process entrypoint. All logic lives in lib.rs so it
// can be unit-tested as a library; this file just calls into it.
//
...
// cmd window behind the setup window on release builds.
//
