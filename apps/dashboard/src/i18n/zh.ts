...
export const zh: Translations = {
  ...
  status: {
    ...
    stopped: "已停止",
    updateMetakinaAgent: "更新 metakina-agent",
    updatingMetakinaAgent: "正在更新 metakina-agent…",
  ...
  profiles: {
    newProfile: "新建 metakina-agent 配置",
    name: "名称",
    namePlaceholder: "例如：coder, writer 等",
    nameRequired: "名称必填",
    nameRule:
      "仅允许小写字母、数字、下划线和短横线；首字符必须是字母或数字；最多 64 个字符。",
    invalidName: "metakina-agent 配置名称非法",
    cloneFromDefault: "从默认 metakina-agent 配置克隆配置",
    allProfiles: "metakina-agent 配置列表",
    noProfiles: "暂无 metakina-agent 配置。",
    defaultBadge: "默认",
    hasEnv: "已配置 env",
    model: "模型",
    skills: "技能",
    ...
    copyFailed: "复制失败",
    confirmDeleteTitle: "删除 metakina-agent 配置？",
    confirmDeleteMessage:
      "将永久删除 metakina-agent 配置 '{name}' — 包括配置、密钥、记忆、会话、技能、定时任务。此操作无法撤销。",
    created: "已创建",
    deleted: "已删除",
    renamed: "已重命名",
  },
  ...
  pluginsPage: {
    ...
    headline: "发现、安装、启用和更新 metakina-agent 插件（对齐 `hermes plugins` CLI）。",
