...
// Keep state initialization at main's original startup point, after userData overrides.
export function createLinkMetadataRuntime() {
  ...
  // electron/link-title-wall.ts; this runtime supplies the two tiers' I/O.
  ...
  return { fetchLinkTitle, resolveFaviconCached }
}
