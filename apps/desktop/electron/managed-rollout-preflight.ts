...
import {
  isVerifiedAssurance, isVerifiedGitSource, REVIEWED_SOURCE_FRESHNESS_MS, reviewedGitSourceMetadata,
...
class StrictJsonParser {
  ...
  private skipWhitespace(): void {
    // eslint-disable-next-line no-control-regex -- JSON permits only these four whitespace bytes
...
// eslint-disable-next-line no-control-regex -- reject NUL and line breaks in cache identity
const RESOLUTION_CONTROL_RE = /[\x00\r\n]/
