...
contextBridge.exposeInMainWorld('hermesDesktop', {
  ...
  browser: {
    ...
    act: (action, sessionId) => ipcRenderer.invoke('hermes:browser:act', action, sessionId),
    completeAction: payload => ipcRenderer.invoke('hermes:browser:actionResult', payload),
    snapshot: sessionId => ipcRenderer.invoke('hermes:browser:snapshot', sessionId),
    completeSnapshot: payload => ipcRenderer.invoke('hermes:browser:snapshotResult', payload),
