...
contextBridge.exposeInMainWorld('hermesDesktop', {
  ...
  git: {
    ...
    review: {
      ...
      snapshot: (repoPath, pin) => ipcRenderer.invoke('hermes:git:review:snapshot', repoPath, pin),
      releaseSnapshot: (repoPath, pin) => ipcRenderer.invoke('hermes:git:review:releaseSnapshot', repoPath, pin),
