...
describe('build stamp → update ownership', () => {
  ...
  it.each([
    ...
    const stamp: ReturnType<typeof buildStampPayload> = buildStampPayload(provenance, { HERMES_DESKTOP_VARIANT: variant, HERMES_PAYLOAD_TAG: 'v1.2.3' }, platform, { runtime })
