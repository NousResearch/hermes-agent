...
import { CROSS_ENGINE_HERMES_HOME, CROSS_ENGINE_PORT } from './e2e/dashboard-cross-engine-home'
  ...
  projects: [
    ...
    ...(hasEdge
      ? [
          {
            name: 'edge',
            use: { ...devices['Desktop Chrome'], browserName: 'chromium' as const, channel: 'msedge' as const }
          }
        ]
      : [])
  ],
