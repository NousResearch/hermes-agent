...
// Reactive routing identity lets persisted window preferences reload when a
// late startup route or a live profile/connection switch becomes active.
export const $apiRequestScope = map<ApiRequestScope>({ connectionId: null, profile: null })
