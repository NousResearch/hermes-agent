...
export function ChatBar({
  ...
  const handleEditorInput = (event: FormEvent<HTMLDivElement>) => {
    ...
    //
    // Remote desktop software (e.g. Jump Desktop) can silently drop
    // compositionend, leaving composingRef stuck at true. Self-heal: if the
    // browser reports composition is no longer active, reset so this input
    // event (which carries the committed text) reaches the draft state.
  ...
  const handleEditorKeyDown = (event: KeyboardEvent<HTMLDivElement>) => {
    ...
    //
    // Remote desktop software (e.g. Jump Desktop) can silently drop
    // compositionend, leaving composingRef stuck at true. Self-heal by trusting
    // the browser-native isComposing flag when the two disagree.
