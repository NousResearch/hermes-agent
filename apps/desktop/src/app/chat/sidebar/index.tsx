...
const SIDEBAR_NAV: SidebarNavItem[] = [
  ...
  { id: 'messaging', label: '메시징', icon: props => <Codicon name="comment" {...props} />, route: MESSAGING_ROUTE },
  { id: 'artifacts', label: '아티팩트', icon: props => <Codicon name="files" {...props} />, route: ARTIFACTS_ROUTE }
]
