...
import { type AppView, ARTIFACTS_ROUTE, GROUPS_ROUTE, MESSAGING_ROUTE, SKILLS_ROUTE } from '../../routes'
...
const SIDEBAR_NAV: SidebarNavItem[] = [
  ...
  { id: 'groups', label: '', icon: props => <Codicon name="organization" {...props} />, route: GROUPS_ROUTE },
