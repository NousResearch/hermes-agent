          ...
          <div className="relative z-2 grid w-[1.375rem] place-items-center" data-row-actions>
            ...
            >
              <Button
                ...
                className="size-5 rounded-[var(--radius-sm)] bg-transparent text-transparent transition-[background-color,color,transform] duration-150 hover:bg-(--ui-control-active-background) hover:text-foreground active:scale-95 focus-visible:bg-(--ui-control-active-background) focus-visible:text-foreground focus-visible:ring-0 data-[state=open]:bg-(--ui-control-active-background) data-[state=open]:text-foreground group-hover:text-(--ui-text-tertiary) [&_svg]:size-3.5!"
                size="icon"
                variant="ghost"
              >
        ...
        >
          ...
          {handoffSource && handoffLabel ? (
            <Tip label={r.handoffOrigin(handoffLabel)}>
              <PlatformAvatar
                className="size-4 rounded-[var(--radius-sm)] text-[0.5rem] [&_svg]:size-2.5"
