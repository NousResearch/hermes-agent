...
const SkillsPage = lazy(async () => ({ default: (await import('../skills/page')).SkillsPage }))
...
export const ChatRoutesSurface = memo(function ChatRoutesSurface({
  ...
  return (
    <Routes>
      ...
      <Route element={page(<SkillsPage setStatusbarItemGroup={setStatusbarItemGroup} />)} path="skills" />
