  ...
  return (
    <>
      ...
      <div
        className={cn(
<<<<<<< HEAD
          'pointer-events-none relative z-20 h-[calc(var(--titlebar-height)+0.1875rem)] items-center justify-between gap-2 ps-3 pr-[calc(var(--titlebar-tools-right,0.75rem)+2.25rem)]',
=======
