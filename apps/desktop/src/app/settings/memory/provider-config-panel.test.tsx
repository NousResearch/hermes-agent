...
describe('ProviderConfigPanel', () => {
  it('renders the declared inline fields generically', async () => {
    ...
    expect(await panel.findByDisplayValue('myws')).toBeTruthy()
    expect(panel.getByPlaceholderText('https://… (self-hosted)')).toBeTruthy()
    expect(panel.getByText('Production')).toBeTruthy()
    expect(panel.getByText('Self-hosted Honcho URL.')).toBeTruthy()
  }, 15_000)
