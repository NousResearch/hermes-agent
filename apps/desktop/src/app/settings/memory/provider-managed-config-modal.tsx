...
export function ProviderManagedConfigModal({
  ...
  async function runAction(action: MemoryProviderConfigAction) {
    ...
    try {
      const result = await runMemoryProviderAction<{ message?: string; ok?: boolean }>(provider, action.name, payload)
  ...
  async function save(overwrite = false) {
    ...
    try {
      await runMemoryProviderAction(provider, config.submit_action, { overwrite, values })
