...
describe('titlebar app-action cluster', () => {
  ...
  it('defaults IDE, settings, layout, and HUD to the right so the left titlebar stays free for tabs', () => {
    renderControls('/')

    const left = screen.getByLabelText('Window controls')
    const right = screen.getByLabelText('App controls')

    expect(within(right).getByLabelText('Open Hermes IDE')).toBeTruthy()
    ...
    expect(within(left).queryByLabelText('Open Hermes IDE')).toBeNull()
  ...
  it('moves IDE, settings, layout, and HUD to the left when the appearance setting says left', () => {
    ...
    expect(within(left).getByLabelText('Open Hermes IDE')).toBeTruthy()
    ...
    expect(within(right).queryByLabelText('Open Hermes IDE')).toBeNull()
