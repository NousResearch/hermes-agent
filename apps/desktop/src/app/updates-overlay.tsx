  ...
  const { title, body } =
    behind === -2
      ? {
          ...
          body: "HEAD and origin/main have diverged (not a fast-forward). Review WIP before updating — this may switch to main / stash WIP.",
        }
      : resolveUpdateCopy({ target, shownItems, copy: u })
