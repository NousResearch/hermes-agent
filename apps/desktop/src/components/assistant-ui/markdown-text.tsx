...
interface MarkdownTextSurfaceProps {
   ...
   *  and on prose/list/quote boxes in place of the Auto resolver vote;
   *  undefined is Auto and lets each block resolve from its visible text. */
...
function MarkdownParagraph({
  ...
  textDirection,
  ...props
}: ComponentProps<'p'> & { scratchpad?: boolean; streaming?: boolean; textDirection?: 'ltr' | 'rtl' }) {
  ...
  return (
    <p className={paragraphClass} {...props} dir={textDirection ?? markdownChildrenDirection(children)}>
      {children}
    </p>
  )
}
...
function MarkdownTextSurface({
  ...
  const components = useMemo(
    () =>
      ({
        h1: ({ children, className, ...props }: ComponentProps<'h1'>) => (
          <h1 className={cn('my-1 font-semibold', HEADING_SIZES.h1, className)} {...props} dir={textDirection ?? markdownChildrenDirection(children)}>
            {children}
          </h1>
        ),
        h2: ({ children, className, ...props }: ComponentProps<'h2'>) => (
          <h2 className={cn('my-1 font-semibold', HEADING_SIZES.h2, className)} {...props} dir={textDirection ?? markdownChildrenDirection(children)}>
            {children}
          </h2>
        ),
        h3: ({ children, className, ...props }: ComponentProps<'h3'>) => (
          <h3 className={cn('my-1 font-semibold', HEADING_SIZES.h3, className)} {...props} dir={textDirection ?? markdownChildrenDirection(children)}>
            {children}
          </h3>
        ),
        h4: ({ children, className, ...props }: ComponentProps<'h4'>) => (
          <h4 className={cn('my-1 font-semibold', HEADING_SIZES.h4, className)} {...props} dir={textDirection ?? markdownChildrenDirection(children)}>
            {children}
          </h4>
        ),
        p: ({ children, ...props }: ComponentProps<'p'>) =>
          previewOnly ? (
            ...
            <MarkdownParagraph {...props} scratchpad={scratchpad} streaming={isStreaming} textDirection={textDirection}>
        ...
        blockquote: ({ children, className, ...props }: ComponentProps<'blockquote'>) => {
          ...
          return (
            <blockquote
              ...
              {...props}
              dir={textDirection ?? markdownChildrenDirection(children)}
            >
              {children}
            </blockquote>
          )
        ...
        ul: ({ children, className, ...props }: ComponentProps<'ul'>) => (
          <ul className={cn('my-1 gap-0', className)} {...props} dir={textDirection ?? markdownChildrenDirection(children)}>
            {children}
          </ul>
        ),
        ol: ({ children, className, ...props }: ComponentProps<'ol'>) => (
          <ol className={cn('my-1 gap-0', className)} {...props} dir={textDirection ?? markdownChildrenDirection(children)}>
            {children}
          </ol>
        ),
        li: ({ children, className, ...props }: ComponentProps<'li'>) => (
          <li className={cn('leading-(--dt-line-height)', className)} {...props} dir={textDirection ?? markdownChildrenDirection(children)}>
            {decorateText ? decorateText(children) : children}
          </li>
        ),
    ...
    [decorateText, disableArtifacts, isStreaming, previewOnly, scratchpad, textDirection]
  )
