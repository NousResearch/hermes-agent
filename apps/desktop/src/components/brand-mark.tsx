...
// Brand badge: IX Agency monogram on a white tile, identical in light/dark.
...
export function BrandMark({ className, ...props }: React.ComponentProps<'span'>) {
  return (
    <span
      ...
      {...props}
    >
      <img alt="" className="size-full object-contain p-0.5" src={assetPath('ix-agency-mark.svg')} />
    </span>
  )
}
