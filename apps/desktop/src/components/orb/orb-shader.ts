// Composed WGSL for the vendored orb renderer: fullscreen-triangle vertex
// shader, the particle-ribbon passes, and the glass composite pass, appended
// after the vendored `effect.wgsl` (which defines `orbGlassLiquidAnim` and the
// shared `u` uniform block).
//
// Ported from https://github.com/LerSent001/orb (src/shader-source.ts).
// Copyright (c) LerSent001. Licensed under the MIT License.

import effectSource from './vendor/effect.wgsl?raw'
