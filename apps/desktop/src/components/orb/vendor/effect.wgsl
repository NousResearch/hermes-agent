// Vendored from https://github.com/LerSent001/orb (effect.wgsl).
// Copyright (c) LerSent001. Licensed under the MIT License.
//
// Adapted for hermes-agent: imported as a raw WGSL string by
// apps/desktop/src/components/orb/orb-shader.ts. Kept verbatim
