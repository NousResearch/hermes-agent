...
// Shared system radius, readable default type, and padding-driven sizing (no fixed heights). The visual
...
export const controlVariants = cva(
  'desktop-input-chrome w-full min-w-0 rounded-[var(--radius-sm)] border text-[0.8125rem] leading-4 text-foreground outline-none placeholder:text-muted-foreground disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50',
  {
    variants: {
      size: {
