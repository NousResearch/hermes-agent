...
const switchThumbVariants = cva(
  'pointer-events-none block rounded-full bg-foreground shadow-[0_0.0625rem_0.1875rem_color-mix(in_srgb,var(--dt-background)_50%,transparent)] ring-0 transition-[background-color,transform] duration-200 ease-[cubic-bezier(0.2,0.8,0.2,1)] data-[state=unchecked]:translate-x-0 data-[state=checked]:bg-background',
  {
    variants: {
      size: {
