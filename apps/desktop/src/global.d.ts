...
declare global {
  type HermesConnectionReason = 'primary_boot' | 'profile_activate' | 'background_session' | 'unknown'
  ...
  interface Window {
    hermesDesktop: {
      ...
      getConnection: (profile?: string | null, reason?: HermesConnectionReason) => Promise<HermesConnection>
