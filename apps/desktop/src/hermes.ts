...
export function setStudyActiveProject(projectId: string): Promise<{
...
export function getStudyOverview(projectId?: string): Promise<StudyOverviewResponse> {
...
export function decideStudyPlanProposal(
  projectId: string,
  proposalId: string,
