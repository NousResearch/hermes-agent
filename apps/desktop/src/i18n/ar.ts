...
export const ar = defineLocale({
  ...
  shell: {
    ...
    statusbar: {
      ...
      turnRunning: 'الدور السابق',
      toggleRunningTimer: 'مدة الدور السابق',
      toggleSessionTimer: 'مؤقت الجلسة',
      contextUsage: 'استخدام السياق',
      session: 'الجلسة',
      toggleLatency: 'زمن استجابة الـ API',
      latencyTitle: 'متوسط زمن استجابة الـ API',
      toggleCompressions: 'مرات الضغط',
      toggleIdleSince: 'منذ آخر رد',
      idleSinceTitle: 'الوقت المنقضي منذ اكتمال آخر رد نهائي',
      compressionsTitle: 'مرات ضغط السياق تلقائيا',
      turnBreakdown: {
        title: 'الدور الأخير',
        running: 'قيد التنفيذ',
        wall: 'الوقت الكلي',
        tools: 'وقت الأدوات',
        model: 'وقت النموذج (تقديري)'
      },
      yoloOn: 'YOLO مفعل',
      yoloOff: 'YOLO معطل',
      modelNone: 'لا نموذج',
