...
export const ar = defineLocale({
  ...
  settings: {
    ...
    quitConfirmation: {
      title: 'التأكيد قبل الخروج',
      description:
        'طلب التأكيد قبل الخروج من Hermes على هذا الكمبيوتر. افتراضيًا، يُطلب التأكيد أثناء عمل الوكلاء فقط. يسري على جميع الملفات الشخصية.',
      never: 'أبدًا',
      whileWorking: 'أثناء عمل الوكلاء',
      always: 'دائمًا',
      loadFailed: 'تعذر تحميل تفضيل تأكيد الخروج.',
      saveFailed: 'تعذر حفظ تفضيل تأكيد الخروج. لا يزال اختيارك السابق ساريًا.'
    },
    quickEntry: {
