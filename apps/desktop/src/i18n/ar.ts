...
export const ar = defineLocale({
  ...
  settings: {
    ...
    vault: {
      ...
      registrableDomainLabel: 'السماح بنطاقات HTTPS الفرعية',
      registrableDomainHint: 'املأ في النطاق القابل للتسجيل ونطاقاته الفرعية عبر HTTPS. اتركه معطلاً ما لم تثق بجميع النطاقات الفرعية.',
      registrableDomainBadge: 'نطاقات HTTPS الفرعية',
  ...
  prompts: {
    ...
    vaultSaveRegistrableDomain: 'السماح بنطاقات HTTPS الفرعية',
    vaultSaveRegistrableDomainHint: 'وسّع تسجيل الدخول صراحةً إلى النطاق القابل للتسجيل نفسه. فعّله فقط إذا كنت تثق بجميع النطاقات الفرعية.',
