...
export const ar = defineLocale({
  sessionImport: {
    sources: 'المصادر',
    grok: 'Grok Bot',
    grokNotice: 'يستورد Grok Bot النص المخزن محليًا فقط. قد يكون السجل غير مكتمل، بما في ذلك رسائل أو ردود قديمة مفقودة.',
    title: 'المتابعة من تطبيق آخر',
    subtitle: 'استورد المحادثات المحلية من هذا الكمبيوتر إلى الوكيل المحدد. لا يشمل الاستيراد الجلسات السحابية فقط.',
    action: 'استيراد جلسة',
    readingFrom: 'القراءة من',
    connectedComputer: 'هذا الكمبيوتر',
    ...
    previewLimit: 'تم اختصار المعاينة لتسهيل القراءة. يتم استيراد كل نص المحادثة المتاح.',
    you: 'أنت',
