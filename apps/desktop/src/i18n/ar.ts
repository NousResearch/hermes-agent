...
export const ar = defineLocale({
  ...
  assistant: {
    thread: {
      ...
      recoveryMissing: 'لم يُعثر على رد في السجل',
      recoveryUnfinished: 'لم يُعثر على رد نهائي',
      recoveryPutBack: 'إعادة إلى حقل الإدخال',
      recoveryHide: 'إخفاء',
      recoveryHidden: 'تم إخفاء الرسالة على هذا الجهاز',
      recoveryUndo: 'تراجع',
      recoveryActivityHint: 'قد تكون الأدوات قد نُفذت. قد تؤدي إعادة الإرسال إلى تكرار الإجراءات.',
      recoveryHideHint: 'يخفي العرض على هذا الجهاز فقط دون تغيير سجل النموذج.',
      recoveryAttachmentHint: 'النص فقط. أعد إرفاق الملفات قبل الإرسال.',
      react: 'تفاعل',
      dismissError: 'تجاهل الخطأ',
      errorLayers: {
