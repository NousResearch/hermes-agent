...
export const ar = defineLocale({
  ...
  settings: {
    ...
    mobilePairing: {
      ...
      description: 'اقرن تطبيق iPhone المصاحب ببوابة Hermes هذه. يستخدم الهاتف الوكلاء والملفات الشخصية والجلسات والذاكرة والمهارات نفسها، ولا يشغّل وكيلاً آخر.',
      ...
      publicUrlRequired: 'اضبط dashboard.public_url على عنوان HTTPS خاص يصل إلى هذه البوابة، ثم حاول مجدداً. لا يمكن استخدام localhost أو HTTP العادي.',
      tokenRequired: 'لا يستطيع هذا الاتصال إصدار رمز محلي قابل لإعادة الاستخدام للبوابة. انتقل إلى بوابة Hermes تستخدم مصادقة الرمز.',
