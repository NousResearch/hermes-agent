...
export const ar = defineLocale({
  ...
  codingWorkspace: {
    ...
    showControlsDescription: "اعرض المشروع ومكان العمل فوق حقل الإدخال للمحادثات الجديدة في هذا الملف الشخصي. لا تتغير المحادثات الحالية أو تفضيلات الشريط الجانبي.",
