...
export const ar = defineLocale({
  ...
  settings: {
    ...
    model: {
      applyAllProfiles: "تطبيق على كل الملفات الشخصية",
      applyAllDesc: "تطبيق المزوّد والنموذج الافتراضي مرة واحدة على كل الملفات الشخصية لهذا الاتصال باستخدام إعدادات المزوّد الخاصة بكل ملف. يمكن تعديل كل ملف على حدة.",
      applyAllSuccess: "تم التطبيق",
      applyAllFailed: "فشل أو لم يتم التأكد",
      applyAllUnavailable: "لم يتم إعداد المزوّد أو النموذج لهذا الملف الشخصي.",
      applyAllConnectionRequired: "حدد اتصالاً أو أعد الاتصال قبل التطبيق على جميع الملفات الشخصية.",
      applyAllInterrupted: "توقفت العملية بسبب تغيير الاتصال أو الملف الشخصي.",
      applyAllNoProfiles: "لا توجد ملفات شخصية متاحة.",
      applyAllMoaUnavailable: "يجب إعداد إعدادات Mixture of Agents المسبقة في كل ملف شخصي.",
