...
export const ar = defineLocale({
  ...
  settings: {
    ...
    appearance: {
      ...
      composerListsTitle: 'القوائم في مربع الرسالة',
      composerListsDesc:
        'Shift+Enter يواصل القائمة المرقّمة أو النقطية أو قائمة مربعات الاختيار؛ Tab وShift+Tab يُدرجان العناصر. واصل أيضًا:',
      composerListStyles: {
        letters: 'الحروف (a. b. c.)',
        roman: 'الأرقام الرومانية (i. ii. iii.)',
        outline: 'أرقام المخطط (1.1. 1.2.)',
        parentheses: 'الأقواس ((1) (a))',
        symbols: 'نقاط الرموز (• ◦ ▪)'
      },
