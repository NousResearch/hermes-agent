...
export const ar = defineLocale({
  ...
  cron: {
    ...
    modelImpact: {
      ...
      message: count =>
        `${count} من المهام المجدولة غير المثبتة لا تزال تستخدم النموذج السابق. استخدم النموذج الجديد، أو أغلق هذه الرسالة لإبقائها دون تغيير.`,
      detailMore: (names, remaining) => `${names} و${remaining} أخرى`,
      adopt: 'استخدام الإعداد الافتراضي الجديد',
      adopted: count => `تستخدم ${count} من المهام المجدولة الإعداد الافتراضي الجديد الآن.`,
      adoptFailed: 'تعذر تحديث المهام المجدولة.',
