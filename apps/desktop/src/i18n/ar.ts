...
export const ar = defineLocale({
  ...
  assistant: {
    thread: {
      ...
      subagentCompleted: 'اكتمل الوكيل الفرعي',
      subagentsCompleted: 'اكتملت الوكلاء الفرعيون',
      showFullPayload: 'عرض الحمولة الكاملة',
      hideFullPayload: 'إخفاء الحمولة الكاملة',
