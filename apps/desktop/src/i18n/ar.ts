...
export const ar = defineLocale({
  ...
  settings: {
    ...
    appearance: {
      ...
      interfaceStyleTitle: 'نمط واجهة GNOME',
      interfaceStyleDesc: 'استخدم مظهرًا مستوحى من Adwaita دون تغيير ميزات Hermes أو تخطيطه.',
      interfaceStyleTypographyTitle: 'خطوط Adwaita',
      interfaceStyleTypographyDesc: 'استخدم Adwaita Sans عند توفره، مع الرجوع إلى خطوط النظام.',
      interfaceStyleControlsTitle: 'عناصر تحكم أكثر نعومة',
      interfaceStyleControlsDesc: 'دوّر الأزرار وأشرطة العنوان وتحديدات الشريط الجانبي برفق.',
      interfaceStyleSurfacesTitle: 'الأسطح العائمة',
      interfaceStyleSurfacesDesc: 'امنح القوائم والنوافذ المنبثقة تباعدًا ومنحنيات وظلالًا شبيهة بـ GNOME.',
