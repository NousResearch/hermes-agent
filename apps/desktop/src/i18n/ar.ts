...
export const ar = defineLocale({
  ...
  sidebar: {
    ...
    row: {
      ...
      stamp: 'ختم',
      stampClear: 'مسح كل الأختام',
      stampCustom: 'ختم مخصص…',
      stampCustomPlaceholder: 'مثال: تم الدمج أو في انتظار CI',
      stampLimit: max => `حتى ${max} أختام لكل جلسة`,
      stampSaved: label => `تم ختم ${label}`,
      stampRemoved: label => `تمت إزالة ${label}`,
      stampCleared: 'تم مسح الختم',
      stampRemove: label => `حذف «${label}» من قائمة الأختام`,
      stampRestore: 'استعادة الأختام المحذوفة',
      stampAdd: 'إضافة ختم…',
      stampAddPlaceholder: 'مثال: موقوف',
      stampEmoji: 'إيموجي…',
      stampEmojiEmpty: 'لم يتم العثور على إيموجي',
      stampEmojiPick: label => `ختم بـ ${label}`,
      stampEmojiSearch: 'ابحث عن إيموجي',
      stampColor: label => `لون «${label}»`,
      stampColorReset: 'اللون الافتراضي',
