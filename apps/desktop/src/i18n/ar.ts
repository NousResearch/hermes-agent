...
export const ar = defineLocale({
  ...
  statusStack: {
    ...
    markDoneAria: task => `وضع علامة مكتمل على المهمة: ${task}`,
    reopen: 'إعادة الفتح',
    reopenAria: task => `إعادة فتح المهمة: ${task}`,
    retryTaskSync: 'إعادة المحاولة',
    syncingTask: 'جارٍ مزامنة حالة المهمة',
    markDoneTitle: 'هل تريد وضع علامة مكتمل على المهمة؟',
    markDoneDescription: 'سيتعامل Hermes مع هذا كقرار منك ولن يعيد فتح المهمة بسبب تحديث أقدم من النموذج.',
    markingDone: 'جارٍ وضع علامة مكتمل…',
    markedDone: 'تم وضع علامة مكتمل',
    reopenTitle: 'هل تريد إعادة فتح المهمة؟',
    reopenDescription: 'قد يواصل Hermes العمل على هذه المهمة.',
    reopening: 'جارٍ إعادة الفتح…',
    reopened: 'أُعيد فتحها',
    taskChanged: 'تغيّرت المهام أثناء التأكيد. راجع القائمة الأحدث وحاول مرة أخرى.',
    taskMissing: 'لم تعد هذه المهمة موجودة في الخطة الحالية.',
    taskSessionMissing: 'جلسة المهمة لم تعد متاحة. استأنف المحادثة وحاول مرة أخرى.',
    taskSyncFailed: 'تعذّرت مزامنة حالة المهمة',
    taskUpdateFailed: 'تعذر تحديث حالة المهمة. حاول مرة أخرى.',
    taskUpdatesUnavailable: 'تحديثات المهام غير متاحة',
