...
export const ar = defineLocale({
  ...
  preview: {
    ...
    invalidNotebookTitle: 'ليس دفتر Jupyter',
    invalidNotebookBody: 'تعذّر تحليل هذا الملف كـ nbformat JSON. انتقل إلى المصدر لمعاينة الملف الخام.',
    notebookWidget: 'ودجة تفاعلية (غير معروضة)',
    edit: 'تحرير',
    editing: 'جار التحرير',
    unsavedChanges: 'تغييرات غير محفوظة',
