...
export const ar = defineLocale({
  ...
  settings: {
    ...
    notifications: {
      title: 'الإشعارات',
      intro:
        'تحكّم في التنبيهات داخل التطبيق وإشعارات نظام التشغيل وأصوات الاكتمال. تُحفظ الإعدادات محلياً لكل جهاز.',
      ...
      inAppPositionTitle: 'موضع التنبيهات داخل التطبيق',
      inAppPositionDesc:
        'اختر زاوية ظهور التنبيهات العادية داخل التطبيق. تبقى الأخطاء والتنبيهات التي تتطلب إجراء في أعلى المنتصف.',
      inAppPositions: {
