...
export const deOverrides = {
  ...
  sidebar: {
    ...
    row: {
      ...
      startSlackSync: 'Mit Slack-Thread synchronisieren',
      stopSlackSync: 'Slack-Synchronisierung beenden',
      slackSyncFailed: 'Slack-Synchronisierung konnte nicht geändert werden',
      copyId: 'ID kopieren',
      export: 'Exportieren',
      branchFrom: 'Branch',
      rename: 'Umbenennen…',
