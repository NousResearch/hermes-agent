...
export const de = defineLocale({
  ...
  settings: {
    ...
    model: {
      ...
      tasks: {
        ...
        web_extract: { label: 'Web-Extraktion', hint: 'Page summarization' },
        compression: { label: 'Komprimierung', hint: 'Context compaction' },
        skills_hub: { label: 'Fähigkeiten-Hub', hint: 'Skill search' },
        approval: { label: 'Freigabe', hint: 'Smart auto-approve' },
        mcp: { label: 'MCP', hint: 'MCP tool routing' },
        title_generation: { label: 'Titel-Generierung', hint: 'Session titles' },
        curator: { label: 'Kurator', hint: 'Skill-usage review' }
      }
    },
    providers: {
  ...
  commandCenter: {
    ...
    archivedChats: 'Archivierte Chats',
    sections: { maintenance: 'Wartung', sessions: 'Sessions', system: 'System', usage: 'Usage' },
    sectionDescriptions: {
    ...
    nav: {
      newChat: { title: 'Neue Sitzung', detail: 'Start a fresh session' },
      settings: { title: 'Einstellungen', detail: 'Configure Hermes desktop' },
      skills: { title: 'Funktionen', detail: 'Skills, tools, and MCP servers' },
      messaging: { title: 'Messaging', detail: 'Set up Telegram, Slack, Discord, and more' },
      artifacts: { title: 'Artefakte', detail: 'Browse generated outputs' }
    },
    sectionEntries: {
      sessions: { title: 'Sitzungspanel', detail: 'Search, pin, and manage sessions' },
      system: { title: 'Systempanel', detail: 'Gateway status, logs, restart/update' },
      usage: { title: 'Nutzungspanel', detail: 'Token, cost, and skill activity' }
    },
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      DISCORD_REPLY_TO_MODE: { label: 'Antwortstil', help: 'first, all, or off.' },
      ...
      QQBOT_HOME_CHANNEL: { label: 'QQ-Home-Kanal', help: 'Default channel or group for cron delivery.' },
      ...
      SLACK_ALLOWED_USERS: { label: 'Erlaubte Slack-Benutzer-IDs', help: 'Recommended. Comma-separated Slack user IDs.' },
      ...
      SIGNAL_ACCOUNT: { label: 'Telefonnummer', help: 'The number registered with your signal-cli bridge.' },
      SIGNAL_ALLOWED_USERS: { label: 'Erlaubte Signal-Benutzer', help: 'Recommended. Comma-separated Signal identifiers.' },
      WHATSAPP_ENABLED: {
