...
export const en: Translations = {
  ...
  codingWorkspace: {
    ...
    agentWorktreeNote: "The agent created this worktree during the chat.",
    newChatHere: "New chat in this worktree",
    projectFolder: "Project folder",
    initializeGit: "Initialize Git repository",
    initializeGitDescription: "Creates the repository with an empty first commit. Your files stay untracked.",
    initializeGitFailed: "Could not initialize Git repository",
    ...
    dirtyNotCopied: "Uncommitted source changes are not copied into the new worktree.",
    createOnSend: "Created on first Send, not now.",
    shared: "This checkout may be shared with other chats. Changes are not isolated.",
    preparing: "Preparing workspace",
    workInProject: "Work in project…",
    useAsProject: "Use as project",
    newChat: "New chat in another workspace…",
    binding: "This chat stays in its original workspace.",
    selectCheckout: "Choose checkout",
    folderFailed: "Could not use this folder as a project",
    unavailable: "Workspace selection is unavailable until this chat has a connected owner.",

    showControls: "Show coding controls",
    showControlsDescription: "Show Project and Work in above the input for new chats in this profile. Existing chats and sidebar preferences stay unchanged.",
    saveFailed: "Could not save coding controls",
  },
  common: {
    apply: 'Apply',
    back: 'Back',
