...
export const en: Translations = {
  ...
  boot: {
    ...
    failure: {
      ...
      remoteDescription:
        'Your remote dashboard backend session has expired. Sign in again to reconnect. Nothing here deletes your chats or settings.',
      retry: 'Retry',
      ...
      signedInMessage: 'Reconnecting to the remote backend…',
  ...
  settings: {
    ...
    gateway: {
      ...
      intro:
        'Hermes Desktop starts its own local dashboard backend by default. Use a remote dashboard backend when you want this app to control an already-running Hermes backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      remoteTitle: 'Remote dashboard backend',
      remoteDesc:
        'Connect this desktop shell to a remote Hermes dashboard backend. Hosted dashboards use OAuth or a username and password; self-hosted ones may use a session token.',
      ...
      authSignedInPassword:
        'This backend uses a username and password. You are signed in; the session refreshes automatically.',
      authSignedInOauth: 'This backend uses OAuth. You are signed in; the session refreshes automatically.',
      authNeedsPassword: 'This backend uses a username and password. Sign in to authorize this desktop app.',
      authNeedsOauth: provider => `This backend uses OAuth. Sign in with ${provider} to authorize this desktop app.`,
      ...
      restartingTitle: 'Backend connection restarting',
      savedTitle: 'Backend connection settings saved',
      ...
      signedOutMessage: 'Cleared the remote backend session.',
      failedLoad: 'Backend connection settings failed to load',
      signInFailed: 'Sign-in failed',
      signOutFailed: 'Sign-out failed',
      testFailed: 'Remote backend test failed',
      applyFailed: 'Could not apply backend connection settings',
      saveFailed: 'Could not save backend connection settings'
    },
    keys: {
  ...
  commandCenter: {
    ...
    noUsageAllTime: 'No usage recorded yet.',
    retry: 'Retry',
