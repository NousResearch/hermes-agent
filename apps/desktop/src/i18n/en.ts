...
export const en: Translations = {
  ...
  boot: {
    ready: 'HT AI Agent is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading HT AI Agent settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting HT AI Agent…'
    },
    errors: {
      backgroundExited: 'HT AI Agent background process exited.',
      backgroundExitedDuringStartup: 'HT AI Agent background process exited during startup.',
    ...
    failure: {
      title: "HT AI Agent couldn't start",
      description:
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your HT AI Agent backend is older than this desktop build and may not work correctly. Update to align them.',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting HT AI Agent.',
    ...
    native: {
      ...
      inputBody: 'HT AI Agent is waiting for your response.',
      turnDoneTitle: 'HT AI Agent finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to HT AI Agent defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while HT AI Agent is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'HT AI Agent asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while HT AI Agent was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let HT AI Agent follow your system setting.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what HT AI Agent is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen HT AI Agent, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'HT AI Agent checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading HT AI Agent configuration...',
    ...
    gateway: {
      ...
      intro:
        'HT AI Agent starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running HT AI Agent backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      localDesc: 'Start a private HT AI Agent backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote HT AI Agent backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      ...
      restartingMessage: 'HT AI Agent will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · HT AI Agent ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. HT AI Agent runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
  ...
  starmap: {
    ...
    emptyDesc: 'As HT AI Agent builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart HT AI Agent to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update HT AI Agent to generate pets.',
      backgroundHint: 'You can close this — HT AI Agent will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure HT AI Agent desktop' },
    ...
    hermesActiveSessions: (version, count) => `HT AI Agent ${version} · Active sessions ${count}`,
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent HT AI Agent environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. HT AI Agent will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the HT AI Agent backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from HT AI Agent. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting HT AI Agent...',
    placeholderReconnecting: 'Reconnecting to HT AI Agent…',
    placeholderFollowUp: 'Send follow-up',
    newSessionPlaceholders: [
      'What are we building?',
      'Give HT AI Agent a task',
      "What's on your mind?",
    ...
    attachUrlDesc: 'HT AI Agent will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask HT AI Agent to open PR',
      agentShipPrompt:
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating HT AI Agent…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting HT AI Agent…',
    ...
    unsupportedMessage: 'This version of HT AI Agent can’t update itself from inside the app.',
    ...
    availableBody: 'A new version of HT AI Agent is ready to install.',
    availableTitleBackend: 'Backend update available',
    availableBodyBackend: 'A newer version of the connected HT AI Agent backend is ready to install.',
    availableBodyNoChangelog: 'A newer version is ready. Release notes aren’t available for this install type.',
    updateNow: 'Update now',
    maybeLater: 'Maybe later',
    moreChanges: count => `+ ${count} more change${count === 1 ? '' : 's'} included.`,
    manualTitle: 'Update from your terminal',
    manualBody: 'You installed HT AI Agent from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'HT AI Agent will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the HT AI Agent desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The HT AI Agent updater takes over in its own window and reopens HT AI Agent automatically when it’s done. Please don’t reopen HT AI Agent yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. HT AI Agent reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then HT AI Agent reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'HT AI Agent needs a one-time install',
    ...
    settingUpTitle: 'Setting up HT AI Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another HT AI Agent CLI or desktop instance is running. Stop any running HT AI Agent instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The HT AI Agent installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with HT AI Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'HT AI Agent is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting HT AI Agent…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run HT AI Agent',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point HT AI Agent at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — HT AI Agent connects automatically',
    ...
    authorizeThere: 'Authorize HT AI Agent there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize HT AI Agent there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      gatewayTitle: 'HT AI Agent inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. HT AI Agent will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'HT AI Agent is restarting...',
      askRestart: 'Ask HT AI Agent to restart the server',
      lookingRestart: taskId => `HT AI Agent is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'HT AI Agent is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `HT AI Agent finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'HT AI Agent could not restart the server.',
      stillWorking:
        'HT AI Agent is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'HT AI Agent is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'HT AI Agent gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.hermes/config.yaml). HT AI Agent won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'HT AI Agent needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'HT AI Agent needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart HT AI Agent to use Save Image.',
    restartToSaveImages: 'Restart HT AI Agent to save images',
