...
export const en: Translations = {
  ...
  keybinds: {
    ...
    actions: {
      ...
      'nav.controlRoom': 'Open Control Room',
      'nav.commandCenter': 'Open Control Room',
  ...
  commandCenter: {
    ...
    sectionDescriptions: {
      home: 'Attention-first control surface — needs you, agents, tasks, messages, system',
  ...
  statusStack: {
    ...
    markDone: 'Mark done',
    markDoneAria: task => `Mark task done: ${task}`,
    reopen: 'Reopen',
    reopenAria: task => `Reopen task: ${task}`,
    retryTaskSync: 'Retry',
    syncingTask: 'Syncing task status',
    markDoneTitle: 'Mark task done?',
    markDoneDescription: 'Hermes will treat this as your decision and will not reopen it from an older model update.',
    markingDone: 'Marking done…',
    markedDone: 'Marked done',
    reopenTitle: 'Reopen task?',
    reopenDescription: 'Hermes may continue working on this task.',
    reopening: 'Reopening…',
    reopened: 'Reopened',
    taskChanged: 'Tasks changed while you were confirming. Review the latest list and try again.',
    taskMissing: 'That task is no longer in the current plan.',
    taskSessionMissing: 'This task session is no longer available. Resume the chat and try again.',
    taskSyncFailed: "Couldn't sync task status",
    taskUpdateFailed: 'Task status could not be updated. Try again.',
  ...
  shell: {
    ...
    statusbar: {
      ...
      closeCommandCenter: 'Close Control Room',
      openCommandCenter: 'Open Control Room',
      ...
      toggleCommandCenter: 'Control Room',
