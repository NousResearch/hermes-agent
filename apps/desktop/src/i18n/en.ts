...
export const en: Translations = {
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc:
      'Profiles are independent Hermes environments. They can also route to a different desktop backend.',
    nameLabel: 'Name',
    ...
    backendLocal: 'This backend',
    backendRemote: 'Remote backend',
    backendLocalDesc: 'Create the profile on the current backend and run it here.',
    backendRemoteDesc: 'Use this profile as a shortcut to another Hermes Desktop backend.',
    remoteUrl: 'Remote URL',
    remoteUrlRequired: 'Remote URL must start with http:// or https://.',
    remoteToken: 'Session token',
    remoteTokenRequired: 'A session token is required for a remote backend.',
    remoteTokenPlaceholder: 'Paste the remote session token',
