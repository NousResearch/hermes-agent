...
export const en: Translations = {
  ...
  settings: {
    ...
    gateway: {
      ...
      intro:
        'Choose the gateway this Desktop controls. Local is always available as a recovery path; saved remotes and Hermes Cloud switch in place without restarting the shell.',
      ...
      savedConnectionsTitle: 'Connections',
      savedConnectionsDesc: 'Switch immediately between Local, Hermes Cloud, and saved remote gateways.',
      addConnection: 'Add remote',
      connectedConnection: 'Active',
      connectConnection: 'Connect',
      connectionShortcut: (id, url) => `${url} · launch with --connection ${id}`,
      deleteConnection: name => `Delete ${name}`,
      deleteConnectionConfirm: name => `Delete the saved gateway “${name}”?`,
      deletedConnectionTitle: 'Gateway deleted',
      deletedConnection: name => `Deleted ${name}.`,
      deleteConnectionFailed: 'Could not delete saved gateway',
      connectionNameTitle: 'Connection name',
      connectionNamePlaceholder: 'Homelab',
      connectionNameDesc: 'A friendly name; Hermes creates a stable shortcut name for CLI launches.',
      connectionIdDesc: id => `CLI shortcut: hermes desktop --connection ${id}`,
      connectionNameRequiredTitle: 'Connection name required',
      connectionNameRequired: 'Name this remote gateway before saving or signing in.',
      ...
      saveAndReconnect: 'Save and connect',
      ...
      restartingTitle: 'Switching gateway',
      savedTitle: 'Gateway settings saved',
      restartingMessage: 'Hermes Desktop is switching connections — the shell stays open.',
