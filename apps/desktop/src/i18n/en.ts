...
export const en: Translations = {
  ...
  sidebar: {
    ...
    row: {
      ...
      moveProjectTitle: 'Move chat to project',
      moveProjectDesc: title =>
        `Move “${title}” to a project. Future commands and tools will run in that project's workspace.`,
      moveProjectFailed: 'Could not move chat',
      moveProjectMissingWorkspace: 'That project has no workspace folder.',
      moveProjectWrongProfile: "Switch to this chat's profile before moving it to a project.",
      moveProjectsLoading: 'Loading projects…',
      moveProjectsEmpty: 'No projects with a workspace folder found.',
