...
export const en: Translations = {
  ...
  messaging: {
    ...
    clientExperienceDesc: 'Choose what clients see while Hermes works. Tools keep running when progress is hidden.',
    toolActivity: 'Tool activity',
    toolActivityDesc: 'Show tool calls in the Telegram conversation.',
    toolProgressOff: 'Off',
    toolProgressNew: 'New tools',
    toolProgressAll: 'All tools',
    toolProgressVerbose: 'Verbose',
    toolProgressLog: 'Log only',
    interimMessages: 'Mid-turn updates',
    interimMessagesDesc: 'Send natural progress commentary before the final answer.',
    reasoningVisibility: 'Reasoning summaries',
    reasoningVisibilityDesc: 'Show reasoning sections when the model provides them.',
    streamResponses: 'Stream responses',
    streamResponsesDesc: 'Edit the Telegram reply as final text is generated.',
    longRunningStatus: 'Long-running status',
    longRunningStatusDesc: 'Show a periodic working indicator during long tasks.',
    displaySaved: name => `${name} client experience updated`,
    displaySavedHint: 'New turns use this setting immediately.',
    failedDisplaySave: name => `Failed to update ${name} client experience`,
