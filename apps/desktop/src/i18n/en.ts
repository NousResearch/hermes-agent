...
export const en: Translations = {
  ...
  boot: {
    ready: 'Reuben is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Reuben settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting Reuben…'
    },
    errors: {
      backgroundExited: 'Remote gateway connection closed.',
      backgroundExitedDuringStartup: 'Remote gateway connection closed during startup.',
      backendStopped: 'Gateway disconnected',
      desktopBootFailed: 'Reuben connection failed',
      gatewayConnectionLost: 'Lost connection to the gateway',
      gatewaySignInRequired: 'Gateway sign-in required',
      ipcBridgeUnavailable: 'Desktop IPC bridge is unavailable.'
    },
    failure: {
      title: "Reuben couldn't connect",
      description:
        'The remote gateway is unavailable or rejected the connection. Check the gateway URL or sign in again. Nothing here deletes your chats or settings.',
      ...
      openLogs: 'Open logs',
      repairHint: 'Configure a remote Reuben gateway URL, then retry the connection.',
      remoteSignInHint: 'Opens the gateway login window. You can also update the gateway URL or token in Settings.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Reuben gateway is older than this desktop build and may not work correctly. Update to align them.',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop gateway rejected that request (405 Method Not Allowed). Try restarting Reuben.',
  ...
  settings: {
    ...
    gateway: {
      ...
      intro:
        'Reuben connects to an already-running gateway by URL. The backend can be on this machine or another host, but it is installed and managed separately.',
      ...
      remoteDesc:
        'Connect this desktop shell to a remote Reuben gateway. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      ...
      diagnosticsDesc: 'Reveal desktop.log in your file manager — useful when the gateway fails to connect.',
      openLogs: 'Open logs',
      ...
      restartingMessage: 'Reuben will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Reuben ${version}` : ''}`,
  ...
  commandCenter: {
    ...
    generatePet: {
      ...
      staleBackend: 'Update Reuben to generate pets.',
      backgroundHint: 'You can close this — Reuben will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Reuben' },
    ...
    hermesActiveSessions: (version, count) => `Reuben ${version} · Active sessions ${count}`,
  ...
  updates: {
    ...
    unsupportedMessage: "This version of Reuben can't update itself from inside the app.",
    ...
    availableBody: 'A new version of Reuben is ready to install.',
    availableTitleBackend: 'Backend update available',
    availableBodyBackend: 'A newer version of the connected Reuben gateway is ready to install.',
    availableBodyNoChangelog: 'A newer version is ready. Release notes aren’t available for this install type.',
    updateNow: 'Update now',
    maybeLater: 'Maybe later',
    moreChanges: count => `+ ${count} more change${count === 1 ? '' : 's'} included.`,
    manualTitle: 'Update from your terminal',
    manualBody: 'You installed Reuben from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Reuben will pick up the new version next time you launch it.',
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Reuben v${version}`,
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Reuben to use Save Image.',
    restartToSaveImages: 'Restart Reuben to save images',
