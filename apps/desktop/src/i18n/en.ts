...
export const en: Translations = {
  ...
  desktop: {
    ...
    browserCapture: 'Capture page',
    browserCapturePreview: 'Capture preview',
    browserSaveCapture: 'Save capture',
    browserClosePreview: 'Close preview',
    browserUrlPlaceholder: 'Enter a URL',
    browserNewTab: 'New tab',
    browserTabLimit: 'All Browser tabs are pinned. Unpin a tab to open another.',
    browserCloseTab: 'Close tab',
    browserQc: 'Quality control',
    browserQcNote: 'Note',
    browserQcEvidence: 'Evidence',
    browserQcPass: 'Pass',
    browserQcFail: 'Fail',
    browserQcUnchecked: 'Unchecked',
    browserEmpty: 'Enter a URL to start browsing',
    browserInvalidUrl: 'Enter a valid URL',
    browserQcComposition: 'Composition',
    browserQcColor: 'Color',
    browserQcTypography: 'Typography',
    browserQcSpacing: 'Spacing',
    browserQcContrast: 'Contrast',
    browserQcClipping: 'Clipping',
    browserQcReferenceMatch: 'Reference match',
