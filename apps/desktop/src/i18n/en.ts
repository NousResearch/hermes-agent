...
export const en: Translations = {
  ...
  assistant: {
    thread: {
      ...
      recoveryMissing: 'No reply found in history',
      recoveryUnfinished: 'No final reply found',
      recoveryPutBack: 'Return to input',
      recoveryHide: 'Hide',
      recoveryHidden: 'Message hidden on this device',
      recoveryUndo: 'Undo',
      recoveryActivityHint: 'Tools may have run. Sending again can repeat actions.',
      recoveryHideHint: 'Only hides this message on this device; model history is unchanged.',
      recoveryAttachmentHint: 'Text only. Reattach files before sending.',
      react: 'React',
      dismissError: 'Dismiss error',
      errorLayers: {
