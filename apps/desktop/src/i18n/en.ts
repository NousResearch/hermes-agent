...
export const en: Translations = {
  ...
  study: {
    title: 'StudyOS',
    subtitle: 'Evidence-backed learning projects, daily action, and reviewable recommendations.',
    close: 'Close StudyOS',
    projectList: 'Projects',
    scheduleList: 'Schedules',
    notConfigured: 'StudyOS vault not configured',
    noProjects: 'No StudyOS projects found.',
    noSchedules: 'No schedules saved for this project.',
    invalidSchedule: 'This StudyOS schedule is invalid and was not rendered.',
    invalidScheduleFiles: 'Schedule files needing attention',
    ...
    timezone: 'Timezone',
    range: 'Range',
    phases: 'Long-term phases',
    events: 'Concrete sessions',
    noConcreteSessions: 'No concrete study sessions scheduled.',
    goals: 'Goals',
    source: 'Source',
    status: 'Status',
    readOnly: 'Evidence-backed',
    settings: 'Settings',
    setupTitle: 'Connect your StudyOS Vault',
    setupDescription:
      'Choose the Obsidian Vault that stores StudyOS projects. This setting is scoped to the active Hermes profile.',
    vaultPath: 'Vault path',
    chooseFolder: 'Choose folder',
    saveSettings: 'Save and enable StudyOS',
    settingsSaved: 'StudyOS settings saved.',
    newSessionRequired: 'StudyOS is enabled. Start a new chat session to load its tools.',
    selectProjectPrompt: 'Select a project to make it active across StudyOS and the agent.',
    todayTab: 'Today',
    calendarTab: 'Calendar',
    reviewTab: 'Review',
    inboxTab: 'Suggestions',
    todayTitle: 'Today’s learning desk',
    scheduledToday: 'Scheduled today',
    noEventsToday: 'No scheduled events today.',
    dueNow: 'Vault reviews due',
    completedToday: 'Reviews completed',
    activityToday: 'Evidence recorded',
    evidenceStatus: 'Evidence status',
    evidenceCoverage: 'Observed dimensions',
    verifiedDimensions: 'Independently verified',
    independentEvidence: 'Verified attempts',
    ...
    noSuggestions: 'No evidence gap currently needs an intervention.',
    suggestionsTitle: 'Suggestion inbox',
    suggestionsDescription:
      'Recommendations are derived from evidence. Saved plan proposals require your explicit decision.',
    pendingChanges: 'Plan proposals',
    recommendations: 'Current recommendations',
    emptyInbox: 'No plan proposals are waiting for a decision.',
    proposalNotice: 'Accepting records your decision only; it never changes the schedule automatically.',
    accept: 'Accept',
    reject: 'Reject',
    actions: 'actions',
    ...
    stats: 'Statistics',
    noDueReviews: 'All caught up!',
    noDueReviewsDesc: 'No reviews due today.',
    reviewLevel: 'Level',
    ...
    reviewed: 'Reviewed',
    of: 'of',
    filterBySubject: 'Tags',
    filterByLevel: 'Level',
    allLevels: 'All',
    streak: 'Streak',
    days: 'days',
    spacingCoverage: 'Spacing coverage',
    learningState: 'State',
    prerequisites: 'Prerequisites',
    newConcepts: 'New Concepts',
    newExamples: 'New Examples',
    noNewConcepts: 'No new concepts',
    noNewExamples: 'No new examples',
    conceptGraph: 'Concept Graph',
    startReview: 'Start review',
    agentReview: 'Review with agent',
    agentReviewThis: 'Review this with agent',
    agentReviewDesc: 'Return to chat so the agent can pick, quiz, explain, and record.',
    agentReviewSelected: 'Review {count} selected with agent',
    selectedReviews: '{count} selected',
    selectAllFiltered: 'Select filtered',
    clearSelection: 'Clear selection',
    selectReviewItem: 'Select review item',
    loadingReview: 'Loading review item…',
    remaining: 'remaining',
    backToList: 'Back to list',
    yourAnswer: 'Your answer',
    answerPlaceholder: 'Write your reasoning before revealing the answer…',
    confidence: 'Confidence',
    revealAnswer: 'Reveal answer',
    referenceAnswer: 'Reference answer',
    noReferenceAnswer: 'This note has no separate answer section. Grade against your source material.',
    selfGrade: 'How did you do?',
    incorrect: 'Incorrect',
    ...
    sessionCompleteDesc: 'You completed {count} reviews in this session.',
    selectProjectForReview: 'Select a StudyOS project before recording review evidence.'
  },
