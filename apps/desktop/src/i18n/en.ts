...
export const en = {
  ...
  notifications: {
    ...
    native: {
      ...
      approvalTitleNamed: (session: string) => `Approval needed — ${session}`,
      approveAction: 'Approve',
      rejectAction: 'Reject',
      inputTitle: 'Input needed',
      inputTitleNamed: (session: string) => `Input needed — ${session}`,
  ...
  settings: {
    ...
    toolsets: {
      ...
      terminalBackend: {
        ...
        needsSetupConfirmTitle: (backend: string) => `Select ${backend} anyway?`,
  ...
  profiles: {
    ...
    defaultSet: (name: string) => `${name} is now the default`,
  ...
  composer: {
    ...
    wakeWord: (phrase: string) => `Wake word "${phrase}"`,
