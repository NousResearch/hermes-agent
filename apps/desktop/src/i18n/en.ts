...
export const en: Translations = {
  ...
  shell: {
    ...
    statusbar: {
      ...
      toggleRunningTimer: 'Last turn time',
      ...
      tokensPerSecondTitle: 'Output tokens per second',
      toggleLatency: 'API latency',
      latencyTitle: 'Average API latency',
      toggleCompressions: 'Compressions',
      toggleIdleSince: 'Since last reply',
      idleSinceTitle: 'Time since the last final reply',
      compressionsTitle: 'Context auto-compressions',
      turnBreakdown: {
        title: 'Last turn',
        running: 'running',
        wall: 'Wall time',
