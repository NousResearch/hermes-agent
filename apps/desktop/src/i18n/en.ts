...
export const en: Translations = {
  ...
  ide: {
    ...
    explorerEmptyTitle: 'No workspace open',
    explorerEmptyBody: 'Open the IDE from a project window to bring its workspace in.',
    editorTitle: 'Editor',
    editorEmptyTitle: 'No file open',
    editorEmptyBody: 'Pick a file in the explorer to start editing.',
    chatTitle: 'Chat',
    chatEmptyTitle: 'No IDE session yet',
    chatEmptyBody: 'IDE sessions live here, scoped to this workspace. Start one to work with the agent.',
    browserTitle: 'Browser',
    browserEmptyTitle: 'No page open',
    browserEmptyBody: 'Open a URL to browse it here, and the agent can operate it with you.',
    ...
    explorerUnreadable: error => `Unable to read this folder (${error}).`,
    editorTabsLabel: 'Open editors',
    closeTab: 'Close',
    closeTabLabel: name => `Close ${name}`,
    reloadFromDisk: 'Reload from disk',
    tooLargeTitle: 'File is too large to edit here',
    tooLargeBody: 'This file is over 512 KB. Open it from the chat preview or a desktop editor instead.',
    loadFailedTitle: 'Could not open this file',
    closeDirtyTitle: 'Close with unsaved changes?',
    closeDirtyBody: 'This tab has edits that have not been saved to disk.',
    closeDirtyConfirm: 'Discard changes',
    diskChangedTitle: 'This file changed on disk',
    diskChangedBody: 'Something else edited this file — an agent run or another app. Saving now would overwrite those changes.',
    overwrite: 'Overwrite',
    chatTabsLabel: 'IDE sessions',
    chatNew: 'New IDE session',
    chatRecent: 'Recent IDE sessions',
    chatCreateFailed: 'Could not start an IDE session',
    browserTabsLabel: 'Browser tabs',
