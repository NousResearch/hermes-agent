...
export const en: Translations = {
  ...
  rightSidebar: {
    ...
    terminal: 'Terminal',
    hostVnc: 'Host VNC',
    hostVncShow: 'Show Host VNC',
    hostVncHide: 'Hide Host VNC',
    hostVncSameOrigin: 'Host VNC must use a dedicated origin or port, not the Hermes Webapp origin.',
  ...
  preview: {
    ...
    surface: {
      activate: label => `Activate ${label}`,
      dock: label => `Dock ${label}`,
      detach: label => `Detach ${label}`,
      minimize: label => `Minimize ${label}`,
      maximize: label => `Maximize ${label}`,
      restore: label => `Restore ${label}`,
      resize: label => `Resize ${label}`,
      snapLayouts: label => `Snap layouts for ${label}`,
      snapTo: (label, slot) => `Snap ${label} to ${slot}`,
      detachedTitle: label => `${label} is detached`,
      detachedBody: 'Use the floating window controls to dock, snap, move, resize, minimize, or close it.',
      floating: 'Floating',
      slots: {
