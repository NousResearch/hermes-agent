...
export const en: Translations = {
  ...
  boot: {
    ready: 'IX Agency is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading IX Agency settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting IX Agency…'
    },
    errors: {
      backgroundExited: 'IX Agency background process exited.',
      backgroundExitedDuringStartup: 'IX Agency background process exited during startup.',
    ...
    failure: {
      title: "IX Agency couldn't start",
      description:
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your IX Agency backend is older than this desktop build and may not work correctly. Update to align them.',
    ...
    errors: {
      ...
      methodNotAllowed: 'The desktop backend rejected that request (405 Method Not Allowed). Try restarting IX Agency.',
    ...
    native: {
      ...
      inputBody: 'IX Agency is waiting for your response.',
      turnDoneTitle: 'IX Agency finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to IX Agency defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while IX Agency is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'IX Agency asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while IX Agency was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let IX Agency follow your system setting.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what IX Agency is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen IX Agency, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'IX Agency checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading IX Agency configuration...',
    ...
    gateway: {
      ...
      intro:
        'IX Agency starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running IX Agency backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      localDesc: 'Start a private IX Agency backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote IX Agency backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      ...
      restartingMessage: 'IX Agency will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · IX Agency ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. IX Agency runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
  ...
  starmap: {
    ...
    emptyDesc: 'As IX Agency builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart IX Agency to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update IX Agency to generate pets.',
      backgroundHint: 'You can close this — IX Agency will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure IX Agency desktop' },
    ...
    hermesActiveSessions: (version, count) => `IX Agency ${version} · Active sessions ${count}`,
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent IX Agency environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. IX Agency will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the IX Agency backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from IX Agency. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting IX Agency...',
    placeholderReconnecting: 'Reconnecting to IX Agency…',
    placeholderFollowUp: 'Send follow-up',
    newSessionPlaceholders: [
      'What are we building?',
      'Give IX Agency a task',
      "What's on your mind?",
    ...
    attachUrlDesc: 'IX Agency will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask IX Agency to open PR',
      agentShipPrompt:
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating IX Agency…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting IX Agency…',
    ...
    unsupportedMessage: 'This version of IX Agency can’t update itself from inside the app.',
    ...
    availableBody: 'A new version of IX Agency is ready to install.',
    availableTitleBackend: 'Backend update available',
    availableBodyBackend: 'A newer version of the connected IX Agency backend is ready to install.',
    availableBodyNoChangelog: 'A newer version is ready. Release notes aren’t available for this install type.',
    updateNow: 'Update now',
    maybeLater: 'Maybe later',
    moreChanges: count => `+ ${count} more change${count === 1 ? '' : 's'} included.`,
    manualTitle: 'Update from your terminal',
    manualBody: 'You installed IX Agency from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'IX Agency will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the IX Agency desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The IX Agency updater takes over in its own window and reopens IX Agency automatically when it’s done. Please don’t reopen IX Agency yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. IX Agency reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then IX Agency reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'IX Agency needs a one-time install',
    ...
    settingUpTitle: 'Setting up IX Agency Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another IX Agency CLI or desktop instance is running. Stop any running IX Agency instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The IX Agency installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with IX Agency Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'IX Agency is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting IX Agency…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run IX Agency',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point IX Agency at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — IX Agency connects automatically',
    ...
    authorizeThere: 'Authorize IX Agency there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize IX Agency there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      gatewayTitle: 'IX Agency inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. IX Agency will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'IX Agency is restarting...',
      askRestart: 'Ask IX Agency to restart the server',
      lookingRestart: taskId => `IX Agency is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'IX Agency is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `IX Agency finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'IX Agency could not restart the server.',
      stillWorking:
        'IX Agency is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'IX Agency is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'IX Agency gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.hermes/config.yaml). IX Agency won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'IX Agency needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'IX Agency needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart IX Agency to use Save Image.',
    restartToSaveImages: 'Restart IX Agency to save images',
