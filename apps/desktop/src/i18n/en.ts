...
export const en: Translations = {
  ...
  shell: {
    ...
    statusbar: {
      ...
      sessionsActive: count => `${count} session${count === 1 ? '' : 's'} active`,
      sessionsActiveTitle: 'Sessions with in-progress work',
      agentsActive: count => `${count} agent${count === 1 ? '' : 's'}`,
      tasks: 'Tasks',
      tasksTitle: 'Terminal and preview background tasks',
      tasksRunning: count => `${count} running`,
      tasksFailed: count => `${count} failed`,
      cron: 'Cron',
