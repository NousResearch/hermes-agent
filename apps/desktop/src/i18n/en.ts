...
export const en: Translations = {
  ...
  shell: {
    ...
    statusbar: {
      ...
      toggleSessionTokens: 'Session tokens',
      ...
      sessionTokensTitle: 'Cumulative model tokens for this session — input is summed across API calls and can exceed the context window',
