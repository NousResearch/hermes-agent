...
export const en: Translations = {
  ...
  cron: {
    ...
    reasoningInherit: 'Inherit global',
    reasoningInactive: 'Inactive for no-agent jobs',
    reasoningInactiveHint: 'Preserved for this job, but inactive while it runs without the agent.',
    reasoningInactiveWithValue: value => `${value} (inactive)`,
    reasoningInvalid: value => `${value} (invalid; inherits global)`,
    reasoningOptions: {
      none: 'Off',
      minimal: 'Minimal',
      low: 'Low',
