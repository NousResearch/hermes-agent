...
export const en: Translations = {
  ...
  settings: {
    ...
    gateway: {
      ...
      connectionNameDesc: 'A friendly name used to generate a stable shortcut for CLI launches.',
      ...
      switchingTitle: 'Switching gateway',
      ...
      switchingMessage: 'Hermes Desktop is switching connections — the shell stays open.',
