...
export const en: Translations = {
  ...
  profiles: {
    ...
    gatewaySwitcher: 'Switch gateway',
    gatewayLocalHeading: 'Local',
    gatewayThisDevice: 'This device',
    gatewayRemoteHeading: 'Remote',
    gatewaySshHeading: 'SSH',
    switchToGateway: name => `Switch to ${name}`,
    cloudAgents: 'Hermes Cloud',
    cloudAgentsEmpty: 'No Hermes Cloud agents available.',
    cloudAgentsLoading: 'Loading Hermes Cloud agents…',
    cloudAgentsRefresh: 'Refresh gateways',
    switchToCloudAgent: name => `Switch to ${name}`,
    starCloudAgent: name => `Star ${name}`,
    unstarCloudAgent: name => `Unstar ${name}`,
    actions: 'Actions',
    color: 'Color…',
    colorFor: 'Color',
  ...
  shell: {
    ...
    gatewayMenu: {
      ...
      favorites: 'Favorite gateways',
      noFavorites: 'No favorite gateways yet.',
      manageFavorites: 'Manage in Settings →',
      useFavorite: name => `Connect to ${name}`,
      activeFavorite: 'Active',
      switchingFavorite: 'Switching…'
    },
    approvalMode: {
      title: 'Approval mode',
