...
export const en: Translations = {
  ...
  sidebar: {
    ...
    projects: {
      ...
      editFoldersTitle: 'Edit folders',
      editFoldersDesc: 'Move or redirect folders after they were renamed on disk.',
      editFoldersEmpty: 'This project has no folders yet.',
      editFolderPick: 'Pick new path…',
      editFolderSave: 'Move',
      editFolderRevert: 'Revert',
      editFolderRemove: 'Remove',
      editFolderUnremove: 'Keep',
      editFolderRemoved: 'Will be removed',
      editFolderConflict: 'Another folder is already at this path.',
      editFolderChanged: 'Changed',
      editFoldersDone: 'Folders updated.',
      editFoldersFailed: 'Could not load project folders.',
      editFoldersMoveFailed: 'Could not move folder',
