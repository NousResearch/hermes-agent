...
export const en: Translations = {
  ...
  lunarCity: {
    ...
    disabledHint: 'Enable World in Settings → Plugins to make Lunar City available again.',
    label: 'Lunar City',
    worldAriaLabel: 'Lunar City world',
    heading: 'Your Hermes world',
    intro:
      'A living interface for Hermes work, agents, alerts, and celebrations. Every action stays connected to the real system.',
    selectSubject: 'Select a worker, leader, task, or event to open its in-world dialogue.',
    defaultsActive: 'Hermes defaults are active',
    starterAssets: 'Built-in pets and starter assets are available.',
    assetCompanions: 'Hermes pet companions',
    assetScene: 'Lunar City starter scene',
    assetTextures: 'Built-in textures and props',
    localAssets: 'Local assets',
    localAssetsForReview: 'Local assets for review',
    reviewOnly: 'Review only — files stay local to this window; no importer is connected.',
    worldSetup: 'Lunar City world setup',
    worldSetupDescription: 'Start with Hermes built-in pets and assets, or stage local files for review.',
    builtInPets: 'Hermes built-in pets and assets',
    builtInPetAlt: 'Hermes built-in pet',
    safeDefault: 'The safe default is ready now; no files leave this device.',
    dropLocalAssets: 'Drop local world assets',
    dropToStage: 'Drop to stage for review',
    formats: 'GLB, GLTF, PNG, JPG, or WEBP',
    stagedFiles: count =>
      `Review only — ${count} local file${count === 1 ? '' : 's'} staged; no importer is connected.`,
    skip: 'Skip for now',
    useDefaults: 'Use Hermes defaults',
    dialogue: {
      ariaLabel: title => `Dialogue: ${title}`,
      label: 'In-world dialogue',
      close: 'Close dialogue',
      source: 'Source',
      state: 'State',
      severity: 'Severity',
      task: 'Task',
      detailUnavailable: 'No additional source detail is available.',
      role: role => `Role: ${role}`,
      assignedTo: assignee => `Assigned to: ${assignee}`,
      actionUnavailable: 'This action is not available from the current Hermes state.',
      actionAccepted: 'Hermes accepted the action.',
      inspectBlocker: 'Inspect blocker',
      inspect: 'Inspect',
      recover: 'Extinguish / recover'
    },
    dispatcher: {
      companion: 'Dispatcher companion',
      cube: 'Dispatcher cube',
      commandCenter: 'Command center',
      description: 'Talk to Hermes through the city.',
      newTask: 'New task',
      newSession: 'New session',
      attention: 'What needs my attention?',
      recentEvents: 'Recent Hermes events',
      ...
      startPrompt: 'Start a fresh Hermes conversation in the current desktop context?',
      starting: 'Starting…',
      startSession: 'Start session',
      activeConditions: count => `${count} active world conditions`,
      recentEventsCount: count => `${count} recent source events`,
      report: 'Situation report',
      openReport: 'Open report',
      taskRequired: 'A task title is required.'
    },
    scene: {
      ariaLabel: 'Lunar City scene',
      liveProjection: 'Live world projection',
      colonyNetwork: 'Hermes colony network',
      stale: 'Stale source',
      connected: 'Connected',
      baselineAriaLabel: 'Baseline 3D scene',
      authoredAssets: (count, profile) => `${count} authored baseline assets · ${profile}`,
      assetDetail: (kind, collection, role, lods) => `${kind} asset in ${collection}. Role: ${role}. LODs: ${lods}.`,
      sceneObject: name => `Scene object: ${name}`,
      downloadScene: 'Download 3D scene',
      downloadRoster: 'Download class roster',
      npcActivity: 'NPC activity',
      quiet: 'The colony is quiet. New Hermes work will appear here as it happens.',
      recentEvents: 'Recent world events',
      status: 'Colony status',
      conditions: 'conditions',
      events: 'events',
      recapAriaLabel: 'World recap',
      whileAway: 'While you were away',
      transitions: count => `${count} Hermes transition${count === 1 ? '' : 's'} need your attention.`
    },
    glb: {
      canvasAriaLabel: 'Interactive Lunar City 3D scene',
      imageAlt: 'Lunar City Blender baseline with grounded roads and concave terrain'
    }
  },
  agents: {
