...
export const en: Translations = {
  ...
  cron: {
    ...
    modelLabel: 'Model',
    defaultProvider: 'Use global provider',
    defaultModel: 'Use global model',
    failedLoadModelOptions: 'Failed to load model options',
    providerModelRequired: 'Choose a model for the selected provider.',
