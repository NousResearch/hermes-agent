...
export const en: Translations = {
  ...
  sidebar: {
    ...
    row: {
      ...
      stampLimit: max => `Up to ${max} stamps per session`,
      stampSaved: label => `Stamped ${label}`,
      stampRemoved: label => `Removed ${label}`,
      stampCleared: 'Stamp cleared',
      stampRemove: label => `Delete “${label}” from the stamp menu`,
      ...
      stampEmojiPick: label => `Stamp with ${label}`,
      stampEmojiSearch: 'Search emoji',
      stampColor: label => `Color of “${label}”`,
