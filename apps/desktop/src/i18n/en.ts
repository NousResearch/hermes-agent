...
export const en: Translations = {
  ...
  preview: {
    ...
    invalidNotebookTitle: 'Not a Jupyter notebook',
    invalidNotebookBody: 'This file could not be parsed as nbformat JSON. Switch to SOURCE to inspect the raw file.',
    notebookWidget: 'Interactive widget (not shown)',
    edit: 'Edit',
    editing: 'Editing',
    unsavedChanges: 'Unsaved changes',
