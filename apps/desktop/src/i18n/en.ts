...
export const en: Translations = {
  ...
  shell: {
    ...
    statusbar: {
      ...
      approvalMenuLabel: 'Approve for me',
      approvalMenuTitle: 'How should Hermes actions be approved?',
      approvalAsk: 'Ask every time',
      approvalAskDescription: 'Always ask to edit external files and use the internet',
      approvalSmart: 'Smart approvals',
      approvalSmartDescription: 'Only ask for actions detected as potentially unsafe',
      approvalFull: 'Full access',
      approvalFullDescription: 'Unrestricted access to the internet and any file on your computer',
      modelNone: 'none',
      noModel: 'no model',
