...
export const en: Translations = {
  ...
  settings: {
    ...
    appearance: {
      ...
      interfaceStyleTitle: 'GNOME Interface Style',
      interfaceStyleDesc: 'Use a restrained Adwaita-inspired treatment without changing Hermes features or layout.',
      interfaceStyleTypographyTitle: 'Adwaita typography',
      interfaceStyleTypographyDesc: 'Prefer Adwaita Sans when installed, with system fonts as fallback.',
      interfaceStyleControlsTitle: 'Softer controls',
      interfaceStyleControlsDesc: 'Gently round buttons, title bars, and sidebar selections.',
      interfaceStyleSurfacesTitle: 'Floating surfaces',
      interfaceStyleSurfacesDesc: 'Give menus and popovers GNOME-like spacing, curves, and shadows.',
