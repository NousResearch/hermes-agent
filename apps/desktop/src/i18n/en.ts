...
export const en: Translations = {
  ...
  artifacts: {
    ...
    failedLoadTitle: "Couldn't load artifacts",
    failedLoadDesc: "Hermes couldn't read recent chats. Check the connection and try again.",
    partialLoadTitle: 'Some artifacts may be missing',
    partialLoadDesc: (failed, total) => `${failed} of ${total} recent chats couldn't be read.`,
    profileLoadErrors: count => `${count} ${count === 1 ? 'profile' : 'profiles'} couldn't be read.`,
    scopeSummary: (loaded, total) => `Showing artifacts from ${loaded} of ${total} recent chats.`,
    loadMoreChats: count => `Load ${count} more chats`,
    tryAgain: 'Try again',
    openFailed: 'Open failed',
    openChatFailed: 'Could not open the source chat',
    itemsImage: 'images',
    itemsLink: 'links',
    itemsFile: 'files',
    itemsGeneric: 'items',
    ...
    loadPreviewFor: label => `Load preview for ${label}`,
    embeddedImage: 'Embedded image',
    chat: 'Chat',
    openSourceChat: label => `Open source chat for ${label}`,
    copyUrl: 'Copy URL',
    copyPath: 'Copy path'
  },
