...
export const esOverrides = {
  ...
  sidebar: {
    ...
    row: {
      ...
      startSlackSync: 'Sincronizar con el hilo de Slack',
      stopSlackSync: 'Detener la sincronización con Slack',
      slackSyncFailed: 'No se pudo cambiar la sincronización con Slack',
      copyId: 'Copiar ID',
      export: 'Exportar',
      branchFrom: 'Rama',
      rename: 'Renombrar',
