...
export const fr = defineLocale({
  ...
  boot: {
    ...
    failure: {
      ...
      remoteSignInHint: signInLabel =>
        `Ouvre la fenêtre de connexion ${signInLabel}. Utilisez la passerelle locale pour basculer vers le backend intégré.`,
      signOutAndSignIn: 'Déconnexion & reconnexion',
  ...
  settings: {
    ...
    plugins: {
      title: 'Plugins du bureau',
      blurb:
        'Extensions d\'interface chargées dans cette app — incluses dans la build, ou déposées dans le dossier desktop-plugins (y compris celles écrites par Hermes). Désactiver décharge un plugin en direct et persiste après redémarrage.',
    ...
    appearance: {
      ...
      uiScaleDesc: (percent: number) =>
        `Ajuste la taille du texte et des contrôles dans toute l\'application. Cmd/Ctrl avec +, - et 0 fonctionne aussi. Actuel : ${percent}%.`,
    ...
    gateway: {
      ...
      remoteAuthHint: 'Les passerelles hébergées utilisent OAuth ou un nom d\'utilisateur/mot de passe ; les auto-hébergées peuvent utiliser un jeton de session.',
      cloudTitle: 'Hermes Cloud',
      cloudDesc: 'Connectez-vous une fois à Hermes Cloud et choisissez parmi les agents de votre compte — aucune URL à coller.',
      ...
      sshDesc:
        'Hermes est lancé sur la machine distante via SSH et tunnellisé vers cette app — rien à démarrer ou exposer vous-même. Nécessite un accès SSH par clé fonctionnel vers l\'hôte.',
      ...
      sshIncompleteHost: 'Entrez un hôte SSH avant de vous connecter.',
      sshErrUnreachable: 'Impossible d\'atteindre cet hôte via SSH. Vérifiez l\'hôte, le port et votre réseau.',
      sshErrAuth:
        'Authentification SSH échouée. Chargez votre clé dans ssh-agent (ssh-add) ou définissez un IdentityFile dans ~/.ssh/config — Hermes exécute ssh en mode non-interactif.',
      sshErrHostKey:
        'La clé d\'hôte a CHANGÉ depuis votre dernière connexion. Vérifiez que c\'est attendu, puis exécutez ssh-keygen -R <hôte> et reconnectez.',
      sshErrNotInstalled:
      ...
      sshErrTimeout: 'La connexion SSH a expiré. L\'hôte est peut-être inaccessible ou en veille.',
    ...
    toolsets: {
      ...
      nousAuthNeededMessage: provider => `${provider} est enregistré mais ne s\'activera qu\'après connexion au portail Nous.`,
      ...
      postSetupInstalledHint: 'Installé. Relancez l\'installation uniquement si quelque chose ne fonctionne plus.',
      ...
      terminalBackend: {
        ...
        needsSetupHint: 'Vous pouvez sélectionner ce backend maintenant — les commandes échoueront tant que l\'installation n\'est pas terminée.'
      }
    }
  },
  ...
  skills: {
    ...
    visionModelHint:
      'La vision utilise votre config de modèle auxiliaire — le modèle compatible image est choisi là-bas, pas ici par fournisseur.',
    ...
    disableUnused: 'Désactiver inutilisés',
  ...
  commandCenter: {
    ...
    pets: {
      ...
      toggleFailed: (enabled) => enabled ? 'Impossible d\'activer la mascotte.' : 'Impossible de désactiver la mascotte.',
    ...
    sectionDescriptions: {
      maintenance: 'Diagnostics, sauvegardes, conservateur et données mémoire',
    ...
    maintenance: {
      ...
      doctorDesc: 'Vérifier l\'installation, la config et les fournisseurs',
      securityAudit: 'Audit de sécurité',
      securityAuditDesc: 'Analyser la config et les skills pour détecter les paramètres à risque',
      backup: 'Créer une sauvegarde',
      backupDesc: 'Compresser la config, les mémoires, les skills et les sessions',
      debugShare: 'Partage de debug',
      debugShareDesc: 'Téléverser un rapport anonymisé + logs, obtenir des liens partageables (suppression auto après 6h)',
      ...
      curator: 'Conservateur de skills',
      ...
      memoryDataDesc: 'Fichiers mémoire intégrés injectés dans chaque session',
      ...
      resetFailed: 'Échec de la réinitialisation',
      actionStarted: name => `${name} démarré — suivi du log...`,
      actionFailed: name => `Échec du démarrage de ${name}`,
      running: 'En cours...',
  ...
  profiles: {
    ...
    color: 'Couleur...',
    colorFor: 'Couleur',
    setColor: (color: string) => `Définir la couleur ${color}`,
    autoColor: 'Auto',
  ...
  sidebar: {
    ...
    projects: {
      ...
      branchOff: () => ({ after: '', before: 'brancher ' }),
  ...
  composer: {
    ...
    queuedPaused: count => `${count} en attente — pause`,
    ...
    queueResumeTip: 'Mis en pause par Stop — reprendre l\'envoi des tours en attente',
  ...
  statusStack: {
    coding: {
      ...
      commitPlaceholder: shortcut => `Message (${shortcut} pour commiter)`,
  ...
  updates: {
    stages: {
      ...
      rebuild: 'Reconstruction de l\'application…',
  ...
  onboarding: {
    ...
    fireworksPitch: 'API directe — modèles frontier hébergés par Fireworks',
  ...
  shell: {
    ...
    statusbar: {
      ...
      modelPinned: 'épinglé par vous ; les nouvelles conversations utilisent ce modèle au lieu du défaut des paramètres',
  ...
  zones: {
    ...
    saveCurrentAs: 'Enregistrer la disposition actuelle comme modèle',
    ...
    editorHintPost: ' inverse la ligne · glisser à travers les zones pour fusionner · glisser les bords partagés pour redimensionner',
    ...
    notExpressible: 'cette disposition s\'entrelace (moulin à vent) — pas encore exprimable en divisions imbriquées',
  ...
  ui: {
    ...
    sidebar: {
      ...
      toggle: (open: boolean) => `${open ? 'Afficher' : 'Masquer'} la barre latérale`
    }
  },
