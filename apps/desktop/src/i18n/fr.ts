...
export const frOverrides = {
  ...
  sidebar: {
    ...
    row: {
      ...
      startSlackSync: 'Synchroniser avec le fil Slack',
      stopSlackSync: 'Arrêter la synchronisation Slack',
      slackSyncFailed: 'Impossible de modifier la synchronisation Slack',
      copyId: "Copier l'ID",
      export: 'Exporter',
      branchFrom: 'Branche',
      rename: 'Renommer',
