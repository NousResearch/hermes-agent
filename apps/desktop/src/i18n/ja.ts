...
export const ja = defineLocale({
  ...
  settings: {
    ...
    appearance: {
      ...
      backgroundTitle: 'チャット背景',
      backgroundDesc: 'Hermes のアート、ローカル画像、またはフォルダー内の画像をシャッフルして会話の背後に表示します。',
      backgroundHermes: 'Hermes',
      backgroundImage: '画像',
      backgroundFolder: 'フォルダー',
      backgroundImages: '背景画像',
      backgroundChooseImage: '背景画像を選択',
      backgroundChooseFolder: '背景フォルダーを選択',
      backgroundChoosing: '選択中…',
      backgroundChange: '変更',
      backgroundRemove: '削除',
      backgroundStrength: '背景の濃さ',
      backgroundInterval: '切り替え間隔',
      backgroundIntervalLabel: minutes => (minutes < 60 ? `${minutes} 分` : `${minutes / 60} 時間`),
      backgroundTruncated: 'このフォルダー内の対応画像を先頭から 1,000 件使用します。',
      backgroundProfileNote: profile => `${profile} プロファイルに保存されます。プロファイルごとに背景を保持します。`,
      backgroundErrors: {
        empty: 'このフォルダーには対応する画像がありません。',
        'invalid-source': '背景の場所が無効です。',
        missing: '選択した背景が見つかりません。',
        unreadable: '選択した背景を読み込めませんでした。',
        unsupported: 'PNG、JPEG、WebP、GIF、BMP、または AVIF 画像を選択してください。'
      },
