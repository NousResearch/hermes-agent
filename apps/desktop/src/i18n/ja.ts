...
export const ja = defineLocale({
  ...
  profiles: {
    ...
    deleting: '削除中...',
    createDesc:
      'プロファイルは独立した Hermes 環境です。別のデスクトップバックエンドにルーティングすることもできます。',
    nameLabel: '名前',
    cloneFrom: '複製元',
    cloneFromNone: 'なし（空）',
    ...
    backendTarget: 'バックエンドの接続先',
    backendLocal: 'このバックエンド',
    backendRemote: 'リモートバックエンド',
    backendLocalDesc: '現在のバックエンドにプロファイルを作成してここで実行します。',
    backendRemoteDesc: 'このプロファイルを別の Hermes Desktop バックエンドへのショートカットとして使います。',
    remoteUrl: 'リモート URL',
    remoteUrlRequired: 'リモート URL は http:// または https:// で始まる必要があります。',
    remoteToken: 'セッショントークン',
    remoteTokenRequired: 'リモートバックエンドにはセッショントークンが必要です。',
    remoteTokenPlaceholder: 'リモートセッショントークンを貼り付けます',
