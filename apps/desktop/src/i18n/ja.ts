...
export const ja = defineLocale({
  ...
  settings: {
    ...
    gateway: {
      ...
      savedConnectionsTitle: '保存済みリモートゲートウェイ',
      savedConnectionsDesc: 'URL や認証情報を再入力せずに、複数のバックエンドを切り替えられます。',
      addConnection: 'リモートを追加',
      noSavedConnections: '保存済みのリモートゲートウェイはありません。',
      connectedConnection: '接続中',
