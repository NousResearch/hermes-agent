...
export const ja = defineLocale({
  ...
  profiles: {
    ...
    gatewaySwitcher: 'ゲートウェイを切り替え',
    gatewayLocalHeading: 'ローカル',
    gatewayThisDevice: 'このデバイス',
    gatewayRemoteHeading: 'リモート',
    gatewaySshHeading: 'SSH',
    switchToGateway: name => `${name} に切り替え`,
    cloudAgents: 'Hermes Cloud',
    cloudAgentsEmpty: '利用できる Hermes Cloud エージェントはありません。',
    cloudAgentsLoading: 'Hermes Cloud エージェントを読み込み中…',
    cloudAgentsRefresh: 'ゲートウェイを更新',
    switchToCloudAgent: name => `${name} に切り替え`,
    starCloudAgent: name => `${name} をお気に入りに追加`,
    unstarCloudAgent: name => `${name} をお気に入りから削除`,
    actions: 'アクション',
  ...
  shell: {
    ...
    gatewayMenu: {
      ...
      favorites: 'お気に入りのゲートウェイ',
      noFavorites: 'お気に入りのゲートウェイはまだありません。',
      manageFavorites: '設定で管理 →',
      useFavorite: name => `${name} に接続`,
      activeFavorite: '使用中',
      switchingFavorite: '切り替え中…'
    },
    approvalMode: {
      title: '承認モード',
