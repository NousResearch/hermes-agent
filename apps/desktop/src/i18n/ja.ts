...
export const ja = defineLocale({
  ...
  settings: {
    ...
    appearance: {
      ...
      backdropDesc: 'カスタム壁紙を表示していないときに使う、薄い組み込みの彫像画像。',
      wallpaper: {
        title: 'カスタム壁紙',
        description: 'この端末にプロファイルごとに保存され、読み込み時に一度だけ最適化されます。',
        choose: '画像を選択',
        replace: '変更',
        remove: '削除',
        reset: '調整をリセット',
        error: '画像を読み込めませんでした。32 MB 以下の有効な JPEG、PNG、WebP ファイルか確認してください。',
        unsupported: '壁紙ピッカーを有効にするには Hermes を一度再起動してください。',
        profileNote: profile => `${profile} プロファイル用にローカル保存されています。`,
        preview: 'プレビュー',
        previewEffect: 'チャット表示',
        previewFull: '画像全体',
        visibility: '表示',
        displayMode: '表示方法',
        adaptiveTheme: '壁紙に合わせた配色',
        adaptiveThemeDesc: '文字のコントラストを保ちながら、画像からアクセント色と表面色を調整します。',
        adaptiveThemeAnalyzing: '画像の色を解析中…',
        adaptiveThemeError: 'この画像から色を取得できませんでした。',
        paletteMode: '配色方法',
        paletteModes: { auto: '自動抽出', manual: '手動指定' },
        paletteManualDesc: 'アクセント色はそのまま適用し、基調色は文字の視認性を保つため表面に薄く混ぜます。',
        paletteDominant: '基調色',
        paletteAccent: 'アクセント',
        modes: { fill: '全体に表示', fit: '収める', tile: '並べる', center: '中央' },
        opacity: '画像の濃さ',
        blur: 'ぼかし',
        overlay: '可読性マスク',
        overlayShape: 'マスク形状',
