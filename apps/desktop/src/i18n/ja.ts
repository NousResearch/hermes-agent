...
export const ja = defineLocale({
  ...
  assistant: {
    thread: {
      ...
      recoveryMissing: '履歴に返信がありません',
      recoveryUnfinished: '最終回答が見つかりません',
      recoveryPutBack: '入力欄に戻す',
      recoveryHide: '非表示',
      recoveryHidden: 'この端末で非表示にしました',
      recoveryUndo: '元に戻す',
      recoveryActivityHint: 'ツールが実行済みの場合があります。再送すると処理が重複する可能性があります。',
      recoveryHideHint: 'この端末の表示のみを隠します。モデルの履歴は変更しません。',
      recoveryAttachmentHint: 'テキストのみ戻します。送信前にファイルを再添付してください。',
      react: 'リアクション',
      dismissError: 'エラーを閉じる',
      errorLayers: {
        auth: '認証エラー',
