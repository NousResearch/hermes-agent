...
export const ja = defineLocale({
  ...
  settings: {
    ...
    mcp: {
      ...
      discoveryTitle: 'このゲートウェイで利用可能',
      discoveryFind: 'MCP サーバーを探す',
      discoveryHint: '既知のクライアント設定とローカルの待受ポートを検索します。検索中にプログラムは起動しません。',
      discoverySearching: 'MCP サーバーを検索中…',
      discoveryEmpty: '追加の MCP サーバーは見つかりませんでした。独自のパスや認証が必要な接続先は手動設定が必要な場合があります。',
      discoveryTarget: name => `${name} で有効にする`,
      newServer: '新しいサーバー',
      reload: 'MCP を再読み込み',
      reloading: '再読み込み中...',
