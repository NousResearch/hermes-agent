...
export const ja = defineLocale({
  ...
  desktop: {
    ...
    branchNoStoredMessage: 'このチャットにはまだブランチ元にできる保存済みメッセージがありません。',
    ...
    branchMessageUnavailable: 'メッセージを利用できません',
    branchMessageNotStored: 'そのメッセージはまだ保存済みの会話履歴に入っていません。',
    branchMessageNotMapped: 'そのメッセージはまだ保存済みの履歴に対応付けできません。',
    deleteFailed: '削除に失敗しました',
    archived: 'アーカイブしました',
