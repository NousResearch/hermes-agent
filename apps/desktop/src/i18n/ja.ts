...
export const ja = defineLocale({
  ...
  pullRequests: {
    ...
    draft: 'ドラフト',
    merged: 'マージ済み',
    reviewDecision: 'レビュー判定',
    checks: 'チェック',
    openGithub: 'GitHub で開く',
    copyUrl: 'URL をコピー',
    back: 'プルリクエストに戻る',
    noneCreated: '作成したプルリクエストはありません',
    noneReview: 'レビュー待ちはありません',
    noneClosed: '最近クローズしたプルリクエストはありません',
    ghMissing: 'GitHub CLI が見つかりません',
    authRequired: 'GitHub の認証が必要です',
    authHint: '`gh auth login` を実行してください',
    loadFailed: 'プルリクエストを読み込めませんでした',
    detailFailed: 'プルリクエストの詳細を読み込めませんでした',
    retry: '再試行',
    updated: '更新日時',
    repository: 'リポジトリ',
    changedFiles: '変更ファイル',
