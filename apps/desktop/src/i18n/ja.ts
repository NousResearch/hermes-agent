...
export const ja = defineLocale({
  ...
  statusStack: {
    ...
    coding: {
      ...
      verification: '検証',
      verificationPassed: '成功',
      verificationFailed: '失敗',
      verificationStale: '期限切れ',
      verificationUnverified: '未検証',
      verificationUnavailable: '利用不可',
      verificationChecking: '確認中',
      verificationCheckingDetail: '記録された検証を確認中',
      verificationNoEvidence: 'このセッションには検証記録がありません',
      verificationUnavailableDetail: '検証記録を利用できません',
      verificationChangesAfterCheck: 'この検証後に変更が加えられました',
      verificationPathsChanged: count => `この検証後に ${count} 件のパスが変更されました`,
      verificationExit: code => `終了コード ${code}`,
      verificationFull: '全体',
      verificationTargeted: '対象限定',
      verificationRun: '変更を検証',
      verificationRunAgain: '再検証',
      verificationPrompt:
        '現在の変更に適した検証を実行してください。必要に応じてリポジトリの標準テスト、lint、型チェック、ビルドコマンドを使用し、実行したコマンドと結果を正確に報告してください。関係のない変更は行わないでください。',
      newBranch: '新しいブランチ',
