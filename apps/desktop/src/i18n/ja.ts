...
export const ja = defineLocale({
  ...
  shell: {
    ...
    statusbar: {
      ...
      sessionsLabel: 'セッション',
      sessionsActive: count => `${count} 件のセッションがアクティブ`,
      sessionsActiveTitle: '進行中の作業があるセッション',
      agentsActive: count => `${count} 個のエージェント`,
      tasks: 'タスク',
      tasksTitle: 'ターミナルとプレビューのバックグラウンドタスク',
      tasksRunning: count => `${count} 件実行中`,
      tasksFailed: count => `${count} 件失敗`,
      cron: 'Cron',
