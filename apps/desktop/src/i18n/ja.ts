...
export const ja = defineLocale({
  ...
  settings: {
    ...
    customEndpoints: {
      ...
      reachableModels: count => `エンドポイントに接続できました。${count} 個のモデルが見つかりました。`,
      reachable: 'エンドポイントに接続できました。',
      validationFailed: 'エンドポイントの検証に失敗しました。',
      activationFailed: '有効化に失敗しました',
      deleteConfirm: name => `${name} を削除しますか？`,
      deleteFailed: '削除に失敗しました',
      loading: 'カスタムエンドポイントを読み込み中…',
      title: 'カスタムエンドポイント',
      active: '使用中',
      ...
      emptyTitle: 'カスタムエンドポイントはありません',
      emptyDescription: '以下に OpenAI 互換エンドポイントを追加してください。',
      editTitle: 'エンドポイントを編集',
      addTitle: 'エンドポイントを追加',
      name: '名前',
      namePlaceholder: 'Axet プロキシ',
      ...
      auto: '自動',
      apiKey: 'API キー',
      keepKey: '現在のキーを保持するには空欄にします',
      optional: '任意',
      useNewChats: '新しいチャットで使用',
    ...
    billing: {
      ...
      autoRefillTurnedOff: '自動補充をオフにしました。',
      threshold: 'しきい値',
      autoRefillThreshold: '自動補充のしきい値',
      reloadTo: '補充後の金額',
      autoRefillReloadTo: '自動補充後の金額',
      disable: '無効化',
      turnOffPrompt: '自動補充をオフにしますか？',
      turnOff: 'オフにする',
      customCreditAmount: '任意のクレジット金額',
      buy: '購入',
      processingSettlement: '処理中…決済結果を確認しています',
      addedBalanceRefreshing: amount => `${amount} を追加しました。残高を更新しています。`,
      openPortal: 'ポータルを開く',
      ...
      fixture: name => `フィクスチャ：${name}`,
      updatedAgo: time => `${time}に更新`,
      billingFixture: '請求フィクスチャ',
      live: 'ライブ',
      openPortalExternal: 'ポータルを開く ↗',
      connectAccountMessage: 'TUI で /portal を実行するか、Nous ポータルを開いてアカウントを接続してください。',
      connectAccountTitle: 'Nous アカウントを接続',
      balance: '残高',
      plan: 'プラン',
      autoRefill: '自動補充',
      enabled: '有効',
      ...
      updateExternal: '更新 ↗',
      paymentMethodMissingDescription: '追加クレジットを購入する前にポータルで支払い方法を追加してください。',
      paymentMethod: '支払い方法',
      noCard: 'カード未登録',
      paymentMethodDescription: '追加購入とサブスクリプション更新に使うカードを管理します。',
      adjustPlanExternal: 'プランを調整 ↗',
      subscriptionUnavailable: 'サブスクリプションの詳細を取得できませんが、ポータルは開けます。',
      renews: date => `更新日：${date}`,
      subscriptionDescription: 'プランを確認し、請求ポータルから変更します。',
      opensPortal: 'ポータルを開く',
      subscription: 'サブスクリプション',
      buyCredits: 'クレジットを購入',
      buyCreditsDescription: 'プラン外のエージェント実行用に追加クレジットを購入します。',
      manage: '管理',
      manageAutoRefillPortal: 'ポータルで自動補充を管理します。',
      autoRefillDescription: '残高がしきい値を下回ったときに自動で補充します。',
      turnOnAutoRefillPortal: 'ポータルで自動補充をオンにしてください',
      differentCard: '別のカード',
      reconcileExternal: '確認 ↗',
      autoRefillCharges: card => `自動補充は ${card} に請求されます。ポータルで確認してください`,
      refillWhen: (amount, threshold) => `残高が ${threshold} を下回ったら ${amount} まで補充`,
      subscriptionRemainingOver: (remaining, monthly, over) => `${monthly} 中 ${remaining} 残り · ${over} 超過`,
      subscriptionRemaining: (remaining, monthly) => `${monthly} 中 ${remaining} 残り`,
      subscriptionCreditsRemaining: 'サブスクリプションクレジット残量',
      resets: date => `リセット日：${date}`,
      subscriptionCredits: 'サブスクリプションクレジット',
      topUpCreditsRemaining: '追加クレジット残量',
      doesNotExpire: '有効期限なし',
      topUpCredits: '追加クレジット',
      amountOfLimitUsed: (amount, limit) => `${limit} 中 ${amount} 使用`,
      monthlySpendCapUsed: '月間支出上限の使用量',
      defaultCeiling: '既定の上限',
      monthlyTerminalBillingSpend: '端末請求の月間支出',
      monthlySpendCap: '月間支出上限',
      planMonthly: (tier, price) => `${tier} · ${price}/月`,
      autoRefillCard: '自動補充カード',
      customerDefault: '顧客の既定カード',
      subscriptionCard: 'サブスクリプションカード',
      creditsAdded: amount => `${amount} を追加しました。`,
      creditsAddedGeneric: 'クレジットを追加しました。',
      chargeFailedTitle: 'チャージに失敗しました',
      chargeOutcomeUnconfirmedMessage: message =>
        `${message} 前回のチャージ結果は未確認です。再試行前に残高または履歴を確認してください。`,
      chargeOutcomeUnconfirmedTitle: 'チャージ結果は未確認です',
      couldNotCheckCharge: 'チャージを確認できませんでした。',
      couldNotCheckChargeTitle: 'チャージを確認できません',
      acceptedNoChargeId: '請求サービスはリクエストを受け付けましたが、チャージ ID を返しませんでした。',
      chargeCouldNotBeTracked: 'チャージを追跡できません',
      chargeMayStillSettle: 'チャージはまだ決済される可能性があります。再試行前にポータルを確認してください。',
      stillProcessing: '5 分経過後も処理中です',
      bankVerificationRequired: '銀行による 3DS 確認が必要です。ポータルで完了して購入を続けてください。',
      cardExpired: 'カードの有効期限が切れています。ポータルで更新してください。',
      cardDeclined: 'カードが拒否されました。ポータルで別のカードをお試しください。',
      chargeProcessingError: reason => `チャージを処理できませんでした（${reason}）。`,
      verificationNotGrantedMessage: '確認は完了しましたが、請求管理アクセスは許可されませんでした。',
      verificationNotGrantedTitle: '確認が承認されませんでした',
      billingAccessVerifiedMessage: '請求管理アクセスを確認しました。',
      billingAccessVerifiedTitle: '確認完了',
      reloadGreaterThanThreshold: '補充後の金額はしきい値より大きくする必要があります。',
      invalidAmount: label => `${label}：小数点以下 2 桁までのドル金額を入力してください。`,
      amountGreaterThanZero: label => `${label}：金額は $0 より大きくする必要があります。`,
      minimumAmount: (label, minimum) => `${label}：最低金額は ${minimum} です。`,
      maximumAmount: (label, maximum) => `${label}：最高金額は ${maximum} です。`,
      errors: {
        tooManyChargesRetry: minutes =>
          `🟡 現在チャージが集中しています（約 ${minutes} 分後に再試行）。支払い失敗ではありません。`,
        tooManyCharges: '🟡 現在チャージが集中しています。支払い失敗ではありません。',
        stripeRetry: minutes => `Stripe に問題が発生しています。約 ${minutes} 分後に再試行してください`,
        stripeTrouble: 'Stripe に問題が発生しています。しばらくしてから再試行してください',
        ...
        idempotencyMessage: '🔴 このチャージキーは別の金額ですでに使用されています。新しくチャージしてください。',
        idempotencyTitle: '新しくチャージしてください',
        noPaymentMethodMessage:
          '💳 端末チャージ用カードが保存されていません。ポータルで設定してください（単発購入では再利用カードは保存されません）。',
        noPaymentMethodTitle: '保存済みカードなし',
        orgAccessMessage: 'このトークンは管理可能な組織に紐付いていません',
        orgAccessTitle: '組織へのアクセスが拒否されました',
        monthlyCapRemaining: remaining => `🔴 月間支出上限に達しました。残り枠は $${remaining} です。`,
        monthlyCapMessage: '🔴 月間支出上限に達しました。',
        monthlyCapTitle: '月間支出上限に達しました',
        tooManyChargesTitle: '現在チャージが集中しています',
        stripeTroubleTitle: 'Stripe に問題が発生しています',
        planLimitMessage: '1 日のプラン変更上限に達しました。明日再試行してください',
        planLimitTitle: '1 日のプラン変更上限に達しました',
        endpointUnavailableMessage:
          '請求エンドポイントが JSON 以外を返しました。この環境では利用できない可能性があります。',
        endpointUnavailableTitle: '請求エンドポイントを利用できません',
        timeoutMessage: '請求リクエストがタイムアウトしました。',
        timeoutTitle: '請求リクエストがタイムアウトしました',
        transportMessage: '請求リクエストはゲートウェイ到達前に失敗しました。',
        transportTitle: '請求接続に失敗しました',
        defaultMessage: '請求リクエストに失敗しました。',
        defaultTitle: '請求リクエストに失敗しました'
      }
    },
    plugins: {
      title: 'デスクトッププラグイン',
    ...
    model: {
      ...
      setupProviderGeneric: 'プロバイダーを設定',
    ...
    memoryProvider: {
      ...
      loadFailedDetail: message => `メモリプロバイダー設定を読み込めませんでした：${message}`,
      savedTitle: provider => `${provider} を保存しました`,
      savedMessage: 'メモリプロバイダー設定を更新しました。',
      saveFailed: provider => `${provider} の設定を保存できませんでした`,
      saveFieldFailed: field => `${field} を保存できませんでした`,
      loading: 'メモリプロバイダー設定を読み込み中…',
      settings: provider => `${provider} の設定`,
      fieldSet: field => `${field} は設定済み`,
      fieldNotSet: field => `${field} は未設定`,
      fieldAbout: field => `${field} について`,
      fullConfig: '完全な設定…',
      fullConfigurationTitle: provider => `${provider} — 完全な設定`,
      fullConfigurationDescription: (provider, profile) =>
        `${profile} プロファイル用の ${provider} の全オプションです。空欄は解決済みホスト値または組み込みの既定値にフォールバックします。`,
      configReference: provider => `${provider} 設定リファレンス`,
      otherGroup: 'その他',
      saveChanges: '変更を保存',
