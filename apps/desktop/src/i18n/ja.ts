...
export const ja = defineLocale({
  ...
  pet: {
    ...
    actionCenter: {
      ...
      itemCount: (total, attention) => `${total} 件 · 要確認 ${attention} 件`,
      open: 'アクションセンターを開く',
      close: 'アクションセンターを閉じる',
      previous: '前のアイテム',
      next: '次のアイテム',
      ...
      unknownProfile: 'デフォルトプロファイル',
      reasoning: '推論',
      queuedCount: count => `${count} 件待機中`,
      connectionConnecting: '接続中',
      connectionOffline: 'オフライン',
      connectionError: '接続エラー',
      messageSession: 'セッションにメッセージを送信',
      queueMessage: 'メッセージをキューに追加',
      liveMessagePlaceholder: 'メッセージを入力…',
      send: '送信',
      steer: '指示を変更',
      queue: 'キューに追加',
      stop: '停止',
      acknowledge: '閉じる',
      steerRejected: '実行中のセッションに指示を送れませんでした。次に送るメッセージとしてキューに追加してください。',
      queueRejected: 'このメッセージをキューに追加',
      steered: '指示を送信しました',
