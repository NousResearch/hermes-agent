...
export const ja = defineLocale({
  ...
  statusStack: {
    ...
    markDone: '完了にする',
    markDoneAria: task => `タスクを完了にする: ${task}`,
    reopen: '再開する',
    reopenAria: task => `タスクを再開する: ${task}`,
    retryTaskSync: '再試行',
    syncingTask: 'タスク状態を同期中',
    markDoneTitle: 'タスクを完了にしますか？',
    markDoneDescription: 'Hermes はこれをあなたの決定として扱い、古いモデル更新から再開しません。',
    markingDone: '完了にしています…',
    markedDone: '完了にしました',
    reopenTitle: 'タスクを再開しますか？',
    reopenDescription: 'Hermes がこのタスクの作業を続ける場合があります。',
    reopening: '再開しています…',
    reopened: '再開しました',
    taskChanged: '確認中にタスクが変更されました。最新の一覧を確認して、もう一度お試しください。',
    taskMissing: 'そのタスクは現在のプランにありません。',
    taskSessionMissing: 'このタスクセッションは利用できません。チャットを再開して、もう一度お試しください。',
    taskSyncFailed: 'タスク状態を同期できませんでした',
    taskUpdateFailed: 'タスク状態を更新できませんでした。もう一度お試しください。',
    taskUpdatesUnavailable: 'タスクの更新は利用できません',
    statusPending: '保留中',
