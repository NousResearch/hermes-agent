...
export const ja = defineLocale({
  ...
  ide: {
    ...
    explorerEmptyTitle: 'ワークスペースが開かれていません',
    explorerEmptyBody: 'プロジェクトのウィンドウからIDEを開くと、そのワークスペースが読み込まれます。',
    editorTitle: 'エディター',
    editorEmptyTitle: 'ファイルが開かれていません',
    ...
    toggleBrowser: 'ブラウザーを切り替え',
    resizeExplorer: 'エクスプローラーのサイズ変更',
    resizeChat: 'チャットのサイズ変更',
    resizeBrowser: 'ブラウザーのサイズ変更',
    refreshExplorer: 'エクスプローラーを更新',
    explorerUnreadable: error => `このフォルダーを読み取れません (${error})。`,
    editorTabsLabel: '開いているファイル',
    closeTab: '閉じる',
    closeTabLabel: name => `${name} を閉じる`,
    reloadFromDisk: 'ディスクから再読込',
    tooLargeTitle: 'このファイルは大きすぎて編集できません',
    tooLargeBody: '512 KB を超えています。チャットのプレビューかデスクトップのエディターで開いてください。',
    loadFailedTitle: 'ファイルを開けませんでした',
    closeDirtyTitle: '未保存の変更があります。閉じますか？',
    ...
    chatNew: '新しいIDEセッション',
    chatRecent: '最近のIDEセッション',
    chatCreateFailed: 'IDEセッションを開始できませんでした',
    browserTabsLabel: 'ブラウザータブ',
    browserOpen: 'ブラウザーを開く',
