...
export const ja = defineLocale({
  ...
  backworkspace: {
    ...
    approvalBadge: count => `${count} 件があなたの承認待ち`,
    approvalWaiting: shortcut => `エージェントが承認を待っています — ${shortcut} で確認`,
    approvalWaitingMany: (count, shortcut) => `${count} 件の承認待ち — ${shortcut} で確認`,
    approvalConfirm: '常に許可 — もう一度押す',
