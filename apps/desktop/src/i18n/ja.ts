...
export const ja = defineLocale({
  ...
  settings: {
    ...
    vault: {
      ...
      registrableDomainLabel: 'HTTPS サブドメインを許可',
      registrableDomainHint: 'このサイトの登録可能ドメインと HTTPS サブドメインで入力します。すべてを信頼する場合のみ有効にしてください。',
      registrableDomainBadge: 'HTTPS サブドメイン',
  ...
  prompts: {
    ...
    vaultSaveRegistrableDomain: 'HTTPS サブドメインを許可',
    vaultSaveRegistrableDomainHint: 'このログインを同じ登録可能ドメインへ明示的に拡張します。すべてのサブドメインを信頼する場合のみ有効にしてください。',
