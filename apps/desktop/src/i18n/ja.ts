...
export const ja = defineLocale({
  ...
  settings: {
    ...
    appearance: {
      ...
      editCustomTheme: 'カスタムテーマを編集',
      customThemeDesc: 'ライトとダークの配色を個別に編集します。変更はリアルタイムでプレビューされ、保存時にのみ書き込まれます。',
      customThemeName: 'テーマ名',
      customAccent: 'アクセント',
      customBackground: '背景',
      customForeground: '前景',
      customUiFont: 'UI フォント',
      customCodeFont: 'コードフォント',
      customSidebar: '半透明サイドバー',
      customContrast: 'コントラスト',
      customInvalidColor: '#0053FD のような有効な16進カラーを入力してください。',
      customReset: 'リセット',
      pet: {
        title: 'ペット',
        intro:
