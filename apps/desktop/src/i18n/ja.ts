...
export const ja = defineLocale({
  ...
  settings: {
    ...
    appearance: {
      ...
      tabStripAlways: '常に表示',
      tabStripNever: '表示しない',
      paneDistributionTitle: 'パネルの分配',
      paneDistributionDesc: 'パネルの追加・移動時に、影響を受ける分割内のパネルをどう配分するかを選びます。手動リサイズは維持されます。',
      paneDistributionPreserve: '従来どおり',
      paneDistributionEqualFlex: '可変パネルを均等に',
      paneDistributionEqualAll: '常に均等に',
      paneDistributionConfirmTitle: '既存のパネルも再配置しますか？',
      paneDistributionConfirmDesc: '現在のレイアウトで対象となるパネルの比率を変更します。固定・非表示・最小化されたパネルの制約は維持されます。',
      paneDistributionApplyExisting: '既存も再配置',
      paneDistributionFutureOnly: '今後の変更だけ',
      paneDistributionCancel: 'キャンセル',
