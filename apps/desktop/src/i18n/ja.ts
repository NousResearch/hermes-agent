...
export const ja = defineLocale({
  ...
  shell: {
    ...
    statusbar: {
      ...
      toggleAccountUsage: 'アカウント使用量',
      accountUsage: 'アカウント使用量',
      accountUsageLeft: remaining => `残り${remaining}%`,
      accountUsagePanel: {
        openUsageSettings: '使用量の設定を開く',
        plan: plan => `${plan} プラン`,
        refresh: '更新',
        remaining: remaining => `残り ${remaining}%`,
        resets: time => `${time}にリセット`,
        sessionLine: (input, output, total) => `入力 ${input} · 出力 ${output} · 合計 ${total}`,
        stale: '使用量を更新できませんでした。最後に取得できた結果を表示しています。',
        thisSession: 'このセッション',
        title: 'アカウント使用量',
        unavailable: '利用不可',
