...
export const ja = defineLocale({
  ...
  skills: {
    ...
    filesLoadFailed: 'スキルファイルの読み込みに失敗しました。',
    binary: 'バイナリ',
    binaryUnsupported: path => `${path} はバイナリファイルのため、テキストエディターでは開けません。`,
    discardUnsaved: '未保存の変更を破棄してファイルを切り替えますか？',
    deleteFile: path => `${path} を削除`,
    deleteFileConfirm: path => `${path} をこのスキルから削除しますか？この操作は元に戻せません。`,
    fileDeleted: 'スキルファイルを削除しました',
    edit: '編集',
    archive: 'アーカイブ',
