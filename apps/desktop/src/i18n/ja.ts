...
export const ja = defineLocale({
  ...
  sidebar: {
    ...
    row: {
      ...
      moveProjectTitle: 'チャットをプロジェクトへ移動',
      moveProjectDesc: title =>
        `「${title}」をプロジェクトへ移動します。以降のコマンドとツールはそのプロジェクトの作業ディレクトリで実行されます。`,
      moveProjectFailed: 'チャットを移動できませんでした',
      moveProjectMissingWorkspace: 'このプロジェクトには作業フォルダーがありません。',
      moveProjectWrongProfile: 'このチャットのプロファイルに切り替えてからプロジェクトへ移動してください。',
      moveProjectsLoading: 'プロジェクトを読み込み中…',
      moveProjectsEmpty: '作業フォルダーのあるプロジェクトが見つかりません。',
      movedToProject: name => `${name} へ移動しました`,
      rename: '名前を変更',
      archive: 'アーカイブ',
      newWindow: '新しいウィンドウ',
