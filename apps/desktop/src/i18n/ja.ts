...
export const ja = defineLocale({
  ...
  sidebar: {
    ...
    archiveAllAria: 'ピン留めされていないセッションをすべてアーカイブ',
    archiveAllDialogTitle: 'すべてのセッションをアーカイブ',
    archiveAllDialogDesc:
      'サイドバーからピン留めされていないセッションをアーカイブします。ピン留め、現在のチャット、実行中のセッションは表示されたままです。',
    archiveAllConfirm: 'すべてアーカイブ',
    archiveAllCancel: 'キャンセル',
    archiveAllSubmitting: 'アーカイブ中...',
    archiveAllChecked: count => `${count} 件の表示中セッションを確認します。`,
