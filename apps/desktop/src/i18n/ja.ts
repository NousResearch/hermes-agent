...
export const ja = defineLocale({
  ...
  composer: {
    ...
    voiceEngineChained: '音声認識 + Hermes 音声',
    voiceEngineLive: 'GPT-Live（全二重、Hermes に委任）',
    voiceEngineLiveNeedsKey: 'OpenAI API キーが必要です',
    voiceEngineGrok: 'Grok Live（全二重、Hermes に委任）',
    voiceEngineGrokNeedsKey: 'SuperGrok サインインまたは xAI API キーが必要です',
    voiceEngineChangeFailed: '音声チャットエンジンを変更できませんでした',
    voiceEngineChainedShort: '音声認識',
    voiceEngineLiveShort: 'GPT-Live',
    voiceEngineGrokShort: 'Grok Live',
    voiceDictation: '音声口述',
