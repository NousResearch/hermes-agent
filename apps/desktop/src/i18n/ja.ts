...
export const ja = defineLocale({
  ...
  notifications: {
    ...
    voice: {
      ...
      microphoneSelectionUnavailable: '選択したマイクは利用できません',
      ...
      usingSystemMicrophone: 'Hermes は今回の録音にシステムデフォルトのマイクを使用します。'
    },
    native: {
  ...
  keybinds: {
    title: 'キーボードショートカット',
    subtitle: open => `ショートカットをクリックすると再割り当てできます · ${open} でこのパネルを再表示できます。`,
    rebind: '再割り当て',
    reset: 'デフォルトに戻す',
    resetAll: 'すべてリセット',
    pressKey: 'キーを押してください…',
    ...
    actions: {
      ...
      'nav.skills': 'スキルを開く',
      'nav.messaging': 'メッセージングを開く',
      'nav.artifacts': 'アーティファクトを開く',
      'nav.cron': 'スケジュール済みジョブを開く',
      'nav.kanban': 'カンバンボードを開く',
      'nav.agents': 'エージェントを開く',
      'session.new': '新しいセッション',
      'session.newWindow': '新しいウィンドウでセッションを開始',
      'session.next': '次のセッション',
      'session.prev': '前のセッション',
      'session.slot.1': '最近のセッション 1 に切り替え',
      'session.slot.2': '最近のセッション 2 に切り替え',
      'session.slot.3': '最近のセッション 3 に切り替え',
      'session.slot.4': '最近のセッション 4 に切り替え',
      'session.slot.5': '最近のセッション 5 に切り替え',
      'session.slot.6': '最近のセッション 6 に切り替え',
      'session.slot.7': '最近のセッション 7 に切り替え',
      'session.slot.8': '最近のセッション 8 に切り替え',
      'session.slot.9': '最近のセッション 9 に切り替え',
      'session.focusSearch': 'セッションを検索',
      'session.togglePin': '現在のセッションをピン留め / 解除',
      'workspace.newWorktree': '新しいワークツリー',
      'composer.focus': 'コンポーザーにフォーカス',
      'composer.modelPicker': 'モデルピッカーを開く',
      'composer.voice': '音声会話を開始 / 停止',
      'view.toggleSidebar': 'セッションサイドバーを切り替え',
      'view.toggleRightSidebar': 'ファイルブラウザーを切り替え',
      'view.toggleReview': 'レビューペインを切り替え',
      'view.showFiles': 'ファイルブラウザーを表示',
      'view.showTerminal': 'ターミナルを切り替え',
      'view.terminalSelection': 'ターミナルの選択範囲をコンポーザーへ送信',
      'view.closePreviewTab': 'プレビュータブを閉じる',
      'view.flipPanes': 'サイドバーの位置を入れ替え',
      'view.toggleSplit': '分割ペインを切り替え',
      'appearance.toggleMode': 'ライト / ダークを切り替え',
      'profile.default': 'デフォルトプロファイルに切り替え',
  ...
  settings: {
    ...
    voice: {
      title: '音声入力',
      microphoneTitle: 'マイク',
      microphoneDesc: 'ディクテーションと音声会話に使用するデバイスローカルの入力。',
      systemDefault: 'システムデフォルトのマイク',
      refreshDevices: '更新',
      devicesUnavailable: 'このランタイムではマイクデバイスを利用できません。',
      missingDeviceOption: '保存済みのマイク（未接続）',
      selectedDeviceUnavailable:
        '保存済みのマイクが接続されていません。Hermes はシステムデフォルトにフォールバックします。',
      backendTitle: '文字起こしバックエンド',
      localBackend: 'ローカル',
      remoteBackend: 'リモート',
      localBackendDesc:
        '音声はここで収録され、ローカルの Hermes バックエンドで文字起こししてからテキストをエージェントに送信します。',
      remoteBackendDesc: baseUrl =>
        `音声はここで収録され、${baseUrl} に送信されて文字起こしされます。モデル API が受け取るのは文字起こしテキストであり、生の音声ではありません。`,
      sttTitle: '音声認識',
      refreshStatus: '確認',
      checkingStatus: '音声認識のステータスを確認中…',
      statusUnavailable: '音声認識のステータスを取得できません。',
      statusUnsupported:
        'このバックエンドはまだ音声認識の診断を公開していません。音声文字起こしは動作する可能性があります。準備状況の詳細を見るにはバックエンドを更新してください。',
      statusFailed: 'ステータス確認に失敗しました',
      statusError: message => `音声認識のステータス確認に失敗しました: ${message}`,
      sttDisabled: '設定で音声認識が無効になっています。',
      sttReady: provider => `接続中のバックエンドで ${provider} の音声認識が利用可能です。`,
      sttUnavailable: provider => `接続中のバックエンドで ${provider} の音声認識がまだ準備できていません。`,
      localSttInstallable: missing =>
        `ローカル STT に ${missing} がありません。遅延インストールが有効なため、初回のローカル文字起こし時にバックエンドが許可されたパッケージをインストールできます。`,
      localSttMissing: missing =>
        `ローカル STT に ${missing} がありません。遅延インストールを有効にするか、このバックエンドにローカル STT パッケージをインストールしてください。`,
      localCommandAvailable: missing =>
        `コマンドベースのローカル STT が利用可能です。不足しているパッケージバンドル: ${missing}。デスクトップでの収録に sounddevice や numpy は不要です。`,
      localPackagesReady: 'このバックエンドにはローカル STT パッケージがインストールされています。',
      localPackagesMissing: missing => `不足しているローカル STT パッケージ: ${missing}。`
    },
    about: {
    ...
    mcp: {
      ...
      test: '接続をテスト',
      testing: 'テスト中…',
      testOk: count => `接続済み — ツール ${count} 個が利用可能`,
      testFailed: '接続に失敗しました',
      enableServer: name => `${name} を有効化`,
      disableServer: name => `${name} を無効化`,
      serverEnabled: name => `${name} を有効にしました — 新しいセッションに適用されます。`,
      serverDisabled: name => `${name} を無効にしました — 新しいセッションに適用されます。`,
      toggleFailed: name => `${name} の切り替えに失敗しました`,
      tabServers: 'サーバー',
      tabCatalog: 'カタログ',
      catalogLoading: 'MCP カタログを読み込み中…',
      catalogLoadFailed: 'MCP カタログの読み込みに失敗しました',
      catalogEmpty: '利用可能なカタログ項目がありません。',
      catalogInstalled: 'インストール済み',
      catalogEnabled: '有効',
      catalogNeedsInstall: 'ビルドが必要',
      catalogInstall: 'インストール',
      catalogInstalling: 'インストール中…',
      catalogInstallStarted: name => `${name} をインストール中… 完了後、新しいセッションに適用されます。`,
      catalogInstallFailed: name => `${name} のインストールに失敗しました`,
      catalogEnvPrompt: name => `${name} には認証情報が必要です`,
    ...
    model: {
      ...
      reasoning: '推論',
      reasoningOff: 'オフ',
      defaultsFailed: 'モデルのデフォルト設定を保存できませんでした',
    ...
    providers: {
      ...
      disconnect: '接続を解除',
      disconnectInTerminal: '接続を解除（ターミナルで削除コマンドを実行します）',
      removeConfirm: provider => `${provider} を削除しますか？`,
      removeExternalGeneric: provider => `${provider} は独自の CLI で管理されています — そちらで削除してください。`,
      removeKeyManaged: provider => `${provider} は API キーで設定されています。API Keys から削除してください。`,
      removeTerminalConfirm: (provider, command) =>
        `${provider} の接続を解除しますか？認証情報をクリアするため、ターミナルで "${command}" を実行します。`,
      removeTerminalRunning: provider => `ターミナルで ${provider} の接続解除を実行中…`,
    ...
    toolsets: {
      ...
      modelInUse: '使用中',
      modelDefault: 'デフォルト',
      modelInactiveHint: 'モデルを変更するには、まずこのバックエンドを選択してください。',
      modelSelectedTitle: 'モデルを選択しました',
      modelSelectedMessage: model => `${model} は新しいセッションに適用されます。`,
      failedSelectModel: model => `${model} の選択に失敗しました`
    }
  },
  ...
  skills: {
    ...
    hub: {
      ...
      featured: '注目のスキル',
      landingHint:
        'ハブを検索して、公式インデックス、GitHub、コミュニティソースからインストール可能なスキルを閲覧できます。',
      noResults: 'ハブに一致するスキルが見つかりません。',
      ...
      verdictDangerous: '危険',
      policyAllow: 'インストール可',
      policyAsk: 'インストール前に確認してください',
      policyBlock: 'ポリシーによりインストールがブロックされています',
  ...
  starmap: {
    ...
    share: 'マップを共有',
    shareHint:
      'コードをコピーしてこのマップを共有するか、コードを貼り付けて読み込みます。レイアウトのみを含み、メモリやスキルの内容は含まれません。',
    shareTitle: 'マップのインポート / エクスポート',
    sharePlaceholder: 'マップコードを貼り付け…',
    copy: 'マップコードをコピー',
    copied: 'コピーしました！',
    importMap: 'マップをインポート',
    importBtn: '読み込む',
    importEmpty: 'マップコードを貼り付けて読み込みます。',
    importSuccess: nodes => `${nodes} 個のノードを含むマップを読み込みました。`,
    importedBadge: 'インポートされたマップ',
  ...
  commandCenter: {
    ...
    mcpServers: 'MCP サーバー',
    archivedChats: 'アーカイブ済みチャット',
    sections: { maintenance: 'メンテナンス', sessions: 'セッション', system: 'システム', usage: '使用状況' },
    sectionDescriptions: {
    ...
    logFile: 'ログファイル',
    logLevel: 'レベル',
    logSearchPlaceholder: 'ログ行をフィルター…',
    maintenance: {
      runOps: '診断',
      doctor: 'ドクターを実行',
      doctorDesc: 'インストール、設定、プロバイダーのヘルスチェック',
      securityAudit: 'セキュリティ監査',
      securityAuditDesc: '設定とスキルの危険な設定をスキャン',
      backup: 'バックアップを作成',
      backupDesc: '設定、メモリ、スキル、セッションを ZIP 化',
      debugShare: 'デバッグ共有',
      debugShareDesc: '秘匿処理済みのレポートとログをアップロードし、共有リンクを取得します（6 時間後に自動削除）',
      debugShareRunning: 'デバッグレポートをアップロード中…',
      debugShareLinks: '共有リンク',
      debugShareFailed: 'デバッグ共有に失敗しました',
      copyLink: 'リンクをコピー',
      linkCopied: 'リンクをコピーしました',
      curator: 'スキルキュレーター',
      curatorDesc: '古くなったエージェント作成スキルをアーカイブするバックグラウンドレビュー',
      curatorPaused: '一時停止中',
      curatorActive: '稼働中',
      curatorDisabled: '無効',
      curatorLastRun: when => `前回の実行 ${when}`,
      curatorNeverRan: '未実行',
      pause: '一時停止',
      resume: '再開',
      runNow: '今すぐ実行',
      memoryData: 'メモリデータ',
      memoryDataDesc: 'すべてのセッションに注入される組み込みメモリファイル',
      memoryProvider: name => `アクティブなプロバイダー: ${name}`,
      builtinMemory: '組み込み',
      memoryFile: 'エージェントメモリ（MEMORY.md）',
      userFile: 'ユーザープロファイル（USER.md）',
      bytes: size => size,
      empty: '空',
      resetMemory: 'メモリをリセット',
      resetUser: 'プロファイルをリセット',
      resetAll: '両方リセット',
      resetConfirm: target => `${target} を削除しますか？この操作は元に戻せません。`,
      resetDone: files => `${files} を削除しました。`,
      resetFailed: 'メモリのリセットに失敗しました',
      actionStarted: name => `${name} を開始しました — ログを追跡中…`,
      actionFailed: name => `${name} の開始に失敗しました`,
      running: '実行中…',
      viewLog: '操作ログ'
    }
  },
  ...
  profiles: {
    ...
    workingBadge: count => `${count} 件のセッションが作業中`,
    attentionBadge: count => `${count} 件のセッションが入力待ち`
  },
  ...
  kanban: {
    ...
    failedLoad: 'カンバンボードの読み込みに失敗しました',
    count: count => `${count} 枚のカード`,
    board: 'ボード',
    nudgeDispatcher: 'ディスパッチャーを起動',
    nudgeSent: (spawned, promoted) => `ディスパッチャーを起動しました — 開始 ${spawned}、昇格 ${promoted}`,
    nudgeFailed: 'ディスパッチャーの起動に失敗しました',
    newCard: '新しいカード',
    noTasks: 'カードがありません',
    unassigned: '未割り当て',
    priority: '優先度',
    progressTitle: (done, total) => `子タスク ${done}/${total} 完了`,
    diagnostics: '診断',
    movedByRules: column => `ボードルールにより「${column}」へ移動しました`,
    ...
    commentPlaceholder: 'コメントを追加…（⌘Enter で送信）',
    addComment: 'コメント',
    commentFailed: 'コメントの追加に失敗しました',
    events: 'イベント',
    noEvents: 'イベントはありません',
    runHistory: '実行履歴',
    noRuns: '実行履歴はまだありません',
    ...
    workerLog: 'ワーカーログ',
    loadingLog: 'ログを読み込み中…',
    noWorkerLog: 'ワーカーログはまだありません',
    attachments: '添付ファイル',
    noAttachments: '添付ファイルはありません',
    addAttachment: '添付ファイルを追加',
    attachmentUploading: 'アップロード中…',
    attachmentUploaded: count =>
      count === 1 ? '添付ファイルを追加しました' : `${count} 件の添付ファイルを追加しました`,
    attachmentUploadFailed: '添付ファイルのアップロードに失敗しました',
    downloadAttachment: name => `${name} をダウンロード`,
    attachmentDownloaded: name => `${name} をダウンロードフォルダーに保存しました`,
    attachmentDownloadFailed: '添付ファイルのダウンロードに失敗しました',
    attachmentReveal: 'フォルダで表示',
    updateFailed: '更新に失敗しました',
    newCardTitle: '新しいカード',
    newCardDesc: 'ディスパッチャーは準備完了のカードを割り当てられたプロファイルに渡します。',
    titleLabel: 'タイトル',
    titlePlaceholder: '何をする必要がありますか？',
    assigneeLabel: '担当者',
    assigneePlaceholder: 'プロファイルを選択',
    bodyLabel: '説明',
    bodyPlaceholder: '目標、アプローチ、受け入れ基準…',
    priorityLabel: '優先度',
    parentLabel: '親カード',
    parentNone: '親なし',
    optional: '任意',
  ...
  commandCenterOverview: {
    sectionLabel: 'すべてのプロファイル',
    sectionDescription: '全プロファイルのアクティビティと共有カンバンボード',
    working: count => `${count} 件作業中`,
    attention: count => `${count} 件入力待ち`,
    ...
    switch: '切り替え',
    openBoard: 'ボードを開く',
    kanbanUnavailable: 'このバックエンドではカンバンを利用できません。',
    noHotCards: 'レビュー中またはブロック中のカードはありません',
    openCard: title => `カンバンボードで「${title}」を開く`
  }
})
