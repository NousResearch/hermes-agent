...
export const ja = defineLocale({
  ...
  sidebar: {
    ...
    projects: {
      ...
      menuBindProfiles: 'プロファイルを割り当て…',
      bindProfilesTitle: 'プロファイルを割り当て',
      bindProfilesDesc: name => `「${name}」がアクティブの間、レールの先頭に表示するプロファイルを選択します。`,
      bindProfilesNone: '名前付きプロファイルはまだありません。',
      menuDelete: '削除',
      reveal: 'フォルダで表示',
      copyPath: 'パスをコピー',
