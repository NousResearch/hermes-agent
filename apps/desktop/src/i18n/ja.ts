...
export const ja = defineLocale({
  ...
  sidebar: {
    ...
    row: {
      ...
      stamp: 'スタンプ',
      stampClear: 'スタンプをすべて解除',
      stampCustom: 'カスタムスタンプ…',
      stampCustomPlaceholder: '例: マージ済み、CI 待ち',
      stampLimit: max => `1セッションにつき最大${max}個まで`,
      stampSaved: label => `${label} をスタンプしました`,
      stampRemoved: label => `${label} を外しました`,
      stampCleared: 'スタンプを解除しました',
      stampRemove: label => `スタンプメニューから「${label}」を削除`,
      stampRestore: '削除したスタンプを復元',
      stampAdd: 'スタンプを追加…',
      stampAddPlaceholder: '例: ブロック中',
      stampEmoji: '絵文字…',
      stampEmojiEmpty: '絵文字が見つかりません',
      stampEmojiPick: label => `${label} でスタンプ`,
      stampEmojiSearch: '絵文字を検索',
      stampColor: label => `「${label}」の色`,
      stampColorReset: '既定の色',
