...
export const ja = defineLocale({
  ...
  sidebar: {
    ...
    customFolderDefaultName: '新しいフォルダー',
    newFolderTitle: '新しいフォルダー',
    renameFolderTitle: 'フォルダー名を変更',
    folderNamePlaceholder: 'フォルダー名',
    renameFolderAction: 'フォルダー名を変更',
    deleteFolderAction: 'フォルダーを削除',
    deleteFolderTitle: 'フォルダーを削除',
    deleteFolderConfirm: name => `「${name}」を削除しますか？チャットは削除されず、セッションに戻ります。`,
    folderEmpty: 'チャットはまだありません — チャットの ⋯ メニューからここに移動できます。',
    pinFolder: 'すべてのプロファイルに固定',
    unpinFolder: 'すべてのプロファイルから固定解除',
    folderPinnedBadge: 'すべてのプロファイルで表示',
    reorderFolder: name => `フォルダー ${name} を並べ替え`,
    folderActionsFor: name => `フォルダー ${name} の操作`,
  ...
  desktop: {
    ...
    restartToCopyImages: '画像をコピーするには Hermes Desktop を再起動してください',
    imageDownloadFailed: '画像のダウンロードに失敗しました',
    imageCopyFailed: '画像のコピーに失敗しました',
    openImage: '画像を開く',
    copyImage: '画像をコピー',
    copyingImage: '画像をコピー中',
