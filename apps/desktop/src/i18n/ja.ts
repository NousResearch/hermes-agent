...
export const ja = defineLocale({
  ...
  assistant: {
    thread: {
      ...
      errorRetryLater: '後で再試行…',
      errorRetryLaterMenu: '後で再試行',
      errorRetryIn1h: '1時間後',
      errorRetryIn3h: '3時間後',
      errorRetryIn6h: '6時間後',
      errorRetryAt: '指定時刻に再試行',
      errorRetryAtInvalid: '14:30 のような時刻を入力してください',
      errorRetryScheduled: when => `${when} に自動再試行`,
      errorRetryCancelScheduled: '自動再試行をキャンセル',
      errorOpenLogs: 'ログを開く',
