...
export const ja = defineLocale({
  ...
  cron: {
    ...
    reasoningLabel: '推論',
    reasoningInherit: 'グローバル設定を継承',
    reasoningInactive: 'エージェントなしジョブでは無効',
    reasoningInactiveHint: 'この設定はジョブに保持されますが、エージェントなしで実行中は無効です。',
    reasoningInactiveWithValue: value => `${value}（無効）`,
    reasoningInvalid: value => `${value}（無効な値、グローバル設定を継承）`,
    reasoningOptions: {
      none: 'オフ',
      minimal: '最小',
      low: '低',
