...
export const ja = defineLocale({
  ...
  preview: {
    ...
    invalidNotebookTitle: 'Jupyter ノートブックではありません',
    invalidNotebookBody: 'このファイルは nbformat JSON として解析できませんでした。SOURCE に切り替えて生ファイルを確認してください。',
    notebookWidget: 'インタラクティブウィジェット（非表示）',
    edit: '編集',
    editing: '編集中',
    unsavedChanges: '未保存の変更',
