...
export const ja = defineLocale({
  ...
  kanban: {
    ...
    orchestration: {
      settings: "オーケストレーション設定",
      label: "オーケストレーション: ",
      auto: "自動",
      manual: "手動",
      loadingMode: "モードを読み込み中…",
      autoModeTitle:
        "オーケストレーション: 自動 — ディスパッチャーが新しいトリアージタスクを各 tick で自動的に分解します。クリックすると手動に切り替わります。",
      manualModeTitle:
        "オーケストレーション: 手動 — 各カードで ⚗ 分解をクリックするまで、タスクはトリアージに残ります。クリックすると自動に切り替わります。",
      configureTitle:
        "Kanban オーケストレーターを設定します（プロファイル選択、既定の担当者、自動分解、プロファイル説明）",
      reload: "再読み込み",
      orchestratorProfile: "オーケストレータープロファイル",
      defaultProfile: "（既定: {profile}）",
      resolved: "解決済み: {profile}",
      orchestratorHelp:
        "ファンアウト後のルートタスクを所有します（完了判定のために再開します）。タスクの分割方法は決めません。分解モデルは auxiliary.kanban_decomposer で設定してください。",
      defaultAssignee: "既定の担当者",
      mode: "オーケストレーションモード",
      autoDecompose: "トリアージタスクを自動分解",
      autoDecomposeHelp: "ディスパッチャーが新しいトリアージタスクを自動的に分解します。",
      manualDecomposeHelp: "⚗ 分解をクリックするまで、タスクはトリアージに残ります。",
      loading: "読み込み中…",
      profileDescriptions: "プロファイル説明",
      profileDescriptionsHelp:
        "説明は分解器のルーティングを補助します。⚗ をクリックして自動生成するか、編集して保存してください。",
      noProfiles: "プロファイルがインストールされていません。",
      defaultTag: "（既定）",
      autoReview: "自動 — 確認が必要",
      noDescriptionWarning: "⚠ 説明なし",
      descriptionPlaceholder: "このプロファイルは何が得意ですか？",
      saveDescriptionTitle: "上の説明をユーザー作成として保存します",
      save: "保存",
      saving: "保存中…",
      autoDescriptionTitle: "このプロファイルのスキルとモデルから説明を自動生成します",
      autoButton: "⚗ 自動",
      generating: "生成中…",
      failedToLoad: "読み込みに失敗しました: {message}",
      settingsSaved: "設定を保存しました。",
      saveFailed: "保存に失敗しました: {message}",
      descriptionSaved: "{name} の説明を保存しました。",
      autoGenerated: "{name} の説明を自動生成しました。",
      autoGenerateFailed: "自動生成に失敗しました: {message}",
      unknownError: "不明なエラー",
    },
    columnLabels: {
      triage: "トリアージ",
