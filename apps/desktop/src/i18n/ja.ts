...
export const ja = defineLocale({
  ...
  notifications: {
    ...
    releaseReadyTitle: 'Hermes の新しいリリース',
    releaseReadyMessage: tag => `${tag || '新しい公式リリース'}をインストールできます。`,
  ...
  settings: {
    ...
    about: {
      ...
      releaseUpdateReady: tag => `${tag || 'Hermes の新しいリリース'}をインストールできます。`,
      ...
      fastTrackDesc: 'main の変更を公開直後に受け取ります。頻繁な更新を許容する上級ユーザー向けです。',
      releaseTrackHint: version => `リリーストラック · ${version}`,
      unknownVersion: '不明',
      branchCommit: (branch, commit) => `ブランチ ${branch} · コミット ${commit}`,
      channel: '更新チャンネル',
      channelDesc: 'このインストールの更新先を選択します。このインストールを使うすべてのプロファイルに適用されます。',
      channelStable: '安定版',
      channelStableDesc: '公開済みの公式リリースのみ。ほとんどのユーザーにおすすめです。',
      channelBeta: 'ベータ (main)',
      channelBetaDesc: 'main の変更を公開直後に受け取ります。上級ユーザー向けです。',
      channelPersistOnlyNote: 'チャンネルの切り替えは設定を保存するだけです。更新の確認と適用は別々に行います。',
      never: '未確認',
      justNow: 'たった今',
  ...
  updates: {
    ...
    allSetTitle: '準備完了',
    releaseReadyTitle: 'Hermes の新しいリリース',
    releaseReadyBody: tag => `${tag || '最新の公式リリース'}をインストールできます。リリースノートは以下のとおりです。`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      releasesBehind: count => `${count} リリース遅れています`,
      release: tag => `リリース ${tag}`,
