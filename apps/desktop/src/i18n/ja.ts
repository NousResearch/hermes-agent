...
export const ja = defineLocale({
  ...
  sidebar: {
    ...
    projects: {
      ...
      editFoldersTitle: 'フォルダを編集',
      editFoldersDesc: 'フォルダがディスク上で移動／リネームされた後に、新しいパスへ付け替えます。',
      editFoldersEmpty: 'このプロジェクトにはまだフォルダがありません。',
      editFolderPick: '新しいパスを選択…',
      editFolderSave: '移動',
      editFolderRevert: '元に戻す',
      editFolderRemove: '削除',
      editFolderUnremove: '戻す',
      editFolderRemoved: '削除予定',
      editFolderConflict: 'このパスには既に別のフォルダがあります。',
      editFolderChanged: '変更済み',
      editFoldersDone: 'フォルダを更新しました。',
      editFoldersFailed: 'プロジェクトのフォルダを読み込めませんでした。',
      editFoldersMoveFailed: 'フォルダを移動できませんでした',
