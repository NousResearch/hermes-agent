...
export const ja = defineLocale({
  ...
  settings: {
    ...
    moa: {
      title: 'MoA スタジオ',
      description: '名前付き Mixture of Agents プリセットを作成し、各シートを調整して現在のチャットへ切り替えます。',
      preset: 'プリセット',
      presetName: 'プリセット名',
      ...
      deleteConfirm: name => `下書きから MoA プリセット「${name}」を削除しますか？適用するには変更を保存してください。`,
      setDefault: 'デフォルトに設定',
      defaultBadge: 'デフォルト',
      activeBadge: 'アクティブ',
      useInThisChat: 'このチャットで使用',
      presetEnabled: 'プリセットを有効化',
      enabledDescription: '無効なプリセットは設定を保持しますが、MoA の実行には使用できません。',
      referencesTitle: '参照シート',
      reference: index => `参照 ${index}`,
      referenceProvider: index => `参照 ${index} のプロバイダー`,
      referenceModel: index => `参照 ${index} のモデル`,
      referenceEffort: index => `参照 ${index} の推論強度`,
      referenceEnabled: (n: number) => `参照 ${n} を有効化`,
      aggregator: 'アグリゲーター',
      aggregatorProvider: 'アグリゲーターのプロバイダー',
      aggregatorModel: 'アグリゲーターのモデル',
      aggregatorEffort: 'アグリゲーターの推論強度',
      providerDefault: 'プロバイダーのデフォルト',
      addReference: '参照を追加',
      removeReference: index => `参照 ${index} を削除`,
      moveReferenceUp: index => `参照 ${index} を上へ移動`,
      moveReferenceDown: index => `参照 ${index} を下へ移動`,
      moveUp: '上へ移動',
      moveDown: '下へ移動',
      remove: '削除',
      executionTitle: '実行と出力',
      cadence: 'アドバイザーの実行頻度',
      cadenceDescription: 'アドバイザーをユーザーターンごとに1回、毎回のツール実行後、または N 回ごとに実行するかを選びます。',
      oncePerUserTurn: 'ユーザーターンごとに一度',
      everyNIterations: 'N 回のツール実行ごと',
      everyNCount: 'N（回数）',
      everyToolIteration: 'ツール反復のたび',
      advisorOutputCap: 'アドバイザー出力上限',
      advisorOutputCapDescription: '各参照シートが返す最大トークン数です。',
      uncappedAdvisorOutput: 'アドバイザー出力を無制限にする',
      aggregatorOutputLimit: 'アグリゲーター出力上限',
      aggregatorOutputLimitDescription: 'アグリゲーターが返す最大トークン数です。',
      advisorTemperature: 'アドバイザー温度',
      advisorTemperatureDescription: '空欄の場合は各参照プロバイダーのデフォルトを使用します。',
      aggregatorTemperature: 'アグリゲーター温度',
      aggregatorTemperatureDescription: '空欄の場合はアグリゲータープロバイダーのデフォルトを使用します。',
      saveChanges: '変更を保存',
      unsaved: '未保存の変更があります。設定が完了したら変更を保存してください。',
      saving: '保存中…',
      saved: '保存済み',
      saveFailedRetained: '保存に失敗しました。変更は未保存のまま保持されています。',
      incomplete: '保存する前に、未完了のプロバイダー、モデル、または数値を入力してください。',
      nameBlank: 'プリセット名を入力してください。',
      nameDuplicate: '同じ名前のプリセットがすでに存在します。',
      unavailable: 'このバックエンドでは MoA プリセットを利用できません。'
    },
    providers: {
  ...
  shell: {
    ...
    modelMenu: {
      ...
      moaPreset: name => `MoA: ${name}`,
      manageMoaPresets: 'MoA プリセットを管理…',
      fast: '高速'
    },
    modelOptions: {
