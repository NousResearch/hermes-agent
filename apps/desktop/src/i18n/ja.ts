...
export const ja = defineLocale({
  ...
  desktop: {
    ...
    browserReload: '再読み込み',
    browserPin: 'ピン留め',
    browserUnpin: 'ピン留めを解除',
    browserOpenExternal: '外部ブラウザーで開く',
    browserCapture: 'ページをキャプチャ',
    browserCapturePreview: 'キャプチャのプレビュー',
    browserSaveCapture: 'キャプチャを保存',
    browserClosePreview: 'プレビューを閉じる',
    browserUrlPlaceholder: 'URL を入力',
    browserNewTab: '新しいタブ',
    browserTabLimit:
      'すべてのブラウザータブがピン留めされています。別のタブを開くにはタブのピン留めを解除してください。',
    browserCloseTab: 'タブを閉じる',
    browserQc: '品質チェック',
    browserQcNote: 'メモ',
    browserQcEvidence: '根拠',
    browserQcPass: '合格',
    browserQcFail: '不合格',
    browserQcUnchecked: '未確認',
    browserEmpty: '閲覧を開始するには URL を入力してください',
    browserInvalidUrl: '有効な URL を入力してください',
    browserQcComposition: '構成',
    browserQcColor: '色',
    browserQcTypography: '文字組み',
    browserQcSpacing: '間隔',
    browserQcContrast: 'コントラスト',
    browserQcClipping: 'クリッピング',
    browserQcReferenceMatch: '参照との一致',
