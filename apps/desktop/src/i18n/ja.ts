...
export const ja = defineLocale({
  ...
  settings: {
    ...
    kanban: {
      title: 'カンバン',
      loadingBoards: 'カンバンボードを読み込み中…',
      boardsLoadFailed: 'カンバンボードの読み込みに失敗しました',
      boardLoadFailed: 'カンバンボードの読み込みに失敗しました',
      unavailableTitle: 'カンバンを利用できません',
      unavailableDescription: 'このプロファイルではカンバンプラグインが有効になっていません。',
      loadFailedTitle: 'カンバンを読み込めませんでした',
      loadFailedDescription: 'バックエンド接続を確認して、もう一度お試しください。',
      retry: '再試行',
      refresh: '更新',
      boardCount: count => `${count} 件のボード`,
      taskCount: count => `${count} 件のタスク`,
      current: '現在',
      emptyTitle: 'カンバンボードがありません',
      emptyDescription: 'アクティブなプロファイルにはカンバンボードがありません。',
      loadingBoard: 'ボードを読み込み中…',
      noSelectionTitle: 'ボードが選択されていません',
      noSelectionDescription: '左側からボードを選択してください。',
      boardUnavailableTitle: 'ボードを利用できません',
      boardUnavailableDescription: 'このボードを読み込めませんでした。別のボードを選ぶか、再試行してください。',
      untitledTask: '無題のタスク',
      moreTasks: count => `ほか ${count} 件`
    },
    notifications: {
      title: '通知',
    ...
    gateway: {
      ...
      profileConnection: profile =>
        `"${profile}" がアクティブプロファイルのときのみ使用される接続。デフォルトを使用するとグローバル接続を継承します。`,
      useDefaultTitle: 'デフォルトを使用',
      useDefaultDesc: 'すべてのプロファイルに選択された接続を継承します。',
