...
export const ja = defineLocale({
  ...
  keybinds: {
    title: 'キーボードショートカット',
    subtitle: open => `ショートカットをクリックすると再割り当てできます · ${open} でこのパネルを再表示`,
    rebind: '再割り当て',
    reset: 'デフォルトに戻す',
    resetAll: 'すべてリセット',
    pressKey: 'キーを押してください…',
    set: '設定済み',
    conflictWith: label => `「${label}」にも割り当て済み`,
    categories: {
      composer: 'コンポーザー',
      profiles: 'プロファイル',
      session: 'セッション',
    ...
    actions: {
      ...
      'nav.cron': 'スケジュールジョブを開く',
      'nav.agents': 'エージェントを開く',
      'session.new': '新規セッション',
      'session.newWindow': '新しいウィンドウでセッションを開く',
      'session.next': '次のセッション',
      'session.prev': '前のセッション',
      'session.slot.1': '最近のセッション1に切り替え',
      'session.slot.2': '最近のセッション2に切り替え',
      'session.slot.3': '最近のセッション3に切り替え',
      'session.slot.4': '最近のセッション4に切り替え',
      'session.slot.5': '最近のセッション5に切り替え',
      'session.slot.6': '最近のセッション6に切り替え',
      'session.slot.7': '最近のセッション7に切り替え',
      'session.slot.8': '最近のセッション8に切り替え',
      'session.slot.9': '最近のセッション9に切り替え',
      'session.focusSearch': 'セッションを検索',
      'session.togglePin': '現在のセッションをピン留め / 解除',
      'workspace.newWorktree': '新規ワークツリー',
      ...
      'profile.switch.1': 'プロファイル1に切り替え',
      'profile.switch.2': 'プロファイル2に切り替え',
      'profile.switch.3': 'プロファイル3に切り替え',
      'profile.switch.4': 'プロファイル4に切り替え',
      'profile.switch.5': 'プロファイル5に切り替え',
      'profile.switch.6': 'プロファイル6に切り替え',
      'profile.switch.7': 'プロファイル7に切り替え',
      'profile.switch.8': 'プロファイル8に切り替え',
      'profile.switch.9': 'プロファイル9に切り替え',
      'profile.switch.10': 'プロファイル10に切り替え',
      'profile.switch.11': 'プロファイル11に切り替え',
      'profile.switch.12': 'プロファイル12に切り替え',
      'profile.switch.13': 'プロファイル13に切り替え',
      'profile.switch.14': 'プロファイル14に切り替え',
      'profile.switch.15': 'プロファイル15に切り替え',
      'profile.switch.16': 'プロファイル16に切り替え',
      'profile.switch.17': 'プロファイル17に切り替え',
      'profile.switch.18': 'プロファイル18に切り替え',
      'profile.next': '次のプロファイル',
      'profile.prev': '前のプロファイル',
      'profile.toggleAll': '全プロファイル表示を切り替え',
      ...
      'composer.mention': 'ファイル・フォルダー・URL を参照',
  ...
  settings: {
    ...
    model: {
      ...
      reasoning: '推論',
      reasoningOff: 'オフ',
      defaultsFailed: 'モデルのデフォルト設定の保存に失敗しました',
    ...
    providers: {
      ...
      disconnect: '接続を解除',
      disconnectInTerminal: '接続を解除（削除コマンドをターミナルで実行）',
      removeConfirm: provider => `${provider} を削除しますか？`,
      removeExternalGeneric: provider => `${provider} は専用の CLI で管理されています。そちらで削除してください。`,
      removeKeyManaged: provider => `${provider} は API キーで設定されています。API Keys から削除してください。`,
      removeTerminalConfirm: (provider, command) =>
        `${provider} の接続を解除しますか？認証情報を消去するため、ターミナルで "${command}" を実行します。`,
      removeTerminalRunning: provider => `${provider} の接続解除をターミナルで実行中…`,
  ...
  starmap: {
    ...
    share: 'マップを共有',
    shareHint: 'コードをコピーしてこのマップを共有、または貼り付けて読み込みます。レイアウトのみが含まれ、メモリやスキルの本文は含まれません。',
