...
export const ja = defineLocale({
  ...
  settings: {
    ...
    plugins: {
      title: 'デスクトッププラグイン',
      blurb:
        'このアプリに読み込まれる UI 拡張です。ビルドに同梱されるか、desktop-plugins フォルダー（Hermes が書き込むものを含む）に配置されます。無効にするとプラグインは即座にアンロードされ、再起動後も維持されます。',
      count: n => `${n} 件インストール`,
      ...
      kinds: { bundled: '同梱', disk: 'ディスク', runtime: '実行時' }
    },
    sections: {
      model: 'モデル',
      chat: 'チャット',
  ...
  providerManager: {
    title: 'プロバイダーマネージャー',
    description: 'プロバイダーの有効化、カスタムエンドポイントの追加、ピッカーに表示するモデルの管理を行います。',
    filters: 'フィルター',
    providerListHeading: 'プロバイダー',
    modelsHeading: 'モデル',
    searchPlaceholder: 'モデルを検索',
    noProviders: '利用可能なモデルを持つプロバイダーがありません。',
    noModels: 'モデルが見つかりません。',
    activeCount: (n: number) => `${n} 件有効`,
    allHidden: 'すべてのモデルが非表示です — ピッカーに表示されません。',
    addProvider: 'プロバイダーを追加…',
    selectProviderHint: 'モデルを管理するプロバイダーを選択してください。',
    ...
    apiKey: 'APIキー',
    apiKeyPlaceholder: '任意 — 空欄の場合は保存済みのキーを維持',
    editProviderCredentials: '認証情報を編集',
    baseUrlOverride: 'ベースURLオーバーライド',
    baseUrlOverridePlaceholder: 'デフォルトのエンドポイントを使用するには空欄のまま',
    apiKeyDescription: 'プロフィールの .env ファイルに保存されます',
    configureProvider: 'プロバイダーを設定',
    configureDescription: 'APIキーを入力してこのプロバイダーを有効化し、モデルを検出します。',
    saveAndDiscover: '保存してモデルを検出',
    apiKeyRequired: 'APIキーは必須です。',
    configuring: '保存中…',
    apiMode: 'APIモード',
    apiModeChat: 'チャット補完 (OpenAI互換)',
    apiModeAnthropic: 'Anthropicメッセージ',
    models: 'モデル',
    modelsPlaceholder: '1行に1つのモデルID (例)\ngpt-4o\nclaude-sonnet-4',
    confirmDelete: 'このプロバイダーを削除しますか？元に戻せません。',
    nameExists: 'この名前のプロバイダーは既に存在します。',
    invalidUrl: 'ベースURLは有効なhttp(s) URLである必要があります。',
    enableProvider: 'プロバイダーを有効化',
    disableProvider: 'プロバイダーを無効化',
    discoverModels: 'モデルを自動検出',
    updateList: 'リストを更新',
    addModel: 'モデルを追加',
    discoveryFailed: 'モデルの検出に失敗しました',
    discoveryEmpty: '新しいモデルが見つかりませんでした',
    listRefreshed: 'モデルリストを更新しました',
    discoverySuccess: (n: number) => `モデル ${n} 件を追加しました`,
    manualModelTitle: 'モデルを追加',
    manualModelDescription: 'このプロバイダーが公開する単一のモデルを登録します。',
    modelId: 'モデルID',
    modelIdPlaceholder: '例: gpt-4o',
    modelName: '表示名',
    modelNamePlaceholder: 'アプリに表示する任意の名前',
    advancedParameters: '詳細パラメーター',
    advancedParametersEmpty: '詳細パラメーターはまだありません。',
    modelIdRequired: 'モデルIDは必須です',
    modelExists: 'このIDのモデルは既に存在します',
    groupLocal: 'ローカル',
    groupConfigured: '設定済み',
    groupUnconfigured: '未設定',
    searchProviders: 'プロバイダーを検索',
    noProvidersMatch: '検索条件に一致するプロバイダーがありません。',
    filterVision: 'ビジョン',
    filterMultimodal: 'マルチモーダル',
    filterReasoning: '推論',
    filterFast: '高速',
    sortActiveFirst: 'アクティブ優先',
    sortAz: 'A → Z',
    sortZa: 'Z → A',
    groupByLetter: '文字でグループ化',
    activeOnly: 'アクティブのみ',
    activateAll: 'すべて有効化',
    deactivateAll: 'すべて無効化',
    testConnection: '接続テスト',
    testOk: (ms: number) => `${ms} ms で接続`,
    testFailed: '接続に失敗しました',
    unavailable: '利用不可',
    activeOfTotal: (active: number, total: number) => `${active}/${total}`
  },
