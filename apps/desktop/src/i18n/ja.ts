...
export const ja = defineLocale({
  ...
  artifacts: {
    ...
    failedLoadTitle: 'アーティファクトを読み込めませんでした',
    failedLoadDesc: '最近のチャットを読み込めませんでした。接続を確認して、もう一度お試しください。',
    partialLoadTitle: '一部のアーティファクトが表示されていない可能性があります',
    partialLoadDesc: (failed, total) => `最近のチャット ${total} 件中 ${failed} 件を読み込めませんでした。`,
    profileLoadErrors: count => `${count} 件のプロファイルを読み込めませんでした。`,
    scopeSummary: (loaded, total) => `最近のチャット ${total} 件中 ${loaded} 件のアーティファクトを表示しています。`,
    loadMoreChats: count => `さらに ${count} 件のチャットを読み込む`,
    tryAgain: '再試行',
    openFailed: '開くことができませんでした',
    openChatFailed: '元のチャットを開けませんでした',
    itemsImage: '画像',
    itemsLink: 'リンク',
    itemsFile: 'ファイル',
    itemsGeneric: '項目',
    ...
    loadPreviewFor: label => `${label} のプレビューを読み込む`,
    embeddedImage: '埋め込み画像',
    chat: 'チャット',
    openSourceChat: label => `${label} の元のチャットを開く`,
    copyUrl: 'URL をコピー',
    copyPath: 'パスをコピー'
  },
