...
export const ptBR = defineLocale({
  ...
  boot: {
    ...
    failure: {
      ...
      remoteFailureHint: 'Verifique o gateway URL e faça login nas configurações do gateway ou mude para o gateway local.',
  ...
  notifications: {
    ...
    voice: {
      ...
      sayStopToEnd: phrase => `Dizer "${phrase}" para encerrar o bate-papo por voz.`,
  ...
  billingBlock: {
    titleNous: 'Fora dos créditos Nous',
  ...
  settings: {
    ...
    plugins: {
      ...
      kinds: { bundled: 'Embutido', disk: 'no disco', runtime: 'Tempo de execução' }
    },
    notifications: {
      title: 'Notificações',
      intro: 'Notificações nativas do desktop, separadas dos toasts no aplicativo. São locais ao dispositivo — cada computador mantém suas próprias configurações.',
    ...
    appearance: {
      title: 'Aparência',
      intro: 'Estas são preferências de exibição exclusivas do desktop. Modo controla o brilho; tema controla a paleta de destaque e o estilo da superfície do chat.',
      ...
      reactionsDesc: 'Tapbacks de emoji no estilo iMessage – reaja às mensagens e Hermes pode reagir às suas.',
    ...
    config: {
      ...
      keepAwakeDesc: 'Impeça esta máquina de dormir por tanto tempo ou as corridas durante a noite continuam. A tela ainda pode escurecer.',
    ...
    quickEntry: {
      ...
      shortcutDesc: 'Precisa de pelo menos um modificador, por ex. CommandOrControl+Shift+Espaço.',
    ...
    envActions: {
      actions: 'Ações',
      manageInKeys: 'Gerenciar em chaves API',
      docs: 'Docs',
    ...
    gateway: {
      ...
      sshDesc:
        'Hermes é iniciado no controle remoto por meio de SSH e encapsulado neste aplicativo – nada para iniciar ou se expor. Requer acesso SSH baseado em chave funcional ao host.',
      sshTrustHint: 'A primeira chave de host apresentada é confiável e fixada; alterações posteriores falham ao serem fechadas.',
      sshHostTitle: 'Hospedar',
      sshHostDesc: 'user@host ou um alias de host de ~/.ssh/config.',
      sshHostPick: 'Selecione um anfitrião…',
      sshHostPickTitle: 'Hospedar',
      ...
      sshIncompleteHost: 'Enter um host SSH antes de conectar.',
      sshErrUnreachable: 'Não foi possível acessar esse host por SSH. Verifique o host, a porta e sua rede.',
      sshErrAuth:
        'A autenticação SSH falhou. Carregue sua chave no agente ssh (ssh-add) ou defina um IdentityFile em ~/.ssh/config — Hermes executa ssh de forma não interativa.',
      sshErrHostKey:
        'A chave do host tem CHANGED desde a última conexão. Verifique se isso é esperado e execute ssh-keygen -R <host> e reconecte.',
      sshErrNotInstalled:
      ...
      sshErrTimeout: 'A conexão SSH expirou. O host pode estar inacessível ou dormindo.',
      sshErrUpdateRequired: 'Atualize Hermes no host remoto antes de conectar-se ao Desktop SSH.',
    ...
    toolsets: {
      ...
      nousAuthNeededMessage: provider => `${provider}é salvo, mas não será ativado até que você faça login no Portal Nous.`,
      ...
      nousAuthFailed: 'O login do portal Nous não foi concluído',
      ...
      terminalBackend: {
        ...
        selectedMessage: backend => `Comandos de terminal agora são executados via${backend}. Aplica-se a novas sessões.`,
        failedSelect: backend => `Falha ao selecionar${backend}`,
        needsSetupHint: 'Você pode selecionar este back-end agora – os comandos falharão até que a configuração seja concluída.'
      }
    }
  },
  ...
  messaging: {
    ...
    pendingAria: count => `${count}emparelhamento pendente${count === 1 ? 'request' : 'requests'}`,
  ...
  webhooks: {
    ...
    disabledBody:
      'Webhooks são sua própria plataforma de gateway. Habilite-os aqui para aceitar eventos HTTP recebidos; canais de chat só são necessários quando uma assinatura é entregue em Telegram, Discord, Slack ou outro canal.',
    enable: 'Habilitar webhooks',
    enabling: 'Habilitando...',
    enabled: (name: string) => `Habilitado: "${name}"`,
    disabled: (name: string) => `Desabilitado: "${name}"`,
    enableRow: 'Habilitar',
    ...
    toggleFailed: (name, enabled) => `Falha ao virar "${name}" ${enabled ? 'on' : 'off'}`,
    newSubscription: 'Nova assinatura',
    restarting: 'Gateway reiniciando...',
    restartNeeded: 'Os webhooks estão habilitados, mas o gateway ainda precisa ser reiniciado antes que o receptor possa ficar online.',
    restartGateway: 'Reiniciar gateway',
    ...
    deliverOptions: {
      ...
      slack: 'Slack',
      email: 'E-mail',
      github_comment: 'Comentário GitHub'
    }
  },
  ...
  composer: {
    ...
    wakeWordListening: phrase => `Palavra de despertar: "${phrase}" - audição`,
  ...
  install: {
    ...
    setupChoiceTitle: 'Configurar a área de trabalho Hermes',
    setupChoiceDesc:
      'Conecte este aplicativo a um gateway Hermes que você já executa ou instale Hermes localmente neste computador.',
    connectExistingTitle: 'Conecte-se ao Hermes existente',
    connectExistingShort: 'Conectar existente',
    connectExistingDesc: 'Use um back-end remoto com um token de sessão ou login no navegador. Nenhuma instalação local será iniciada.',
    installLocalTitle: 'Instale Hermes localmente',
    installLocalDesc: 'Baixe Hermes, crie seu ambiente Python e execute o backend neste computador.',
    ...
    remoteSetupDesc: 'Enter seu gateway URL. O Hermes Desktop detectará se precisa de um token ou login no navegador.',
    ...
    probeError: 'Não foi possível acessar o gateway Hermes.',
    identityProvider: 'seu provedor de identidade',
    authTitle: 'Autenticação',
    ...
    enterUrlFirst: 'Enter um gateway URL primeiro.',
    ...
    pasteSessionToken: 'Colar token de sessão',
    incompleteSignInTest: 'Faça login antes de testar este gateway fechado por OAuth.',
    incompleteTokenTest: 'Enter um token de sessão antes de testar este gateway.',
  ...
  assistant: {
    ...
    clarify: {
      ...
      lateAnswerHint: 'Este prompt não está mais esperando. Escolha uma opção para redigi-la como uma mensagem de acompanhamento.'
    },
    tool: {
