...
remoteSignInHint: signInLabel =>
        `Encerra a sessão remota salva e abre ${signInLabel}. Usar gateway local to switch to the bundled backend instead.`,
signOutAndSignIn: 'Sair e Entrar',
remoteFailureHint: 'Check the gateway URL and sign-in under Configurações do gateway, or switch to the local gateway.',
