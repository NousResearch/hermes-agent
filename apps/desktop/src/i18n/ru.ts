  ...
  settings: {
    ...
    config: {
      ...
      alwaysExternalLinksDesc:
        'Открывать ссылки и доступные превью в системном браузере. Удалённые файлы, недоступные браузеру, остаются во встроенном окне; его также можно выбрать вручную.',
