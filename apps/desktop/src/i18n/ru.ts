...
export const ru = defineLocale({
  ...
  shell: {
    ...
    statusbar: {
      ...
      toggleRunningTimer: 'Прошлый ход',
      ...
      toggleLatency: 'Задержка API',
      latencyTitle: 'Средняя задержка API',
      toggleCompressions: 'Сжатия',
      toggleIdleSince: 'С последнего ответа',
      idleSinceTitle: 'Время с момента последнего финального ответа',
      compressionsTitle: 'Автосжатия контекста',
      turnBreakdown: {
        title: 'Последний ход',
        running: 'выполняется',
        wall: 'Общее время',
        tools: 'Время инструментов',
        model: 'Время модели (оценка)'
      },
      cacheHitRateTitle: 'Доля попаданий в кэш',
      tokensPerSecondTitle: 'Выходных токенов в секунду',
      agents: 'Агенты',
