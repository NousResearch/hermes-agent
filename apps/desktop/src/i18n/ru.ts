...
export const ru = defineLocale({
  ...
  settings: {
    ...
    notifications: {
      title: 'Уведомления',
      intro:
        'Настройте уведомления в приложении, системные уведомления и звуки завершения. Для каждого устройства отдельно.',
      ...
      inAppPositionTitle: 'Положение уведомлений в приложении',
      inAppPositionDesc:
        'Выберите угол для обычных уведомлений. Ошибки и уведомления с действиями остаются сверху по центру.',
      inAppPositions: {
