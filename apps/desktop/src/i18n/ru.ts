...
export const ru = defineLocale({
  ...
  assistant: {
    thread: {
      ...
      recoveryMissing: 'Ответ в истории не найден',
      recoveryUnfinished: 'Итоговый ответ не найден',
      recoveryPutBack: 'Вернуть в поле ввода',
      recoveryHide: 'Скрыть',
      recoveryHidden: 'Сообщение скрыто на этом устройстве',
      recoveryUndo: 'Отменить',
      recoveryActivityHint: 'Инструменты могли уже выполниться. Повторная отправка может повторить действия.',
      recoveryHideHint: 'Скрывается только на этом устройстве; история модели не меняется.',
      recoveryAttachmentHint: 'Только текст. Перед отправкой прикрепите файлы заново.',
      react: 'Реакция',
      dismissError: 'Скрыть ошибку',
