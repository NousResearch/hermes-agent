...
export const ru = defineLocale({
  ...
  settings: {
    ...
    appearance: {
      ...
      composerPopoutTitle: 'Закрепить композер снизу',
      composerPopoutDesc: 'Запрещает вытягивать композер из нижней док-зоны. Выключайте, только если нужен плавающий композер.',
