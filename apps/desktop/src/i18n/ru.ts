  ...
  settings: {
    ...
    fieldLabels: defineFieldCopy({
      ...
      voice: {
        ...
        ttsConclusionOnly: 'Озвучивать только итоговый ответ',
        ttsConclusionGraceMs: 'Пауза перед озвучиванием (мс)'
      },
      stt: {
    ...
    fieldDescriptions: defineFieldCopy({
      ...
      voice: {
        ...
        ttsConclusionOnly:
          'При включённом чтении вслух озвучивать только последний ответ серии, а не каждое промежуточное сообщение.',
        ttsConclusionGraceMs: 'Тихое окно в миллисекундах перед озвучиванием итогового ответа.'
      },
      tts: {
        xai: {
