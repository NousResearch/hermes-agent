...
export const ru = defineLocale({
  ...
  settings: {
    ...
    appearance: {
      ...
      composerSuggestionsTitle: 'Подсказки композера',
      composerSuggestionsDesc:
        'Показывать полезные кнопки-подсказки над композером. Отключение не влияет на дополнение слеш-команд или историю черновиков.',
