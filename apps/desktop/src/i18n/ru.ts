...
export const ru = defineLocale({
  ...
  shell: {
    ...
    statusbar: {
      ...
      toggleSessionTokens: 'Токены сеанса',
      ...
      sessionTokensTitle: 'Суммарные токены модели за этот сеанс — вход считается по всем API-вызовам и может превышать размер окна контекста',
