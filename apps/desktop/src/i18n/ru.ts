...
export const ru = defineLocale({
  ...
  settings: {
    ...
    config: {
      ...
      largePasteAttachTitle: 'Превращать большие вставки во вложения',
      largePasteAttachDesc:
        'Вставка более 3 000 символов прикрепляется как .txt-файл вместо вставки в поле ввода. Отключите, чтобы длинные вставки оставались в композере, — полезно, когда вставленный текст и есть сам промпт (спецификации, задачи агентам, логи).'
    },
    hudModifier: {
