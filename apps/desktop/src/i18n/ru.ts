...
export const ru = defineLocale({
  ...
  assistant: {
    thread: {
      ...
      subagentCompleted: 'Субагент завершил работу',
      subagentsCompleted: 'Субагенты завершили работу',
      showFullPayload: 'Показать полные данные',
      hideFullPayload: 'Скрыть полные данные',
