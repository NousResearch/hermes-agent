  ...
  settings: {
    ...
    fieldLabels: defineFieldCopy({
      ...
      display: {
        ...
        busyInputMode: 'Enter во время работы'
      },
      desktop: {
    ...
    fieldDescriptions: defineFieldCopy({
      ...
      display: {
        ...
        busyInputMode:
          'Действие при нажатии Enter во время работы агента. Interrupt перенаправляет текущий ход вашим текстом, steer добавляет его к следующему результату инструмента без остановки, а queue запускает его после завершения хода.'
      },
      desktop: {
