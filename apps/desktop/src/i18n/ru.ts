...
export const ru = defineLocale({
  ...
  codingWorkspace: {
    ...
    existingWorktree: "Существующее рабочее дерево",
    currentCheckout: "Текущая рабочая копия",
    agentWorktree: "Рабочая копия агента",
    agentWorktreeNote: "Агент создал эту рабочую копию во время чата.",
    newChatHere: "Новый чат в этой рабочей копии",
    projectFolder: "Папка проекта",
    initializeGit: "Инициализировать Git-репозиторий",
    initializeGitDescription: "Создаёт репозиторий с пустым первым коммитом. Ваши файлы остаются неотслеживаемыми.",
    initializeGitFailed: "Не удалось инициализировать Git-репозиторий",
    searchProjects: "Поиск проектов",
    noProjects: "Нет подходящих проектов",
    projectsFailed: "Не удалось загрузить проекты",
    browse: "Обзор…",
    base: "От ветки",
    dirty: "Незафиксированные изменения",
    clean: "Без изменений",
    detached: "Отсоединённый HEAD",
    dirtyNotCopied: "Незафиксированные изменения не копируются в новое рабочее дерево.",
    createOnSend: "Создаётся при первой отправке, не сейчас.",
    shared: "Эту рабочую копию могут использовать другие чаты. Изменения не изолированы.",
    preparing: "Подготовка рабочего пространства",
    workInProject: "Работать в проекте…",
    useAsProject: "Использовать как проект",
    newChat: "Новый чат в другом пространстве…",
    binding: "Этот чат остаётся в исходном рабочем пространстве.",
    selectCheckout: "Выбрать рабочую копию",
    folderFailed: "Не удалось использовать папку как проект",
    unavailable: "Выбор рабочего пространства доступен после подключения владельца чата.",

    showControls: "Показывать элементы для разработки",
    showControlsDescription: "Показывать проект и рабочую папку над вводом в новых чатах этого профиля. Существующие чаты и настройки боковой панели не меняются.",
    saveFailed: "Не удалось сохранить настройку разработки",
  },
  common: {
    apply: 'Применить',
    back: 'Назад',
