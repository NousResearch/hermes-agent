  ...
  settings: {
    ...
    fieldLabels: defineFieldCopy({
      ...
      voice: {
        ...
        autoTts: 'Зачитывать ответы вслух (сообщения и CLI)'
      },
      stt: {
    ...
    fieldDescriptions: defineFieldCopy({
      ...
      voice: {
        autoTts:
          'Автоматически зачитывать ответы ассистента вслух в каналах сообщений и в голосовом режиме CLI. В чате desktop-приложения есть свой переключатель: используйте «Зачитывать ответы вслух» в голосовом меню композера.'
      },
      tts: {
        xai: {
