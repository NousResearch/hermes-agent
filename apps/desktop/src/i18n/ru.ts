...
export const ru = defineLocale({
  ...
  boot: {
    ...
    failure: {
      ...
      remoteSignInHint: signInLabel =>
        `Завершает сохранённый удалённый сеанс браузера, затем открывает ${signInLabel}. Чтобы переключиться на встроенный бэкенд, выберите «Использовать локальный шлюз».`,
  ...
  settings: {
    ...
    gateway: {
      ...
      remoteAuthHint:
        'Размещённые провайдером шлюзы используют OAuth или логин и пароль; размещённые самостоятельно — токен сессии.',
      cloudTitle: 'Hermes Cloud',
      cloudDesc:
        'Войдите в Hermes Cloud один раз и выберите агента из вашего аккаунта — URL вставлять не нужно.',
      ...
      cloudNoAgents: {
        before: 'В этом аккаунте нет агентов. Создайте агента на ',
