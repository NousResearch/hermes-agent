...
export const ru = defineLocale({
  ...
  composer: {
    ...
    microphone: {
      title: 'Микрофон',
      description:
        'Какой вход Hermes слушает для голосового чата, диктовки и слова активации. Только на этом компьютере.',
      systemDefault: 'Системный по умолчанию',
      chooseTitle: 'Выберите микрофон',
      chooseDescription:
        'На этом компьютере несколько входов. Выберите тот, в который говорите: виртуальные микшеры молчат, если их приложение не запущено.',
      useThis: 'Использовать этот микрофон',
      virtualHint: 'Виртуальное устройство — часто молчит',
      silent: label => `На «${label}» нет речи. Переключите микрофон, если вы говорили.`
    },
