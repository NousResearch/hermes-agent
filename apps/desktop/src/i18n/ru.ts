...
export const ru = defineLocale({
  ...
  settings: {
    ...
    quitConfirmation: {
      ...
      description:
        'Запрашивать подтверждение перед выходом из Hermes на этом компьютере. По умолчанию — только во время работы агентов. Действует для всех профилей.',
      never: 'Никогда',
      whileWorking: 'Во время работы агентов',
      always: 'Всегда',
      loadFailed: 'Не удалось загрузить настройку подтверждения выхода.',
      saveFailed: 'Не удалось сохранить настройку подтверждения выхода. Предыдущий выбор остаётся в силе.'
    },
    quickEntry: {
