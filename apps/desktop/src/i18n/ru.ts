...
export const ru = defineLocale({
  ...
  settings: {
    ...
    appearance: {
      ...
      toolViewDesc: 'В удобном режиме сырые данные инструментов скрыты; технический режим показывает полный ввод и вывод.',
      ...
      technicalDesc: 'Показывает сырые аргументы, результаты и низкоуровневые детали.',
      themeTitle: 'Тема',
