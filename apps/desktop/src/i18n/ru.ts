...
export const ru = defineLocale({
  ...
  preview: {
    ...
    invalidNotebookTitle: 'Это не Jupyter-ноутбук',
    invalidNotebookBody: 'Файл не разобрался как nbformat JSON. Переключитесь на ИСТОЧНИК, чтобы посмотреть сырой файл.',
    notebookWidget: 'Интерактивный виджет (не показан)',
    edit: 'Изменить',
    editing: 'Изменение',
    unsavedChanges: 'Несохранённые изменения',
