...
export const ru = defineLocale({
  ...
  keybinds: {
    ...
    actions: {
      'view.openIde': 'Открыть Hermes IDE',
  ...
  ide: {
    title: 'Hermes IDE',
    noWorkspace: 'Нет рабочей папки',
    explorerTitle: 'Проводник',
    explorerEmptyTitle: 'Рабочая папка не открыта',
    explorerEmptyBody: 'Откройте IDE из окна проекта, чтобы подхватить его рабочую папку.',
    editorTitle: 'Редактор',
    editorEmptyTitle: 'Файл не открыт',
    editorEmptyBody: 'Выберите файл в проводнике, чтобы начать редактирование.',
    chatTitle: 'Чат',
    chatEmptyTitle: 'Пока нет сессий IDE',
    chatEmptyBody: 'Сессии IDE живут здесь и привязаны к этой рабочей папке. Начните одну, чтобы работать с агентом.',
    browserTitle: 'Браузер',
    browserEmptyTitle: 'Страница не открыта',
    browserEmptyBody: 'Откройте URL, чтобы просматривать его здесь — агент может работать с ним вместе с вами.',
    toggleExplorer: 'Переключить проводник',
    toggleChat: 'Переключить чат',
    toggleBrowser: 'Переключить браузер',
    resizeExplorer: 'Изменить ширину проводника',
    resizeChat: 'Изменить ширину чата',
    resizeBrowser: 'Изменить высоту браузера',
    refreshExplorer: 'Обновить проводник',
    explorerUnreadable: error => `Не удалось прочитать эту папку (${error}).`,
    editorTabsLabel: 'Открытые файлы',
    closeTab: 'Закрыть',
    closeTabLabel: name => `Закрыть ${name}`,
    reloadFromDisk: 'Перезагрузить с диска',
    tooLargeTitle: 'Файл слишком большой для редактирования',
    tooLargeBody: 'Этот файл больше 512 КБ. Откройте его в предпросмотре чата или в настольном редакторе.',
    loadFailedTitle: 'Не удалось открыть файл',
    closeDirtyTitle: 'Закрыть с несохранёнными изменениями?',
    closeDirtyBody: 'В этой вкладке есть несохранённые правки.',
    closeDirtyConfirm: 'Отменить изменения',
    diskChangedTitle: 'Файл изменён на диске',
    diskChangedBody: 'Файл отредактировало что-то ещё — запуск агента или другое приложение. Сохранение перезапишет эти изменения.',
    overwrite: 'Перезаписать',
    chatTabsLabel: 'Сессии IDE',
    chatNew: 'Новая сессия IDE',
    chatRecent: 'Недавние сессии IDE',
    chatCreateFailed: 'Не удалось создать сессию IDE',
    browserTabsLabel: 'Вкладки браузера',
    browserOpen: 'Открыть браузер',
    browserNewTab: 'Новая вкладка браузера',
