...
export const ru = defineLocale({
  ...
  settings: {
    ...
    appearance: {
      ...
      collapseSettledDiffsTitle: 'Сворачивать завершённые изменения кода',
      collapseSettledDiffsDesc:
        'Автоматически сворачивать изменения кода после завершения ответа. Ручное раскрытие или сворачивание сохраняется.',
