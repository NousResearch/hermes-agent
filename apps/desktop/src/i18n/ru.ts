...
export const ru = defineLocale({
  ...
  settings: {
    ...
    appearance: {
      ...
      compactChatTitle: 'Компактный чат',
      compactChatDesc:
        'Скрыть рассуждения, строки инструментов, таймеры и уведомления фоновых процессов. Запросы на подтверждение и сообщения между агентами остаются видимыми.',
