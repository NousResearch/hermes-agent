...
export const ru = defineLocale({
  ...
  settings: {
    ...
    appearance: {
      ...
      composerTodoListTitle: 'Список задач в композере',
      composerTodoListDesc: 'Показывать или скрывать строки todo / task list в статус-стеке композера. Фоновые задачи, goal и subagent по-прежнему видны.',
