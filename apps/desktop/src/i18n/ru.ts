...
export const ru = defineLocale({
  ...
  settings: {
    ...
    appearance: {
      ...
      composerListsTitle: 'Списки в поле сообщения',
      composerListsDesc:
        'Shift+Enter продолжает нумерованный, маркированный или чек-лист; Tab и Shift+Tab вкладывают пункты. Также продолжать:',
      composerListStyles: {
        letters: 'Буквы (a. b. c.)',
        roman: 'Римские цифры (i. ii. iii.)',
        outline: 'Многоуровневые номера (1.1. 1.2.)',
        parentheses: 'Скобки ((1) (a))',
        symbols: 'Символьные маркеры (• ◦ ▪)'
      },
