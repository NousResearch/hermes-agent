...
export const ru = defineLocale({
  sessionImport: {
    sources: 'Источники',
    grok: 'Grok Bot',
    grokNotice: 'Grok Bot импортирует только локально кэшированный текст. История может быть неполной: старые сообщения или ответы могут отсутствовать.',
    title: 'Продолжить из другого приложения',
    subtitle: 'Импортируйте локальные разговоры с этого компьютера в выбранного агента. Облачные сессии не включены.',
    action: 'Импортировать сессию',
    readingFrom: 'Читаем с',
    connectedComputer: 'этого компьютера',
    ...
    previewLimit: 'Просмотр сокращён для удобства чтения. Импортируется весь доступный текст разговора.',
    you: 'Вы',
