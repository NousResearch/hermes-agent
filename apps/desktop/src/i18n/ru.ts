...
export const ru = defineLocale({
  ...
  settings: {
    ...
    appearance: {
      ...
      alwaysUseDropdownTitle: 'Всегда использовать выпадающий список',
      alwaysUseDropdownDesc:
        'Всегда показывать выбор профиля на боковой панели сеансов как выпадающий список, даже для одного профиля. Настройка действует для всех профилей и шлюзов в этом приложении.',
