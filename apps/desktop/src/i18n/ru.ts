...
export const ru = defineLocale({
  ...
  settings: {
    ...
    plugins: {
      ...
      agent: {
        setupInstalled:
          'Файлы установлены; состояние включения не изменено. Откройте Плагины и включите плагин для проверки или повтора настройки.',
        reviewSetup: 'Проверить настройку в Плагинах',
        setupTitle: 'Настройка нативного плагина',
        setupConfirm: 'Настроить и включить',
        setupBusy: 'Настройка…',
        setupTrust:
          'Запускается доверенный код плагина на выбранном бэкенде. Текущие сеансы не изменятся; для активации перезапустите шлюз.'
      },
      installModal: {
