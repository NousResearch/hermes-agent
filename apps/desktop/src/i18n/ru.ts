  ...
  settings: {
    ...
    fieldLabels: defineFieldCopy({
      ...
      compression: {
        ...
        codexGpt55Autoraise: 'Автоповышение порога Codex',
        codexGpt55AutoraiseNotice: 'Уведомление об автоповышении Codex',
    ...
    fieldDescriptions: defineFieldCopy({
      ...
      compression: {
        ...
        codexGpt55Autoraise:
          'Повышает порог сжатия до 85% для поддерживаемых моделей через ChatGPT Codex OAuth. Отключите, чтобы всегда использовать общий порог.',
        codexGpt55AutoraiseNotice:
          'Один раз уведомляет, когда Codex повышает фактический порог. Отключение уведомления не отключает автоповышение.'
      },
      voice: {
