...
export const zhHant = defineLocale({
  ...
  profiles: {
    ...
    deleting: '刪除中…',
    createDesc: '設定檔是獨立的 Hermes 環境，也可以路由到不同的桌面後端。',
    nameLabel: '名稱',
    cloneFrom: '複製來源',
    cloneFromNone: '無（空白）',
    ...
    backendLocal: '此後端',
    backendRemote: '遠端後端',
    backendLocalDesc: '在目前後端建立設定檔並在此執行。',
    backendRemoteDesc: '將此設定檔作為另一個 Hermes Desktop 後端的捷徑。',
    remoteUrl: '遠端 URL',
    remoteUrlRequired: '遠端 URL 必須以 http:// 或 https:// 開頭。',
    remoteToken: '工作階段權杖',
    remoteTokenRequired: '遠端後端需要工作階段權杖。',
    remoteTokenPlaceholder: '貼上遠端工作階段權杖',
