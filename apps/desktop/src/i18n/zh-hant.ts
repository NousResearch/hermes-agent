...
export const zhHant = defineLocale({
  ...
  artifacts: {
    ...
    failedLoad: '成品載入失敗',
    failedLoadTitle: '無法載入成品',
    failedLoadDesc: 'Hermes 無法讀取最近的聊天。請檢查連線後再試一次。',
    partialLoadTitle: '部分成品可能缺失',
    partialLoadDesc: (failed, total) => `最近 ${total} 個聊天中有 ${failed} 個無法讀取。`,
    profileLoadErrors: count => `有 ${count} 個設定檔無法讀取。`,
    scopeSummary: (loaded, total) => `正在顯示最近 ${total} 個聊天中 ${loaded} 個的成品。`,
    loadMoreChats: count => `再載入 ${count} 個聊天`,
    tryAgain: '再試一次',
    openFailed: '開啟失敗',
    openChatFailed: '無法開啟來源聊天',
    itemsImage: '張圖片',
    itemsLink: '個連結',
    itemsFile: '個檔案',
    itemsGeneric: '項',
    ...
    previewUnavailable: '無法提供預覽',
    loadPreview: '載入預覽',
    loadPreviewFor: label => `載入 ${label} 的預覽`,
    embeddedImage: '嵌入圖片',
    chat: '聊天',
    openSourceChat: label => `開啟 ${label} 的來源聊天`,
    copyUrl: '複製 URL',
    copyPath: '複製路徑'
  },
