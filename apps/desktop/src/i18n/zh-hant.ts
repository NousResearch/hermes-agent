...
export const zhHant = defineLocale({
  ...
  settings: {
    ...
    appearance: {
      ...
      interfaceStyleTitle: 'GNOME 介面風格',
      interfaceStyleDesc: '使用內斂的 Adwaita 風格，同時保持 Hermes 的功能與版面不變。',
      interfaceStyleTypographyTitle: 'Adwaita 字體',
      interfaceStyleTypographyDesc: '已安裝時優先使用 Adwaita Sans，否則使用系統字體。',
      interfaceStyleControlsTitle: '柔和控制項',
      interfaceStyleControlsDesc: '為按鈕、標題列與側邊欄選取項目加入適度圓角。',
      interfaceStyleSurfacesTitle: '浮動介面',
      interfaceStyleSurfacesDesc: '為選單與彈出框使用 GNOME 風格的間距、圓角與陰影。',
