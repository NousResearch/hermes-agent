...
export const zhHant = defineLocale({
  ...
  sidebar: {
    ...
    row: {
      ...
      branchFrom: '分支',
      moveToProject: '移至專案…',
      moveProjectTitle: '將聊天移至專案',
      moveProjectDesc: title => `將「${title}」移至一個專案。之後的命令與工具會在該專案的工作目錄中執行。`,
      moveProjectFailed: '無法移動聊天',
      moveProjectMissingWorkspace: '該專案沒有工作目錄。',
      moveProjectWrongProfile: '請先切換至該聊天所屬的設定檔，再將它移至專案。',
      moveProjectsLoading: '正在載入專案…',
      moveProjectsEmpty: '找不到具有工作目錄的專案。',
      movedToProject: name => `已移至 ${name}`,
      rename: '重新命名',
      archive: '封存',
      newWindow: '新視窗',
