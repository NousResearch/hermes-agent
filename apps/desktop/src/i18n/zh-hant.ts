...
export const zhHant = defineLocale({
  ...
  cron: {
    ...
    reasoningLabel: '推理',
    reasoningInherit: '繼承全域設定',
    reasoningInactive: '無代理工作中不啟用',
    reasoningInactiveHint: '此設定會保留在工作中，但在無代理模式執行時不會生效。',
    reasoningInactiveWithValue: value => `${value}（未啟用）`,
    reasoningInvalid: value => `${value}（無效；繼承全域設定）`,
    reasoningOptions: {
      none: '關閉',
      minimal: '最小',
      low: '低',
