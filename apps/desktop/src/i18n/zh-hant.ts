...
export const zhHant = defineLocale({
  ...
  settings: {
    ...
    appearance: {
      ...
      translucencyTitle: '桌面視窗透明度',
      translucencyDesc: '調整桌面透過 Hermes 主視窗的程度。僅支援 macOS 與 Windows。',
      menuBarTransparencyTitle: '選單列視窗透明度',
      menuBarTransparencyDesc: '調整選單列的玻璃表面，同時保持文字與控制項清晰。',
      backdropTitle: '聊天背景',
      ...
      embedsAlways: '一律',
      embedsOff: '關閉',
      menuBarCompanionTitle: '選單列伴侶',
      menuBarCompanionDesc: '顯示 macOS 選單列伴侶，用於斜線指令、快速設定與生態連結。',
