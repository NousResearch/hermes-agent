...
export const zhHant = defineLocale({
  ...
  assistant: {
    thread: {
      ...
      recoveryMissing: '歷史中未見回覆',
      recoveryUnfinished: '未見最終回覆',
      recoveryPutBack: '放回輸入框',
      recoveryHide: '隱藏',
      recoveryHidden: '訊息已在本機隱藏',
      recoveryUndo: '復原',
      recoveryActivityHint: '工具可能已經執行，再次傳送可能重複操作。',
      recoveryHideHint: '僅隱藏本機顯示，不刪除模型歷史。',
      recoveryAttachmentHint: '僅放回文字，傳送前請重新加入附件。',
      react: '回應',
      dismissError: '关闭错误',
      errorLayers: {
        auth: '認證錯誤',
