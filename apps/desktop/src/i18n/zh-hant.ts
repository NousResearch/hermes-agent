...
export const zhHant = defineLocale({
  ...
  lunarCity: {
    disabled: '世界已停用',
    disabledHint: '在「設定 → 外掛程式」中啟用世界，即可再次使用月城。',
    label: '月城',
    worldAriaLabel: '月城世界',
    heading: '你的 Hermes 世界',
    intro: 'Hermes 工作、代理、提醒與慶祝活動的生動介面。每個操作都與真實系統保持連線。',
    selectSubject: '選擇工作單元、負責人、任務或事件，開啟世界內對話。',
    defaultsActive: 'Hermes 預設設定已啟用',
    starterAssets: '內建寵物與初始資產可供使用。',
    assetCompanions: 'Hermes 寵物夥伴',
    assetScene: '月城初始場景',
    assetTextures: '內建材質與道具',
    localAssets: '本機資產',
    localAssetsForReview: '供檢視的本機資產',
    reviewOnly: '僅供檢視 — 檔案會留在此視窗；未連線匯入器。',
    worldSetup: '月城世界設定',
    worldSetupDescription: '使用 Hermes 內建寵物與資產開始，或暫存本機檔案供檢視。',
    builtInPets: 'Hermes 內建寵物與資產',
    builtInPetAlt: 'Hermes 內建寵物',
    safeDefault: '安全的預設設定已就緒；檔案不會離開此裝置。',
    dropLocalAssets: '放置本機世界資產',
    dropToStage: '放置以供檢視',
    formats: 'GLB、GLTF、PNG、JPG 或 WEBP',
    stagedFiles: count => `僅供檢視 — 已暫存 ${count} 個本機檔案；未連線匯入器。`,
    skip: '暫時略過',
    useDefaults: '使用 Hermes 預設設定',
    dialogue: {
      ariaLabel: title => `對話：${title}`,
      label: '世界內對話',
      close: '關閉對話',
      source: '來源',
      state: '狀態',
      severity: '嚴重性',
      task: '任務',
      detailUnavailable: '沒有更多來源詳細資訊。',
      role: role => `角色：${role}`,
      assignedTo: assignee => `指派給：${assignee}`,
      actionUnavailable: '目前 Hermes 狀態不支援此操作。',
      actionAccepted: 'Hermes 已接受此操作。',
      inspectBlocker: '檢查阻礙原因',
      inspect: '檢查',
      recover: '解除阻礙 / 復原'
    },
    dispatcher: {
      ...
      cube: '派遣方塊',
      commandCenter: '指令中心',
      description: '透過城市與 Hermes 對話。',
      newTask: '新增任務',
      newSession: '新增工作階段',
      attention: '什麼需要我注意？',
      recentEvents: 'Hermes 最近事件',
      recentActivity: '最近活動',
      createTask: '建立 Kanban 任務',
      title: '標題',
      brief: '簡述',
      sending: '正在傳送至 Hermes…',
      dispatch: '派遣任務',
      startPrompt: '要在目前桌面環境中開始新的 Hermes 對話嗎？',
      starting: '正在開始…',
      startSession: '開始工作階段',
      activeConditions: count => `${count} 個活躍世界條件`,
      recentEventsCount: count => `${count} 個最近來源事件`,
      report: '情況報告',
      openReport: '開啟報告',
      taskRequired: '需要填寫任務標題。'
    },
    scene: {
      ariaLabel: '月城場景',
      liveProjection: '即時世界投影',
      colonyNetwork: 'Hermes 殖民地網路',
      stale: '來源已過期',
      connected: '已連線',
      baselineAriaLabel: '基準 3D 場景',
      authoredAssets: (count, profile) => `${count} 個已製作的基準資產 · ${profile}`,
      assetDetail: (kind, collection, role, lods) => `${collection} 中的 ${kind} 資產。角色：${role}。LOD：${lods}。`,
      sceneObject: name => `場景物件：${name}`,
      downloadScene: '下載 3D 場景',
      downloadRoster: '下載類別名冊',
      npcActivity: 'NPC 活動',
      quiet: '殖民地很安靜。新的 Hermes 工作出現時會顯示在這裡。',
      recentEvents: '最近世界事件',
      status: '殖民地狀態',
      conditions: '條件',
      events: '事件',
      recapAriaLabel: '世界回顧',
      whileAway: '你離開期間',
      transitions: count => `有 ${count} 個 Hermes 狀態變化需要你注意。`
    },
    glb: {
      canvasAriaLabel: '互動式月城 3D 場景',
      imageAlt: '具有落地道路與凹形地形的月城 Blender 基準場景'
    }
  },
  agents: {
