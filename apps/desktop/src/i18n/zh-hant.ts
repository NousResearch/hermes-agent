...
export const zhHant = defineLocale({
  ...
  pet: {
    ...
    actionCenter: {
      title: '操作中心',
      count: n => `${n} 個待處理操作`,
      itemCount: (total, attention) => `${total} 項 · ${attention} 項需要處理`,
      open: '開啟操作中心',
      close: '關閉操作中心',
      previous: '上一項',
      next: '下一項',
      ...
      unknownProfile: '預設設定檔',
      reasoning: '推理',
      queuedCount: count => `${count} 則已排入佇列`,
      connectionConnecting: '正在連線',
      connectionOffline: '離線',
      connectionError: '連線錯誤',
      messageSession: '傳送訊息至工作階段',
      queueMessage: '將訊息排入佇列',
      liveMessagePlaceholder: '輸入訊息…',
      send: '傳送',
      steer: '調整方向',
      queue: '排入佇列',
      stop: '停止',
      acknowledge: '關閉',
      steerRejected: '無法調整執行中的工作階段。請將訊息排入佇列，稍後傳送。',
      queueRejected: '將此訊息排入佇列',
      steered: '已傳送指示',
      queued: '訊息已排入佇列',
      stopped: '工作階段已停止',
      acknowledged: '已關閉'
