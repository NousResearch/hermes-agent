...
export const zhHant = defineLocale({
  ...
  notifications: {
    ...
    voice: {
      ...
      microphoneSelectionUnavailable: '所選麥克風不可用',
      ...
      unavailable: '語音不可用',
      usingSystemMicrophone: 'Hermes 將在本次錄音中使用系統預設麥克風。'
    },
    native: {
      approvalTitle: '需要核准',
      approveAction: '核准',
  ...
  keybinds: {
    title: '鍵盤快速鍵',
    subtitle: open => `點擊快速鍵即可重新綁定 · ${open} 可重新開啟此面板。`,
    rebind: '重新綁定',
    reset: '還原預設',
    resetAll: '全部重設',
    pressKey: '請按下按鍵…',
    set: '設定',
    conflictWith: label => `已綁定到「${label}」`,
    categories: {
      composer: '輸入框',
      profiles: '設定檔',
      session: '工作階段',
    ...
    actions: {
      'keybinds.openPanel': '開啟鍵盤快速鍵',
      'nav.commandPalette': '開啟命令面板',
      'nav.commandCenter': '開啟命令中心',
      'nav.settings': '開啟設定',
      'nav.profiles': '開啟設定檔',
      'nav.skills': '開啟技能',
      'nav.messaging': '開啟訊息平台',
      'nav.artifacts': '開啟成品',
      'nav.cron': '開啟排程工作',
      'nav.kanban': '開啟看板',
      'nav.agents': '開啟代理',
      'session.new': '新工作階段',
      'session.newWindow': '在新視窗中開啟新工作階段',
      'session.next': '下一個工作階段',
      'session.prev': '上一個工作階段',
      'session.slot.1': '切換到最近工作階段 1',
      'session.slot.2': '切換到最近工作階段 2',
      'session.slot.3': '切換到最近工作階段 3',
      'session.slot.4': '切換到最近工作階段 4',
      'session.slot.5': '切換到最近工作階段 5',
      'session.slot.6': '切換到最近工作階段 6',
      'session.slot.7': '切換到最近工作階段 7',
      'session.slot.8': '切換到最近工作階段 8',
      'session.slot.9': '切換到最近工作階段 9',
      'session.focusSearch': '搜尋工作階段',
      'session.togglePin': '釘選/取消釘選目前工作階段',
      'workspace.newWorktree': '新增工作樹',
      'composer.focus': '聚焦輸入框',
      'composer.modelPicker': '開啟模型選擇器',
      'composer.voice': '開始 / 停止語音對話',
      'view.toggleSidebar': '切換工作階段側邊欄',
      'view.toggleRightSidebar': '切換檔案瀏覽器',
      'view.toggleReview': '切換審查面板',
      'view.showFiles': '顯示檔案瀏覽器',
      'view.showTerminal': '顯示終端機',
      'view.terminalSelection': '將終端機選取範圍傳送到輸入框',
      'view.closePreviewTab': '關閉預覽分頁',
      'view.flipPanes': '交換側邊欄位置',
      'view.toggleSplit': '切換分割窗格',
      ...
      'profile.next': '下一個設定檔',
      'profile.prev': '上一個設定檔',
      'profile.toggleAll': '切換全部設定檔檢視',
      'profile.create': '建立設定檔',
      'composer.send': '傳送訊息',
      'composer.newline': '插入換行',
      'composer.steer': '引導執行中的回合',
      'composer.sendQueued': '傳送下一則排隊訊息',
      'composer.mention': '引用檔案、資料夾、網址',
      'composer.slash': '斜線命令面板',
      'composer.help': '快速說明',
      'composer.history': '切換彈出視窗/歷史',
  ...
  settings: {
    ...
    voice: {
      title: '語音輸入',
      microphoneTitle: '麥克風',
      microphoneDesc: '用於聽寫和語音對話的本機輸入裝置。',
      systemDefault: '系統預設麥克風',
      refreshDevices: '重新整理',
      devicesUnavailable: '目前執行環境無法存取麥克風裝置。',
      missingDeviceOption: '已儲存的麥克風（未連接）',
      selectedDeviceUnavailable: '已儲存的麥克風未連接。Hermes 將改用系統預設麥克風。',
      backendTitle: '轉寫後端',
      localBackend: '本機',
      remoteBackend: '遠端',
      localBackendDesc: '音訊在此處擷取，並由本機 Hermes 後端轉寫成文字後傳送給智能體。',
      remoteBackendDesc: baseUrl =>
        `音訊在此處擷取，然後傳送到 ${baseUrl} 進行轉寫。模型 API 收到的是轉寫文字，而不是原始音訊。`,
      sttTitle: '語音轉文字',
      refreshStatus: '檢查',
      checkingStatus: '正在檢查語音轉文字狀態…',
      statusUnavailable: '語音轉文字狀態不可用。',
      statusUnsupported: '此後端尚未提供語音轉文字診斷介面。語音轉寫可能仍可使用；更新後端後可查看就緒詳情。',
      statusFailed: '狀態檢查失敗',
      statusError: message => `語音轉文字狀態檢查失敗：${message}`,
      sttDisabled: '設定中已停用語音轉文字。',
      sttReady: provider => `已連線後端上的 ${provider} 語音轉文字已就緒。`,
      sttUnavailable: provider => `已連線後端上的 ${provider} 語音轉文字尚未就緒。`,
      localSttInstallable: missing =>
        `本機 STT 缺少 ${missing}。延遲安裝已啟用，後端可在首次本機轉寫時安裝允許的套件。`,
      localSttMissing: missing => `本機 STT 缺少 ${missing}。請啟用延遲安裝，或在此後端安裝本機 STT 套件。`,
      localCommandAvailable: missing =>
        `命令式本機 STT 可用。缺少的套件組合：${missing}。桌面端擷取不需要 sounddevice 或 numpy。`,
      localPackagesReady: '此後端已安裝本機 STT 套件。',
      localPackagesMissing: missing => `缺少本機 STT 套件：${missing}。`
    },
    about: {
    ...
    mcp: {
      ...
      test: '測試連線',
      testing: '測試中…',
      testOk: count => `已連線 — ${count} 個工具可用`,
      testFailed: '連線失敗',
      enableServer: name => `啟用 ${name}`,
      disableServer: name => `停用 ${name}`,
      serverEnabled: name => `${name} 已啟用 — 對新工作階段生效。`,
      serverDisabled: name => `${name} 已停用 — 對新工作階段生效。`,
      toggleFailed: name => `切換 ${name} 失敗`,
      tabServers: '伺服器',
      tabCatalog: '目錄',
      catalogLoading: '正在載入 MCP 目錄…',
      catalogLoadFailed: 'MCP 目錄載入失敗',
      catalogEmpty: '沒有可用的目錄項目。',
      catalogInstalled: '已安裝',
      catalogEnabled: '已啟用',
      catalogNeedsInstall: '需要建置',
      catalogInstall: '安裝',
      catalogInstalling: '安裝中…',
      catalogInstallStarted: name => `正在安裝 ${name}… 完成後對新工作階段生效。`,
      catalogInstallFailed: name => `安裝 ${name} 失敗`,
      catalogEnvPrompt: name => `${name} 需要憑證`,
      catalogEnvRequired: '安裝前請填寫必要的值。',
    ...
    providers: {
      ...
      disconnect: '中斷連線',
      disconnectInTerminal: '中斷連線（在終端機中執行移除命令）',
      ...
      removeTerminalConfirm: (provider, command) =>
        `中斷 ${provider} 的連線？這將在終端機中執行 "${command}" 以清除憑證。`,
      removeTerminalRunning: provider => `正在終端機中中斷 ${provider} 的連線…`,
      removedTitle: '帳號已移除',
    ...
    toolsets: {
      ...
      modelInUse: '使用中',
      modelDefault: '預設',
      modelInactiveHint: '請先選擇此後端，然後再變更其模型。',
      modelSelectedTitle: '模型已選擇',
      modelSelectedMessage: model => `${model} 將套用至新工作階段。`,
  ...
  starmap: {
    ...
    share: '分享圖譜',
    shareHint: '複製代碼以分享此圖譜，或貼上代碼以載入。僅包含版面配置，不含你的記憶或技能內容。',
    shareTitle: '匯入 / 匯出圖譜',
    sharePlaceholder: '貼上圖譜代碼…',
    copy: '複製圖譜代碼',
    copied: '已複製！',
    importMap: '匯入圖譜',
    importBtn: '載入',
    importEmpty: '貼上圖譜代碼以載入。',
  ...
  commandCenter: {
    ...
    mcpServers: 'MCP 伺服器',
    archivedChats: '已封存聊天',
    sections: { maintenance: '維護', sessions: '工作階段', system: '系統', usage: '使用量' },
    sectionDescriptions: {
      maintenance: '診斷、備份、策展器與記憶資料',
      sessions: '搜尋和管理工作階段',
      system: '狀態、記錄和系統動作',
    ...
    logFile: '記錄檔',
    logLevel: '層級',
    logSearchPlaceholder: '篩選記錄行…',
    maintenance: {
      runOps: '診斷',
      doctor: '執行健檢',
      doctorDesc: '檢查安裝、設定與提供方的健康狀態',
      securityAudit: '安全性稽核',
      securityAuditDesc: '掃描設定與技能中的風險設定',
      backup: '建立備份',
      backupDesc: '打包設定、記憶、技能與工作階段',
      debugShare: '偵錯分享',
      debugShareDesc: '上傳去識別化報告與記錄，取得可分享連結（6 小時後自動刪除）',
      debugShareRunning: '正在上傳偵錯報告…',
      debugShareLinks: '分享連結',
      debugShareFailed: '偵錯分享失敗',
      copyLink: '複製連結',
      linkCopied: '連結已複製',
      curator: '技能策展器',
      curatorDesc: '背景審查並封存過期的智能體自建技能',
      curatorPaused: '已暫停',
      curatorActive: '執行中',
      curatorDisabled: '已停用',
      curatorLastRun: when => `上次執行 ${when}`,
      curatorNeverRan: '從未執行',
      pause: '暫停',
      resume: '繼續',
      runNow: '立即執行',
      memoryData: '記憶資料',
      memoryDataDesc: '注入每個工作階段的內建記憶檔案',
      memoryProvider: name => `目前提供方：${name}`,
      builtinMemory: '內建',
      memoryFile: '智能體記憶（MEMORY.md）',
      userFile: '使用者輪廓（USER.md）',
      bytes: size => size,
      empty: '空',
      resetMemory: '重設記憶',
      resetUser: '重設輪廓',
      resetAll: '全部重設',
      resetConfirm: target => `刪除 ${target}？此操作無法復原。`,
      resetDone: files => `已刪除 ${files}。`,
      resetFailed: '記憶重設失敗',
      actionStarted: name => `${name} 已啟動 — 正在追蹤記錄…`,
  ...
  profiles: {
    ...
    workingBadge: count => `${count} 個工作階段執行中`,
    attentionBadge: count => `${count} 個工作階段等待你的輸入`
  },
  ...
  kanban: {
    ...
    loading: '正在載入看板…',
    failedLoad: '載入看板失敗',
    count: count => `${count} 張卡片`,
    board: '面板',
    nudgeDispatcher: '觸發調度器',
    nudgeSent: (spawned, promoted) => `已觸發調度器 — 啟動 ${spawned}，晉級 ${promoted}`,
    nudgeFailed: '觸發調度器失敗',
    newCard: '新增卡片',
    noTasks: '暫無卡片',
    unassigned: '未指派',
    priority: '優先順序',
    progressTitle: (done, total) => `子任務已完成 ${done}/${total}`,
    diagnostics: '診斷',
    movedByRules: column => `已按面板規則移至「${column}」`,
    moveFailed: '移動失敗',
    columnLabels: {
      triage: '分流',
      todo: '待辦',
    ...
    comments: '留言',
    noComments: '暫無留言',
    commentPlaceholder: '新增留言…（⌘Enter 傳送）',
    addComment: '留言',
    commentFailed: '新增留言失敗',
    events: '事件',
    noEvents: '暫無事件',
    runHistory: '執行歷史',
    noRuns: '暫無執行記錄',
    ...
    workerLog: '工作程序記錄',
    loadingLog: '正在載入記錄…',
    noWorkerLog: '暫無工作程序記錄',
    attachments: '附件',
    noAttachments: '暫無附件',
    addAttachment: '新增附件',
    attachmentUploading: '上傳中…',
    attachmentUploaded: count => (count === 1 ? '附件已新增' : `已新增 ${count} 個附件`),
    attachmentUploadFailed: '附件上傳失敗',
    downloadAttachment: name => `下載 ${name}`,
    attachmentDownloaded: name => `已將 ${name} 儲存到下載資料夾`,
    attachmentDownloadFailed: '附件下載失敗',
    attachmentReveal: '在資料夾中顯示',
    updateFailed: '更新失敗',
    newCardTitle: '新增卡片',
    newCardDesc: '調度器會把就緒卡片交給其指派的設定檔執行。',
    titleLabel: '標題',
    titlePlaceholder: '需要做什麼？',
    assigneeLabel: '負責人',
    assigneePlaceholder: '選擇設定檔',
    bodyLabel: '描述',
    bodyPlaceholder: '目標、方案、驗收標準…',
    priorityLabel: '優先順序',
    parentLabel: '父卡片',
    parentNone: '無父卡片',
    optional: '選填',
  ...
  onboarding: {
    ...
    localApiKeyPlaceholder: 'API 金鑰（選填 — 僅當端點需要時填寫）',
    couldNotSave: '無法儲存憑證。',
    connecting: '連線中',
    update: '更新',
    flowSubtitles: {
  ...
  commandCenterOverview: {
    sectionLabel: '全部設定檔',
    sectionDescription: '總覽所有設定檔的活動，以及共享的看板',
    working: count => `${count} 個進行中`,
    attention: count => `${count} 個待輸入`,
    ...
    switch: '切換',
    openBoard: '開啟看板',
    kanbanUnavailable: '此後端不支援看板。',
    noHotCards: '沒有待審查或受阻的卡片',
    openCard: title => `在看板中開啟「${title}」`
  }
})
