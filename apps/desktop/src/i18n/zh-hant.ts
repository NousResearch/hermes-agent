...
export const zhHant = defineLocale({
  ...
  sidebar: {
    ...
    projects: {
      ...
      editFoldersTitle: '編輯資料夾',
      editFoldersDesc: '當磁碟上的資料夾被重新命名或移動後,在此將其重新指向新位置。',
      editFoldersEmpty: '該專案尚無資料夾。',
      editFolderPick: '選擇新路徑…',
      editFolderSave: '移動',
      editFolderRevert: '復原',
      editFolderRemove: '移除',
      editFolderUnremove: '保留',
      editFolderRemoved: '將被移除',
      editFolderConflict: '已有其他資料夾位於此路徑。',
      editFolderChanged: '已修改',
      editFoldersDone: '資料夾已更新。',
      editFoldersFailed: '無法載入專案資料夾。',
      editFoldersMoveFailed: '無法移動資料夾',
