...
export const zhHant = defineLocale({
  ...
  settings: {
    ...
    about: {
      ...
      channel: '更新通道',
      channelDesc: '選擇此安裝的更新來源。適用於使用此安裝的所有設定檔。',
      channelStable: '穩定版',
      channelStableDesc: '僅發布過的官方版本。推薦大多數使用者使用。',
      channelBeta: '測試版 (main)',
      channelBetaDesc: 'main 上的每項變更一發布就取得。適合進階使用者。',
      channelPersistOnlyNote: '切換通道只會儲存偏好設定——檢查更新與安裝更新需分開操作。',
      never: '從未',
      justNow: '剛剛',
