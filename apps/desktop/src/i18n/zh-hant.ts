  ...
  settings: {
    ...
    billing: {
      ...
      errors: {
        ...
        terminalBillingApprovalMessage: '需要啟用終端帳單。請先加值以啟用，然後重試。',
        terminalBillingApprovalTitle: '終端帳單需要核准',
        adminDisabledTerminalBilling: '管理員已關閉此終端的終端帳單。',
        youDisabledTerminalBilling: '你已關閉此終端的終端帳單。',
        reauthorizeDevice: message => `${message} 請從「設定 → 閘道」重新連線並授權此裝置。`,
        terminalBillingOffTitle: '終端帳單已關閉',
        sessionLoggedOutMessage: '工作階段已登出，請從「設定 → 閘道」重新登入。',
        sessionLoggedOutTitle: '工作階段已登出',
        terminalBillingDisabledMessage: '此帳戶的終端帳單已關閉，需要管理員在入口網站啟用。',
        terminalBillingDisabledTitle: '終端帳單已關閉',
