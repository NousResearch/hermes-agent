...
export const zhHant = defineLocale({
  ...
  desktop: {
    ...
    browserPin: '釘選',
    browserUnpin: '取消釘選',
    browserOpenExternal: '在外部瀏覽器中開啟',
    browserCapture: '擷取頁面',
    browserCapturePreview: '擷取預覽',
    browserSaveCapture: '儲存擷取',
    browserClosePreview: '關閉預覽',
    browserUrlPlaceholder: '輸入網址',
    browserNewTab: '新增分頁',
    browserTabLimit: '所有瀏覽器分頁均已釘選。請先取消釘選一個分頁，再開啟新分頁。',
    browserCloseTab: '關閉分頁',
    browserQc: '品質檢查',
    browserQcNote: '備註',
    browserQcEvidence: '證據',
    browserQcPass: '通過',
    browserQcFail: '不通過',
    browserQcUnchecked: '未檢查',
    browserEmpty: '輸入網址以開始瀏覽',
    browserInvalidUrl: '請輸入有效網址',
    browserQcComposition: '構圖',
    browserQcColor: '色彩',
    browserQcTypography: '排版',
    browserQcSpacing: '間距',
    browserQcContrast: '對比度',
    browserQcClipping: '裁切',
    browserQcReferenceMatch: '參考比對',
