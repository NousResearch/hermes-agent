...
export const zhHant = defineLocale({
  ...
  ide: {
    ...
    noWorkspace: '未開啟工作區',
    explorerTitle: '檔案總管',
    explorerEmptyTitle: '未開啟工作區',
    explorerEmptyBody: '從專案視窗開啟 IDE，即可載入該專案的工作區。',
    editorTitle: '編輯器',
    editorEmptyTitle: '未開啟檔案',
    editorEmptyBody: '在檔案總管中選擇檔案即可開始編輯。',
    chatTitle: '對話',
    chatEmptyTitle: '尚無 IDE 工作階段',
    chatEmptyBody: 'IDE 工作階段只顯示在這裡，並與目前工作區關聯。新增工作階段即可與代理協作。',
    browserTitle: '瀏覽器',
    browserEmptyTitle: '未開啟頁面',
    browserEmptyBody: '開啟網址即可在此瀏覽，代理可以與你一同操作頁面。',
    toggleExplorer: '切換檔案總管',
    toggleChat: '切換對話',
    toggleBrowser: '切換瀏覽器',
    resizeExplorer: '調整檔案總管寬度',
    resizeChat: '調整對話寬度',
    resizeBrowser: '調整瀏覽器高度',
    refreshExplorer: '重新整理檔案總管',
    explorerUnreadable: error => `無法讀取此資料夾（${error}）。`,
    editorTabsLabel: '已開啟的檔案',
    closeTab: '關閉',
    closeTabLabel: name => `關閉 ${name}`,
    reloadFromDisk: '從磁碟重新載入',
    tooLargeTitle: '檔案過大，無法在此編輯',
    tooLargeBody: '此檔案超過 512 KB。請從對話預覽或桌面編輯器開啟。',
    loadFailedTitle: '無法開啟此檔案',
    closeDirtyTitle: '有未儲存的變更，仍要關閉嗎？',
    closeDirtyBody: '此分頁有尚未儲存到磁碟的編輯。',
    closeDirtyConfirm: '捨棄變更',
    diskChangedTitle: '檔案已在磁碟上變更',
    diskChangedBody: '其他操作（代理執行或其他應用程式）編輯了此檔案。現在儲存將覆寫那些變更。',
    overwrite: '覆寫',
    chatTabsLabel: 'IDE 工作階段',
    chatNew: '新增 IDE 工作階段',
    chatRecent: '最近的 IDE 工作階段',
    chatCreateFailed: '無法啟動 IDE 工作階段',
    browserTabsLabel: '瀏覽器分頁',
    browserOpen: '開啟瀏覽器',
