...
export const zhHant = defineLocale({
  ...
  statusStack: {
    ...
    markDone: '標記完成',
    markDoneAria: task => `將任務標記為完成：${task}`,
    reopen: '重新開啟',
    reopenAria: task => `重新開啟任務：${task}`,
    retryTaskSync: '重試',
    syncingTask: '正在同步任務狀態',
    markDoneTitle: '將任務標記為完成？',
    markDoneDescription: 'Hermes 會將此視為你的決定，不會因較舊的模型更新而重新開啟此任務。',
    markingDone: '正在標記完成…',
    markedDone: '已標記完成',
    reopenTitle: '重新開啟任務？',
    reopenDescription: 'Hermes 可能會繼續處理此任務。',
    reopening: '正在重新開啟…',
    reopened: '已重新開啟',
    taskChanged: '你確認時任務已變更。請查看最新清單後再試一次。',
    taskMissing: '該任務已不在目前計畫中。',
    taskSessionMissing: '此任務工作階段已不可用。請恢復聊天後再試一次。',
    taskSyncFailed: '無法同步任務狀態',
    taskUpdateFailed: '無法更新任務狀態，請再試一次。',
    taskUpdatesUnavailable: '任務更新無法使用',
    statusPending: '待處理',
