...
export const zhHant = defineLocale({
  ...
  codingWorkspace: {
    ...
    noProject: "無專案",
    newWorktree: "新增工作樹",
    existingWorktree: "現有工作樹",
    currentCheckout: "目前簽出",
    agentWorktree: "代理工作樹",
    agentWorktreeNote: "此工作樹由代理在對話期間建立。",
    newChatHere: "在此工作樹中新建對話",
    projectFolder: "專案資料夾",
    initializeGit: "初始化 Git 儲存庫",
    initializeGitDescription: "以空的首次提交建立儲存庫。你的檔案保持未追蹤。",
    initializeGitFailed: "無法初始化 Git 儲存庫",
    searchProjects: "搜尋專案",
    noProjects: "沒有符合的專案",
    projectsFailed: "無法載入專案",
    browse: "瀏覽…",
    base: "基於分支",
    dirty: "有未提交變更",
    clean: "乾淨",
    detached: "分離的 HEAD",
    dirtyNotCopied: "未提交的來源變更不會複製到新工作樹。",
    createOnSend: "首次傳送時建立，而非現在。",
    shared: "此簽出可能與其他對話共用。變更不隔離。",
    preparing: "正在準備工作區",
    workInProject: "在專案中工作…",
    useAsProject: "用作專案",
    newChat: "在其他工作區新增對話…",
    binding: "此對話保留在原工作區。",
    selectCheckout: "選擇簽出",
    folderFailed: "無法將此資料夾用作專案",
    unavailable: "對話連線至所屬後端後才能選擇工作區。",

    showControls: "顯示程式開發控制項",
    showControlsDescription: "在此設定檔的新對話輸入框上方顯示專案與工作位置。現有對話與側欄偏好不變。",
    saveFailed: "無法儲存程式開發控制項設定",
  },
  common: {
    apply: '套用',
    back: '返回',
