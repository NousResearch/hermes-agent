...
export const zhHant = defineLocale({
  ...
  settings: {
    ...
    vault: {
      ...
      registrableDomainLabel: '允許 HTTPS 子網域',
      registrableDomainHint: '允許在此網站的可註冊網域及其 HTTPS 子網域填寫。除非信任所有子網域，否則請保持關閉。',
      registrableDomainBadge: 'HTTPS 子網域',
  ...
  prompts: {
    ...
    vaultSaveRegistrableDomain: '允許 HTTPS 子網域',
    vaultSaveRegistrableDomainHint: '明確將此登入擴展到同一可註冊網域。除非信任所有子網域，否則請保持關閉。',
