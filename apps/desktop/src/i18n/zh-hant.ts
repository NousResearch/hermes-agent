...
export const zhHant = defineLocale({
  ...
  shell: {
    ...
    statusbar: {
      ...
      openAgents: '開啟代理',
      sessionsLabel: '工作階段',
      sessionsActive: count => `${count} 個工作階段進行中`,
      sessionsActiveTitle: '有進行中工作的工作階段',
      agentsActive: count => `${count} 個代理`,
      tasks: '工作',
      tasksTitle: '終端與預覽背景工作',
      tasksRunning: count => `${count} 個執行中`,
      tasksFailed: count => `${count} 個失敗`,
      cron: '排程',
      openCron: '開啟排程工作',
      turnRunning: '執行中',
