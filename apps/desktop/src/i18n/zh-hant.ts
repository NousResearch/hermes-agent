...
export const zhHant = defineLocale({
  ...
  profiles: {
    ...
    gatewaySwitcher: '切換閘道',
    gatewayLocalHeading: '本機',
    gatewayThisDevice: '此裝置',
    gatewayRemoteHeading: '遠端',
    gatewaySshHeading: 'SSH',
    switchToGateway: name => `切換至 ${name}`,
    cloudAgents: 'Hermes Cloud',
    cloudAgentsEmpty: '沒有可用的 Hermes Cloud 代理。',
    cloudAgentsLoading: '正在載入 Hermes Cloud 代理…',
    cloudAgentsRefresh: '重新整理閘道',
    switchToCloudAgent: name => `切換至 ${name}`,
    starCloudAgent: name => `收藏 ${name}`,
    unstarCloudAgent: name => `取消收藏 ${name}`,
    actions: '動作',
    color: '顏色…',
    colorFor: '顏色',
  ...
  shell: {
    ...
    gatewayMenu: {
      ...
      favorites: '收藏的閘道',
      noFavorites: '尚無收藏的閘道。',
      manageFavorites: '在設定中管理 →',
      useFavorite: name => `連線至 ${name}`,
      activeFavorite: '目前使用',
      switchingFavorite: '切換中…'
    },
    approvalMode: {
      title: '核准模式',
