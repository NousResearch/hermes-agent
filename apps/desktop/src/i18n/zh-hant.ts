...
export const zhHant = defineLocale({
  ...
  settings: {
    ...
    appearance: {
      ...
      autoSendTitle: '免持傳送',
      autoSendDesc: '停止鍵入或聽寫後自動傳送已撰寫的內容。按任意鍵即可取消。',
      autoSendDelayTitle: '免持延遲',
      autoSendDelayDesc: '輸入框在最後一次按鍵或聽寫的詞語後等待多久自動傳送。',
      tipsTitle: '應用程式內提示',
  ...
  composer: {
    ...
    stop: '停止',
    send: '傳送',
    autoSendCountdown: (seconds: number) => `${seconds} 秒後傳送`,
    speaking: '說話中',
    transcribing: '轉寫中',
    thinking: '思考中',
    muted: '已靜音',
