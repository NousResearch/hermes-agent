...
export const zh: Translations = {
  ...
  desktop: {
    ...
    browserPin: '固定',
    browserUnpin: '取消固定',
    browserOpenExternal: '在外部浏览器中打开',
    browserCapture: '捕获页面',
    browserCapturePreview: '捕获预览',
    browserSaveCapture: '保存捕获',
    browserClosePreview: '关闭预览',
    browserUrlPlaceholder: '输入网址',
    browserNewTab: '新建标签页',
    browserTabLimit: '所有浏览器标签页均已固定。请取消固定一个标签页后再打开新标签页。',
    browserCloseTab: '关闭标签页',
    browserQc: '质量检查',
    browserQcNote: '备注',
    browserQcEvidence: '证据',
    browserQcPass: '通过',
    browserQcFail: '不通过',
    browserQcUnchecked: '未检查',
    browserEmpty: '输入网址以开始浏览',
    browserInvalidUrl: '请输入有效网址',
    browserQcComposition: '构图',
    browserQcColor: '色彩',
    browserQcTypography: '排版',
    browserQcSpacing: '间距',
    browserQcContrast: '对比度',
    browserQcClipping: '裁切',
    browserQcReferenceMatch: '参考匹配',
