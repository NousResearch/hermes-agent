...
export const zh: Translations = {
  ...
  study: {
    title: 'StudyOS',
    subtitle: '以证据为基础的学习项目、今日行动与可审议建议。',
    close: '关闭 StudyOS',
    projectList: '项目',
    scheduleList: '日程',
    notConfigured: 'StudyOS vault not configured',
    noProjects: '还没有 StudyOS 项目。',
    noSchedules: '此项目还没有保存日程。',
    invalidSchedule: '此 StudyOS 日程无效，因此没有渲染。',
    invalidScheduleFiles: '需要处理的日程文件',
    ...
    phases: '长期阶段',
    events: '具体学习时段',
    noConcreteSessions: '尚未安排具体学习时段。',
    goals: '目标',
    source: '来源',
    status: '状态',
    readOnly: '证据驱动',
    settings: '设置',
    setupTitle: '连接 StudyOS Vault',
    setupDescription: '选择保存 StudyOS 项目的 Obsidian Vault。此设置仅作用于当前 Hermes 配置档案。',
    vaultPath: 'Vault 路径',
    chooseFolder: '选择文件夹',
    saveSettings: '保存并启用 StudyOS',
    settingsSaved: 'StudyOS 设置已保存。',
    newSessionRequired: 'StudyOS 已启用；新建聊天后即可加载它的工具。',
    selectProjectPrompt: '请选择一个项目，使桌面端与 agent 使用同一个活动项目。',
    todayTab: '今日',
    calendarTab: '日历',
    reviewTab: '复习',
    inboxTab: '建议',
    todayTitle: '今日学习台',
    scheduledToday: '今日安排',
    noEventsToday: '今天没有已排定的事件。',
    dueNow: 'Vault 待复习',
    completedToday: '今日已复习',
    activityToday: '今日新增证据',
    evidenceStatus: '证据状态',
    evidenceCoverage: '已观察维度',
    verifiedDimensions: '独立验证维度',
    independentEvidence: '已验证尝试',
    latestEvidence: '最近证据',
    noEvidence: '尚无证据',
    attempts: '尝试次数',
    nextAction: '建议的下一步',
    openReview: '打开复习',
    startWithAgent: '交给 agent 开始',
    noSuggestions: '当前没有需要干预的证据缺口。',
    suggestionsTitle: '建议收件箱',
    suggestionsDescription: '建议由学习证据推导；已保存的计划提案必须由你明确决定。',
    pendingChanges: '计划提案',
    recommendations: '当前建议',
    emptyInbox: '目前没有等待决定的计划提案。',
    proposalNotice: '接受只会记录你的决定，不会自动修改日程。',
    accept: '接受',
    reject: '拒绝',
    actions: '项行动',
    reviewTitle: '艾宾浩斯复习',
    ...
    reviewed: '已复习',
    of: '/',
    filterBySubject: '标签筛选',
    filterByLevel: '等级',
    allLevels: '全部',
    streak: '连续天数',
    days: '天',
    spacingCoverage: '间隔复习覆盖',
    learningState: '状态',
    prerequisites: '前置概念',
    newConcepts: '新概念',
    newExamples: '新题目',
    ...
    conceptGraph: '概念图谱',
    startReview: '开始复习',
    agentReview: '让 agent 带我复习',
    agentReviewThis: '让 agent 复习这题',
    agentReviewDesc: '回到聊天，由 agent 自动找题、追问、讲解并记录。',
    agentReviewSelected: '让 agent 复习已选 {count} 题',
    selectedReviews: '已选 {count} 题',
    selectAllFiltered: '选择当前筛选',
    clearSelection: '清空选择',
    selectReviewItem: '选择复习题',
    loadingReview: '正在加载题目…',
    remaining: '题待完成',
    backToList: '返回列表',
    yourAnswer: '你的答案',
    answerPlaceholder: '先写出完整思路，再查看答案…',
    confidence: '作答信心',
    revealAnswer: '查看答案',
    referenceAnswer: '参考答案',
    noReferenceAnswer: '这篇笔记没有独立答案区，请根据原始资料自行评估。',
    selfGrade: '本题完成得如何？',
    incorrect: '错误',
    partial: '部分正确',
    correct: '正确',
    reviewRecorded: '已记录本次复习',
    nextReview: '下次复习',
    sessionComplete: '本轮复习完成',
    sessionCompleteDesc: '本轮已完成 {count} 道复习。',
    selectProjectForReview: '请先选择一个 StudyOS 项目，再记录复习证据。'
  },
