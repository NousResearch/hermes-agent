...
export const zh: Translations = {
  ...
  kanban: {
    ...
    attachmentUploaded: count => (count === 1 ? '附件已添加' : `已添加 ${count} 个附件`),
    attachmentUploadFailed: '附件上传失败',
    downloadAttachment: name => `下载 ${name}`,
    attachmentDownloaded: name => `已将 ${name} 保存到下载文件夹`,
    attachmentDownloadFailed: '附件下载失败',
    attachmentReveal: '在文件夹中显示',
    updateFailed: '更新失败',
    newCardTitle: '新建卡片',
