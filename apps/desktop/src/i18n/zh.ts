...
export const zh: Translations = {
  ...
  hud: {
    follow: '跟随指针',
    followOn: '正在跟随指针 — 点击停止',
    followOff: '跟随指针',
    followUnsupported: '此桌面无法自行放置窗口，HUD 无法跟随指针',
    agent: '代理',
    switchAgent: '切换代理',
    room: '群聊',
    switchRoom: '在这里与群聊对话',
    inRoom: room => `群聊：${room}`,
    leaveRoom: '离开群聊',
    openRoomInApp: '在主窗口打开',
    roomEmpty: '这里还没有消息。在下方输入即可开始。',
    roomThinking: name => `${name} 正在回复…`,
    you: '你',
    noAgents: '暂无其他代理',
    noRooms: '暂无群聊',
    busyWarning: '正在生成回复 — 切换代理会重启 HUD 并中断它',
    askTitle: '想对它做什么？',
    viaShortcut: '指针位置',
    viaRightClick: '右键',
    explain: '解释',
  ...
  settings: {
    ...
    appearance: {
      ...
      themeProfileNote: _profile => '此主题将应用于 Team Hermes 中的所有配置文件。',
    ...
    hud: {
      followTitle: 'HUD 跟随指针',
      followDesc: '悬浮栏会跟着鼠标移动；当你去够它或在其中输入时保持不动。',
      followUnsupported: '原生 Wayland 不可用：窗口无法自行定位。',
      petsTitle: 'HUD 上的像素宠物',
      petsDesc: '各代理的宠物会在栏上方的小道走动，随对话动作，并在指针靠近时停下来看你。',
      petByAgentTitle: '每个代理的宠物',
      petByAgentDesc: '与每个代理对话时 HUD 上出现哪只宠物。在群聊中，所有成员的宠物都会出现。',
      petChoice: { hank: 'Hank', mina: 'Mina', avatar: '头像徽章', none: '无宠物' },
      askShortcutTitle: '询问指针下方的内容',
      askShortcutDesc: '全局快捷键。捕获应用与指针周围的截图，并打开 HUD 询问要做什么。',
      rightClickTitle: 'Ctrl + 右键也可询问',
      rightClickDesc: '使用系统级输入钩子。普通右键永远不会被拦截。',
      rightClickUnavailable: reason => `需要可选的 uiohook-napi 模块 — ${reason || '未安装'}。`,
      active: '快捷键已生效。',
      takenBy: '其他应用已占用此快捷键 — 请换一个。',
      invalidShortcut: '快捷键无效。至少包含一个修饰键。'
    },
    credentials: {
      pasteKey: '粘贴密钥',
