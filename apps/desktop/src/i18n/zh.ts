...
export const zh: Translations = {
  ...
  shell: {
    ...
    statusbar: {
      ...
      approvalMenuLabel: '为我批准',
      approvalMenuTitle: 'Hermes 操作应如何批准？',
      approvalAsk: '每次询问',
      approvalAskDescription: '始终询问是否编辑外部文件和使用互联网',
      approvalSmart: '智能批准',
      approvalSmartDescription: '仅对检测为可能不安全的操作进行询问',
      approvalFull: '完全访问',
      approvalFullDescription: '不受限制地访问互联网和你电脑上的任何文件',
      modelNone: '无',
      noModel: '无模型',
      switchModel: '切换模型',
