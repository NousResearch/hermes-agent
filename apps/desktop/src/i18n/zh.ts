...
export const zh = defineLocale({
  ...
  statusStack: {
    ...
    markDone: '标记完成',
    markDoneAria: task => `将任务标记为完成：${task}`,
    reopen: '重新打开',
    reopenAria: task => `重新打开任务：${task}`,
    retryTaskSync: '重试',
    syncingTask: '正在同步任务状态',
    markDoneTitle: '将任务标记为完成？',
    markDoneDescription: 'Hermes 会将此视为你的决定，不会因较旧的模型更新而重新打开该任务。',
    markingDone: '正在标记完成…',
    markedDone: '已标记完成',
    reopenTitle: '重新打开任务？',
    reopenDescription: 'Hermes 可能会继续处理此任务。',
    reopening: '正在重新打开…',
    reopened: '已重新打开',
    taskChanged: '你确认时任务已发生变化。请查看最新列表后重试。',
    taskMissing: '该任务已不在当前计划中。',
    taskSessionMissing: '此任务会话已不可用。请恢复聊天后重试。',
    taskSyncFailed: '无法同步任务状态',
    taskUpdateFailed: '无法更新任务状态，请重试。',
    taskUpdatesUnavailable: '任务更新不可用',
    statusPending: '待处理',
