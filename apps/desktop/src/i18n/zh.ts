...
export const zh = defineLocale({
  ...
  settings: {
    ...
    vault: {
      ...
      registrableDomainLabel: '允许 HTTPS 子域名',
      registrableDomainHint: '允许在该站点的可注册域及其 HTTPS 子域名填充。除非信任所有子域名，否则请保持关闭。',
      registrableDomainBadge: 'HTTPS 子域名',
  ...
  prompts: {
    ...
    vaultSaveRegistrableDomain: '允许 HTTPS 子域名',
    vaultSaveRegistrableDomainHint: '明确将此登录扩展到同一可注册域。除非信任所有子域名，否则请保持关闭。',
