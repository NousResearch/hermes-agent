...
export const zh: Translations = {
  ...
  profiles: {
    ...
    gatewaySwitcher: '切换网关',
    gatewayLocalHeading: '本地',
    gatewayThisDevice: '此设备',
    gatewayRemoteHeading: '远程',
    gatewaySshHeading: 'SSH',
    switchToGateway: name => `切换到 ${name}`,
    cloudAgents: 'Hermes Cloud',
    cloudAgentsEmpty: '没有可用的 Hermes Cloud 智能体。',
    cloudAgentsLoading: '正在加载 Hermes Cloud 智能体…',
    cloudAgentsRefresh: '刷新网关',
    switchToCloudAgent: name => `切换到 ${name}`,
  ...
  shell: {
    ...
    gatewayMenu: {
      ...
      favorites: '收藏的网关',
      noFavorites: '还没有收藏的网关。',
      manageFavorites: '在设置中管理 →',
      useFavorite: name => `连接到 ${name}`,
      activeFavorite: '当前使用',
      switchingFavorite: '切换中…'
    },
    approvalMode: {
      title: '审批模式',
