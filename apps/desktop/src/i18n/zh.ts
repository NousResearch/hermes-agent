...
export const zh = defineLocale({
  ...
  shell: {
    ...
    statusbar: {
      ...
      tokensPerSecondTitle: '每秒输出 token 数',
      toggleLatency: 'API 延迟',
      latencyTitle: '平均 API 延迟',
      toggleCompressions: '压缩次数',
      toggleIdleSince: '距上次回复',
      idleSinceTitle: '距上一次最终回复完成已过多久',
      compressionsTitle: '上下文自动压缩次数',
      turnBreakdown: {
        title: '最近一回合',
        running: '进行中',
        wall: '总耗时',
