...
export const zh: Translations = {
  ...
  artifacts: {
    ...
    failedLoad: '产物加载失败',
    failedLoadTitle: '无法加载产物',
    failedLoadDesc: 'Hermes 无法读取最近的对话。请检查连接后重试。',
    partialLoadTitle: '部分产物可能缺失',
    partialLoadDesc: (failed, total) => `最近 ${total} 个对话中有 ${failed} 个无法读取。`,
    profileLoadErrors: count => `有 ${count} 个配置文件无法读取。`,
    scopeSummary: (loaded, total) => `正在显示最近 ${total} 个对话中 ${loaded} 个的产物。`,
    loadMoreChats: count => `再加载 ${count} 个对话`,
    tryAgain: '重试',
    openFailed: '打开失败',
    openChatFailed: '无法打开来源对话',
    itemsImage: '张图片',
    itemsLink: '个链接',
    itemsFile: '个文件',
    itemsGeneric: '项',
    ...
    loadPreview: '加载预览',
    loadPreviewFor: label => `加载 ${label} 的预览`,
    embeddedImage: '嵌入图片',
    chat: '对话',
    openSourceChat: label => `打开 ${label} 的来源对话`,
    copyUrl: '复制 URL',
    copyPath: '复制路径'
  },
