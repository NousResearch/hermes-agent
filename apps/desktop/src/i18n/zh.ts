...
export const zh: Translations = {
  ...
  settings: {
    ...
    config: {
      ...
      previewUblock: {
        checkingCache: '正在检查缓存的版本…',
        downloading: '正在下载 uBlock Origin Lite…',
        extracting: '正在解压版本…',
        loading: '正在加载 Preview 扩展…',
        preparing: '正在准备 Electron 兼容性…',
        validating: '正在测试内容拦截…',
        verifying: '正在验证官方版本…',
        enabled: version => '已启用 · ' + version,
        transferred: amount => '已传输 ' + amount,
        downloadProgress: 'uBlock Origin Lite 下载进度',
        retry: '重试'
      },
  ...
  preview: {
    ...
    web: {
      ...
      ublockPopup: '打开 uBlock Origin Lite 控制项',
      ublockPopupBlockedRequests: count => `打开 uBlock Origin Lite 控制项 — 此页面已拦截 ${count} 个请求`,
      ublockPopupFailed: '无法打开 uBlock 控制项',
      ublockPopupRetry: '重试 uBlock 控制项',
      address: '地址',
