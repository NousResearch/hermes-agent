...
export const zh: Translations = {
  ...
  settings: {
    ...
    appearance: {
      ...
      translucencyTitle: '桌面窗口透明度',
      translucencyDesc: '调整桌面透过 Hermes 主窗口的程度。仅支持 macOS 和 Windows。',
      menuBarTransparencyTitle: '菜单栏窗口透明度',
      menuBarTransparencyDesc: '调整菜单栏的玻璃表面，同时保持文字和控件清晰。',
      backdropTitle: '聊天背景',
      ...
      embedsAlways: '总是',
      embedsOff: '关闭',
      menuBarCompanionTitle: '菜单栏伴侣',
      menuBarCompanionDesc: '显示 macOS 菜单栏伴侣，用于斜杠命令、快捷设置与生态链接。',
