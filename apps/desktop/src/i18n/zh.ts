...
export const zh: Translations = {
  ...
  profiles: {
    ...
    deleting: '删除中…',
    createDesc: '配置档案是相互独立的 Hermes 环境，也可以路由到不同的桌面后端。',
    nameLabel: '名称',
    cloneFrom: '克隆来源',
    cloneFromNone: '无（空白）',
    ...
    backendLocal: '此后端',
    backendRemote: '远程后端',
    backendLocalDesc: '在当前后端创建配置档案并在此运行。',
    backendRemoteDesc: '将此配置档案用作另一个 Hermes Desktop 后端的快捷入口。',
    remoteUrl: '远程 URL',
    remoteUrlRequired: '远程 URL 必须以 http:// 或 https:// 开头。',
    remoteToken: '会话令牌',
    remoteTokenRequired: '远程后端需要会话令牌。',
    remoteTokenPlaceholder: '粘贴远程会话令牌',
