...
export const zh: Translations = {
  ...
  messaging: {
    ...
    clientExperienceDesc: '选择客户在 Hermes 工作时可以看到的内容。隐藏进度不会停止工具运行。',
    toolActivity: '工具活动',
    toolActivityDesc: '在 Telegram 对话中显示工具调用。',
    toolProgressOff: '关闭',
    toolProgressNew: '新工具',
    toolProgressAll: '所有工具',
    toolProgressVerbose: '详细',
    toolProgressLog: '仅记录日志',
    interimMessages: '过程更新',
    interimMessagesDesc: '在最终答案前发送自然语言进度说明。',
    reasoningVisibility: '推理摘要',
    reasoningVisibilityDesc: '模型提供推理内容时显示推理部分。',
    streamResponses: '流式回复',
    streamResponsesDesc: '生成最终文本时持续编辑 Telegram 回复。',
    longRunningStatus: '长任务状态',
    longRunningStatusDesc: '长时间任务期间定期显示工作状态。',
    displaySaved: name => `${name} 客户体验已更新`,
    displaySavedHint: '新对话会立即使用此设置。',
    failedDisplaySave: name => `更新 ${name} 客户体验失败`,
