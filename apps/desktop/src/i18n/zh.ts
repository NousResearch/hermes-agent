...
export const zh: Translations = {
  ...
  desktop: {
    ...
    annotations: {
      ...
      clear: '清除批注',
      comment: '评论',
      commentPlaceholder: '希望代理审查或更改什么？',
      concern: '问题',
      discard: '放弃草稿',
      discardDescription: '未保存的批注将丢失。',
      discardReplaceTitle: '替换当前批注草稿？',
      discardTitle: '放弃此批注草稿？',
      edit: '编辑批注',
      labels: {
        accessibility: '无障碍',
        bug: '缺陷',
      ...
      lastTurnTracking: '将在下一条提示时开始跟踪上一个回合。',
      listTitle: '批注',
      planApprove: '批准并继续',
      planApproved: '计划已批准',
      planAvailable: '计划已可供审查',
      planRequestChanges: '请求更改',
      planReview: '审查计划',
      remove: '移除批注',
      reopen: '重新打开批注草稿',
      save: '保存批注',
      ...
      scopeLastTurn: '上一轮',
      scopeUncommitted: '未提交',
      sendToAgent: '将反馈发送给代理',
      storageError: '无法在此窗口保存批注草稿。',
      statusOrphaned: '未找到锚点',
      statusSent: '已发送',
      statusStale: '版本已更改',
      suggestedReplacement: '建议替换',
      suggestion: '建议',
      suggestionPlaceholder: '替换文本或代码',
      title: '添加批注',
      preview: {
        annotateSelection: '批注所选内容',
        documentComment: '文档评论',
        minimizeEditor: '最小化批注编辑器',
        html: {
          decrease: '缩小 HTML 预览',
          increase: '放大 HTML 预览',
          pan: '拖动以平移 HTML 预览',
          reset: zoom => `从 ${zoom}% 重置 HTML 预览`,
          zoom: 'HTML 预览缩放'
        },
        image: {
          decrease: '缩小图像预览',
          deleteMarkup: '删除所选标记',
          externalResourcesBlocked: '已阻止外部 SVG 资源',
          increase: '放大图像预览',
          reset: zoom => `从 ${zoom}% 重置图像预览`,
          undoMarkup: '撤销标记',
          zoom: '图像预览缩放'
        },
        ocr: {
          label: 'OCR',
          language: 'OCR 语言',
          languages: { chi_sim: '简体中文', chi_tra: '繁体中文', eng: '英语', jpn: '日语' },
          recognizing: '正在识别文本…',
          unavailable: 'OCR 不可用'
        },
        pdf: {
          couldNotOpen: '无法打开 PDF',
          find: '查找',
          fit: '适应',
          incorrectPassword: '密码不正确',
          open: '打开 PDF',
          page: '页码',
          passwordProtected: '受密码保护的 PDF',
          search: '搜索 PDF',
          width: '宽度'
        },
        tex: { compilationFailed: 'TeX 编译失败', engineUnavailable: 'TeX 引擎不可用', updating: '正在更新渲染预览…' },
        tools: {
          arrow: '箭头',
          pan: '平移图像',
          pen: '画笔',
