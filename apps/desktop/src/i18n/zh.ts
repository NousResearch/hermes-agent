...
export const zh: Translations = {
  ...
  sidebar: {
    ...
    projects: {
      ...
      editFoldersTitle: '编辑文件夹',
      editFoldersDesc: '当磁盘上的文件夹被重命名或移动后,在此将其重新指向新位置。',
      editFoldersEmpty: '该项目尚无文件夹。',
      editFolderPick: '选择新路径…',
      editFolderSave: '移动',
      editFolderRevert: '撤销',
      editFolderRemove: '移除',
      editFolderUnremove: '保留',
      editFolderRemoved: '将被移除',
      editFolderConflict: '已有其它文件夹位于此路径。',
      editFolderChanged: '已修改',
      editFoldersDone: '文件夹已更新。',
      editFoldersFailed: '无法加载项目文件夹。',
      editFoldersMoveFailed: '无法移动文件夹',
