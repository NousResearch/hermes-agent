...
export const zh: Translations = {
  ...
  shell: {
    ...
    statusbar: {
      ...
      openAgents: '打开代理',
      sessionsLabel: '会话',
      sessionsActive: count => `${count} 个会话进行中`,
      sessionsActiveTitle: '有进行中工作的会话',
      agentsActive: count => `${count} 个代理`,
      tasks: '任务',
      tasksTitle: '终端与预览后台任务',
      tasksRunning: count => `${count} 个运行中`,
      tasksFailed: count => `${count} 个失败`,
      cron: '排程',
      openCron: '打开排程任务',
      turnRunning: '运行中',
