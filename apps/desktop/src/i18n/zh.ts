...
export const zh: Translations = {
  ...
  pet: {
    ...
    actionCenter: {
      title: '操作中心',
      count: n => `${n} 个待处理操作`,
      itemCount: (total, attention) => `${total} 项 · ${attention} 项需要处理`,
      open: '打开操作中心',
      close: '关闭操作中心',
      previous: '上一项',
      next: '下一项',
      ...
      unknownProfile: '默认配置',
      reasoning: '推理',
      queuedCount: count => `${count} 条已排队`,
      connectionConnecting: '正在连接',
      connectionOffline: '离线',
      connectionError: '连接错误',
      messageSession: '向会话发送消息',
      queueMessage: '将消息加入队列',
      liveMessagePlaceholder: '输入消息…',
      send: '发送',
      steer: '调整方向',
      queue: '排队',
      stop: '停止',
      acknowledge: '关闭',
      steerRejected: '无法调整正在运行的会话。请将消息加入队列，稍后发送。',
      queueRejected: '将此消息加入队列',
      steered: '已发送指令',
      queued: '消息已加入队列',
      stopped: '会话已停止',
      acknowledged: '已关闭'
