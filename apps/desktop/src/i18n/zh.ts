...
export const zh = defineLocale({
  ...
  settings: {
    ...
    config: {
      ...
      keepAwakeTitle: '代理运行期间保持电脑唤醒',
      keepAwakeDesc: '仅在代理回合运行时阻止系统休眠。屏幕仍可变暗。',
      closedDisplayTitle: '合上屏幕仍阻止系统休眠（实验性）',
      closedDisplayDesc: '仅限 macOS。需要一次性管理员设置，行为可能因 Mac 型号、电源和显示器而异。',
      closedDisplaySetupUnavailable: 'Power Protect 设置仅可在 macOS Desktop 中使用。',
      closedDisplaySetupFailed: 'Power Protect 设置已取消或失败。实验性选项仍保持关闭。',
