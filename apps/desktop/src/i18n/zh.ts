...
export const zh = defineLocale({
  ...
  assistant: {
    thread: {
      ...
      recoveryMissing: '历史中未见回复',
      recoveryUnfinished: '未见最终回复',
      recoveryPutBack: '放回输入框',
      recoveryHide: '隐藏',
      recoveryHidden: '消息已在本机隐藏',
      recoveryUndo: '撤销',
      recoveryActivityHint: '工具可能已经执行，再次发送可能重复操作。',
      recoveryHideHint: '仅隐藏本机显示，不删除模型历史。',
      recoveryAttachmentHint: '仅放回文字，发送前请重新添加附件。',
      react: '回应',
      dismissError: '关闭错误',
      errorLayers: {
        auth: '认证错误',
