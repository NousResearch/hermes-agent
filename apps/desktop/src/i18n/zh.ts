...
export const zh = defineLocale({
  ...
  ide: {
    ...
    noWorkspace: '未打开工作区',
    explorerTitle: '资源管理器',
    explorerEmptyTitle: '未打开工作区',
    explorerEmptyBody: '从项目窗口打开 IDE，即可载入该项目的工作区。',
    editorTitle: '编辑器',
    editorEmptyTitle: '未打开文件',
    editorEmptyBody: '在资源管理器中选择文件即可开始编辑。',
    chatTitle: '对话',
    chatEmptyTitle: '暂无 IDE 会话',
    chatEmptyBody: 'IDE 会话只显示在这里，并与当前工作区关联。新建会话即可与智能体协作。',
    browserTitle: '浏览器',
    browserEmptyTitle: '未打开页面',
    browserEmptyBody: '打开网址即可在此浏览，智能体可以与你一同操作页面。',
    toggleExplorer: '切换资源管理器',
    toggleChat: '切换对话',
    toggleBrowser: '切换浏览器',
    resizeExplorer: '调整资源管理器宽度',
    resizeChat: '调整对话宽度',
    resizeBrowser: '调整浏览器高度',
    refreshExplorer: '刷新资源管理器',
    explorerUnreadable: error => `无法读取此文件夹（${error}）。`,
    editorTabsLabel: '已打开的文件',
    closeTab: '关闭',
    closeTabLabel: name => `关闭 ${name}`,
    reloadFromDisk: '从磁盘重新加载',
    tooLargeTitle: '文件过大，无法在此编辑',
    tooLargeBody: '该文件超过 512 KB。请从对话预览或桌面编辑器中打开。',
    loadFailedTitle: '无法打开此文件',
    closeDirtyTitle: '有未保存的更改，仍要关闭吗？',
    closeDirtyBody: '此标签页有尚未保存到磁盘的编辑。',
    closeDirtyConfirm: '放弃更改',
    diskChangedTitle: '文件已在磁盘上更改',
    diskChangedBody: '其他操作（智能体运行或其他应用）编辑了此文件。现在保存将覆盖那些更改。',
    overwrite: '覆盖',
    chatTabsLabel: 'IDE 会话',
    chatNew: '新建 IDE 会话',
    chatRecent: '最近的 IDE 会话',
    chatCreateFailed: '无法启动 IDE 会话',
    browserTabsLabel: '浏览器标签页',
    browserOpen: '打开浏览器',
