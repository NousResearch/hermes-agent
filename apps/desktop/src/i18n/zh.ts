...
export const zh = defineLocale({
  ...
  settings: {
    ...
    appearance: {
      ...
      interfaceStyleTitle: 'GNOME 界面风格',
      interfaceStyleDesc: '使用克制的 Adwaita 风格，同时保持 Hermes 的功能和布局不变。',
      interfaceStyleTypographyTitle: 'Adwaita 字体',
      interfaceStyleTypographyDesc: '已安装时优先使用 Adwaita Sans，否则使用系统字体。',
      interfaceStyleControlsTitle: '柔和控件',
      interfaceStyleControlsDesc: '为按钮、标题栏和侧边栏选中项添加适度圆角。',
      interfaceStyleSurfacesTitle: '浮动界面',
      interfaceStyleSurfacesDesc: '为菜单和弹出框使用 GNOME 风格的间距、圆角和阴影。',
