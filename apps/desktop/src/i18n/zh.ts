...
export const zh: Translations = {
  ...
  sidebar: {
    ...
    row: {
      ...
      branchFrom: '分支',
      moveToProject: '移到项目…',
      moveProjectTitle: '将聊天移到项目',
      moveProjectDesc: title => `将“${title}”移到一个项目。之后的命令和工具将在该项目的工作目录中运行。`,
      moveProjectFailed: '无法移动聊天',
      moveProjectMissingWorkspace: '该项目没有工作目录。',
      moveProjectWrongProfile: '请先切换到该聊天所属的配置，再将它移到项目。',
      moveProjectsLoading: '正在加载项目…',
      moveProjectsEmpty: '没有找到带工作目录的项目。',
      movedToProject: name => `已移到 ${name}`,
      rename: '重命名',
      archive: '归档',
      newWindow: '新窗口',
      hideTabBar: '隐藏标签栏',
