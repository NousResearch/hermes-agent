...
export const zh: Translations = {
  ...
  cron: {
    ...
    reasoningLabel: '推理',
    reasoningInherit: '继承全局设置',
    reasoningInactive: '无代理任务中不启用',
    reasoningInactiveHint: '该设置会为此任务保留，但在无代理模式下不会生效。',
    reasoningInactiveWithValue: value => `${value}（未启用）`,
    reasoningInvalid: value => `${value}（无效；继承全局设置）`,
    reasoningOptions: {
      none: '关闭',
      minimal: '最少',
      low: '低',
