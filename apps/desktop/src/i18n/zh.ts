...
export const zh: Translations = {
  ...
  codingWorkspace: {
    ...
    noProject: "无项目",
    newWorktree: "新建工作树",
    existingWorktree: "现有工作树",
    currentCheckout: "当前检出",
    agentWorktree: "代理工作树",
    agentWorktreeNote: "此工作树由代理在对话期间创建。",
    newChatHere: "在此工作树中新建对话",
    projectFolder: "项目文件夹",
    initializeGit: "初始化 Git 仓库",
    initializeGitDescription: "以空的首次提交创建仓库。你的文件保持未跟踪。",
    initializeGitFailed: "无法初始化 Git 仓库",
    searchProjects: "搜索项目",
    noProjects: "没有匹配的项目",
    ...
    clean: "干净",
    detached: "分离的 HEAD",
    dirtyNotCopied: "未提交的源更改不会复制到新工作树。",
    createOnSend: "首次发送时创建，而非现在。",
    shared: "此检出可能与其他对话共享。更改不隔离。",
    preparing: "正在准备工作区",
    ...
    binding: "此对话保留在原工作区。",
    selectCheckout: "选择检出",
    folderFailed: "无法将此文件夹用作项目",
    unavailable: "对话连接到所属后端后才能选择工作区。",

    showControls: "显示编程控件",
    showControlsDescription: "在此配置的新对话输入框上方显示项目和工作位置。现有对话和侧栏偏好不变。",
    saveFailed: "无法保存编程控件设置",
  },
  common: {
    apply: '应用',
    back: '返回',
