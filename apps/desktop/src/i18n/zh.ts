...
export const zh = defineLocale({
  ...
  settings: {
    ...
    appearance: {
      ...
      autoSendTitle: '免提发送',
      autoSendDesc: '停止键入或听写后自动发送已编写的内容。按任意键即可取消。',
      autoSendDelayTitle: '免提延迟',
      autoSendDelayDesc: '输入框在最后一次按键或听写的词语后等待多久自动发送。',
      tipsTitle: '应用内提示',
  ...
  composer: {
    ...
    stop: '停止',
    send: '发送',
    autoSendCountdown: (seconds: number) => `${seconds} 秒后发送`,
    speaking: '讲话中',
    transcribing: '转写中',
    thinking: '思考中',
    muted: '已静音',
