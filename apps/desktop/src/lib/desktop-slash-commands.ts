...
/** Why a known IX Agency command has no desktop UI surface. */
...
const DESKTOP_COMMAND_SPECS: readonly DesktopCommandSpec[] = [
  ...
  { name: '/profile', description: 'Switch the active IX Agency profile', surface: action('profile') },
  ...
  { name: '/version', description: 'Show IX Agency Agent version', surface: exec() },
 ...
 * IX Agency' built-in slash commands — i.e. skill commands (`/gif-search`,
