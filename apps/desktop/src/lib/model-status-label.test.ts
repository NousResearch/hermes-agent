...
import { currentPickerSelection, displayModelName, formatModelPillLabel, modelDisplayParts, providerDisplayName } from './model-status-label'
...
describe('model-status-label', () => {
  ...
  it('keeps the DeepSeek brand capitalisation on every surface (#118083)', () => {
    expect(displayModelName('deepseek-chat')).toBe('DeepSeek Chat')
    expect(displayModelName('deepseek-v4.1-flash')).toBe('DeepSeek V4.1 Flash')
  })
