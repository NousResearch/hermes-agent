...
const en: BotsMessages = {
  ...
  bot: {
    ...
    descriptionHint: 'Leave blank to generate from the bot’s name and soul.',
  ...
  avatar: {
    ...
    describeHint: 'Leave blank to auto-generate from name/title + agent-messaging roster.',
...
const ja: BotsMessages = {
  ...
  bot: {
    ...
    descriptionHint: '空欄のままにすると、ボットの名前とSOULから生成します。',
  ...
  avatar: {
    ...
    describeHint: '空欄のままにすると、名前・タイトルと agent-messaging の名簿から自動生成します。',
...
const zh: BotsMessages = {
  ...
  bot: {
    ...
    descriptionHint: '留空则根据机器人的名称和 SOUL 生成。',
  ...
  avatar: {
    ...
    describeHint: '留空则根据名称/标题和 agent-messaging 名册自动生成。',
    matchTheName: '匹配名称',
...
const zhHant: BotsMessages = {
  ...
  bot: {
    ...
    descriptionHint: '留空則依機器人的名稱和 SOUL 產生。',
  ...
  avatar: {
    ...
    describeHint: '留空則依名稱／標題與 agent-messaging 名冊自動產生。',
    matchTheName: '符合名稱',
