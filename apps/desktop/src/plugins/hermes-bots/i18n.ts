...
const tr: BotsMessages = {
  editor: {
    fullConfigHint: 'Tam yapılandırma daha yeni bir ağ geçidi gerektirir (Hermes’i güncelledikten sonra yeniden başlatın).',
    liveCapabilities: 'Yetenekler (hemen uygulanır — beceriler, araçlar, MCP)',
    editSoul: 'SOUL.md (kişilik + ajan mesajlaşma protokolü)',
    remoteCapabilitiesHint: 'Uzak yetenekler daha yeni bir masaüstü gerektirir. Model ve SOUL değişiklikleri siz kaydedene dek beklemede kalır.',
    skillsEnabled: (enabled, total) => `Beceriler (${enabled}/${total} etkin)`,
    toolsetsEnabled: (enabled, total) =>
      `Araç setleri (${enabled}/${total} etkin — hepsinin işaretini kaldırmak varsayılanı geri yükler)`,
    mcpServers: 'MCP sunucuları',
    providerCustom: 'Sağlayıcı (Özel)',
    modelCustom: 'Model (Özel)',
    backToDropdowns: '← Açılır listelere dön',
    inheritLaunch: 'Devral (başlatma profili)',
    enterManually: '✏️ Manuel gir…',
    gatewayDefault: 'ağ geçidi varsayılanı',
    modelNameExample: 'örn. model adı',
    modelSwitchFailed: 'Model değişimi başarısız',
    newDescription: 'Kendi belleği, becerileri ve sohbeti olan, adlandırılmış bir takım arkadaşı. Diğer ajanlarınıza mesaj gönderebilir.',
    name: 'Ad',
    title: 'Başlık',
    description: 'Açıklama',
    createOn: 'Şurada oluştur',
    general: 'Genel',
    capabilities: 'Yetenekler',
    skills: 'Beceriler',
    tools: 'Araçlar',
    cloneFrom: 'Profilden klonla',
    freshProfile: 'Yeni profil (paket beceriler)',
    inheritedModel: 'başlatma profilinden devralındı',
    soul: 'SOUL.md (isteğe bağlı — üretilen kişiliğin yerine geçer)',
    shareKeys: 'Anahtarları ve hesapları ana profille paylaş',
    shareKeysOn: target => `${target} üzerindeki varsayılan profille anahtarları ve hesapları paylaş`,
    shareKeysHint: 'Abonelikler, OAuth girişleri ve API anahtarları paylaşılan kalır (kopyalanmaz), böylece token yenilemeleri birbirini geçersiz kılmaz. İzole bir anlık kopya için işareti kaldırın.',
    needsModel: "Henüz hazır bir model sağlayıcısı yok, bu yüzden tanıtımını atladı. Gelişmiş altından bir sağlayıcı ve model seçin.",
    configureModel: "Modeli yapılandır",
    createEmpty: 'Boş oluştur (paket becerileri atla)',
    nameTakenHint: 'O ad kullanılıyor — yetenekleri yapılandırmadan önce başka bir tane seçin.',
    nameFirstHint: 'Önce botu adlandırın — bu sekmeyi açtığınızda bir taslak profil oluşturulur (iptal ederseniz atılır).',
    newerDesktop: 'Beceriler daha yeni bir Hermes Desktop gerektirir.',
    newerGateway: 'Yetenek kataloğu daha yeni bir ağ geçidi gerektirir (Hermes’i güncelledikten sonra yeniden başlatın).',
    emptySkillsHint: '“Boş oluştur” işaretli — paket beceri kurulmayacak.',
    defaultToolsHint: 'Hepsini (veya hiçbirini) işaretli bırakmak varsayılan araç seti davranışını korur.',
    catalog: 'katalog',
    catalogInstalled: 'katalog · kurulu',
    mcpHint: 'Yapılandırılmış sunucular ana profilden kopyalanır; katalog girdileri paket MCP menüsüdür. API anahtarı gerektiren girdiler önce kurulumdan geçer (kimlik bilgileri paylaşılan anahtarlar ayarını izler).',
    creating: 'Oluşturuluyor…',
    createBot: 'Bot Oluştur',
    auto: 'Otomatik',
    autoHint: 'Otomatik — adı belirler',
    unlock: 'Kilidi aç',
    lockFace: 'Yüzü kilitle',
    lockedHint: 'Yüz kilitli — yeniden adlandırmak onu değiştirmez.',
    unlockedHint: 'Yüz adı izler.',
    noImageModel: 'Kullanılabilir görsel modeli yok. Az önce bir tane etkinleştirdiyseniz (veya Hermes’i güncellediyseniz), ağ geçidini yeniden başlatın: Ctrl+K → "Ağ geçidini yeniden başlat".',
    checkingImage: 'Görsel arka ucu kontrol ediliyor…',
    chooseImage: 'Bir görsel seçin…',
    editDescription: (name, profile) => `${name} (${profile}) için görünüm ve rol.`,
    nameTaken: name => `"${name}" adlı bir ajan zaten var.`,
    nameTakenOn: (name, target) => `${target} üzerinde "${name}" adlı bir ajan zaten var.`,
    currentConnection: name => `${name} (mevcut)`,
    remoteHint: target =>
      `Ajan ${target} üzerinde oluşturulur ve listede bir Bağlantılar botu olarak görünür. Sohbet o makineye yönlenir.`,
    cloneFromOn: target => `Profilden klonla (${target} üzerinde)`,
    catalogHint: source =>
      `${source} kaynağından katalog — işaretlenmemiş beceriler oluşturmadan sonra devre dışı kalır.`,
    sectionsFailed: sections => `Bazı bölümler başarısız oldu: ${sections}`,
    updated: name => `${name} güncellendi`,
    created: name => `"${name}" botu oluşturuldu`,
    createdOn: (name, target) => `"${name}" botu ${target} üzerinde oluşturuldu`
  },
  roster: {
    ...
    waitingForGateway: 'Ağ geçidi bağlantısı bekleniyor… (uzak ağ geçitleri birkaç saniye sürebilir; otomatik yeniden dener)'
  },
  sections: {
    ...
    deleted: (name, count) =>
      count === 0 ? `“${name}” silindi` : `“${name}” silindi — ${count} bot Atanmamış'a taşındı`,
    undo: 'Geri al'
  },
  bot: {
    newTitle: 'Yeni bot',
  ...
  group: {
    ...
    nameLabel: 'Grup adı',
    holdDetection: 'Durdurma yönergelerini algıla',
    holdDetectionHint: 'Oda mesajları, adı geçen üyeleri yeniden anılana kadar beklemeye alsın.',
    compressHistory: 'Geçmişi sıkıştır',
    compressHistoryHint: member =>
      `${member} üyesinin gizli oda geçmişini sıkıştır, böylece üye boş yanıtlarla başarısız olmayı bıraksın`,
    compressing: member => `${member} üyesinin oda geçmişi sıkıştırılıyor…`,
    compressDone: (member, compressed, detail) =>
      `${member} için ${compressed} oda oturumu sıkıştırıldı${detail ? ` — ${detail}` : ''}`,
    compressNothing: member => `${member} için sıkıştırılacak bir şey yok — henüz oda oturumu yok`,
    compressFailed: (member, error) => `${member} üyesinin oda geçmişi sıkıştırılamadı: ${error}`,
    ...
    slashCommandsUnsupported: 'Grup sohbetlerinde eğik çizgi komutları desteklenmez. Kullanmak için bir bireysel bot sohbeti açın.',
  ...
  tools: {
    installHint: name => `"${name}" kur ve yukarıdaki listeye ekle`,
    installed: name => `"${name}" becerisi kuruldu`,
    installFailed: name => `"${name}" kurulumu başarısız oldu`,
    searchHint: 'Topluluk + bilinen kaynaklarda aranıyor — ~10 sn sürebilir…',
    resizeHint: 'Yeniden boyutlandırmak için köşeyi sürükleyin.',
    addServerFailed: 'Sunucu eklenemedi',
    noTarget: 'Hedef profil yok',
    setKeyFailed: key => `${key} ayarlanamadı`,
    configured: name => `${name} yapılandırıldı`,
    authenticated: name => `${name} kimliği doğrulandı`,
    testFailed: 'Kurulumdan sonra sunucu testi başarısız',
    completeSignIn: 'Girişi tarayıcınızda tamamlayın...',
    needsSetup: keys =>
      `kurulum gerekiyor (${keys}) — uygulama içi kurulumu etkinleştirmek için ağ geçidini yeniden başlatın`,
    setUpDone: 'kuruldu ✓',
    saveTest: 'Kaydet ve test et',
  ...
  screen: {
    title: 'Ekran',
    menu: 'Ekranı Aç',
    unsupportedTitle: 'Bu ana makinede bot ekranı yok',
    unsupportedBody: 'Bot ekranları Linux ağ geçidi ana makinelerinde çalışır. Bu bot ana makinenin kendi ekranını kullanır.',
    notInstalledTitle: 'Ekran paketleri eksik',
    notInstalledBody: 'Ağ geçidi ana makinesi, bu bota ekran vermek için TigerVNC ve Xfce çekirdeğine ihtiyaç duyar. Ana makinede çalıştırın:',
    installHint: 'Ağ geçidi ana makinesinde Hermes’in çalıştığı kullanıcı olarak çalışır; sudo bir kez, Hermes üzerinden istenir.',
    install: 'Ana makineye kur',
    installing: 'Kuruluyor…',
    installCancelled: 'Kurulum iptal edildi: sudo parolası verilmedi.',
    installFailed: 'Kurulum başarısız. Yukarıdaki günlüğü okuyun veya komutu ana makinede kendiniz çalıştırın.',
    noPackageManager: 'Ağ geçidi ana makinesinde desteklenen bir paket yöneticisi (apt, dnf, pacman) bulunamadı.',
    portalTitle: 'Ekran',
    portalOpen: 'Aç',
    heroStopped: 'Ekran kapalı',
    heroNotInstalled: 'Bu ana makinede kurulu değil',
    heroConnecting: 'Ekran kontrol ediliyor…',
    heroStale: 'Son görülme — ekrana ulaşılamıyor',
    heroSuppressed: 'Biri kontroldeyken gizli',
    heroOpenLive: 'Canlı aç',
    heroInstall: 'Kur',
    heroStart: 'Başlat',
    portalWatching: 'Canlı · bot kontrolde',
    portalYouControl: 'Canlı · siz kontroldesiniz',
    portalOtherControls: 'Canlı · başka bir izleyici kontrolde',
    portalStopped: 'Durduruldu',
    portalNotInstalled: 'Ana makinede kurulu değil',
    portalUnsupported: 'Bu ana makinede kullanılamıyor',
    portalUnavailable: 'Ekranı kullanmak için botun Hermes’ini güncelleyin',
    unavailableTitle: 'Ekran daha yeni bir Hermes gerektirir',
    autoOpenMenu: 'Bot kullandığında Ekranı aç',
    autoOpenOnToast: name => `${name} botunun Ekranı, masaüstünü kullanmaya başladığında açılır`,
    autoOpenOffToast: name => `${name} botunun Ekranı, siz açana dek kapalı kalır`,
    stoppedTitle: 'Ekran kapalı',
    stoppedBody: 'Ne yaptığını izlemek ve gerektiğinde devralmak için bu botun masaüstünü başlatın.',
    start: 'Ekranı başlat',
    attaching: 'Ekrana bağlanılıyor…',
    streamLost: 'Ekran akışı sona erdi',
    reconnect: 'Yeniden bağlan',
    takeOver: 'Devral',
    handBack: 'Geri ver',
    handBackForce: 'Geri ver (zorla)',
    handBackForceHint: 'Artık burada olmayan bir izleyicinin (örn. yeniden yükleme sonrası) tuttuğu kilidi serbest bırak.',
    openNeedsUpdate: 'Bot ekranlarını açmak için Hermes Desktop’ı güncelleyin.',
    youControl: 'Siz kontroldesiniz',
    otherControls: 'Başka bir izleyici kontrolde',
    agentControls: 'Bot kontrolde',
    controlTaken: 'Başka bir izleyici kontrolü aldı. Yalnızca izleniyor.'
  },
  cron: {
    untitled: 'Adsız iş',
    nameNul: 'İş adı NUL (U+0000) içeremez.',
    instructionNul: 'İş talimatı NUL (U+0000) içeremez.',
    minutesFromNow: 'dakika sonra',
    hoursFromNow: 'saat sonra',
    daysFromNow: 'gün sonra',
    stopAfter: 'Şundan sonra durdur',
    runsHint: 'çalıştırma (boş = sonsuza dek)',
    detailDescription: 'Bu işin ne çalıştırdığı ve bir sonraki çalıştırma zamanı.',
    status: 'Durum',
    active: 'Etkin',
    paused: 'Duraklatıldı',
    schedule: 'Zamanlama',
    rawSchedule: 'Zamanlama (ham)',
    repeat: 'Tekrar',
    ...
    succeeded: 'Başarılı',
    failed: 'Başarısız',
    deliveryFailed: 'Çalıştı ama teslim başarısız',
    blockedConfig: 'Yapılandırma tarafından engellendi (çalıştırılmadı)',
    legacyUnsafe: 'Güvenlik için duraklatıldı: tekrar çalıştırmadan önce bu eski işi silip yeniden oluşturun.',
    filterHint: 'Bu profilde zamanlanmış işler var ama hiçbiri bu bot için etiketlenmemiş. Burada göstermek için bir işi "[bot:<ad>] …" olarak adlandırın veya aşağıdaki Cron\'da görün.',
    ...
    createDesc: bot =>
      `${bot} botunun bir zamanlamayla çalıştırdığı tekrarlayan görev. Çalıştırmalar kendi sohbet geçmişine düşer.`,
    instruction: 'Talimat',
    ...
    continuity: 'Süreklilik: her çalıştırma bir önceki çalıştırmanın çıktısını görür (yinelenenleri ayıkla, kaldığı yerden devam et)',
