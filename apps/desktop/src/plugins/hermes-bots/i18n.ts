 ...
 *
 * Locales follow kanban: `en` / `ja` / `zh` / `zh-hant` / `pl`. Arabic falls through
...
const pl: BotsMessages = {
  roster: {
    search: 'Szukaj botów i czatów grupowych',
    searchPlaceholder: 'Szukaj botów i czatów grupowych…',
    newBotOrGroup: 'Nowy bot lub czat grupowy',
    groupChats: 'Czaty grupowe',
    emptyTitle: 'Nie ma jeszcze botów',
    emptyDesc: 'Utwórz swojego pierwszego bota.',
    noMatchQuery: query => `Żaden bot ani czat grupowy nie pasuje do „${query}”`,
    noMatchQueryOn: (query, gateway) => `Żaden bot ani czat grupowy na ${gateway} nie pasuje do „${query}”`,
    noMatchFiltersOn: gateway => `Żaden bot ani czat grupowy na ${gateway} nie pasuje do tych filtrów`,
    noMatchFilters: 'Żaden bot ani czat grupowy nie pasuje do tych filtrów.',
    clearFilters: 'Wyczyść filtry',
    allHidden: 'Wszystkie boty są ukryte',
    allHiddenDesc: 'Działają dalej i zachowują swoją historię.',
    showHidden: 'Pokaż ukryte boty',
    noHiddenMatch: 'Żaden ukryty bot nie pasuje do tych filtrów.',
    hiddenFromRoster: 'Ukryty na liście',
    pinned: 'Przypięte',
    needsAttention: 'wymaga uwagi',
    needsInput: 'Czeka na Twoją odpowiedź',
    botsAndGroups: 'Boty i czaty grupowe',
    botsOnly: 'Tylko boty',
    groupsOnly: 'Tylko czaty grupowe',
    anyActivity: 'Dowolna aktywność',
    activeNow: 'Aktywne teraz',
    recentlyActive: 'Ostatnio aktywne',
    older: 'Starsze',
    gatewayRemoved: 'Brama usunięta',
    onDemand: 'Na żądanie',
    ready: 'Gotowe',
    ...
    rosterUnavailable: reason =>
      `Lista niedostępna: ${reason}. Jeśli Twoja brama jest starsza niż profiles.list, zaktualizuj Hermesa i zrestartuj bramę.`,
    waitingForGateway:
      'Czekam na połączenie z bramą… (zdalne bramy mogą potrzebować kilku sekund; ponawiam automatycznie)'
  },
  sections: {
    newSection: 'Nowa sekcja',
    newTitle: 'Nowa sekcja',
    renameTitle: 'Zmiana nazwy sekcji',
    nameLabel: 'Nazwa sekcji',
    namePlaceholder: 'np. Klienci',
    create: 'Utwórz',
    rename: 'Zmień nazwę…',
    moveUp: 'Przenieś w górę',
    moveDown: 'Przenieś w dół',
    unassigned: 'Nieprzypisane',
    options: name => `Opcje sekcji ${name}`,
    headingTip: 'Upuść tu boty · kliknij dwukrotnie, aby zmienić nazwę',
    emptyHint: 'Przeciągnij tu boty',
    moveTo: 'Przenieś do sekcji',
    newSectionEllipsis: 'Nowa sekcja…',
    removeFromSection: 'Usuń z sekcji',
    deleted: (name, count) =>
      count === 0
        ? `Usunięto „${name}”`
        : `Usunięto „${name}” — ${count} ${count === 1 ? 'bot przeniesiony' : 'botów przeniesionych'} do Nieprzypisanych`,
    undo: 'Cofnij'
  },
  bot: {
    newTitle: 'Nowy bot',
    ...
    editMenu: 'Edytuj…',
    helpPromptPlaceholder: 'W czym ten bot ma pomagać?',
    descriptionHint: 'Zostaw puste, aby wygenerować z nazwy i opisu bota.',
    newChatWith: 'Nowy czat z tym botem',
    openBotChat: 'Otwórz czat bota',
    duplicate: 'Duplikuj',
    duplicateFailed: 'Duplikowanie nie powiodło się',
    deleteTitle: 'Usunąć bota i profil?',
    removeFromAllGroups: 'Usuń ze wszystkich grup',
    createFirstHint: 'Otwórz panel Boty i kliknij „Nowy bot”.',
    createFailed: 'Nie udało się jeszcze utworzyć profilu',
    advanced: 'Zaawansowane',
    advancedHint: 'Zaawansowane — model, umiejętności, zestawy narzędzi, SOUL.md',
    advancedFailed: 'Konfiguracja zaawansowana nie powiodła się',
    openAnotherChatUnsupported: 'Zaktualizuj Hermes Desktop, aby otworzyć kolejny czat bota.',
    remoteConnectionsUnsupported: 'Zaktualizuj Hermes Desktop, aby rozmawiać z botami na innych połączeniach.',
    chatEmpty: 'Napisz coś, aby zacząć.',
    kickoff: 'Cześć, opowiedz mi o sobie!'
  },
  avatar: {
    classicShapes: 'Klasyczne kształty',
    blobFromName: 'Twarz-plama — rysowana z nazwy bota',
    unlockFollowsName: 'Odblokuj — twarz znów podąża za nazwą bota',
    randomize: 'Losuj',
    tabBot: 'Bot',
    tabGenerate: 'Generuj',
    upload: 'Wgraj',
    tabPet: 'Zwierzak',
    removeImage: 'Usuń obraz — użyj kształtu',
    removeBackToShape: 'Usuń — wróć do awatara z kształtu',
    describePlaceholder: 'Opisz swojego awatara…',
    describeHint:
      'Zostaw puste, aby wygenerować automatycznie z nazwy/tytułu/opisu i listy botów w komunikacji agentów.',
    matchTheName: 'Dopasuj do nazwy',
    pickPet: 'Wybierz zwierzaka na zdjęcie profilowe tego bota.',
    petLoadFailed: 'Nie udało się wczytać tego zwierzaka — spróbuj innego.',
    imageTooLarge: 'Obraz za duży (maks. 15 MB).',
    generationFailed: 'Generowanie awatara nie powiodło się',
    savedLocally: 'Zapisano wygląd lokalnie; zapis zdalny nie powiódł się',
    savedLocallyDescriptionFailed: 'Zapisano wygląd lokalnie; aktualizacja opisu nie powiodła się',
    generate: 'Generuj',
    generating: 'Generowanie…'
  },
  group: {
    newTitle: 'Nowy czat grupowy',
    manageDesc: 'Bot może należeć do wielu czatów grupowych. Członkostwa synchronizują się na każdą maszynę.',
    manageTitle: 'Zarządzaj grupami',
    settingsTitle: 'Ustawienia grupy',
    settingsDesc: 'Zmień nazwę grupy albo ustaw zdjęcie pokoju. Członkowie i historia zostają zachowani.',
    nameLabel: 'Nazwa grupy',
    searchToAdd: 'Szukaj botów do dodania',
    searchToAddPlaceholder: 'Szukaj botów do dodania…',
    removeFromSelection: 'Usuń z zaznaczenia',
    disbandTitle: 'Rozwiązać czat grupowy?',
    deleteTitle: 'Usunąć czat grupowy?',
    deleteAction: 'Usuń',
    composerPlaceholder: 'Napisz coś — każdy bot w tej grupie słyszy pokój.',
    attachHint: 'Załącz pliki — zobaczy je każdy odpowiadający bot',
    newThread: 'Nowy wątek',
    reply: 'Odpowiedz',
    replyInThread: 'Odpowiedz w wątku',
    replyInThreadPlaceholder: 'Odpowiedz w wątku…',
    openThread: 'Otwórz ten wątek',
    collapseThread: 'Zwiń wątek',
    collapseThreadLabel: 'Zwiń ten wątek',
    activity: 'Aktywność',
    noActivityYet: 'W tej turze nie ma jeszcze aktywności.',
    showActivity: 'Pokaż aktywność pokoju',
    hideActivity: 'Ukryj aktywność pokoju',
    stop: 'Zatrzymaj',
    stopHint: 'Zatrzymaj to uruchomienie — przerywa botowi na turze i wstrzymuje pozostałych',
    allHeldStatus: count => `Wszystkie boty (${count}) są wstrzymane`,
    heldMembersStatus: members => `Wstrzymani: ${members}`,
    holdReleaseHint: 'Wspomnij wstrzymanego bota albo wyślij @all resume, aby ich zwolnić.',
    needsYourInput: 'Bot w tym czacie grupowym czeka na Twoją odpowiedź',
    pictureGenerationFailed: 'Generowanie zdjęcia grupy nie powiodło się',
    nameTaken: name => `Grupa o nazwie „${name}” już istnieje.`,
    memberCount: count => `botów: ${count}`,
    settingsHint: group => `Ustawienia grupy — zmień nazwę ${group} albo ustaw zdjęcie pokoju`,
    settingsLabel: group => `Ustawienia grupy ${group}`,
    disbandHint: group => `Rozwiąż czat grupowy ${group}`,
    disbandLabel: group => `Rozwiąż ${group}`,
    disbandAction: 'Rozwiąż',
    disbanding: 'Rozwiązywanie…',
    disbandDone: 'Rozwiązano',
    disbanded: group => `Rozwiązano „${group}”`,
    disbandDescPrefix: 'To usuwa grupowanie ',
    disbandDescSuffix: count =>
      ` z jej botów (${count}) i czyści wspólny log pokoju. Same boty i ich sesje w tej grupie zostają zachowane.`,
    stopped: group => `Zatrzymano ${group} — pozostałe tury czekają, aż wznowisz`,
    removeAttachment: 'Usuń załącznik',
    threadFallback: 'Wątek',
    replyCount: replies => `${replies} ${replies === 1 ? 'odpowiedź' : 'odpowiedzi'}`,
    dropToThread: 'Upuść, aby załączyć do tej odpowiedzi w wątku',
    dropToRoom: 'Upuść, aby załączyć — zobaczy to każdy odpowiadający bot',
    waitingForAnswer: 'Czekam na Twoją odpowiedź…',
    memberThinking: name => `${name} myśli…`,
    roomWorking: 'Pokój pracuje…',
    messageRoom: group => `Napisz do ${group}`,
    newThreadPlaceholder: group => `Nowy wątek w ${group}… (@nazwa kieruje do bota, @everyone do wszystkich)`,
    everyoneMeta: 'Każdy bot w pokoju',
    commandApproval: 'zgoda na polecenie',
    answerFailed: (handle, error) => `Nie udało się wysłać odpowiedzi do @${handle}: ${error}`,
    wantsToRunCommand: handle => `@${handle} chce uruchomić polecenie:`,
    asks: handle => `@${handle} pyta:`,
    answerTo: member => `Odpowiedz @${member}`
  },
  tools: {
    skillsHub: 'Centrum umiejętności Hermesa',
    filterSkills: 'Filtruj umiejętności…',
    searchHub: 'Szukaj w centrum (społeczność i znane źródła)…',
    noMcpServers: 'Brak skonfigurowanych serwerów MCP i pozycji w katalogu.'
  },
  cron: {
    filterHint:
      'W tym profilu są zaplanowane zadania, ale żadne nie jest otagowane dla tego bota. Nazwij zadanie „[bot:<nazwa>] …”, aby pojawiło się tutaj, albo znajdź je w sekcji Cron poniżej.',
    needsRosterFirst: 'Ten bot musi najpierw pojawić się na liście.',
    staleNotice: 'Nie udało się odświeżyć zaplanowanych zadań. Pokazuję ostatnią listę, jaką mieliśmy.',
    readFailure: 'Lista prawdopodobnie nadal istnieje — to był błąd odczytu, a nie usunięcie.',
    createDesc: bot =>
      `Cykliczne zadanie, które ${bot} wykonuje według harmonogramu. Wyniki trafiają do jego historii czatu.`,
    instruction: 'Instrukcja',
    whenToRun: 'Kiedy uruchamiać',
    dayOfMonth: 'Dzień miesiąca',
    sendResultsTo: 'Wyślij wyniki do',
    runHistoryOnly: 'Tylko historia uruchomień',
    botChatTarget: bot => `czat bota ${bot} (bot odpowiada)`,
    continuity:
      'Ciągłość: każde uruchomienie widzi wynik poprzedniego (bez powtórek, kontynuuje od miejsca, w którym skończyło)',
    onceIn: when => `Raz (${when})`,
    everyNDays: days => `Co ${days} dni`,
    everyNHours: hours => `Co ${hours} godz.`,
    everyNMinutes: minutes => `Co ${minutes} min`,
    freqOnce: 'Raz, za…',
    freqHourly: 'Co godzinę',
    freqDaily: 'Codziennie',
    freqWeekdays: 'W dni robocze',
    freqWeekly: 'Co tydzień',
    freqMonthly: 'Co miesiąc',
    freqInterval: 'Co określony czas',
    freqAdvanced: 'Zaawansowane…',
    unitMinutes: 'minut(y)',
    unitHours: 'godzin(y)',
    unitDays: 'dni',
    runsOnce: (count, unit) => `Uruchomi się raz, za ${count} ${unit}`,
    runsHourly: 'Uruchamia się o pełnej godzinie',
    runsDaily: time => `Uruchamia się codziennie o ${time}`,
    runsWeekdays: time => `Uruchamia się od poniedziałku do piątku o ${time}`,
    runsWeekly: (day, time) => `Uruchamia się w każdy ${day} o ${time}`,
    runsMonthly: (day, time) => `Uruchamia się ${day}. dnia każdego miesiąca o ${time}`,
    runsInterval: (count, unit) => `Uruchamia się co ${count} ${unit}`,
    runsRaw: 'Surowy harmonogram — każde Nm/Nh/Nd albo 5-polowy cron',
    timesTotal: count => `, łącznie ${count} raz(y)`
  }
}

export const BOTS_LOCALES: PluginLocaleBundles = { en, ja, zh, 'zh-hant': zhHant, pl }
