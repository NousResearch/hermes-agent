...
const pl: KanbanMessages = {
  nav: 'Kanban',
  openBoard: 'Kanban: otwórz tablicę',
  newTaskCommand: 'Kanban: nowe zadanie',
  countTip: (running, ready) => `Kanban — w trakcie: ${running}, gotowych: ${ready}`,
  col: {
    triage: { label: 'Triaż', help: 'Surowe pomysły — specyfikator dopracowuje opis.' },
    todo: { label: 'Do zrobienia', help: 'Czeka na zależności albo jest nieprzypisane.' },
    scheduled: { label: 'Zaplanowane', help: 'Czeka na nadejście zaplanowanego terminu.' },
    ready: {
      label: 'Gotowe',
      help: 'Zależności spełnione — przypisz profil, a dyspozytor uruchomi zadanie.'
    },
    running: {
      label: 'W trakcie',
      help: 'Przejęte przez wykonawcę — pracuje nad tym agent. Ustawiane przez dyspozytora.'
    },
    blocked: { label: 'Zablokowane', help: 'Wykonawca poprosił o decyzję człowieka.' },
    review: { label: 'Przegląd', help: 'Agent recenzujący sprawdza pracę. Ustawiane przez dyspozytora.' },
    done: { label: 'Zrobione', help: 'Ukończone; zależne zadania potomne stają się gotowe.' },
    archived: { label: 'Zarchiwizowane', help: 'Ukryte w domyślnym widoku tablicy.' }
  },
  locked: {
    review: 'Przegląd ustawia dyspozytor, gdy agent recenzujący przejmuje kartę.',
    running: 'Stan „w trakcie” ustawia dyspozytor, gdy wykonawca przejmuje kartę.',
    scheduled: 'Zaplanowane wymaga terminu wybudzenia — ustawiają go agenci; nie da się tam przeciągnąć karty.'
  },
  arcRunning: 'Agent właśnie nad tym pracuje.',
  arcStale: 'Przejęte, ale od ponad 2 minut brak pulsu wykonawcy — dyspozytor odzyska kartę.',
  title: 'Kanban',
  orchestrationSettings: 'Ustawienia orkiestracji',
  newTask: 'Nowe zadanie',
  filterCards: 'Filtruj karty…',
  noMatch: 'Żadne zadanie nie pasuje do filtrów',
  noTasks: 'Brak zadań na tej tablicy',
  open: 'Otwórz',
  select: modifier => `Zaznacz (${modifier}+kliknięcie)`,
  deselect: 'Odznacz',
  moveTo: label => `Przenieś do: ${label}`,
  delete: 'Usuń',
  reviewChecking: 'Agent recenzujący sprawdza ukończoną pracę.',
  attachedTip: name => `${name} jest podpięty — dyspozytor przekaże to przy następnym cyklu (≤1 min).`,
  orchestratorTip: name => `${name} (orkiestrator) przejmie to w następnym cyklu i napisze specyfikację.`,
  autoAssignTip: name => `Automatyczne przypisanie do „${name}” (kanban.default_assignee) w następnym cyklu.`,
  wontRun: 'nie uruchomi się',
  wontRunTip:
    'Gotowe karty uruchamiają się dopiero po przypisaniu profilu. Otwórz kartę i wskaż osobę przypisaną albo ustaw domyślnego wykonawcę w ustawieniach orkiestracji.',
  noHeartbeat: 'brak pulsu',
  expand: label => `Rozwiń ${label}`,
  collapse: label => `Zwiń ${label}`,
  newTaskIn: label => `Nowe zadanie w: ${label}`,
  empty: 'Pusto',
  ...
  groupRunning: 'Grupuj „w trakcie” według profilu',
  nSelected: n => `zaznaczonych: ${n}`,
  moveToShort: 'Przenieś do',
  assign: 'Przypisz',
  unassignAction: 'Usuń przypisanie',
  archive: 'Archiwizuj',
  clearSelection: 'Wyczyść zaznaczenie (Esc)',
  refused: 'odrzucono',
  bulkFailed: (failed, total, err) =>
    `${failed} z ${total} nie powiodło się — ${err}. Nieudane karty pozostają zaznaczone.`,
  titlePlaceholderTriage: 'Zgrubny pomysł — specyfikator go dopracuje',
  titlePlaceholder: 'Tytuł',
  descPlaceholder: 'Opis (opcjonalny)',
  priority: 'Priorytet',
  workspace: 'Przestrzeń robocza',
  boardDefaultSuffix: ' · domyślne tablicy',
  workspaceOverride: 'Ścieżka przestrzeni roboczej (opcjonalne nadpisanie)',
  model: 'Model',
  modelInherit: 'Domyślny profilu',
  modelClear: 'Wyczyść nadpisanie modelu',
  modelHint:
    'Uruchamia to zadanie na wskazanym modelu i z wybraną głębokością myślenia. Puste = ustawienia przypisanego profilu.',
  workspaceInherit: 'Dziedziczy katalog projektu tablicy',
  workspaceInheritDir: dir => `Zostaw puste, aby odziedziczyć ${dir}`,
  workspaceInheritGeneric: 'Zostaw puste, aby odziedziczyć katalog projektu tablicy.',
  assignee: 'Przypisany',
  defaultOption: name => `${name} (domyślny)`,
  parkedOption: 'nieprzypisane (odstawione — nie uruchomi się)',
  skills: 'Umiejętności (po przecinku)',
  skillsPlaceholder: 'translation, github',
  parent: 'Zadanie nadrzędne (blokuje do czasu ukończenia)',
  noParent: '— brak nadrzędnego —',
  goalMode: 'Tryb celu (wykonawca pracuje w pętli, aż sędzia uzna zadanie za ukończone)',
  creating: 'Tworzenie…',
  createTask: 'Utwórz zadanie',
  cancel: 'Anuluj',
  save: 'Zapisz',
  estimate: 'Oszacuj',
  estimateEffort: 'Oszacuj nakład pracy',
  estimating: 'Szacowanie…',
  reEstimate: 'Oszacuj ponownie',
  makesModelCall: 'wykonuje wywołanie modelu',
  estimateTip: 'Zgrubne oszacowanie tokenów i złożoności z modelu pomocniczego — wykonuje wywołanie modelu.',
  estimateTipLong:
    'Wykonuje szybkie wywołanie modelu pomocniczego, aby oszacować tokeny i złożoność. To orientacyjna wskazówka, a nie rachunek.',
  roughEstimate: 'Zgrubne oszacowanie',
  tokUnit: 'tok.',
  couldNotEstimate: 'Nie udało się oszacować',
  complexity: { S: 'Mała', M: 'Średnia', L: 'Duża' },
  introBody:
    'To nie Ty uruchamiasz karty — robią to agenci. Wstaw kartę do Gotowych z przypisanym profilem, a agent przejmie ją w ciągu minuty. Bez przypisania nie ma uruchomienia. Triaż: agent najpierw przepisuje pomysł na porządne zadanie. Do zrobienia: czeka na inne karty. Zaplanowane: czeka na zegar. W trakcie i Przegląd: tory agentów, ręce przy sobie. Zablokowane: czeka na Ciebie. Wyniki wracają na kartę.',
  introGotIt: 'Rozumiem',
  evtCreated: (where, assignee) =>
    `utworzono${where ? ` w ${where}` : ''}${assignee ? ` · przypisano do ${assignee}` : ''}`,
  evtMovedTo: col => `przeniesiono do ${col}`,
  evtParentReopened: parent => `zadanie nadrzędne ${parent} zostało otwarte ponownie`,
  evtAssignedTo: assignee => `przypisano do ${assignee}`,
  evtUnassigned: 'usunięto przypisanie',
  evtCommentBy: author => `komentarz od ${author}`,
  evtClaimedReview: 'przejęte przez agenta recenzującego',
  evtClaimedWorker: 'przejęte przez wykonawcę',
  evtWorkerStarted: 'wykonawca wystartował',
  evtCompleted: 'ukończono',
  evtBlocked: 'zablokowane — wymaga decyzji człowieka',
  evtUnblocked: col => `odblokowano${col ? ` → ${col}` : ' → Gotowe'}`,
  evtReclaimed: 'odzyskane — wróciło do kolejki',
  evtSpecified: 'specyfikację napisał agent triażu',
  evtPromoted: 'zależności ukończone — przeniesiono do Gotowych',
  evtScheduled: 'zaplanowano na później',
  evtArchived: 'zarchiwizowano',
  evtReprioritized: priority => `priorytet ustawiony na ${priority}`,
  someone: 'ktoś',
  metaPriority: 'Priorytet',
  metaTenant: 'Najemca',
  metaCreatedBy: 'Utworzone przez',
  metaCreated: 'Utworzono',
  metaWorkerPid: 'PID wykonawcy',
  readyUnassignedTitle: 'Gotowe, ale nieprzypisane — ta karta nigdy się nie uruchomi.',
  readyUnassignedBody:
    'Dyspozytor przejmuje tylko gotowe karty, które mają przypisany profil. Wybierz profil w polu Przypisany powyżej (albo ustaw domyślnego wykonawcę w ustawieniach orkiestracji), a zadanie ruszy w ciągu minuty.',
  diagnosticsN: n => `Diagnostyka · ${n}`,
  commandCopied: 'Skopiowano polecenie',
  description: 'Opis',
  editDescription: 'Edytuj opis',
  cancelEdit: 'Anuluj edycję',
  noDescription: 'Brak opisu.',
  result: 'Wynik',
  latestSummary: 'Najnowsze podsumowanie',
  dependencies: 'Zależności',
  blockedBy: 'Zablokowane przez',
  blocks: 'Blokuje',
  comments: n => `Komentarze · ${n}`,
  commentsHelpRunning:
    'To zadanie jest w trakcie. Twoja notatka trafia do bieżącej tury wykonawcy w ciągu kilku sekund — bez zabawy w blokowanie i odblokowywanie. „Wstaw do kolejki z notatką” zamiast tego uruchamia zadanie od nowa z Twoją notatką w kontekście.',
  commentsHelp:
    'Komentarze trafiają do wątku zadania. Gdy wykonawca przejmie zadanie, przeczyta je jako część swojego kontekstu.',
  send: 'Wyślij',
  comment: 'Komentarz',
  messageWorker: 'Napisz do działającego wykonawcy…',
  addComment: 'Dodaj komentarz…',
  deliveredLive: 'Dostarczone działającemu wykonawcy w ciągu kilku sekund.',
  requeueWithNote: 'Wstaw do kolejki z notatką',
  notePosted: 'Notatka dodana — zadanie wróciło do kolejki',
  activity: n => `Aktywność · ${n}`,
  runs: n => `Uruchomienia · ${n}`,
  workerLog: 'Log wykonawcy',
  workerLogTail: 'Log wykonawcy · końcówka',
  attachments: n => `Załączniki · ${n}`,
  noAttachments: 'Brak załączników.',
  uploadAttachment: 'Wyślij załącznik',
  taskActions: 'Akcje zadania',
  copyTaskId: 'Kopiuj identyfikator zadania',
  copyTitle: 'Kopiuj tytuł',
  copiedId: id => `Skopiowano ${id}`,
  copiedTitle: 'Skopiowano tytuł',
  close: 'Zamknij',
  working: 'pracuje',
  board: 'Tablica',
  newBoard: 'Nowa tablica',
  newBoardDots: 'Nowa tablica…',
  exportDots: 'Eksportuj…',
  importDots: 'Importuj…',
  renameDots: 'Zmień nazwę…',
  settingsDots: 'Ustawienia…',
  exportBoardTitle: 'Eksportuj tablicę…',
  importBoardTitle: 'Importuj tablicę…',
  boardExported: path => `Tablicę wyeksportowano do ${path}`,
  boardImported: name => `Zaimportowano ${name}`,
  boardImportedAs: slug => `Ta nazwa była zajęta — zaimportowano jako ${slug}`,
  renameBoardTitle: 'Zmiana nazwy tablicy',
  deleteBoardTitle: name => `Usunąć „${name}”?`,
  deleteBoardConfirm:
    'Tablica jest archiwizowana, a nie kasowana — jej zadania i załączniki zostają na dysku i można je przywrócić.',
  boardArchived: path => `Tablicę zarchiwizowano w ${path}`,
  boardSettingsFor: name => `Ustawienia tablicy — ${name}`,
  name: 'Nazwa',
  boardNamePlaceholder: 'Nazwa tablicy',
  slug: slug => `slug: ${slug}`,
  project: 'Projekt',
  noProject: 'Brak projektu (tymczasowe piaskownice)',
  projectHintPre:
    'Nowe zadania działają w repozytorium projektu (osobne worktree na zadanie); każde zadanie nadal może nadpisać swoją przestrzeń roboczą przy tworzeniu. Projektami zarządzasz przez ',
  projectHintCmd: 'hermes project',
  createBoard: 'Utwórz tablicę',
  orchestratorProfile: 'Profil orkiestratora',
  defaultAssignee: 'Domyślnie przypisany',
  defaultParen: '(domyślny)',
  autoDecompose: 'Automatycznie rozbijaj zadania z triażu',
  profileDescriptions: 'Opisy profili',
  profileDescriptionsHint:
    'Opisy kierują routingiem dekompozytora. Wygeneruj je automatycznie modelem pomocniczym albo napisz własne.',
  profileGoodAt: 'W czym ten profil jest dobry?',
  auto: 'Auto',
  notify: {
    completedTitle: 'Zadanie ukończone',
    blockedTitle: 'Zadanie zablokowane — wymaga Twojej decyzji',
    blockLoopTitle: 'Zadanie trafiło do triażu — wymaga decyzji',
    gaveUpTitle: 'Zadanie się poddało',
    crashedTitle: 'Wykonawca padł — ponowię próbę',
    timedOutTitle: 'Przekroczono czas zadania — ponowię próbę',
    openKanban: 'Otwórz Kanban',
    artifacts: (n: number) => `${n} artefaktów`
  }
}

/** Registered via `ctx.i18n.register` at plugin load (disposer tracked). */
export const KANBAN_LOCALES: PluginLocaleBundles = { en, ja, zh, 'zh-hant': zhHant, pl }
