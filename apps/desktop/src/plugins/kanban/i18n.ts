...
const tr: KanbanMessages = {
  ...
  col: {
    triage: { label: 'Triyaj', help: 'Ham fikirler — bir belirleyici spesifikasyonu detaylandırır.' },
    todo: { label: 'Yapılacak', help: 'Bağımlılıkları bekliyor veya atanmamış.' },
    scheduled: { label: 'Zamanlanmış', help: 'Zamanlanmış bir anın gelmesini bekliyor.' },
    ready: { label: 'Hazır', help: 'Bağımlılıklar karşılandı — bir profil atayın, sevk edici çalıştırsın.' },
    running: { label: 'Çalışıyor', help: 'Bir işçi tarafından alındı — bir ajan üzerinde. Sevk edici tarafından ayarlanır.' },
    blocked: { label: 'Engellendi', help: 'İşçi insan girdisi istedi.' },
    review: { label: 'İnceleme', help: 'Bir inceleme ajanı işi kontrol ediyor. Sevk edici tarafından ayarlanır.' },
    done: { label: 'Bitti', help: 'Tamamlandı; bağımlı alt görevler hazır olur.' },
    archived: { label: 'Arşivlendi', help: 'Varsayılan pano görünümünden gizlendi.' }
  },
  locked: {
    review: 'İnceleme, bir inceleme ajanı kartı aldığında sevk edici tarafından girilir.',
    running: 'Çalışıyor, bir işçi kartı aldığında sevk edici tarafından ayarlanır.',
    scheduled: 'Zamanlanmış bir uyanma zamanı gerektirir — ajanlar ayarlar; sürüklenerek girilemez.'
  },
  arcRunning: 'Bir ajan şu anda bunun üzerinde çalışıyor.',
  arcStale: 'Alındı ama 2+ dakikadır işçi kalp atışı yok — sevk edici yeniden alacak.',
  title: 'Kanban',
  ...
  moveTo: label => `${label} sütununa taşı`,
  delete: 'Sil',
  reviewChecking: 'Bir inceleme ajanı tamamlanan işi kontrol ediyor.',
  attachedTip: name => `${name} atandı — sevk edici bir sonraki tıkında (≤1dk) devreder.`,
  orchestratorTip: name => `${name} (orkestratör) bir sonraki tıkta bunu alır ve spesifikasyonu yazar.`,
  autoAssignTip: name => `Bir sonraki sevk tıkında “${name}” profiline (kanban.default_assignee) otomatik atanır.`,
  wontRun: 'çalışmaz',
  wontRunTip:
    'Hazır kartlar yalnızca bir profil atandığında çalışır. Kartı açıp bir atanan belirleyin veya orkestrasyon ayarlarında varsayılan bir atanan yapılandırın.',
  noHeartbeat: 'kalp atışı yok',
  expand: label => `${label} genişlet`,
  collapse: label => `${label} daralt`,
  ...
  refused: 'reddedildi',
  bulkFailed: (failed, total, err) => `${total} işlemden ${failed} tanesi başarısız — ${err}. Başarısız kartlar seçili kalır.`,
  titlePlaceholderTriage: 'Kaba fikir — bir belirleyici detaylandıracak',
  ...
  modelClear: 'Model geçersiz kılmayı temizle',
  modelHint: 'Bu görevi belirli bir modelde ve düşünme derinliğinde çalıştırır. Ayarlanmazsa atanan profilin kendi modeli kullanılır.',
  workspaceInherit: 'Panonun proje dizinini devralır',
  workspaceInheritDir: dir => `${dir} devralmak için boş bırakın`,
  workspaceInheritGeneric: 'Panonun proje dizinini devralmak için boş bırakın.',
  assignee: 'Atanan',
  defaultOption: name => `${name} (varsayılan)`,
  parkedOption: 'atanmamış (park edildi — çalışmaz)',
  skills: 'Beceriler (virgülle ayrılmış)',
  skillsPlaceholder: 'translation, github',
  parent: 'Üst görev (bitene kadar engeller)',
  noParent: '— üst görev yok —',
  goalMode: 'Hedef modu (bir yargıç bitti diyene kadar işçi döngüde kalır)',
  creating: 'Oluşturuluyor…',
  createTask: 'Görev oluştur',
  cancel: 'İptal',
  save: 'Kaydet',
  estimate: 'Tahmin',
  estimateEffort: 'Eforu tahmin et',
  estimating: 'Tahmin ediliyor…',
  reEstimate: 'Yeniden tahmin et',
  makesModelCall: 'bir model çağrısı yapar',
  estimateTip: 'Yardımcı modelden kaba token + karmaşıklık tahmini — bir model çağrısı yapar.',
  estimateTipLong: 'Token + karmaşıklığı tahmin etmek için hızlı bir yardımcı-model çağrısı yapar. Kaba bir rehber, fatura değil.',
  roughEstimate: 'Kaba tahmin',
  tokUnit: 'tok',
  couldNotEstimate: 'Tahmin edilemedi',
  complexity: { S: 'Küçük', M: 'Orta', L: 'Büyük' },
  introBody:
    'Kartları siz çalıştırmazsınız — ajanlar çalıştırır. Bir kartı atananıyla Hazır sütununa koyun, bir ajan bir dakika içinde alır. Atanan yoksa çalışmaz. Triyaj: bir ajan önce fikri düzgün bir göreve dönüştürür. Yapılacak: diğer kartları bekliyor. Zamanlanmış: bir zamanlayıcı bekliyor. Çalışıyor ve İnceleme: ajanların şeritleri, karışmayın. Engellendi: sizi bekliyor. Sonuçlar kartta geri gelir.',
  introGotIt: 'Anladım',
  evtCreated: (where, assignee) =>
    `oluşturuldu${where ? ` (${where})` : ''}${assignee ? ` · ${assignee} atandı` : ''}`,
  evtMovedTo: col => `${col} sütununa taşındı`,
  evtParentReopened: parent => `üst görev ${parent} yeniden açıldı`,
  evtAssignedTo: assignee => `${assignee} atandı`,
  evtUnassigned: 'atama kaldırıldı',
  evtCommentBy: author => `${author} tarafından yorum`,
  evtClaimedReview: 'bir inceleme ajanı tarafından alındı',
  evtClaimedWorker: 'bir işçi tarafından alındı',
  evtWorkerStarted: 'işçi başladı',
  evtCompleted: 'tamamlandı',
  evtBlocked: 'engellendi — insan girdisi gerekiyor',
  evtUnblocked: col => `engel kaldırıldı${col ? ` → ${col}` : ' → Hazır'}`,
  evtReclaimed: 'yeniden alındı — kuyruğa döndü',
  evtSpecified: 'spesifikasyon triyaj ajanı tarafından yazıldı',
  evtPromoted: "bağımlılıklar tamamlandı — Hazır'a yükseltildi",
  evtScheduled: 'sonraya zamanlandı',
  ...
  metaWorkerPid: 'İşçi pid',
  readyUnassignedTitle: 'Hazır ama atanmamış — bu kart asla çalışmayacak.',
  readyUnassignedBody:
    'Sevk edici yalnızca atananı olan Hazır kartları alır. Yukarıdaki Atanan alanından bir profil seçin (veya orkestrasyon ayarlarında varsayılan bir atanan belirleyin), bir dakika içinde çalışır.',
  ...
  result: 'Sonuç',
  latestSummary: 'En son özet',
  dependencies: 'Bağımlılıklar',
  blockedBy: 'Şununla engellendi',
  blocks: 'Şunları engeller',
  comments: n => `Yorumlar · ${n}`,
  commentsHelpRunning:
    'Bu görev çalışıyor. Notunuz birkaç saniye içinde işçinin geçerli turuna katılır — engelle/engeli kaldır uğraşı yok. “Notla yeniden kuyruğa al” ise görevi notunuz bağlamdayken baştan başlatır.',
  commentsHelp:
    'Yorumlar görev başlığına eklenir. Bir işçi görevi aldığında onları bağlamının parçası olarak okur.',
  send: 'Gönder',
  comment: 'Yorum',
  messageWorker: 'Çalışan işçiye mesaj…',
  addComment: 'Bir yorum ekle…',
  deliveredLive: 'Çalışan işçiye birkaç saniye içinde iletildi.',
  requeueWithNote: 'Notla yeniden kuyruğa al',
  notePosted: 'Not gönderildi — işçi yeniden kuyruğa alındı',
  activity: n => `Etkinlik · ${n}`,
  runs: n => `Çalıştırmalar · ${n}`,
  workerLog: 'İşçi günlüğü',
  workerLogTail: 'İşçi günlüğü · son',
  attachments: n => `Ekler · ${n}`,
  noAttachments: 'Henüz ek yok.',
  uploadAttachment: 'Ek yükle',
  taskActions: 'Görev eylemleri',
  ...
  boardExported: path => `Pano ${path} konumuna aktarıldı`,
  boardImported: name => `${name} içe aktarıldı`,
  boardImportedAs: slug => `O ad alınmıştı — ${slug} olarak içe aktarıldı`,
  renameBoardTitle: 'Panoyu yeniden adlandır',
  deleteBoardTitle: name => `"${name}" silinsin mi?`,
  deleteBoardConfirm:
    'Pano silinmez, arşivlenir — görevleri ve ekleri diskte kalır ve geri yüklenebilir.',
  ...
  slug: slug => `slug: ${slug}`,
  project: 'Proje',
  noProject: 'Proje yok (geçici sanal alanlar)',
  projectHintPre:
    'Yeni görevler projenin deposunda çalışır (görev başına bir worktree); her görev yine de oluşturulurken çalışma alanını geçersiz kılabilir. Projeleri şununla yönetin: ',
  projectHintCmd: 'hermes project',
  createBoard: 'Pano oluştur',
  orchestratorProfile: 'Orkestratör profili',
  defaultAssignee: 'Varsayılan atanan',
  defaultParen: '(varsayılan)',
  autoDecompose: 'Triyaj görevlerini otomatik ayrıştır',
  profileDescriptions: 'Profil açıklamaları',
  profileDescriptionsHint:
    'Açıklamalar ayrıştırıcının yönlendirmesine rehberlik eder. Yardımcı modelle otomatik üretin veya kendiniz yazın.',
  profileGoodAt: 'Bu profil ne konuda iyi?',
  auto: 'Otomatik',
  notify: {
    completedTitle: 'Görev tamamlandı',
    blockedTitle: 'Görev engellendi — girişiniz gerekiyor',
    blockLoopTitle: 'Görev triyaja yönlendirildi — bir karar gerekiyor',
    gaveUpTitle: 'Görev durduruldu',
    gaveUpBody: "Hermes bu görevi tamamlayamadı. Nedenini görmek ve yeniden atamak için Kanban'ı açın.",
    crashedTitle: 'Görev bir sorunla karşılaştı — Hermes otomatik olarak yeniden deneyecek',
    timedOutTitle: 'Görev çok uzun sürdü — Hermes otomatik olarak yeniden deneyecek',
    openKanban: "Kanban'ı aç",
    artifacts: (n: number) => `${n} yapıt`
  }
}
