...
import { isIdeWindow } from './windows'
...
// Window-scoped: the Hermes IDE window's browser pane keeps its own active tab.
const RIGHT_RAIL_ACTIVE_TAB_STORAGE_KEY = isIdeWindow()
  ? 'hermes.desktop.rightRailActiveTab.ide.v1'
