...
import { canOpenBrowserWindow, openBrowserInNewWindow, previewTabsStorageKey } from './windows'
...
const TABS_STORAGE_KEY = previewTabsStorageKey(window.location.search)
