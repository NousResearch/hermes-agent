...
// and default OFF. Used by the Settings UI (local Desktop only).
export async function getUnattendedSchedule(): Promise<DesktopUnattendedSchedule> {
...
): Promise<DesktopUnattendedSchedule> {
