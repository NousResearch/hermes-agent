...
logger = logging.getLogger("argus.directives")

# Default path for directives.yaml
_DEFAULT_DIRECTIVES_PATH = os.path.expanduser("~/.hermes/argus/directives.yaml")
_DEFAULT_CUSTOM_CHECKS_DIR = os.path.expanduser("~/.hermes/argus/checks/")
...
def setup_directives():
    ...
    """
    argus_dir = os.path.expanduser("~/.hermes/argus")
