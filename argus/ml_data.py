"""ARGUS ML data pipeline — convert entropy detections to training data.

Optional feature. When enabled, Argus exports trajectories and facts for model
...
logger = logging.getLogger("argus.ml_data")


class MLDataExporter:
    """Export Argus detections as ML training data.
    ...
    def export_detection_trajectory(
        ...
        4. System/Tool: Argus detection alert
        ...
        filename = f"argus_{safe_type}_{ts}.json"
    ...
    def _build_trajectory(
        ...
        # Argus detection alert (system message)
        argus_alert = self._format_alert(entropy_type, severity, detection_details)
    ...
    def _format_alert(self, entropy_type: str, severity: str, details: Dict) -> str:
        """Format Argus detection as system alert."""
        return (
...
class HolographicMemoryBridge:
    """Bridge Argus detections to holographic memory system.
