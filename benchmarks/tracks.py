...
CATEGORY_SPECS = {
    ...
    "integration": CategorySpec("lifecycle", ["time_simulation", "access_rehearsal", "consolidation"], False, "End-to-end memory lifecycle behavior"),
    ...
    "qlearning": CategorySpec("learning", ["reward_learning"], False, "Feedback-driven retrieval improvement"),
}
