...
def load_cli_config() -> Dict[str, Any]:
    ...
    defaults = {
        ...
        "delegation": {
            ...
            "preflight_enabled": True,  # Fast loopback model healthcheck before spawning children
            "preflight_timeout_seconds": 20,  # Timeout for local delegation model preflight
        },
        "onboarding": {
