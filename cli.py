#!/usr/bin/env python3
"""
IX Agency CLI - Interactive Terminal Interface

A beautiful command-line interface for IX Agency, inspired by Claude Code.
    ...
    defaults = {
        ...
        "agent": {
            ...
            "personalities": {
                ...
                "pirate": "Arrr! Ye be talkin' to Captain IX, the most tech-savvy pirate to sail the digital seas! Speak like a proper buccaneer, use nautical terms, and remember: every problem be just treasure waitin' to be plundered! Yo ho ho!",
                "shakespeare": "Hark! Thou speakest with an assistant most versed in the bardic arts. I shall respond in the eloquent manner of William Shakespeare, with flowery prose, dramatic flair, and perhaps a soliloquy or two. What light through yonder terminal breaks?",
                "surfer": "Duuude! You're chatting with the chillest AI on the web, bro! Everything's gonna be totally rad. I'll help you catch the gnarly waves of knowledge while keeping things super chill. Cowabunga!",
                "noir": "The rain hammered against the terminal like regrets on a guilty conscience. They call me IX - I solve problems, find answers, dig up the truth that hides in the shadows of your codebase. In this city of silicon and secrets, everyone's got something to hide. What's your story, pal?",
...
#   6. Default: assume dark (matches the legacy IX Agency assumption)
#
...
def _strip_markdown_syntax(text: str) -> str:
    ...
    # but in IX Agency output it's common to display cron schedules verbatim.
    #
...
# ASCII Art - IX-AGENCY logo (full width, single line - requires ~72 char terminal)
...
# ASCII Art - IX monogram (compact, fits in left panel)
...
def _build_compact_banner() -> str:
    ...
    if skin_name == "default":
        line1 = "✦ IX AGENCY - AI Agent Framework"
        tiny_line = "✦ IX AGENCY"
    else:
        agent_name = _skin.get_branding("agent_name", "IX Agency") if _skin else "IX Agency"
    ...
    if os.environ.get("HERMES_FAST_STARTUP_BANNER") == "1":
        ...
        version_line = f"IX Agency v{_version} ({_release_date})"
    else:
        version_line = format_banner_version_label()

    w = min(shutil.get_terminal_size().columns - 2, 88)
    if w < 30:
        return f"\n[{title_color}]{tiny_line}[/] [dim {dim_color}]- Intelliverse X[/]\n"
...
class HermesCLI(CLIAgentSetupMixin, CLICommandsMixin):
    ...
    def __init__(
        ...
        # it's shared across all IX Agency processes for this HERMES_HOME.
    ...
    def _build_status_bar_text(self, width: Optional[int] = None) -> str:
        ...
        try:
            ...
            return f"✦ {self.model if getattr(self, 'model', None) else 'IX Agency'}"
    ...
    def show_banner(self):
        ...
        if ctx_len and ctx_len < MINIMUM_CONTEXT_LENGTH:
            ...
            self._console_print(
                f"[dim]   IX Agency needs at least {MINIMUM_CONTEXT_LENGTH:,} tokens. Tool schemas + system prompt use a large fixed prefix.[/]"
            )
        ...
        if is_nous_hermes_non_agentic(model_name):
            ...
            self._console_print(
                ...
                "designed for use with IX Agency.[/]"
            )
            self._console_print(
    ...
    def show_help(self):
        ...
        _cprint(f"\n  {_DIM}Tip: Just type your message to chat with IX Agency!{_RST}")
    ...
    def show_history(self):
        ...
        for msg in self.conversation_history:
            ...
            _cli_visible_print(f"\n  [IX Agency #{visible_index}]{_ts_suffix(msg)}")
    ...
    def _confirm_expensive_model_switch(self, result) -> bool:
        ...
        choices = [
            ("once", "Switch anyway", "Use this model for the current IX Agency session."),
    ...
    def _handle_codex_runtime(self, cmd_original: str) -> None:
        ...
        Usage:
            ...
            /codex-runtime auto                  — IX Agency default (chat_completions)
    ...
    def run(self):
        ...
        try:
            ...
            _welcome_text = _welcome_skin.get_branding("welcome", "Welcome to IX Agency! Type your message or /help for commands.")
            _welcome_color = _welcome_skin.get_color("banner_text", "#FFF8DC")
        except Exception:
            _welcome_text = "Welcome to IX Agency! Type your message or /help for commands."
        ...
        # after an OpenClaw→IX Agency migration (especially migrations done by
        ...
        if _preserve_ctrl_enter_newline():
            ...
            def handle_ctrl_enter_newline(event):
                ...
                conflicting IX Agency binding. See issue #22379.
                """
                event.current_buffer.insert_text('\n')
        ...
        def handle_ctrl_z(event):
            ...
            from prompt_toolkit.application import run_in_terminal
            from hermes_cli.skin_engine import get_active_skin
            agent_name = get_active_skin().get_branding("agent_name", "IX Agency")
        ...
        # Dynamic prompt: shows IX Agency symbol when agent is working,
        ...
        def _get_clarify_display():
            ...
            box_width = _panel_box_width("IX Agency needs your input", preview_lines)
            inner_text_width = max(8, box_width - 2)
            ...
            lines.append(('class:clarify-title', 'IX Agency needs your input'))
            lines.append(('class:clarify-border', ' ' + ('─' * max(0, box_width - len("IX Agency needs your input") - 3)) + '╮\n'))
            if not use_compact_chrome:
...
def main(
    ...
    """
    IX Agency CLI - Interactive AI Assistant
    ...
    if gateway:
        ...
        print("Starting IX Agency Gateway (messaging platforms)...")
    ...
    if toolsets:
        ...
        # Coding posture (base IX Agency): with no explicit --toolsets, collapse
            ...
            if quiet:
                ...
                if cli._ensure_runtime_credentials():
                    ...
                    if cli._init_agent(
                        ...
                        # machine-readable (no styled "IX Agency" box, no tool-gen
