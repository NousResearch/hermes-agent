...
# --- Display/rendering helpers (extracted to display_engine.py) -----------
from hermes_cli.display_engine import (
    # Light mode
    _detect_light_mode, _maybe_remap_for_light_mode, _install_skin_light_mode_hook,
    _luminance_from_hex, _query_osc11_background,
    # ANSI + skin
    _hex_to_ansi, _SkinAwareAnsi, _accent_hex, _ACCENT, _DIM, _RST,
    # Rich text + markdown
    ...
    _record_output_history_entry, _record_output_history, _replay_output_history,
    _coerce_output_history_limit,
    _OUTPUT_HISTORY_ENABLED, _OUTPUT_HISTORY_REPLAYING, _OUTPUT_HISTORY_SUPPRESSED,
    # _cprint
    _cprint,
    # Image attachments
    _termux_example_image_path, _split_path_input, _resolve_attachment_path,
    _detect_file_drop, _format_image_attachment_badges, _IMAGE_EXTENSIONS,
    # Paste/terminal
...
# Load configuration at module startup (imported below with other CLI modules)
...
from hermes_cli.cli_config import load_cli_config, save_config_value, _parse_skills_argument
...
# Colors and ANSI building blocks — now imported from display_engine.py.
# Kept as a comment for reference; actual constants live in display_engine.py.
