...
def _record_xiaoxing_cli_working_memory(
    *,
    source: str,
    session_id: str,
    user_message: Any,
    ...
    """Record non-gateway XiaoXing turns into short-lived working memory."""
    ...
    try:
        ...
        if source == "codex_mentor":
            chat_id = "xiaoxing-codex-mentor"
            trigger = "codex_mentor_cli_turn"
        else:
            chat_id = source
            trigger = "cli_turn"
        record_event(
            ...
            user_id="codex",
            user_name="Codex",
            interlocutor_id="codex",
            interlocutor_name="Codex",
        ...
        logger.debug("XiaoXing CLI working memory record failed", exc_info=True)
...
class HermesCLI:
    ...
    def chat(self, message, images: list = None) -> Optional[str]:
        ...
        try:
            ...
            _record_xiaoxing_cli_working_memory(
                source=os.environ.get("HERMES_SESSION_SOURCE", "cli"),
                session_id=self.session_id,
