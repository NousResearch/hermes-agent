...
def illustrate(draft: dict, out_dir: Path, density: str = "per-section",
    ...
    # Generate each image.
    # article_illustrator is the X-article illustrator. The brand and
    # platform must come from the draft (threaded by article_pipeline._run_for_brand),
    # NOT default to "sahilblog" — SahilBlog is generated by blog/blog_illustrator
    # (Codex CLI via blog/art_director), which never imports this module.
    base_draft = {
        "brand": draft.get("brand") or "sahil_twitter",
