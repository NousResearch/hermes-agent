...
BASE_DIR = Path(os.environ.get("CONTENT_ENGINE_ROOT", Path(__file__).resolve().parent)).resolve()
OUTPUT_DIR = BASE_DIR / "output"
DB_PATH = Path(os.environ.get("CONTENT_ENGINE_DB_PATH", BASE_DIR / "db" / "content_engine.db")).resolve()
