# Design: cosmos Cognitive Projection (FCP) - v1.3

## Overview

This design introduces the **cosmos Cognitive Projection (FCP)** protocol, a novel system for managing agent state and context.
...
| Feature | GSD / Clawdbot | FCP / Nexus (cosmos) |
| :--- | :--- | :--- |
...
1.  **FCP Engine** (`cosmos.core.fcp`): The projection logic.
2.  **Nexus Bus** (`cosmos.core.nexus`): The signal propagation system.
3.  **Neural Adapters** (`cosmos.interfaces`): The connection to external reality.
