...
.card {{ background:rgba(3,6,11,.88); border:1px solid var(--line); border-radius:24px; overflow:hidden; backdrop-filter:blur(18px) saturate(145%); box-shadow:0 14px 34px rgba(0,0,0,.32); }}
...
.nav-link {{ color:rgba(245,247,251,.86); text-decoration:none; border:1px solid rgba(245,247,251,.16); border-radius:999px; padding:7px 11px; font:11px var(--mono); background:rgba(3,6,11,.86); box-shadow:0 8px 22px rgba(0,0,0,.28); }}
.nav-link.primary {{ color:#fff; border-color:rgba(35,167,255,.56); background:linear-gradient(135deg,rgba(117,108,255,.42),rgba(35,167,255,.20)); }}
...
.nav a, .quick-nav a, .back { color:rgba(245,247,251,.86); text-decoration:none; border:1px solid rgba(245,247,251,.16); background:rgba(3,6,11,.88); padding:7px 10px; border-radius:999px; font:11px var(--mono); text-transform:uppercase; letter-spacing:.08em; white-space:nowrap; box-shadow:0 8px 22px rgba(0,0,0,.28); }
.nav a.active, .nav a:hover, .quick-nav a.active, .quick-nav a:hover, .back:hover { color:#fff; border-color:rgba(35,167,255,.56); background:linear-gradient(135deg,rgba(117,108,255,.42),rgba(35,167,255,.20)); box-shadow:inset 0 0 0 1px rgba(35,167,255,.16), 0 0 18px rgba(117,108,255,.18); }
...
.stat, .archive-card, .job-row, .output-row, .report-shell, .detail-card { border:1px solid var(--line-soft); background:rgba(3,6,11,.84); border-radius:14px; box-shadow:0 12px 34px rgba(0,0,0,.28); }
.stat { padding:6px 8px; color:rgba(245,247,251,.76); font:10px var(--mono); text-transform:uppercase; letter-spacing:.06em; }
