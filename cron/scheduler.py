...
def mark_running_jobs_interrupted(
    ...
    *,
    ...
    That preserves an auditable output file in the owning cron store even when
    shutdown interrupts the worker before ``run_one_job`` reaches its normal
    ``save_job_output`` step.
