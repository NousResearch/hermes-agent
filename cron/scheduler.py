...
def _run_one_job_body(
    ...
    try:
        ...
        _scope_token = set_secret_scope(build_profile_secret_scope(_get_hermes_home()), home=_get_hermes_home())
...
def _launch_external_cron_worker(job: dict) -> bool:
    ...
    secret_token = set_secret_scope(build_profile_secret_scope(profile_home), home=profile_home)
    try:
