...
def run_job(job: dict) -> tuple[bool, str, str, Optional[str]]:
    ...
    try:
        ...
        # Run with timeout (v0.7.0) so a hung API call or tool doesn't
        # block the cron ticker thread indefinitely.
        ...
        try:
            ...
            logger.error("Job '%s' timed out after %.0fs", job_name, _cron_timeout)
