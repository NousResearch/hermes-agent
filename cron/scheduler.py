...
def _build_job_prompt(job: dict, prerun_script: Optional[tuple] = None) -> str:
    ...
    cron_hint = (
        ...
        "DELIVERABLE ONLY: The final response must contain only the "
        "user-facing deliverable. Do not include verification summaries, "
        "tool execution explanations, script logs, changed-path notes, "
        "or file-check results unless the user explicitly requested those "
        "details as part of the deliverable. "
