---
title: Canvas Labs Context Pack
tags:
  - hermes-agent
  - context-pack
  - workspace-40
status: active
updated: 2026-05-20
project_slug: tech-tools-canvas-labs
---
...
|---|---|
| Category | `Tech Tools` |
| Relative path | `Tech Tools/Canvas Labs` |
| Absolute path | `/Users/rattanasak/Documents/Viber Project/Tech Tools/Canvas Labs` |
| Stack | `unknown/mixed` |
| Git | `false` |
| `.hermes` | `true` |
| Risk | `high` |
| Primary role | `devex` |
| Obsidian note | `[[tech-tools-canvas-labs]]` |
