...
- **OQ2:** Does the original Instacart leak (session `590cf2`, main-turn-tagged) share RC#2 with the 00:02 leak, or was it also a mis-tagged subagent send? Unprovable from rotated/compacted logs; the instrumentation will disambiguate the *next* one. Not blocking.
