...
# NOTE: env_enablement_fn must return a FLAT dict. The caller pops
# "home_channel" and merges every other key into PlatformConfig.extra.
# Returning {"extra": {...}} would wrongly nest under extra["extra"].
def _env_enablement():
