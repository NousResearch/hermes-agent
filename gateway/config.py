...
class PlatformConfig:
    ...
    # Critical terminal alert after bounded supervisor recovery is exhausted. Separate from routine
    # restart noise so operators can mute online/restart pings without hiding a dead gateway.
    gateway_restart_failure_notification: bool = True
    ...
    def to_dict(self) -> Dict[str, Any]:
        result = {
            ...
            "gateway_restart_failure_notification": self.gateway_restart_failure_notification,
    ...
    _TYPED_KEYS = frozenset({
        ...
        "gateway_restart_notification", "gateway_restart_failure_notification", "typing_indicator", "typing_status_text",
    })
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "PlatformConfig":
        ...
        return cls(
            ...
            gateway_restart_failure_notification=_coerce_bool(
                toplevel_or_extra("gateway_restart_failure_notification"), True
            ),
