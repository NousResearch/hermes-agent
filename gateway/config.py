...
def _apply_env_overrides(config: GatewayConfig) -> None:
    ...
    if linear_enabled or linear_api_key:
        ...
        linear_inbox_states = os.getenv("LINEAR_INBOX_STATES")
        if linear_inbox_states:
            linear_cfg.extra["inbox_states"] = [s.strip() for s in linear_inbox_states.split(",") if s.strip()]
