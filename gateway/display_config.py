...
_GLOBAL_DEFAULTS: dict[str, Any] = {
    ...
    # One editable runtime-telemetry message. Opt-in and independent from ordinary tool-progress
    # bubbles; the transport consumes existing structured callbacks and never invokes the model.
    "live_hud": False,
