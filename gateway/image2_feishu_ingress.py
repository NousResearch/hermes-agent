    ...
    *,
    ...
    if not explicit_print_request:
        ...
        if size_only_spec.get("status") == "ok":
            ...
            if print_source_payload:
                size_only_direct_approved = print_approved_from_source_files(print_source_payload.get("source_files") or [])
    ...
    if explicit_print_request and spec.get("status") == "ok":
        ...
        # A bare size reply in an image thread (e.g. "80×120厘米") means the
