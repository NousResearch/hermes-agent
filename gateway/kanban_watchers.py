...
from gateway.kanban_watchers_shutdown import stop_scoped_workers_on_shutdown
...
class GatewayKanbanWatchersMixin:
    ...
    def _kanban_dispatcher_boot(self) -> Optional[tuple]:
        ...
        self._kanban_dispatcher_lock_handle = None
        _lock_path = _owner_kanban_boards.kanban_home() / "kanban" / ".dispatcher.lock"
    ...
    async def _kanban_dispatcher_watcher(self) -> None:
        ...
        while self._running:
            ...
            try:
                ...
                stop_scoped_workers_on_shutdown(_load_config)
