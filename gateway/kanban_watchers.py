...
class GatewayKanbanWatchersMixin:
    ...
    async def _kanban_notifier_watcher(self, interval: float = 5.0) -> None:
        ...
        **Multi-board:** iterates every board discovered on disk per
        ...
        # it out), so claiming them on startup is strictly an improvement
        # over the prior silent-drop behaviour. First gateway to start wins;
        # the others are no-ops because the column is already populated.
        # See task t_b212a749.
