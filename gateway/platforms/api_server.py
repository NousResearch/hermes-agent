...
class APIServerAdapter(OpenAICompatRoutesMixin, BasePlatformAdapter):
    ...
    def _bind_api_server_session(
        *, chat_id: str = "", session_key: str = "", session_id: str = "",
        ...
        """Bind the single API-agent context choke point.

        Ordinary requests are explicitly non-gateway. The dedicated proxy route
        binds its already-verified upstream origin and hidden gateway capability.
        Both remain stateless for async-delivery purposes.
