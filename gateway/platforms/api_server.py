...
class APIServerAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config: PlatformConfig):
        ...
        # Peer adapters dict -- populated by GatewayRunner after all
        # platforms connect.  Keyed by Platform enum, values are
        # BasePlatformAdapter instances.  Used by /api/weixin/send to
        # reach the WeixinAdapter without creating a duplicate session.
        self._peer_adapters: Dict[Any, Any] = {}
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            # Weixin message send proxy (for alert-bridge)
            self._app.router.add_post("/api/weixin/send", self._handle_weixin_send)
