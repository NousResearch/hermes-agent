...
def _sniff_audio_ext(data: bytes, fallback_ext: str) -> str:
    ...
    Thin wrapper around the shared sniffer in ``tools.audio_container`` — one
    module owns detection for both outbound TTS repair and this inbound cache.
    """
...
class BasePlatformAdapter(ABC):
    ...
    def extract_media(content: str) -> Tuple[List[Tuple[str, bool]], str]:
        ...
        # (Our local .html/.htm extensions already live in MEDIA_DELIVERY_EXTS
        # on line 1181 — upstream added them to the shared source of truth.)
