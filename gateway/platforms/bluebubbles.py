...
class BlueBubblesAdapter(BasePlatformAdapter):
    ...
    async def send_animation(self, chat_id: str, animation_url: str, caption: Optional[str] = None,
                             reply_to: Optional[str] = None, metadata: Optional[Dict[str, Any]] = None) -> SendResult:
    ...
    async def send_typing(self, chat_id: str, metadata=None) -> None:
        ...
        try:
            ...
            if guid:
                ...
                await self.client.post(self._api_url(f'/api/v1/chat/{encoded}/typing'), timeout=5)
        except Exception:
            pass
    ...
    async def stop_typing(self, chat_id: str) -> None:
        ...
        try:
            ...
            if guid:
                encoded = quote(guid, safe="")
                await self.client.delete(self._api_url(f'/api/v1/chat/{encoded}/typing'), timeout=5)
        except Exception:
            pass
    ...
    async def mark_read(self, chat_id: str) -> bool:
        ...
        try:
            ...
            if guid:
                encoded = quote(guid, safe="")
                await self.client.post(self._api_url(f'/api/v1/chat/{encoded}/read'), timeout=5)
                return True
        except Exception:
            pass
        return False
    ...
    async def send_reaction(self, chat_id: str, message_guid: str, reaction: str, part_index: int = 0) -> SendResult:
        ...
        if not guid:
            return SendResult(success=False, error=f"Chat not found: {chat_id}")
        try:
            res = await self._api_post('/api/v1/message/react', {
                'chatGuid': guid,
    ...
    async def get_chat_info(self, chat_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if guid:
                ...
                display_name = data.get('displayName') or data.get('chatIdentifier') or chat_id
                participants = []
    ...
    async def _handle_webhook(self, request):
        ...
        if isinstance(assoc_type, int) and assoc_type in {**_TAPBACK_ADDED, **_TAPBACK_REMOVED}:
            return web.Response(text='ok')
