...
class DiscordAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config: PlatformConfig):
        ...
        # Tracks active typing loops per channel ID
    ...
    async def send(
        ...
        try:
            ...
            # Stop typing indicator after messages are sent
    ...
    async def _start_typing_loop(self, chat_id: str) -> None:
        """Start periodic typing indicator for a channel."""
        await self._stop_typing_task(chat_id)
    ...
    async def _stop_typing_task(self, chat_id: str) -> None:
