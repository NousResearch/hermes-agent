...
# The "other" marker is the literal string "other"; there is no reserved
# numeric index — a numeric marker always maps to a 1-based choice index
# (see adapter._default_interaction_dispatch).
