...
from gateway.relay.prompt_surface import (  # noqa: F401 — re-exported for callers/tests
    RelayPromptMixin,
    _EXEC_APPROVAL_LABELS,
    _PROMPT_RESOLVERS,
    _RESOLVED_PROMPT_MEMORY,
...
class RelayAdapter(RelayPromptMixin, BasePlatformAdapter):
