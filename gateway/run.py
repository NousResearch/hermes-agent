...
from gateway.scoped_reasoning import install_scoped_reasoning_runtime

# Install gateway-only reasoning scope preservation without reintroducing
# package-import side effects in gateway.__init__.
