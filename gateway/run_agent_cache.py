...
class GatewayAgentCacheMixin:
    ...
    async def _apply_session_switch(
        ...
        # #119864); a resume IS one, and the funnel above clears only in-memory state — without
        # this the next turn's _rehydrate_session_model_override resurrects the pin it just cleared.
