...
class GatewayGoalsMixin:
    ...
    async def _send_goal_status_notice(self, source: Any, message: str, *, goal_event: Optional[Dict[str, Any]] = None) -> None:
    ...
    async def _defer_goal_status_notice_after_delivery(self, source: Any, message: str, *, goal_event: Optional[Dict[str, Any]] = None) -> None:
    ...
    async def _post_turn_goal_continuation(
        ...
        if msg and source is not None:
            goal_event = self._build_goal_status_event(
                decision=decision, goal_state=getattr(mgr, "state", None), raw_text=msg,
            )
