...
class TurnRunner:
    ...
    def _run_conversation_with_approval(self, agent, agent_history, observed_group_context,
        ...
        try:
            ...
            expected_epoch = ctx.expected_conversation_epoch
            if isinstance(expected_epoch, int) and _accepts_keyword(agent.run_conversation, "expected_conversation_epoch"):
                kwargs["expected_conversation_epoch"] = expected_epoch
