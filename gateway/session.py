...
def build_session_key(
    ...
    # bug class). isinstance-guard bare test fixtures: a MagicMock/
    # SimpleNamespace source auto-creates a truthy non-string ``account``
    # (AGENTS.md pitfall #17), which would otherwise be interpolated into
    # the namespace and corrupt every key those fixtures derive.
