    ...
    *,
    ...
    if context.source.platform == Platform.SLACK:
        ...
        lines.append(
            ...
            "If the whole response is only a quick acknowledgment and a native "
            "tapback is appropriate, reply with exactly `TAPBACK:like`, "
            "`TAPBACK:love`, `TAPBACK:laugh`, `TAPBACK:emphasize`, "
            "`TAPBACK:question`, or `TAPBACK:dislike`; the gateway converts it "
            "to a BlueBubbles tapback on the user's message instead of sending text. "
            "For rare celebratory/emphasis beats, reply with exactly "
            "`EFFECT:<effect>|<text>` using effects like lasers, balloons, "
            "fireworks, slam, loud, gentle, invisible-ink, confetti, or heart; "
            "the gateway sends the text with that native iMessage effect. "
