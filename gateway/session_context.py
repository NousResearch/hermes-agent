...
# SHA-256 of the opaque gateway routing-boundary capability epoch. The raw
# epoch is never placed in task context, prompts, model payloads, or IPC.
_CAPABILITY_EPOCH_SHA256: ContextVar = ContextVar(
    "HERMES_CAPABILITY_EPOCH_SHA256", default=_UNSET
)
...
_VAR_MAP = {
    ...
    "HERMES_CAPABILITY_EPOCH_SHA256": _CAPABILITY_EPOCH_SHA256,
...
def set_session_vars(
    ...
    tokens = [
        ...
        _SESSION_ID.set(session_id),
        _CAPABILITY_EPOCH_SHA256.set(capability_epoch_sha256),
