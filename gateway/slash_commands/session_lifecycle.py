"""/reset (/new), /branch, /resume, /sessions, /title, /topic, /rollback, /undo, /retry, /diff, /save slash-command handlers for GatewayRunner.
...
class SessionLifecycleCommandsMixin:
    """/reset (/new), /branch, /resume, /sessions, /title, /topic, /rollback, /undo, /retry, /diff, /save handlers."""
