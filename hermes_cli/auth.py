...
from hermes_cli.auth_constants import (  # noqa: F401  re-exported
    ...
    DEFAULT_GITHUB_MODELS_BASE_URL, DEFAULT_COPILOT_ACP_BASE_URL, DEFAULT_CLAUDE_CODE_ACP_BASE_URL,
...
_REGISTRY_ROWS: Tuple[Any, ...] = (
    ...
    ProviderConfig(
        ...
        inference_base_url=DEFAULT_CLAUDE_CODE_ACP_BASE_URL, base_url_env_var="CLAUDE_CODE_ACP_BASE_URL"),
