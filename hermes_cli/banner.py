...
_UPSTREAM_REPO_URL = "https://github.com/uaixo/awesome-hermes-agent.git"
_OFFICIAL_REPO_CANONICAL = "github.com/uaixo/awesome-hermes-agent"
...
def _fetch_pypi_latest(package: str = "ht-ai-agent") -> Optional[str]:
...
_RELEASE_URL_BASE = "https://github.com/uaixo/awesome-hermes-agent/releases/tag"
...
def format_banner_version_label() -> str:
    ...
    base = f"HT AI Agent v{VERSION} ({RELEASE_DATE})"
