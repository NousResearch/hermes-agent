        ...
        def run_background():
            ...
            try:
                bg_agent = AIAgent(
                    ...
                    provider_data_residency=self._provider_data_residency,
                    provider_eu_owned=self._provider_eu_owned,
                    provider_max_retention_days=self._provider_max_retention_days,
