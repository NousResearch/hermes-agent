...
class CLIModalMixin:
    ...
    def _clear_active_overlays_for_interrupt(self) -> None:
        ...
        if self._clarify_state:
            # KENSEI CUSTOM (restored): batch clarify preserves staged answers on
            # interrupt ({answers, cancelled: True}); single-question clarify gets
            # the plain-text cancel.
            try:
    ...
    # ── KENSEI CUSTOM (restored): batch-clarify cancel + ask_user_questions callback ──
