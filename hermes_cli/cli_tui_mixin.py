...
class CLITuiMixin:
    ...
    def _tui_build_input_area(self):
        ...
        from cli import _cli_input_min_height, _estimate_tui_input_height, get_skill_bundles, get_skill_commands
        ...
        _min_input_height = _cli_input_min_height(cli_ref.config)
        input_area = TextArea(
            height=Dimension(min=1, max=8, preferred=_min_input_height),
            prompt=get_prompt,
        ...
        def _input_height():
            ...
            try:
                ...
                return _estimate_tui_input_height(
                    doc.lines, self._get_tui_prompt_text(), terminal_columns, min_height=_min_input_height)
            except Exception:
                return _min_input_height
