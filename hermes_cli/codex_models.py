...
DEFAULT_CODEX_MODELS: List[str] = [
    ...
    # (previewed 2026-06-26). Do not list the public-API-style ``*-pro``
    # variants here: the chatgpt.com Codex OAuth backend rejects them for
    # ChatGPT accounts with HTTP 400, so static fallback must not surface them.
    "gpt-5.6-sol",
    "gpt-5.6-terra",
    "gpt-5.6-luna",
    "gpt-5.5",
