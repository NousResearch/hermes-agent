...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("voice", "Toggle voice mode", "Configuration",
               args_hint="[join|leave|on|off|tts|status]", subcommands=("join", "channel", "leave", "on", "off", "tts", "status")),
    CommandDef("transcribe", "Control inbound voice/audio transcription", "Configuration",
               args_hint="[on|off|status]", subcommands=("on", "off", "status"), gateway_only=True),
