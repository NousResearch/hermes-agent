...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("fast", "Toggle fast mode — OpenAI Priority Processing / Anthropic Fast Mode (Normal/Fast/Auto/Cold)", "Configuration",
               args_hint="[normal|fast|auto|cold|status]",
               subcommands=("normal", "fast", "auto", "cold", "status", "on", "off")),
