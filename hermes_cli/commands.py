...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("fast", "Toggle fast mode — OpenAI Priority Processing / Anthropic Fast Mode (Normal/Fast/Auto)", "Configuration",
               args_hint="[normal|fast|auto|status]",
               subcommands=("normal", "fast", "auto", "status", "on", "off")),
