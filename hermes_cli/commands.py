...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("apikey", "Hot-swap the API key for the current provider mid-session",
               "Configuration", aliases=("key",), cli_only=True,
               args_hint="[--save] [--reload] [KEY]"),
    CommandDef("apikey-d", "Hot-swap the API key used by subagent delegation",
               "Configuration", aliases=("delegation-key", "dkey"), cli_only=True,
               args_hint="[--save] [--provider name] [--model name] [KEY]"),
    CommandDef("apikey-c", "Hot-swap the API key used by context compression",
               "Configuration", aliases=("compression-key", "ckey"), cli_only=True,
               args_hint="[--save] [--provider name] [--model name] [KEY]"),
