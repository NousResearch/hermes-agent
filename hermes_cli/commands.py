...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("ctx", "Show a compact context brief for the current gateway thread", "Session",
               gateway_only=True, aliases=("brief", "where")),
    ...
    CommandDef("qa", "Review Telegram Quick Action routing candidates",
               "Tools & Skills", aliases=("quick-actions",),
               args_hint="[list|show|promote|discard|prune-active]",
               subcommands=("list", "ls", "show", "promote", "discard", "prune-active")),
