...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("rollback", "List or restore filesystem checkpoints", "Session",
               args_hint="[number]"),
    CommandDef("snapshot", "Runtime state snapshots — create, list, rewind, branch, WAL", "Session",
               aliases=("snap",), args_hint="[list|create|rewind <id>|diff <a> <b>|prune|branch|wal]"),
