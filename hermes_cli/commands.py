...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("topic", "Enable Telegram DM topic sessions or inspect group-topic context", "Session",
               gateway_only=True, args_hint="[off|help|set|workdir|skills|session-id]"),
