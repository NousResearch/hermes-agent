...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("branch", "Branch the current session (new thread on Discord/Telegram/Slack; --here keeps current surface)", "Session",
               aliases=("fork",), args_hint="[name | --here [name]]"),
