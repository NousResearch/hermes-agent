...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("extend", "Add N minutes to the current turn's inactivity timeout", "Session",
               gateway_only=True, args_hint="[minutes]",
               busy_policy="dispatch", busy_handler="extend"),
