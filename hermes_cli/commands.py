...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("kill", "Close the current Telegram topic without deleting its history", "Session",
               gateway_only=True, busy_policy="interrupt_then_dispatch", busy_handler="kill"),
