...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("ard", "Agentic Resource Discovery — search registries, publish catalog, serve",
               "Tools & Skills", args_hint="[search|publish|serve|catalog] [query]",
               aliases=("ard-discover",),
               subcommands=("search", "publish", "serve", "catalog")),
