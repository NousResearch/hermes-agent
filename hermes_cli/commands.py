...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("learn", "Learn repeat workflows and draft automations for approval",
               "Tools & Skills", args_hint="[status|start|pause|resume|stop|review|delete-data]",
               subcommands=("status", "start", "pause", "resume", "stop", "review", "delete-data", "config")),
