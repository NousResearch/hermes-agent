...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("context", "Inspect or control the current gateway thread context", "Session",
               gateway_only=True, args_hint="[status|pause|resume|clear|summarize]"),
    ...
    CommandDef("controls", "Show Mattermost-friendly model, reasoning, and permissions controls",
               "Configuration", aliases=("control", "runtime"),
               args_hint="[status]"),
    CommandDef("permissions", "Show or change command approval bypass for this session",
               "Configuration", aliases=("perms", "approval-mode"),
               args_hint="[status|session|manual]",
               subcommands=("status", "session", "yolo", "on", "manual", "normal", "off")),
