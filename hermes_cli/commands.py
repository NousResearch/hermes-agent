...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("kanban", "Multi-profile collaboration board (tasks, links, comments)",
               ...
               busy_policy="dispatch"),
    CommandDef("workflows", "Import visual workflows from Hermes Studio and inspect blueprints",
               "Tools & Skills", cli_only=True, args_hint="[import-studio|list|show]",
               subcommands=("import-studio", "list", "show")),
