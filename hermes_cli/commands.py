...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("leave", "Stop responding in current Slack thread (use @mention to re-enable)", "Session",
               gateway_only=True, args_hint=""),
    CommandDef("silent", "Go silent in current Slack thread but keep context (use @mention to re-enable)", "Session",
               gateway_only=True, args_hint=""),
