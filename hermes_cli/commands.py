...
COMMANDS = {
    ...
    "/clear": "Clear screen and reset conversation (same session)",
    "/history": "Show conversation history",
    "/new": "Start a new session (fresh session ID + empty history)",
    "/reset": "Reset conversation history only (keep same session)",
