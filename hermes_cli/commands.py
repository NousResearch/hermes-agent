...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("curator", "Background skill maintenance (status, report, run, pin, archive, list-archived)",
               "Tools & Skills", args_hint="[subcommand]",
               subcommands=("status", "report", "run", "pause", "resume", "pin", "unpin", "restore", "list-archived")),
