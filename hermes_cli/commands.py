...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("skill-candidates", "List, inspect, approve, or reject layered memory skill candidates",
               "Tools & Skills", cli_only=True,
               args_hint="[list|inspect <name>|approve <name>|reject <name> [reason]]",
               subcommands=("list", "inspect", "approve", "reject")),
