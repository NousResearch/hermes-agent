...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("close-task", "Close an eligible Kanban task via the authoritative lifecycle engine", "Tools & Skills",
               args_hint="<task|reference> [--board <board>] [--result <text>] [--summary <text>]", cli_only=True,
               gateway_config_gate="kanban.close_task_command", busy_policy="dispatch"),
