...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("awf", "Agent Workflow Synthesis status and local approval gates",
               "Tools & Skills", gateway_only=True,
               args_hint="status|details <issue-or-run>|approve <issue-or-run> <stage>|reject <issue-or-run> <stage> <reason>",
               subcommands=("status", "details", "approve", "reject")),
