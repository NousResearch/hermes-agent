...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("goal", "Set a standing goal Hermes works on across turns until achieved", "Session",
               args_hint="[text | pause | resume | clear | status | remove N]"),
    ...
    # Tools & Skills
    CommandDef("tools", "Manage tools, toolsets, skills, bundles, MCPs and reloads", "Tools & Skills",
               args_hint="[list|disable|enable|reload-mcp|reload-skills] [name...]", cli_only=True),
    ...
    CommandDef("reload", "Reload .env, MCP servers, or skills", "Tools & Skills",
               cli_only=True, args_hint="[env|mcp|skills]"),
