...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("compress", "Manually compress conversation context", "Session",
               aliases=("c",), args_hint="[focus topic]"),
    CommandDef("handoff", "새 세션용 이어가기 안내를 생성", "Session",
               aliases=("h", "continuity"), args_hint="[current next step]"),
    CommandDef("move", "새 세션을 만들고 같은 인계문을 첫 컨텍스트로 전달", "Session",
               aliases=("m",), args_hint="[current next step]"),
