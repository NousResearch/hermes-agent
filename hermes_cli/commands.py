...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("persona", "Route this chat through a Donna specialist persona", "Session",
               gateway_only=True, args_hint="[list|cos|<profile> [prompt]]",
               subcommands=("list", "cos", "eng", "kb", "personal", "pm", "data", "finance", "legal", "ops")),
