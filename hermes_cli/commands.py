...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("access", "Manage this gateway's DM/group allowlists from chat (admins)", "Configuration",
               gateway_only=True, args_hint="[list | allow|deny user|group <ref>]",
               subcommands=("list", "allow", "deny"), busy_policy="dispatch"),
