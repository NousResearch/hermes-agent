...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("loop", "Durable outcome runner: plan, run one story at a time, verify with evidence", "Session",
               args_hint="start <outcome> | status | plan | run next | complete <id> --evidence <path> | block <id> <reason> | review | close",
               subcommands=("start", "status", "docs", "grill", "plan", "run", "complete", "block", "review", "close")),
