...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("claude", "Ask Claude Code once (default opus + xhigh)", "Session",
               args_hint="<question>", gateway_only=True, gateway_platforms=("discord",)),
    CommandDef("codex", "Ask Codex once (default gpt-5.5 + xhigh)", "Session",
               args_hint="<question>", gateway_only=True, gateway_platforms=("discord",)),
    CommandDef("tmux_claude", "Open or manage a persistent Claude tmux worker in Discord", "Session",
               args_hint="<title>", subcommands=("status", "tail", "stop"), gateway_only=True, gateway_platforms=("discord",)),
    CommandDef("tmux_codex", "Open or manage a persistent Codex tmux worker in Discord", "Session",
               args_hint="<title>", subcommands=("status", "tail", "stop"), gateway_only=True, gateway_platforms=("discord",)),
    ...
    # Info
    CommandDef("root", "Browse the Obsidian vault root", "Info",
               gateway_only=True),
