...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("deliver", "Enforced actor-critic delivery — worker implements, critic reviews, loops until COMPLETE",
               "Tools & Skills", args_hint="<task>"),
    CommandDef("fanout", "Decompose task into stories, run deliver per story with state tracking",
               "Tools & Skills", args_hint="<task>", aliases=("fo",)),
