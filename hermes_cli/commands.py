...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("interrupt", "Interrupt the current task and start a new one", "Session",
               args_hint="<prompt>"),
    CommandDef("cancel", "Cancel the current or specified task", "Session",
               args_hint="[task-summary]"),
