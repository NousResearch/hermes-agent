...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("reasoning", "Manage reasoning effort and display", "Configuration",
               args_hint="[level: none|minimal|low|medium|high|xhigh|max|show|hide|reset]",
               subcommands=("none", "minimal", "low", "medium", "high", "xhigh", "max", "reset", "show", "hide", "on", "off", "full", "clamp")),
