...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("background", "Detach this turn or run a background prompt", "Session",
               aliases=("bg", "btw"), args_hint="[prompt]", busy_policy="dispatch",
               busy_handler="background"),
    CommandDef("back", "Move a live Telegram agent to the background", "Session",
               gateway_only=True, args_hint="<session-id>", busy_policy="dispatch"),
    CommandDef("front", "Move a live Telegram agent to the foreground", "Session",
               gateway_only=True, args_hint="<session-id>", busy_policy="dispatch"),
