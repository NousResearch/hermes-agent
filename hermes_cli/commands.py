...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("quota", "Provider quota read-out — /quota lists the options with live examples",
               "Configuration", cli_only=True,
               args_hint="[session|both|weekly|tightest|off]",
               subcommands=("session", "both", "weekly", "tightest", "off", "status")),
