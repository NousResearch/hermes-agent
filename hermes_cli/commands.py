...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef(
        "ingest",
        "Run a Slack-history ingest workflow from natural-language instructions",
        "Session",
        gateway_only=True,
        args_hint="<request>",
    ),
    ...
    CommandDef("slack-ingest", "Run a Slack channel-history wiki ingest from a natural-language request",
               "Tools & Skills", gateway_only=True, args_hint="<what to ingest and save>"),
