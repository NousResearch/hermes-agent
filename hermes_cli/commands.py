...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("approve", "Approve a pending command or Kanban request", "Session",
               gateway_only=True, args_hint="[request-id|session|always]"),
    CommandDef("deny", "Deny a pending command or Kanban request", "Session",
               gateway_only=True,
               args_hint="[request-id [reason]|all [reason]]"),
