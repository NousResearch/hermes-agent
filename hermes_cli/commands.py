...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("footer", "Toggle gateway runtime-metadata footer on final replies",
               ...
               busy_policy="dispatch", desktop="terminal"),
    CommandDef("mute", "Silence this chat — drop messages without replying until /unmute",
               "Session", aliases=("unmute",), gateway_only=True,
               args_hint="[duration|off|status]",
               subcommands=("off", "status"), busy_policy="dispatch"),
