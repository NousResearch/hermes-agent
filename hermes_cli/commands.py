...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("forge", "Generate a NightForge-style goal for Telegram", "Session",
               gateway_only=True, args_hint="[tonight|status|pause|resume|clear|history]",
               subcommands=("tonight", "status", "pause", "resume", "clear", "history")),
