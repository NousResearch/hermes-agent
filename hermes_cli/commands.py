...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("approve", "Approve a pending dangerous command", "Session",
               gateway_only=True, args_hint="[session|always|for <duration>|<n> times]", busy_policy="dispatch",
               desktop="messaging"),
    CommandDef("deny", "Deny a pending dangerous command (optionally with a reason)", "Session",
               ...
               desktop="messaging"),
    CommandDef("grants", "List or revoke this chat's time-boxed approval grants", "Session",
               gateway_only=True, args_hint="[revoke <id>|revoke all]", subcommands=("revoke",),
