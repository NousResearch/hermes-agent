...
OPTIONAL_ENV_VARS = {
    ...
    "HERMES_PRODUCER_NORMALIZER_ENABLED": {
        "description": "Enable Producer Normalizer gate between producer and reviewer (1=on, 0=off)",
        "prompt": "Producer Normalizer enabled",
        "url": None,
        "password": False,
        "category": "setting",
        "advanced": True,
    },
    "HERMES_PRODUCER_NORMALIZER_VERSION": {
        "description": "Producer Normalizer ruleset version (1.0.0 or 1.1.0)",
        "prompt": "Producer Normalizer version",
        "url": None,
        "password": False,
        "category": "setting",
        "advanced": True,
    },
    "HERMES_PRODUCER_NORMALIZER_SHADOW_MODE": {
        "description": "Producer Normalizer shadow mode (1=on: log without blocking; 0=off: enforce)",
        "prompt": "Producer Normalizer shadow mode",
        "url": None,
        "password": False,
        "category": "setting",
        "advanced": True,
    },
    "HERMES_PRODUCER_NORMALIZER_LIMITED_ENFORCE": {
        "description": "Producer Normalizer limited enforce mode (1=on: skip reviewer only for NO_EVIDENCE and deterministic BLOCKED; 0=off: shadow or global enforce)",
        "prompt": "Producer Normalizer limited enforce",
        "url": None,
        "password": False,
        "category": "setting",
        "advanced": True,
    },
    "HERMES_ORCHESTRATOR_BATCH_ENABLED": {
        "description": "Orchestrator batch runner enabled (1=on: BatchRunner wired to Kanban; 0=off)",
        "prompt": "Orchestrator batch enabled",
        "url": None,
        "password": False,
        "category": "setting",
        "advanced": True,
    },
    "HERMES_ORCHESTRATOR_BATCH_SHADOW_MODE": {
        "description": "Orchestrator batch shadow mode (1=on: log without mutating Kanban; 0=off: enforce)",
        "prompt": "Orchestrator batch shadow mode",
        "url": None,
        "password": False,
        "category": "setting",
        "advanced": True,
    },
    "HERMES_ORCHESTRATOR_BATCH_MAX_CONCURRENT_WORKERS": {
        "description": "Orchestrator batch max concurrent workers (1..N)",
        "prompt": "Orchestrator batch max concurrent workers",
        "url": None,
        "password": False,
        "category": "setting",
        "advanced": True,
    },
    "HERMES_ORCHESTRATOR_BATCH_ALLOWLIST": {
        "description": "Comma-separated task_ids allowlist (only these tasks may be mutated; empty = no batch)",
        "prompt": "Orchestrator batch allowlist",
        "url": None,
        "password": False,
        "category": "setting",
        "advanced": True,
    },
    "HERMES_ORCHESTRATOR_BATCH_DRY_RUN": {
        "description": "Orchestrator batch dry-run (1=on: no Kanban mutation, intent-only; 0=off: real mutations)",
        "prompt": "Orchestrator batch dry run",
        "url": None,
        "password": False,
        "category": "setting",
        "advanced": True,
