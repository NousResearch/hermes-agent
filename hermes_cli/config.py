...
OPTIONAL_ENV_VARS = {
    ...
    "HERMES_DASHBOARD_ALLOW_REMOTE_WS": {
        "description": "Allow WebSocket connections from remote hosts/proxies (bypasses loopback check)",
        "prompt": "Allow remote WebSocket connections (true/false)",
        "url": None,
        "password": False,
        "category": "setting",
    },
