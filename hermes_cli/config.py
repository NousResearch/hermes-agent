...
OPTIONAL_ENV_VARS = {
    ...
    "SIGNAL_HTTP_URL": {
        "description": "signal-cli daemon HTTP endpoint",
    ...
    "SIGNAL_ACCOUNT": {
        ...
        "prompt": "Signal account (+1234567890)",
        "url": None,
        "password": False,
        "category": "messaging",
    },
    "SIGNAL_ALLOWED_USERS": {
        "description": "Comma-separated Signal user IDs allowed to use the bot",
        "prompt": "Allowed Signal user IDs",
        "url": None,
        "password": False,
        "category": "messaging",
    },
    "SIGNAL_GROUP_ALLOWED_USERS": {
        "description": "Signal group IDs allowed to interact (preferred name)",
        "prompt": "Allowed group IDs (empty = disabled)",
        "url": None,
        "password": False,
        "category": "messaging",
    },
    ...
    "SIGNAL_GROUP_POLICY": {
        "description": "Group policy: disabled, allowlist, or open",
        "prompt": "Group policy",
        "url": None,
        "password": False,
        "category": "messaging",
    ...
    "SIGNAL_IGNORE_ATTACHMENTS": {
        "description": "Ignore incoming attachments (true/false)",
        "prompt": "Ignore attachments",
        "url": None,
        "password": False,
        "category": "messaging",
        "advanced": True,
    ...
    "SIGNAL_IGNORE_STORIES": {
        "description": "Ignore story updates (true/false)",
        "prompt": "Ignore stories",
        "url": None,
        "password": False,
        "category": "messaging",
        "advanced": True,
    ...
    "SIGNAL_DEBUG": {
        "description": "Enable verbose debug logging for Signal adapter (true/false)",
        "prompt": "Enable Signal debug logging",
        "url": None,
        "password": False,
        "category": "messaging",
        "advanced": True,
