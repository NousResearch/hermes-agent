...
OPTIONAL_ENV_VARS = {
    ...
    "X402_BASE_URL": {
        "description": "x402 router base URL",
        "prompt": "x402 router base URL",
        "url": None,
        "password": False,
        "category": "provider",
        "advanced": True,
    ...
    "X402_AUTH_HELPER_CMD": {
        "description": "Command that prints JSON request headers for x402 auth (fallback)",
        "prompt": "x402 auth helper command",
        "url": None,
        "password": False,
        "category": "provider",
        "advanced": True,
    ...
    "X402_PAYMENT_SIGNATURE": {
        "description": "Static x402 payment signature header value (advanced fallback)",
        "prompt": "x402 payment signature",
        "url": None,
        "password": True,
        "category": "provider",
        "advanced": True,
    ...
    "X402_PAYMENT_HEADER": {
        "description": "x402 payment header name override",
        "prompt": "x402 payment header name",
        "url": None,
        "password": False,
        "category": "provider",
        "advanced": True,
