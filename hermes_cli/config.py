...
OPTIONAL_ENV_VARS = {
    ...
    "AAMP_BASE_URL": {
        "description": "AAMP management-service base URL (defaults to https://meshmail.ai when unset)",
        "prompt": "AAMP service URL",
        "url": None,
        "password": False,
        "category": "messaging",
    },
    "AAMP_SLUG": {
        "description": "Optional override for the AAMP auto-registration slug (defaults to hermes)",
        "prompt": "AAMP mailbox slug override",
        "url": None,
        "password": False,
        "category": "messaging",
        "advanced": True,
    ...
    "AAMP_EMAIL": {
        "description": "Explicit AAMP mailbox email (optional when using auto-registration)",
        "prompt": "AAMP mailbox email",
        "url": None,
        "password": False,
        "category": "messaging",
        "advanced": True,
    ...
    "AAMP_PASSWORD": {
        "description": "Explicit AAMP mailbox SMTP password (optional when using auto-registration)",
        "prompt": "AAMP mailbox password",
        "url": None,
        "password": True,
        "category": "messaging",
        "advanced": True,
    ...
    "AAMP_MAILBOX_TOKEN": {
        "description": "AAMP mailbox token in base64(email:password) form",
        "prompt": "AAMP mailbox token",
        "url": None,
        "password": True,
        "category": "messaging",
        "advanced": True,
    ...
    "AAMP_ALLOWED_USERS": {
        "description": "Comma-separated AAMP peer mailbox emails allowed to use Hermes",
        "prompt": "Allowed AAMP peer mailboxes (comma-separated)",
        "url": None,
        "password": False,
        "category": "messaging",
    },
    "AAMP_SENDER_POLICIES": {
        "description": "JSON sender policies for AAMP, with optional exact-match X-AAMP-Dispatch-Context rules per sender",
        "prompt": "AAMP sender policies JSON",
        "url": None,
        "password": False,
        "category": "messaging",
        "advanced": True,
    ...
    "AAMP_HOME_CHANNEL": {
        "description": "Default AAMP peer mailbox email for cron results and notifications",
        "prompt": "AAMP home mailbox",
        "url": None,
        "password": False,
        "category": "messaging",
    },
    "AAMP_CREDENTIALS_FILE": {
        "description": "Path to the cached AAMP mailbox identity JSON file",
        "prompt": "AAMP credentials file path",
        "url": None,
        "password": False,
        "category": "messaging",
        "advanced": True,
    ...
    "AAMP_POLL_INTERVAL": {
        "description": "Reconnect / polling-fallback interval in seconds for the AAMP Python SDK",
        "prompt": "AAMP reconnect interval",
        "url": None,
        "password": False,
        "category": "messaging",
        "advanced": True,
    },
    "AAMP_REJECT_UNAUTHORIZED": {
        "description": "Whether Hermes verifies TLS certificates for the AAMP SDK connection (true/false)",
        "prompt": "Verify AAMP TLS certificates (true/false)",
        "url": None,
        "password": False,
        "category": "messaging",
        "advanced": True,
    ...
    "AAMP_DESCRIPTION": {
        "description": "Description used when Hermes auto-registers an AAMP mailbox",
        "prompt": "AAMP mailbox description",
        "url": None,
        "password": False,
        "category": "messaging",
        "advanced": True,
    ...
    "AAMP_ALLOW_ALL_USERS": {
        "description": "Allow all AAMP peer mailboxes to use Hermes (true/false)",
        "prompt": "Allow all AAMP users (true/false)",
        "url": None,
        "password": False,
        "category": "messaging",
        "advanced": True,
