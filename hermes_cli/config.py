...
DEFAULT_CONFIG = {
    ...
    "compression": {
        ...
        "snapshot_before_compress": False,  # Save raw messages to ~/.hermes/sessions/{sid}_pre_compact.json before compression
        "warn_before_compress": False,      # Emit a warning to gateway chats before auto-compression fires
    },
