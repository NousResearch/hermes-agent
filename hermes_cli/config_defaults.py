...
DEFAULT_CONFIG = {
    ...
    "kanban": {
        # Optional base for board-qualified scratch workspaces. When mount
        # admission is required the dispatcher refuses, rather than falling
        # back to durable storage, if this root is unavailable.
