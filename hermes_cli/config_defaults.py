...
DEFAULT_CONFIG = {
    ...
    "kanban": {
        # Optional route for this profile's workers when a task has no explicit
        # model/provider override. Both values must be non-empty to take effect;
        # empty values preserve the assigned profile's configured route.
        "default_model": "",
        "default_provider": "",
