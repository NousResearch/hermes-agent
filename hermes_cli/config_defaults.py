...
DEFAULT_CONFIG = {
    ...
    "compression": {
        ...
        # A raised floor is opportunistic, not absolute: the tail is token-bounded and never above
        # 20% of the window; oversized rows don't ride the floor past that (#108647).
