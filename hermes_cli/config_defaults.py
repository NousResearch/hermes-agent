...
DEFAULT_CONFIG = {
    ...
    "tool_loop_guardrails": {
        ...
        "loop_caps": {
            ...
            "max_tool_searches": 20,  # tool_search (tool-discovery) calls per turn
        },
    },
    ...
    "tools": {
        "tool_search": {
            ...
            "max_search_limit": 25,
            # Maximum description characters returned for each search hit. Full metadata
            # remains available through tool_describe. Range 80..1000.
            "max_description_chars": 400,
            # Cap the top-level description returned by tool_describe. The parameter schema
            # is preserved so calls remain reliable. Range 200..4000.
