...
def auto_migration_opted_out(default_home: Path) -> bool:
    ...
    false, not truthy. The previously documented nested ``gateway.auto_migrate`` is also honored:
    either explicit false vetoes migration. There is no top-level alias."""
