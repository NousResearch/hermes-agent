...
_DEFAULT_PAYLOADS = {
    ...
    "post_agent_result": {
        "event": {
            "schema_version": "hermes.observer.v1",
            "event": "agent.result",
            "actor": "root",
            "role": "root",
            "session_id": "test-session",
            ...
            "lineage_sha256": "0" * 64,
            "lineage_hash_input_complete": True,
            "lineage_hash_input_truncated_fields": "",
            "result_kind": "returned",
            "completed": True,
            "failed": False,
            "partial": False,
            "interrupted": False,
            "response_transformed": False,
            "output": "Synthetic final response for hooks test",
            "output_type": "text",
            "output_chars": 39,
            "output_truncated": False,
            "output_excerpt_sha256": "0" * 64,
            "error": "",
            "error_chars": 0,
