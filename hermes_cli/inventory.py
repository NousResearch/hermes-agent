...
def build_models_payload(
    ...
    return {
        "providers": rows, "model": ctx.current_model, "provider": ctx.current_provider,
        "preferred_models": [{"provider": provider, "model": model} for provider, model in ctx.preferred_models],
    }
