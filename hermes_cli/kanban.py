...
def _cmd_dispatch(args: argparse.Namespace) -> int:
    ...
    try:
        ...
        stale_timeout_seconds = _coerce_positive_int(
            _kanban_cfg.get("dispatch_stale_timeout_seconds")
        ) or 0
        stale_heartbeat_gap_seconds = _coerce_positive_int(
            _kanban_cfg.get("dispatch_stale_heartbeat_gap_seconds")
        )
        ...
        stale_heartbeat_gap_seconds = None
