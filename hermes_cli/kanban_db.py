...
class Task:
    ...
    # Parsed JSON; the raw declaration is immutable once the card is created.
    ...
    def from_row(cls, row: sqlite3.Row) -> "Task":
        ...
        return cls(
            ...
            **{col: g(col) or None for col in _TASK_EMPTY_IS_NULL_COLUMNS},
            ...
            skills=skills_value,
            execution_contract=_json_or(g("execution_contract")),
...
def create_task(
    ...
    from hermes_cli.kanban_execution_contract import validate_execution_contract
            ...
            with write_txn(conn, allow_nested=True):
                ...
                conn.execute(
                    ...
                    INSERT INTO tasks (
                        ...
                        reasoning_effort,
                        goal_mode, goal_max_turns, session_id, completion_contract, execution_contract
                    ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
                    """,
                    (
                        ...
                        json.dumps(execution_contract) if execution_contract is not None else None,
                    ),
                )
                for pid in parents:
