...
_TASK_RUN_COLUMNS = (
    # PID reuse is common enough on long-lived hosts that a terminal-worker
    # sweep must retain the process incarnation captured at spawn, not PID
    # alone. NULL is deliberately unreapable for pre-migration runs.
