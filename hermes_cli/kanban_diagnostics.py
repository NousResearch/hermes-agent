...
def _rule_repeated_failures(task, events, runs, now, cfg) -> list[Diagnostic]:
    ...
    for r in reversed(ordered_runs):
        ...
        if oc in {"spawn_failed", "timed_out", "progress_stalled", "crashed"}:
    ...
    elif most_recent_outcome in {"timed_out", "progress_stalled", "crashed"}:
    ...
    outcome_label = {
        "spawn_failed": "spawn",
        "timed_out": "timeout",
        "progress_stalled": "progress timeout",
        "crashed": "crash",
