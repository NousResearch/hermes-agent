...
_SPECS = [
    ...
    _cmd("create", [
        ...
        _arg("--completion-contract", metavar="CONTRACT",
             help="local-only (default), OWNER/REPO or exact GitHub PR URL, gitlab[-merged]:HOST/PROJECT or exact "
                  "GitLab MR URL; required CI (and, for -merged, the merge) gates done."),
