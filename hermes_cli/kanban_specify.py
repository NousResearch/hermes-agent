...
def _load_triage_task(task_id: str) -> tuple[Optional[_owner_kanban_db_models.Task], str]:
...
def _task_prompt_fields(task: _owner_kanban_db_models.Task) -> dict[str, str]:
