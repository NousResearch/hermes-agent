...
# _SUPERVISOR is assigned only after start() completes its health wait. Serialize the full boot
# so the backend-start thread and an on-demand resolution kick cannot both spawn a router there.
