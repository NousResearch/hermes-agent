...
_PROVIDER_MODEL_FLOWS = {
    ...
    "commandcode-oauth": lambda c, m, a: _model_flow_commandcode_oauth(c, m, args=a),
    "command-code": lambda c, m, a: _model_flow_commandcode_oauth(c, m, args=a),
