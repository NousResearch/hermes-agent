...
def main():
    ...
    moa_activate = moa_subparsers.add_parser("activate", aliases=["use"], help="Make a MoA preset the active /moa preset")
    moa_activate.add_argument("name", help="Preset name to activate")
    moa_subparsers.add_parser("deactivate", aliases=["off"], help="Clear the active /moa preset override")
