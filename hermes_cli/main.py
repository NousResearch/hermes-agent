...
def _do_build_web_ui(web_dir: Path, *, fatal: bool = False) -> bool:
    ...
    if not npm:
        ...
        return not fatal
    build_env = _web_ui_build_env(with_hermes_node_path())
    # Match hermes update step style:
    #   → Building web UI...
    #     bundling pages ✓
    #     vendors ✓
    #     assets ✓
    #   Web UI Complete
    # On failure: what broke + meaning + error detail, then a solution line.
    _say("")
    ...
    def _run_web_build() -> "subprocess.CompletedProcess":
        ...
        # still surface and failures can relay logs (#33788).
