...
Usage:
    ...
    hermes uninstall           Uninstall metakina-agent
...
def cmd_whatsapp(args):
    ...
    if (session_dir / "creds.json").exists():
        ...
        if wa_mode == "bot":
            ...
            print()
            print("  Tip: Agent responses are prefixed with '元话 Agent'")
        else:
            print("  Next steps:")
            print("    1. Start the gateway:  hermes gateway")
...
def cmd_version(args):
    """Show version."""
    print(f"元话 Agent / metakina-agent v{__version__} ({__release_date__})")
...
def cmd_update(args):
    """Update metakina-agent to the latest version.
    ...
    if is_managed():
        managed_error("update metakina-agent")
        return
...
def main():
    ...
    setup_parser = subparsers.add_parser(
        ...
        description="Configure 元话 Agent with an interactive wizard. "
    ...
    status_parser = subparsers.add_parser(
        ...
        description="Display status of metakina-agent components",
    )
    ...
    doctor_parser = subparsers.add_parser(
        ...
        description="Diagnose issues with metakina-agent setup",
    )
    ...
    debug_parser = subparsers.add_parser(
        ...
        description="Debug utilities for metakina-agent. Use 'hermes debug share' to "
...
""",
    ...
    config_parser = subparsers.add_parser(
        ...
        description="Manage metakina-agent configuration",
    )
    ...
    update_parser = subparsers.add_parser(
        "update",
        help="Update metakina-agent to the latest version",
    ...
    uninstall_parser = subparsers.add_parser(
        "uninstall",
        help="Uninstall metakina-agent",
        description="Remove metakina-agent from your system. Can keep configs/data for reinstall.",
    )
    ...
    acp_parser = subparsers.add_parser(
        "acp",
        help="Run metakina-agent as an ACP (Agent Client Protocol) server",
        description="Start metakina-agent in ACP mode for editor integration (VS Code, Zed, JetBrains)",
    )
    _add_accept_hooks_flag(acp_parser)

    def cmd_acp(args):
        """Launch metakina-agent as an ACP server."""
        try:
    ...
    dashboard_parser = subparsers.add_parser(
        ...
        description="Launch the metakina-agent web dashboard for managing config, API keys, and sessions",
    )
