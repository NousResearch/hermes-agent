...
def _lap_user_provider_rows(b: _PickerBuild, user_providers: dict) -> None:
    ...
    for grp in ep_groups.values():
        ...
        # KENSEI CUSTOM (ported from 5a3466e349): xkiro-free serves cached non-free models;
        # restrict the row to free-tier SKUs so the picker matches the plan's actual access.
