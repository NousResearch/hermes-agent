...
CANONICAL_PROVIDERS: list[ProviderEntry] = [
    ...
    ProviderEntry("google-antigravity", "Google Antigravity (OAuth)", "Google Antigravity (OAuth via Google account — no API key needed)"),
...
PROVIDER_GROUPS: dict[str, tuple[str, str, list[str]]] = {
    ...
    "google":   ("Google Gemini",   "AI Studio (API key), Antigravity OAuth, or Vertex AI", ["gemini", "google-antigravity", "vertex"]),
