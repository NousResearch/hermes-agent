...
# Most non-api-key flows need bespoke picker UX and are skipped.  External-process
# profiles are the exception: their generic auth-status and model-discovery contracts
# are sufficient for the normal picker, so out-of-tree ACP providers can participate.
