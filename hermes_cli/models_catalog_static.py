...
_PROVIDER_MODELS: dict[str, list[str]] = {
    ...
    # Hyphenated exactly as Anthropic's /v1/models answers: a dotted curated id and its live
    # hyphenated twin both survive the curated-first merge, so the picker shows one model twice.
    "anthropic": [
