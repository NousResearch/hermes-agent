...
the CLI through OS package managers and signed installers, so IX Agency expects
...
def cmd_setup(args: argparse.Namespace) -> int:
    ...
    console.print(
        Panel.fit(
            ...
            "IX Agency resolves [cyan]op://vault/item/field[/cyan] references through your\n"
    ...
    if binary and not token_set:
        ...
        if who:
            ...
            console.print(
                ...
                "IX Agency will warn and skip 1Password on next startup.[/yellow]"
            )
    if not references:
        console.print(
