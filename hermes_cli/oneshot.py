...
def _run_agent(
    ...
    # again and returns to it once the window lifts. ``choice.model`` moves with
    # the provider: swapping one while keeping the other would send e.g. a
