...
VALID_HOOKS: Set[str] = {
    ...
    # respawn_guarded, skipped_self_review, skipped_per_profile_capped, skipped_unassigned,
    # skipped_nonspawnable, skipped_locked). Privacy: result carries task ids, assignees, and workspace paths.
