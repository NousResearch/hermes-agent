...
def _join_background_discovery(timeout: float = 30.0) -> None:
    ...
    # The worker waits for the installation lock this thread holds: discover inline instead of
    # joining it, and cancel the queued sweep so it cannot resurrect what this thread unloads.
