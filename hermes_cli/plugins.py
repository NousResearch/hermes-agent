...
class PluginManager(PluginLoaderMixin, PluginDispatchMixin, PluginLedgerMixin):
    ...
    def __init__(self, scope_key: Optional[str] = None) -> None:
        ...
        # policy hook cannot spawn a new abandoned thread on every fire. The per-callback FIFO
        # serializes healthy concurrent invocations instead of dropping them.
        self._hook_callback_waiters: Dict[tuple, List[threading.Event]] = {}
