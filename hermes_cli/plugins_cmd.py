...
# Sibling modules' names are re-exported here (origin) so callers and tests keep one import path.
from hermes_cli.plugins_cmd_git_update import (  # noqa: F401 — re-exported
    _autostash_dirty_tree, _clear_plugin_bytecode, _git_pull_plugin_dir, _reapply_stash, _run_plugin_git,
    _stash_ref, noninteractive_git_env,
)
