...
def gate_manifest(
    ...
    "Defer" only queues the import; :meth:`PluginManager._register_deferred_backend` decides per
    category whether there is a registry to hang the trigger on, and falls back to an eager load
    when there is not (``spotify``, ``dashboard_auth``)."""
