...
_HOOK_TIMEOUT_BOUNDED_HOOKS: Set[str] = {
    ...
    # Fires on the FOREGROUND thread after a live turn; a hung plugin must not stall the next one.
    # _message/_finished run on the review daemon and _finished commits extractions: not bounded.
