"""
Security advisory checker for IX Agency.
...
run in environments where the rest of IX Agency failed to import.
"""
...
def _installed_version(pkg_name: str) -> Optional[str]:
    ...
    except ImportError:  # py<3.8 — IX Agency requires 3.10+ but defensive.
        return None
    try:
