...
def _refusal(target: str, current: str, *, on_cross_vm_fs: bool) -> Optional[str]:
    """Admission checks that need no I/O. The holder scan is the platform admission:
    foreign_state_db_holders() covers Windows through psutil too, and a missing psutil
    fails closed as an unknown-holder sentinel instead of an all-clear."""
