...
[dim #7A3511]⠀⠀⠀⠀⠀⠀⠀tail flame lit⠀⠀⠀⠀⠀⠀⠀⠀[/]""",
    ...
    "forest-teal": {
        "name": "forest-teal",
        "description": "Living studio — mint-teal on deep forest, calm and low-glare",
        "colors": {
            "background": "#0d1410",
            "ui_accent": "#4fe3c4",
            "banner_accent": "#4fe3c4",
            "ui_primary": "#cfeede",
            "banner_title": "#cfeede",
            "ui_text": "#c7d8cf",
            "banner_text": "#c7d8cf",
            ...
            "ui_thinking": "#6f8a7d",
            "ui_border": "#3a6e57",
            "banner_border": "#3a6e57",
            "session_border": "#3a6e57",
            "ui_tool": "#4fe3c4",
            "ui_ok": "#7fe6a3",
            "ui_warn": "#e6c074",
            "ui_error": "#f08a8a",
            "input_rule": "#4fe3c4",
            "response_border": "#7fe6a3",
            "status_bar_bg": "#08100c",
            "status_bar_text": "#c7d8cf",
            "status_bar_strong": "#cfeede",
            "status_bar_dim": "#6f8a7d",
            "status_bar_good": "#7fe6a3",
            "status_bar_warn": "#e6c074",
            "status_bar_bad": "#f08a8a",
            "status_bar_critical": "#f08a8a",
            "session_label": "#4fe3c4",
            "completion_menu_bg": "#0a130f",
            "completion_menu_current_bg": "#1a3a32",
            "selection_bg": "#1a3a32",
            "shell_dollar": "#4fe3c4",
            "voice_status_bg": "#0a130f",
        },
        "light_colors": {
            "banner_title": "#0F3A2E",
            "banner_accent": "#0E7A5F",
            "banner_dim": "#4A6358",
            "banner_text": "#16241E",
            "ui_accent": "#0E7A5F",
            "ui_label": "#0F3A2E",
            ...
            "prompt": "#16241E",
            "input_rule": "#3A6E57",
            "response_border": "#0E7A5F",
            "status_bar_bg": "#E7EFEA",
            "status_bar_text": "#16241E",
            "status_bar_strong": "#0E7A5F",
            "status_bar_dim": "#52655B",
            "status_bar_good": "#1B7A3E",
            "status_bar_warn": "#9A6400",
            "status_bar_bad": "#9A4226",
            "status_bar_critical": "#B23A48",
            "session_label": "#0E7A5F",
            "session_border": "#5C7A6C",
            "completion_menu_bg": "#EEF3EF",
            "completion_menu_current_bg": "#BBD8C8",
            "selection_bg": "#BBD8C8",
            "shell_dollar": "#0E7A5F",
            "voice_status_bg": "#E7EFEA",
        },
        "spinner": {},
        "branding": {
            "agent_name": "Hermes Agent",
