"""IX Agency CLI skin/theme engine.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "IX Agency"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " ⚕ IX Agency "       # Response box header label
...
.. code-block:: python
    ...
    print(skin.get_branding("agent_name"))  # "IX Agency"
...
- ``default`` — Classic IX Agency gold/kawaii (the current look)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic IX Agency — gold and kawaii",
        "colors": {
        ...
        "branding": {
            "agent_name": "IX Agency",
            "welcome": "Welcome to IX Agency! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " ✦ IX Agency ",
            "prompt_symbol": "❯",
