...
[dim #7A3511]⠀⠀⠀⠀⠀⠀⠀tail flame lit⠀⠀⠀⠀⠀⠀⠀⠀[/]""",
    ...
    'makima': {'name': 'makima',
            'description': 'Makima desktop palette port - warm gruvbox browns, gold accent, '
                           'burgundy edge',
            'colors': {'banner_border': '#d79921',
                       'banner_title': '#fabd2f',
                       'banner_accent': '#d3869b',
                       'banner_dim': '#a89984',
                       'banner_text': '#f0e8d0',
                       'ui_accent': '#d79921',
                       'ui_label': '#83a598',
                       ...
                       'prompt': '#f0e8d0',
                       'input_rule': '#5d141a',
                       'response_border': '#d79921',
                       'status_bar_bg': '#1d2021',
                       'status_bar_text': '#d5c4a1',
                       'status_bar_strong': '#fabd2f',
                       'status_bar_dim': '#a89984',
                       'status_bar_good': '#b8bb26',
                       'status_bar_warn': '#fabd2f',
                       'status_bar_bad': '#d79921',
                       'status_bar_critical': '#cc241d',
                       'session_label': '#d79921',
                       'session_border': '#504945',
                       'voice_status_bg': '#1d2021',
                       'selection_bg': '#504945',
                       'completion_menu_bg': '#1d2021',
                       'completion_menu_current_bg': '#504945',
                       'completion_menu_meta_bg': '#282828',
                       'completion_menu_meta_current_bg': '#5d141a'},
            'spinner': {'waiting_faces': ['(mk)', '(--)', '(..)', '(==)'],
                        'thinking_faces': ['(mk)', '(..)', '(??)', '(!!)'],
                        'thinking_verbs': ['watching threads',
                                           'pulling chains',
                                           'tempering plans',
                                           'reading contracts',
                                           'binding context',
                                           'shaping intent'],
                        'wings': [['[gold ', ' gold]'], ['{ctrl ', ' ctrl}'], ['<red ', ' red>']]},
            'branding': {'agent_name': 'Makima Hermes',
                         'welcome': 'Welcome to Makima Hermes. Type your message or /help for '
                                    'commands.',
                         'goodbye': 'Goodbye. Stay in control.',
                         'response_label': ' Makima Hermes ',
                         'prompt_symbol': '>',
                         'help_header': 'Makima commands'},
            'tool_prefix': '|',
            'tool_emojis': {'terminal': '>_',
                            'read_file': 'rd',
                            'write_file': 'wr',
                            'patch': 'pt',
                            'web_search': 'ws',
                            'web_extract': 'wx',
                            'delegate_task': 'dg'},
            'banner_logo': '[bold #fabd2f] __  __    _    _  _____ __  __    _    [/]\n'
                           '[bold #d79921]|  \\/  |  / \\  | |/ /_ _|  \\/  |  / \\   [/]\n'
                           "[#d3869b]     | |\\/| | / _ \\ | ' / | || |\\/| | / _ \\  [/]\n"
                           '[#cc241d]     | |  | |/ ___ \\| . \\ | || |  | |/ ___ \\ [/]\n'
                           '[#5d141a]     |_|  |_/_/   \\_\\_|\\_\\___|_|  |_/_/   \\_\\[/]\n',
            'banner_hero': '[#5d141a]        .-----------------------.[/]\n'
                           '[#cc241d]       /  CONTROL DEVIL DOSSIER  \\\\[/]\n'
                           '[#d79921]      |  bg #282828  fg #f0e8d0 |[/]\n'
                           '[#fabd2f]      |  gold #d79921 red #cc241d|[/]\n'
                           '[#d3869b]       \\\\__ warm terminal contract _/[/]\n'},
    'manjaro': {'name': 'manjaro',
             'description': 'Manjaro desktop palette port - midnight purple, hot magenta, teal '
                            'highlights',
             'colors': {'banner_border': '#e6207a',
                        'banner_title': '#ff1493',
                        'banner_accent': '#a96cef',
                        'banner_dim': '#6e6580',
                        'banner_text': '#e8e0f0',
                        'ui_accent': '#e6207a',
                        'ui_label': '#5cc8d8',
                        ...
                        'prompt': '#e8e0f0',
                        'input_rule': '#7b2fbe',
                        'response_border': '#e6207a',
                        'status_bar_bg': '#090714',
                        'status_bar_text': '#c4b8d8',
                        'status_bar_strong': '#ff1493',
                        'status_bar_dim': '#6e6580',
                        'status_bar_good': '#2eb398',
                        'status_bar_warn': '#f0c040',
                        'status_bar_bad': '#e6207a',
                        'status_bar_critical': '#ff1493',
                        'session_label': '#e6207a',
                        'session_border': '#1a1530',
                        'voice_status_bg': '#090714',
                        'selection_bg': '#1a1530',
                        'completion_menu_bg': '#090714',
                        'completion_menu_current_bg': '#1a1530',
                        'completion_menu_meta_bg': '#0d0b1a',
                        'completion_menu_meta_current_bg': '#7b2fbe'},
             'spinner': {'waiting_faces': ['(mj)', '(//)', '(~~)', '(**)'],
                         'thinking_faces': ['(mj)', '(**)', '(~~)', '(>>)'],
                         'thinking_verbs': ['sailing midnight',
                                            'threading magenta',
                                            'routing teal paths',
                                            'tuning plasma',
                                            'shaping violet context',
                                            'charting gradients'],
                         'wings': [['[neon ', ' neon]'],
                                   ['{violet ', ' violet}'],
                                   ['<teal ', ' teal>']]},
             'branding': {'agent_name': 'Manjaro Hermes',
                          'welcome': 'Welcome to Manjaro Hermes. Type your message or /help for '
                                     'commands.',
                          'goodbye': 'Smooth sailing.',
                          'response_label': ' Manjaro Hermes ',
                          'prompt_symbol': '>',
                          'help_header': 'Manjaro commands'},
             'tool_prefix': '|',
             'tool_emojis': {'terminal': '>_',
                             'read_file': 'rd',
                             'write_file': 'wr',
                             ...
                             'web_extract': 'wx',
                             'delegate_task': 'dg'},
             'banner_logo': '[bold #ff1493] __  __    _    _   _      _    ____   ___  [/]\n'
                            '[bold #e6207a]|  \\/  |  / \\  | \\ | |    | |  / ___| / _ \\ [/]\n'
                            '[#a96cef]     | |\\/| | / _ \\ |  \\| |_   | | | |  _ | | | |[/]\n'
                            '[#5cc8d8]     | |  | |/ ___ \\| |\\  | |__| | | |_| || |_| |[/]\n'
                            '[#2eb398]     |_|  |_/_/   \\_\\_| \\_|\\____/   \\____| \\___/ [/]\n',
             'banner_hero': '[#090714]        .-----------------------.[/]\n'
                            '[#1a1530]       /     SMOOTH SAILING      \\\\[/]\n'
                            '[#e6207a]      |  bg #0d0b1a mag #e6207a |[/]\n'
                            '[#5cc8d8]      |  teal #2eb398 vio #7b2fbe|[/]\n'
                            '[#ff1493]       \\\\__ midnight neon route __/[/]\n'}
}
