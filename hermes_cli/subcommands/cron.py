...
_CRON_EDIT_REASONING_CHOICES = (*_CRON_REASONING_CHOICES, "inherit")
...
def build_cron_parser(subparsers, *, cmd_cron: Callable) -> None:
    ...
    cron_edit.add_argument(
        "--reasoning-effort",
        choices=_CRON_EDIT_REASONING_CHOICES,
        help=(
            "Set this job's reasoning effort override. Use 'inherit' to "
            "clear it and inherit agent.reasoning_effort; use 'none' to "
