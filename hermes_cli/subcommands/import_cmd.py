...
def build_import_cmd_parser(subparsers, *, cmd_import: Callable) -> None:
    ...
    import_parser = subparsers.add_parser(
        "import",
        help="Restore a HT AI Agent backup from a zip file",
        description="Extract a previously created HT AI Agent backup into your "
        "HT AI Agent home directory, restoring configuration, skills, "
        "sessions, and data",
    )
