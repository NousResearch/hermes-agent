...
def _wizard_vscode() -> None:
    ...
    _info("Kitty keyboard protocol is enabled. Open Settings (JSON) and add:")
    _info("")
    _info('  "terminal.integrated.enableKittyKeyboardProtocol": true')
    _info("")
    _info("Then open a fresh integrated terminal tab. Update your VS Code-family")
    _info("editor if that setting is unavailable, or check its documentation for")
    _info("the equivalent setting.")
    _info("")
