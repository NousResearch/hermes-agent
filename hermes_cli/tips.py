...
TIPS = [
    ...
    "AGENTS.md is universal coordination policy; SOUL.md is the active profile's identity.",
    "Root SOUL.md customizes the default profile; named profiles use profiles/<name>/SOUL.md.",
