...
TIPS = [
    ...
    "Set approvals.mode: smart to let an LLM auto-approve low-risk commands and escalate high-risk ones for approval.",
    "Set approvals.mode: policy plus approvals.policy allow/ask/block rules for deterministic local approvals.",
