...
TIPS = [
    ...
    "delegate_task with acp_command: 'claude' spawns Claude Code as a subagent from any platform.",
    "Delegation has a heartbeat thread — subagent activity propagates to the parent, preventing gateway timeouts.",
