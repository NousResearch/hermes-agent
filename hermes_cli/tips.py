...
TIPS = [
    ...
    "hermes memory setup lets you configure an external memory provider (Recall, Honcho, Mem0, etc.).",
    ...
    "9 external memory providers available: Recall, Honcho, OpenViking, Mem0, Hindsight, and more.",
