...
TIPS = [
    ...
    "Set display.busy_input_mode: queue to queue messages, steer to inject mid-run, or menu for gateway action buttons.",
    ...
    '/busy queue|steer|interrupt|menu controls what follow-up input does while Hermes is working.',
