...
TIPS = [
    ...
    "hermes profile create work --clone copies config, keys, SOUL.md, curated memory, and skills; sessions stay fresh.",
    ...
    "hermes profile create backup --clone-all copies config, keys, SOUL.md, memories, skills, cron, and plugins; session history stays fresh.",
