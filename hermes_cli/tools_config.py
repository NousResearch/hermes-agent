...
CONFIGURABLE_TOOLSETS = [
    ...
    ("config",           "⚙️  Safe Config Changes",      "hermes_config_set (explicit safe leaves only)"),
]
...
_DEFAULT_OFF_TOOLSETS = {"homeassistant", "spotify", "discord", "discord_admin", "video", "video_gen", "x_search", "a2a", "config"}
