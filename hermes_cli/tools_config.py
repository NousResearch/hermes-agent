...
TOOL_CATEGORIES = {
    "tts": {
        ...
        "providers": [
            ...
            _row("Alibaba DashScope", "paid", "Qwen3-TTS, optimized for Chinese and multilingual speech",
                 [_key("DASHSCOPE_API_KEY", "DashScope API key", "https://modelstudio.console.alibabacloud.com/")],
    ...
    "stt": {
        ...
        "providers": [
            ...
            _row("Alibaba DashScope", "paid", "Qwen3-ASR, optimized for Chinese and multilingual speech",
                 [_key("DASHSCOPE_API_KEY", "DashScope API key", "https://modelstudio.console.alibabacloud.com/")],
