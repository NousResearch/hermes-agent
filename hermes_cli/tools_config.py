...
CONFIGURABLE_TOOLSETS = [
    ...
    ("buzz_admin",      "🐝 Buzz Channel Management",   "create and list channels with the active Buzz identity"),
...
_DEFAULT_OFF_TOOLSETS = {"homeassistant", "spotify", "discord", "discord_admin", "buzz_admin", "video", "video_gen", "x_search", "a2a"}
