...
from hermes_cli.update_cmd_deps import (  # noqa: F401
    ...
    _reapply_plugin_python_dependencies, _rebuild_desktop_after_update, _record_npm_lockfile_hash,
    _record_python_dependencies_hash, _refresh_active_lazy_features,
