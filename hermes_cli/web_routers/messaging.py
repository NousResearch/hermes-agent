...
Extracted from hermes_cli/web_server.py (god-file slice R4-C2C5, epic #78791):
the platform catalog builders, env-metadata discovery, and the Channels
management routes.  Cross-cluster helpers resolve through web_deps.late().
"""
...
# Cross-cluster helpers owned by web_server — late-bound (cycle-safe,
# monkeypatch-transparent).
_GATEWAY_HEALTH_URL = late("_GATEWAY_HEALTH_URL")
