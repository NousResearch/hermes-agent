...
# Both helpers are needed: get_process_hermes_home() is upstream's
# launch-profile home (used by the liveness probe), while the fork's weixin QR
# onboarding route resolves the *active* profile's home via get_hermes_home().
