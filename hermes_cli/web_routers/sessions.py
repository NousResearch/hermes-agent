...
async def get_session_messages(
    ...
    ``from_end`` is a one-shot tail selector: when true, ``offset`` is ignored
    and the response contains the newest page. The returned pagination offset
    is absolute; clients page backward by subtracting their next page size and
    omitting ``from_end``.
    """
