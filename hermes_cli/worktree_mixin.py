"""Git worktree isolation helpers — extracted verbatim from cli.py
(godfile shard s1, clusters c10 + c11, proposed module
hermes_cli/worktree_mixin.py).

Module-level functions and state that originally lived in cli.py at lines
1402-2115 (cluster c10) and 2213-2497 (cluster c11). cli.py re-imports every
name so the ``from cli import ...`` API (hermes_cli/main.py,
tests/cli/test_worktree_security.py, ...) is unchanged.
"""
