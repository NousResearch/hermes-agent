...
class SessionDB:
    ...
    def _conn(self) -> sqlite3.Connection:
        if getattr(self, "_conn_val", None) is None:
            self._connect_and_init()
        return self._conn_val

    @_conn.setter
    def _conn(self, value):
        self._conn_val = value
    ...
    def _connect_and_init(self):
        if self.read_only:
            ...
            self._conn_val = sqlite3.connect(
            ...
            self._conn_val.row_factory = sqlite3.Row
            return
        ...
        self._conn_val.row_factory = sqlite3.Row
        apply_wal_with_fallback(self._conn_val, db_label="state.db")
        self._conn_val.execute("PRAGMA foreign_keys=ON")
        self._init_schema()
    ...
    def __init__(self, db_path: Path = None, read_only: bool = False):
        ...
        try:
            try:
                ...
                try:
                    if self._conn_val is not None:
                        self._conn_val.close()
                except Exception:
                    pass
