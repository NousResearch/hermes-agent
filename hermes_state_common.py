...
CREATE TABLE IF NOT EXISTS sessions (
    ...
    compaction_pruned_skills INTEGER NOT NULL DEFAULT 0,
    compaction_pruned_tool_outputs INTEGER NOT NULL DEFAULT 0,
    compaction_tokens_reclaimed INTEGER NOT NULL DEFAULT 0,
    profile_name TEXT,
