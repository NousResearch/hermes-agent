...
| North-Forge version | `NF-v0.5.2` (`RUN-2026-09-07-006`, `CHG-2026-09-07-016..018`): two cheap Codex-audit fixes — README stale-MinGit prose removed / linked upstream (`F-08`); `nf-secret-scan.yml` `actions/checkout` pinned to SHA (`F-10`) — plus ledger back-logging of Codex `F-02`/`F-03`/`F-05`/`F-07`/`F-09` (`ERR-2026-09-07-004..007`, `DECISION-2026-09-07-002`). No behavioural code change. `NF-v0.5.1` (`RUN-2026-09-07-005`, `CHG-2026-09-07-015`): **data-loss fix** — `bootstrap-north-forge.ps1` path guard rejects a venv/data dir equal to / inside / containing the checkout (Codex `F-04`, `ERR-2026-09-07-003`). `NF-v0.5.0` (`RUN-2026-09-07-004`, `CHG-2026-09-07-011..014`): README Quick Install restructure (drive-native `north-forge.cmd` first); North Forge CLI skin (`skins/north-forge.yaml`, `DECISION-2026-09-07-001` **DECIDED — skin swap stands**); self-healing `<drive>:\Start North Forge.lnk` launcher. `NF-v0.4.2` (`CHG-2026-09-07-010`: `upstream/main` sync). `NF-v0.4.1` (`CHG-2026-09-07-009`). `NF-v0.4.0` first application-code identity pass. `NF-v0.2.0`..`NF-v0.5.2` public on `origin/main`. | 2026-09-07 |
| Ledger schema | `v2` | 2026-09-06 |
| Latest run | `RUN-2026-09-07-006` — Codex-audit cheap fixes + back-logging: `CHG-2026-09-07-016` README stale MinGit prose → upstream link (`F-08`); `CHG-2026-09-07-017` `nf-secret-scan.yml` `actions/checkout@v4` → `@de0fac2e… # v6.0.2` (`F-10`); `CHG-2026-09-07-018` logged `ERR-2026-09-07-004` (`F-02`, HIGH), `ERR-2026-09-07-005` (`F-03`, HIGH — **queued next**), `ERR-2026-09-07-006` (`F-05`, MED), `ERR-2026-09-07-007` (`F-09`, MED), `DECISION-2026-09-07-002` (`F-07`, MED) — **logged only, not implemented**; reaffirmed `DECISION-2026-09-07-001` DECIDED. `NF-v0.5.2` cut + pushed. Prior: `RUN-2026-09-07-005` (F-04 data-loss fix, `CHG-2026-09-07-015`, `NF-v0.5.1`); `RUN-2026-09-07-004` (drive-native onboarding, `CHG-2026-09-07-011..014`, `NF-v0.5.0`); `RUN-2026-09-07-003` (push/sync); `RUN-2026-09-07-002`; `RUN-2026-09-07-001`. | 2026-09-07 |
...
| [ERR-2026-09-07-005](./errors/ERROR-LOG.md#err-2026-09-07-005--high--githookscontent-scan-whitespace-path-bypass) | HIGH | Codex `F-03` — `.githooks/content-scan` word-splits space-containing paths → a token in `dir/file name.txt` passes pre-push **and** CI. **Queued next.** (R-02) |
