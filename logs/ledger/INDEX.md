...
| North-Forge version | `NF-v0.5.0` (`RUN-2026-09-07-004`, `CHG-2026-09-07-011..014`): README Quick Install restructure so the drive-native `north-forge.cmd` path leads and the stock installers are labelled "not North Forge"; **North Forge CLI skin** (`skins/north-forge.yaml`) swaps the launch splash with no `banner.py` edit; self-healing `<drive>:\Start North Forge.lnk` launcher. MINOR (new capability). `NF-v0.4.2` (`CHG-2026-09-07-010`: mechanical `upstream/main` sync, rebase-only, 333→0 behind). `NF-v0.4.1` (`CHG-2026-09-07-009`: legacy-SOUL auto-upgrade). `NF-v0.4.0` first application-code identity pass. `NF-v0.2.0`..`NF-v0.5.0` public on `origin/main`. | 2026-09-07 |
| Ledger schema | `v2` | 2026-09-06 |
| Latest run | `RUN-2026-09-07-004` — drive-native onboarding pass (owner followed the README onto stock Hermes): `CHG-2026-09-07-011` README Quick Install rewrite (drive-native path first, stock installers labelled); `CHG-2026-09-07-012` North Forge CLI skin (`DECISION-2026-09-07-001` DECIDED — C, skin route, `banner.py` untouched); `CHG-2026-09-07-013` self-healing drive-root `.lnk` launcher; `CHG-2026-09-07-014` ledger — `ERR-2026-09-07-002` closed **ACCEPTED-RISK** (owner: no shim). `NF-v0.5.0` cut; rebased clean onto `origin/main`'s mid-run +15 upstream-merge (`c4e88d2ab6`) and pushed. Prior: `RUN-2026-09-07-003` (push/sync, `CHG-2026-09-07-009`/`-010`, `ERR-2026-09-07-002` opened); `RUN-2026-09-07-002` (`CHG-2026-09-07-007`/`-008`, `ERR-2026-09-07-001`); `RUN-2026-09-07-001` (`CHG-2026-09-07-001..006`). | 2026-09-07 |
