...
| --- | --- | --- |
| Upstream base | `hermes@a7198a8855` — **0 behind `upstream/main`** as of `RUN-2026-09-07-003` (`CHG-2026-09-07-010`): `git rebase upstream/main` replayed the 8 NF commits clean, zero conflicts. The last handoff's "13 behind" had grown to 333 before this sync. Post-rebase HEAD `ef3467348a`. | 2026-09-07 |
| North-Forge version | `NF-v0.4.2` (`RUN-2026-09-07-003`, `CHG-2026-09-07-010`: mechanical `upstream/main` sync, rebase-only, 333→0 behind). `NF-v0.4.1` (`CHG-2026-09-07-009`: legacy-SOUL auto-upgrade closes the `CHG-2026-09-07-007` gap — homes seeded `NF-v0.2.0`..`NF-v0.3.x` converge to the North Forge `DEFAULT_SOUL_MD`). `NF-v0.4.0` (first application-code identity pass) **now pushed**. `NF-v0.2.0`..`NF-v0.4.2` public on `origin/main` (history rewritten by the rebase — old merge-based line replaced). | 2026-09-07 |
| Ledger schema | `v2` | 2026-09-06 |
| Latest run | `RUN-2026-09-07-003` — consolidated push/sync pass: pushed `NF-v0.4.0`; `CHG-2026-09-07-009` legacy-SOUL auto-upgrade (`NF-v0.4.1`); `CHG-2026-09-07-010` clean `upstream/main` rebase 333→0 behind (`NF-v0.4.2`); `ERR-2026-09-07-002` opened (upstream Windows test-collection defect, LOW); `⚕ NOUS HERMES` splash art **left open** for the owner (not defaulted). Prior: `RUN-2026-09-07-002` (`CHG-2026-09-07-007`/`-008`, `ERR-2026-09-07-001`); `RUN-2026-09-07-001` (`CHG-2026-09-07-001..006`). | 2026-09-07 |
...
| [ERR-2026-09-07-002](./errors/ERROR-LOG.md#err-2026-09-07-002--low--upstream-test-suite-fails-collection-on-windows) | LOW | Upstream test files call `os.geteuid()` in an eager `skipif` decorator arg → `pytest tests/` aborts at collection on Windows. Pre-existing upstream (surfaced by the `CHG-2026-09-07-010` sync); NF touches none of the files. Targeted runs unaffected. Owner call on whether to carry a local shim. |
