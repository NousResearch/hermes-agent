...
- **Error register:** [`errors/ERROR-LOG.md`](./errors/ERROR-LOG.md) — incidents & anomalies.
- **Templates:** [`templates/`](./templates/) — copy when adding an audit / change / error.
...
| North-Forge version | `NF-v0.1.1` (pushed to `origin/main`) | 2026-09-06 |
| Ledger schema | `v1` | 2026-09-06 |
...
| Fork identity | **undecided** — rebrand vs thin-downstream deferred (`ERR-2026-09-06-002`, identity half) | 2026-09-06 |
...
| [ERR-2026-09-06-002](./errors/ERROR-LOG.md#err-2026-09-06-002--medium--fork-identity--version-drift) | MEDIUM | Version-drift **closed** (synced to upstream, `NF-v0.1.x` pushed). Identity decision (rebrand vs thin-downstream, `NF-v0.2.0`) still deferred. |
