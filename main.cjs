...
const { createWorkflowBackendManager, resolveLangflowRoot } = require('./workflow-backend.cjs')
...
const ALLOWED_WEBVIEW_PARTITIONS = new Set(['persist:hermes-preview', 'persist:hermes-workflow'])
