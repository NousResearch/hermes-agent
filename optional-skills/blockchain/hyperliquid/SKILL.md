...
The script reads `${HERMES_HOME}/.env` for two optional defaults:
...
Helper script: `${HERMES_HOME}/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python ${HERMES_HOME}/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${HERMES_HOME}/.env`.
...
```bash
python ${HERMES_HOME}/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python ${HERMES_HOME}/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
