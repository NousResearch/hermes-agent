...
python ${HERMES_HOME}/skills/blockchain/solana/scripts/solana_client.py stats
```
...
```bash
python ${HERMES_HOME}/skills/blockchain/solana/scripts/solana_client.py \
...
```bash
python ${HERMES_HOME}/skills/blockchain/solana/scripts/solana_client.py price BONK
python ${HERMES_HOME}/skills/blockchain/solana/scripts/solana_client.py price JUP
python ${HERMES_HOME}/skills/blockchain/solana/scripts/solana_client.py price SOL
python ${HERMES_HOME}/skills/blockchain/solana/scripts/solana_client.py price DezXAZ8z7PnrnRJjz3wXBoRgixCa6xjnB7YaB1pPB263
```
