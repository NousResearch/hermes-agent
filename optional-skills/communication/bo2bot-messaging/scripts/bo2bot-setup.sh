...
# Usage: bash ~/.hermes/skills/communication/bo2bot-messaging/scripts/bo2bot-setup.sh
...
echo ""
echo "Next steps:"
echo "  1. Run validation: bash ~/.hermes/skills/communication/bo2bot-messaging/scripts/bo2bot-validate.sh"
