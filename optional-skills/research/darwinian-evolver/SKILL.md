...
```bash
mkdir -p ${HERMES_HOME}/cache/darwinian-evolver && cd ${HERMES_HOME}/cache/darwinian-evolver
...
```bash
cd ${HERMES_HOME}/cache/darwinian-evolver/darwinian_evolver \
...
Open `${HERMES_HOME}/cache/darwinian-evolver/darwinian_evolver/darwinian_evolver/lineage_visualizer.html`
...
SKILL_DIR=${HERMES_HOME}/skills/research/darwinian-evolver
DE_DIR=${HERMES_HOME}/cache/darwinian-evolver/darwinian_evolver
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside Hermes core.
   Custom driver scripts under `$HERMES_HOME/skills/...` are user-side and fine.
