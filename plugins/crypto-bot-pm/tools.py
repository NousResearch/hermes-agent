...
REPO_ROOT = Path(
    os.environ.get("CRYPTO_BOT_PM_REPO_ROOT", "/Users/preston/robinhood/crypto_bot")
)
HERMES_PROJECT_DESCRIPTOR = Path(
    os.environ.get(
        "CRYPTO_BOT_PM_PROJECT_DESCRIPTOR",
...
COMMAND_TEMPLATES: dict[str, tuple[str, ...]] = {
    "crypto_bot_pm_issue_lifecycle": (
        "python3",
        "{script_root}/scripts/hermes_pm/hermes_pm_issue_lifecycle.py",
        "--issue-index",
        "1",
        "--expected-title",
    ...
    "crypto_bot_pm_status": (
        "python3",
        "{script_root}/scripts/hermes_pm/hermes_pm_status.py",
        "--repo-root",
        "{repo_root}",
        "--live-gitea-read",
        "--format",
    ...
    "crypto_bot_pm_kanban_packet": (
        "python3",
        "{script_root}/scripts/hermes_pm/generate_kanban_proposal_packet.py",
        "--repo-root",
        "{repo_root}",
        "--project-id",
        "crypto_bot",
    ...
    "crypto_bot_pm_backlog_expansion": (
        "python3",
        "{script_root}/scripts/hermes_pm/generate_backlog_expansion_proposal.py",
        "--repo-root",
        "{repo_root}",
        "--project-id",
        "crypto_bot",
    ...
    "crypto_bot_pm_backlog_selection": (
        "python3",
        "{script_root}/scripts/hermes_pm/generate_backlog_selection_packet.py",
        "--repo-root",
        "{repo_root}",
        "--project-id",
        "crypto_bot",
    ...
    "crypto_bot_pm_candidate_approval_scope": (
        "python3",
        "{script_root}/scripts/hermes_pm/generate_backlog_candidate_approval_scope.py",
        "--repo-root",
        "{repo_root}",
        "--project-id",
        "crypto_bot",
    ...
    "crypto_bot_pm_forge_plan": (
        "python3",
        "{script_root}/scripts/hermes_pm/generate_forge_write_plan.py",
        "--repo-root",
        "{repo_root}",
        "--project-id",
        "crypto_bot",
    ...
    "crypto_bot_pm_forge_approval_packet": (
        "python3",
        "{script_root}/scripts/hermes_pm/generate_forge_approval_packet.py",
        "--repo-root",
        "{repo_root}",
        "--project-id",
        "crypto_bot",
    ...
    "crypto_bot_pm_capability_map": (
        "python3",
        "{script_root}/scripts/hermes_pm/map_gitea_forge_capabilities.py",
        "--base-url",
        "http://127.0.0.1:3005",
        "--owner",
        "preston",
    ...
    "crypto_bot_pm_development_workstream": (
        "python3",
        "{script_root}/scripts/hermes_pm/generate_development_workstream_packet.py",
        "--repo-root",
        "{repo_root}",
        "--project-id",
        "crypto_bot",
    ...
    "crypto_bot_pm_development_slice": (
        "python3",
        "{script_root}/scripts/hermes_pm/generate_development_slice_packet.py",
        "--repo-root",
        "{repo_root}",
        "--project-id",
        "crypto_bot",
...
def _json_result(payload: dict[str, Any]) -> str:
    with_flags = {
        **payload,
        **NON_ACTION_BOOLEANS,
        "managed_project_descriptor": str(HERMES_PROJECT_DESCRIPTOR),
        "autonomy_profile": "branch_local_development",
        "operator_per_task_approval_required_for_safe_branch_local_work": False,
    }
