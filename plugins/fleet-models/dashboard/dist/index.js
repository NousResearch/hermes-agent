...
${d.calls} calls (${d.modelark_calls} on subscription)` }, /* @__PURE__ */ h("div", { className: "fm-day-bars" }, /* @__PURE__ */ h("span", { className: "fm-day-money", style: { height: 100 * d.billed_usd / maxDay + "%" } }), /* @__PURE__ */ h("span", { className: "fm-day-calls", style: { height: 100 * d.calls / maxCalls + "%" } }, /* @__PURE__ */ h("span", { style: { height: (d.calls ? 100 * d.modelark_calls / d.calls : 0) + "%" } }))), /* @__PURE__ */ h("div", { className: "fm-day-label" }, new Date(d.day * 864e5).toLocaleDateString(void 0, { day: "numeric", month: "short" }))))), /* @__PURE__ */ h("div", { className: "fm-legend" }, /* @__PURE__ */ h("span", { className: "fm-lg fm-lg--money" }), " billed $ ", /* @__PURE__ */ h("span", { className: "fm-lg fm-lg--calls" }), " calls ", /* @__PURE__ */ h("span", { className: "fm-lg fm-lg--sub" }), " of which subscription")), /* @__PURE__ */ h("div", { className: "fm-two" }, /* @__PURE__ */ h(Section, { title: `Spend by agent \xB7 ${usage.days === 1 ? "24 h" : usage.days + " days"}`, right: /* @__PURE__ */ h("span", { className: "fm-muted fm-small" }, "bar = billed $ \xB7 teal = subscription calls") }, /* @__PURE__ */ h(BarList, { rows: Object.entries(byAgent).map(([p, rs]) => ({
      ...
      })) })), /* @__PURE__ */ h(Section, { title: "Spend by model", right: /* @__PURE__ */ h("span", { className: "fm-muted fm-small" }, "old OpenRouter DeepSeek ids are history from before 09-11") }, /* @__PURE__ */ h(BarList, { rows: Object.values(rows.reduce((acc, r) => {
