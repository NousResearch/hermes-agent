(() => {
  ...
  if (SDK) {
    let cls = function(...xs) {
    ...
    }, AgentCard = function({ doc, p, drift, use, onOpen }) {
      ...
      return /* @__PURE__ */ h(
        ...
        /* @__PURE__ */ h("footer", { className: "fm-card-foot" }, /* @__PURE__ */ h("span", null, /* @__PURE__ */ h("b", null, num(use.calls)), " calls"), /* @__PURE__ */ h("span", null, /* @__PURE__ */ h("b", null, money(use.billed, 3)), " billed"), /* @__PURE__ */ h("span", null, /* @__PURE__ */ h("b", null, num(use.ma)), " on subscription"), top ? /* @__PURE__ */ h("span", { className: "fm-muted", title: "most calls served by" }, "via ", top[0]) : null)
      );
      ...
      return out;
    }, FleetView = function({ state, doc, usage, onOpen }) {
      ...
      return /* @__PURE__ */ h(Fragment, null, /* @__PURE__ */ h("div", { className: "fm-stats" }, /* @__PURE__ */ h(Stat, { label: `Calls \xB7 ${usage ? usage.days : 7}d`, value: num(tot.calls) }), /* @__PURE__ */ h(Stat, { label: "Billed (OpenRouter)", value: money(tot.billed, 2), sub: "real invoices", tone: "money" }), /* @__PURE__ */ h(Stat, { label: "ModelArk subscription", value: num(tot.ma) + " calls", sub: tot.calls ? Math.round(100 * tot.ma / tot.calls) + "% of all calls \xB7 $0" : "$0", tone: "sub" }), /* @__PURE__ */ h(Stat, { label: "Registry", value: Object.keys(models).length + " models", sub: Object.values(models).filter((m) => m.provider === "modelark").length + " subscription \xB7 " + Object.values(models).filter((m) => m.provider === "openrouter").length + " OpenRouter" }), /* @__PURE__ */ h(Stat, { label: "Sync", value: Object.keys(state.drift || {}).length ? Object.keys(state.drift).length + " drifted" : "all 9 in sync", tone: Object.keys(state.drift || {}).length ? "warn" : "ok", sub: "revision " + state.revision })), /* @__PURE__ */ h("div", { className: "fm-grid" }, state.profiles.map((p) => /* @__PURE__ */ h(AgentCard, { key: p, doc, p, drift: (state.drift || {})[p], use: byP[p] || empty, onOpen: () => onOpen(p) }))));
      ...
      }) }, REASONING.map((r) => /* @__PURE__ */ h("option", { key: r, value: r }, r || "Hermes default"))), /* @__PURE__ */ h("small", null, "Per-model pins (Models tab) win \u2014 e.g. v4.1 always runs high.")), /* @__PURE__ */ h("label", { className: "fm-field" }, /* @__PURE__ */ h("span", null, "Why this setup"), /* @__PURE__ */ h("input", { value: a.why || "", onChange: (e) => set((x) => {
      ...
      }) }), " Locked (Smith is the overwatch \u2014 changes need an explicit unlock)") : null), /* @__PURE__ */ h(Section, { title: "Profile default OpenRouter routing" }, /* @__PURE__ */ h("p", { className: "fm-muted fm-small" }, "Applies to this agent's OpenRouter calls for models without their own host pins. Models with pins (Models tab) override it wherever they run. ", /* @__PURE__ */ h("b", null, "data_collection: deny"), " is always on."), /* @__PURE__ */ h("label", { className: "fm-field" }, /* @__PURE__ */ h("span", null, "Prefer hosts (order)"), /* @__PURE__ */ h(
        "input",
        {
      ...
      ))))) : null, /* @__PURE__ */ h("div", { className: "fm-hostuse" }, Object.entries(hostUse).sort((a, b) => b[1].calls - a[1].calls).map(([host, u]) => /* @__PURE__ */ h("div", { key: host, className: "fm-bar-row" }, /* @__PURE__ */ h("span", { className: "fm-bar-label" }, host), /* @__PURE__ */ h("span", { className: "fm-bar" }, /* @__PURE__ */ h("span", { style: { width: (totalCalls ? 100 * u.calls / totalCalls : 0) + "%" } })), /* @__PURE__ */ h("span", { className: "fm-bar-val" }, num(u.calls), " \xB7 ", money(u.billed, 3)))), !totalCalls ? /* @__PURE__ */ h("div", { className: "fm-muted fm-small" }, "No calls in this window.") : null))), m.provider === "openrouter" ? /* @__PURE__ */ h(Section, { title: "Hosts", right: /* @__PURE__ */ h("span", { className: "fm-muted fm-small" }, (m.rules || {}).first_host ? `rule: ${m.rules.first_host} first` : "", (m.rules || {}).min_uptime ? ` \xB7 later hosts \u2265 ${m.rules.min_uptime}% uptime` : "") }, /* @__PURE__ */ h(
        HostTable,
        {
          model: m,
          market: mk,
    ...
    }, ModelsView = function({ draft, setDraft, usage, sel, setSel }) {
      const aliases = Object.keys(draft.models || {});
      const cur = sel && draft.models[sel] ? sel : aliases[0];
      return /* @__PURE__ */ h("div", { className: "fm-models" }, /* @__PURE__ */ h("aside", { className: "fm-model-list" }, aliases.map((a) => {
        const m = draft.models[a];
        return /* @__PURE__ */ h("button", { key: a, className: cls("fm-model-item", a === cur && "is-active"), onClick: () => setSel(a) }, /* @__PURE__ */ h("span", { className: cls("fm-pill-dot", "fm-dot--" + m.provider) }), /* @__PURE__ */ h("span", { className: "fm-model-item-name" }, m.short || a), /* @__PURE__ */ h("span", { className: "fm-muted fm-small" }, usedBy(draft, a).length, " slots"));
      }), /* @__PURE__ */ h("div", { className: "fm-model-list-foot" }, /* @__PURE__ */ h(AddModel, { draft, setDraft, onAdded: setSel }))), /* @__PURE__ */ h("div", { className: "fm-model-main" }, cur ? /* @__PURE__ */ h(ModelDetail, { key: cur, draft, alias: cur, setDraft, usage }) : null));
    }, CostsView = function({ doc, usage, days, setDays }) {
      ...
      const maxDay = Math.max(1e-6, ...usage.daily.map((d) => d.billed_usd));
      ...
      return /* @__PURE__ */ h(Fragment, null, /* @__PURE__ */ h("div", { className: "fm-row fm-costs-bar" }, [1, 7, 30].map((d) => /* @__PURE__ */ h("button", { key: d, className: cls("fm-chip", d === days && "is-active"), onClick: () => setDays(d) }, d === 1 ? "24 h" : d + " days")), /* @__PURE__ */ h("span", { className: "fm-muted fm-small" }, "from all nine state.db ledgers \xB7 ", ago(usage.generated_at))), /* @__PURE__ */ h("div", { className: "fm-stats" }, /* @__PURE__ */ h(Stat, { label: "Billed (OpenRouter)", value: money(tot.billed, 2), tone: "money", sub: "what actually gets invoiced" }), /* @__PURE__ */ h(Stat, { label: "ModelArk subscription", value: num(tot.ma) + " calls", tone: "sub", sub: "$0 \xB7 cap-equivalent " + money(tot.cap, 2) }), /* @__PURE__ */ h(Stat, { label: "All calls", value: num(tot.calls), sub: num(tot.tin) + " in \xB7 " + num(tot.tout) + " out tokens" }), /* @__PURE__ */ h(Stat, { label: "Subscription share", value: tot.calls ? Math.round(100 * tot.ma / tot.calls) + "%" : "\u2014", sub: "of calls served on the flat plan" })), /* @__PURE__ */ h(Section, { title: "Per day" }, /* @__PURE__ */ h("div", { className: "fm-days" }, usage.daily.map((d) => /* @__PURE__ */ h("div", { key: d.day, className: "fm-day", title: `${new Date(d.day * 864e5).toDateString()}
billed ${money(d.billed_usd)}
${d.calls} calls (${d.modelark_calls} on subscription)` }, /* @__PURE__ */ h("div", { className: "fm-day-bars" }, /* @__PURE__ */ h("span", { className: "fm-day-money", style: { height: 100 * d.billed_usd / maxDay + "%" } }), /* @__PURE__ */ h("span", { className: "fm-day-calls", style: { height: 100 * d.calls / maxCalls + "%" } }, /* @__PURE__ */ h("span", { style: { height: (d.calls ? 100 * d.modelark_calls / d.calls : 0) + "%" } }))), /* @__PURE__ */ h("div", { className: "fm-day-label" }, new Date(d.day * 864e5).toLocaleDateString(void 0, { day: "numeric", month: "short" }))))), /* @__PURE__ */ h("div", { className: "fm-legend" }, /* @__PURE__ */ h("span", { className: "fm-lg fm-lg--money" }), " billed $ ", /* @__PURE__ */ h("span", { className: "fm-lg fm-lg--calls" }), " calls ", /* @__PURE__ */ h("span", { className: "fm-lg fm-lg--sub" }), " of which subscription")), /* @__PURE__ */ h(Section, { title: "By agent, model and host" }, /* @__PURE__ */ h("div", { className: "fm-table-wrap" }, /* @__PURE__ */ h("table", { className: "fm-table" }, /* @__PURE__ */ h("thead", null, /* @__PURE__ */ h("tr", null, /* @__PURE__ */ h("th", null, "Agent"), /* @__PURE__ */ h("th", null, "Model"), /* @__PURE__ */ h("th", null, "Served by"), /* @__PURE__ */ h("th", null, "Where"), /* @__PURE__ */ h("th", { className: "r" }, "Calls"), /* @__PURE__ */ h("th", { className: "r" }, "In"), /* @__PURE__ */ h("th", { className: "r" }, "Out"), /* @__PURE__ */ h("th", { className: "r" }, "Cache read"), /* @__PURE__ */ h("th", { className: "r" }, "Billed"), /* @__PURE__ */ h("th", { className: "r" }, "Cap-equiv."))), /* @__PURE__ */ h("tbody", null, Object.entries(byAgent).map(([p, rs]) => rs.map((r, i) => /* @__PURE__ */ h("tr", { key: p + i }, /* @__PURE__ */ h("td", null, i === 0 ? /* @__PURE__ */ h("b", null, (doc.agents[p] || {}).name || p) : null), /* @__PURE__ */ h("td", null, idToShort[r.model] || /* @__PURE__ */ h("code", { className: "fm-code" }, r.model)), /* @__PURE__ */ h("td", null, r.modelark ? /* @__PURE__ */ h("span", { className: "fm-prov fm-prov--modelark" }, "modelark subscription") : r.host || "\u2014"), /* @__PURE__ */ h("td", { className: "fm-muted" }, r.task === "main" ? "main" : TASK_LABEL[r.task] || r.task), /* @__PURE__ */ h("td", { className: "r" }, num(r.calls)), /* @__PURE__ */ h("td", { className: "r" }, num(r.input)), /* @__PURE__ */ h("td", { className: "r" }, num(r.output)), /* @__PURE__ */ h("td", { className: "r" }, num(r.cache_read)), /* @__PURE__ */ h("td", { className: "r" }, r.modelark ? "$0" : money(r.billed_usd)), /* @__PURE__ */ h("td", { className: "r fm-muted" }, r.modelark ? money(r.cap_equivalent_usd) : "")))))))));
      ...
      const loadUsage = useCallback(() => fetchJSON(`${API}/usage?days=${days}`).then(setUsage).catch(() => {
      }), [days]);
      useEffect(() => {
        load();
      }, []);
      useEffect(() => {
        loadUsage();
        const t = setInterval(loadUsage, 6e4);
      ...
      const preview = () => {
        setBusy(true);
        fetchJSON(`${API}/plan`, { method: "POST", headers: { "Content-Type": "application/json" }, body: body() }).then((r) => {
          setPlan(r);
          setBusy(false);
        }).catch((e) => {
          setBusy(false);
      ...
      const apply = () => {
        setBusy(true);
        fetchJSON(`${API}/apply`, { method: "POST", headers: { "Content-Type": "application/json" }, body: body() }).then((r) => {
          setBusy(false);
          if (r.ok) {
            setPlan(null);
            setSummary("");
      ...
      if (err && !state) return /* @__PURE__ */ h("div", { className: "fm-root" }, /* @__PURE__ */ h("div", { className: "fm-note fm-note--bad" }, "Models tab can't load: ", err));
      if (!state || !draft) return /* @__PURE__ */ h("div", { className: "fm-root" }, /* @__PURE__ */ h("div", { className: "fm-muted fm-loading" }, "Loading the fleet's model settings\u2026"));
      const doc = draft;
      const TABS = [["fleet", "Fleet"], ["agent", "Agents"], ["models", "Models & hosts"], ["costs", "Costs"], ["decisions", "Rules & history"]];
      return /* @__PURE__ */ h("div", { className: "fm-root" }, /* @__PURE__ */ h("header", { className: "fm-head" }, /* @__PURE__ */ h("div", null, /* @__PURE__ */ h("h1", null, "Models"), /* @__PURE__ */ h("div", { className: "fm-sub" }, "Every agent's waterfall from one file \u2014 ", /* @__PURE__ */ h("code", null, "~/.hermes/fleet/models.yaml"), " \xB7 revision ", state.revision, " \xB7 ", state.doc.updated_by || "\u2014", " ", ago(state.doc.updated_at))), /* @__PURE__ */ h("div", { className: "fm-row" }, /* @__PURE__ */ h(Badge, { tone: "ok", title: "data_collection: deny on every OpenRouter call" }, "no-training \xB7 deny"), /* @__PURE__ */ h(Badge, { tone: state.runtime.aux_routing_seam ? "ok" : "warn", title: "helper calls follow each model's pins (fleet-models plugin)" }, state.runtime.aux_routing_seam ? "helper routing on" : "helper routing off"), state.validation.errors.length ? /* @__PURE__ */ h(Badge, { tone: "bad", title: state.validation.errors.join("\n") }, state.validation.errors.length, " rule breach") : null, /* @__PURE__ */ h("button", { className: "fm-btn", onClick: () => {
        load();
        loadUsage();
      } }, "Refresh"))), /* @__PURE__ */ h("nav", { className: "fm-tabs" }, TABS.map(([k, l]) => /* @__PURE__ */ h("button", { key: k, className: cls("fm-tab", tab === k && "is-active"), onClick: () => setTab(k) }, l))), movedUnder ? /* @__PURE__ */ h("div", { className: "fm-note fm-note--warn" }, "Someone applied a change while you were editing (now revision ", state.revision, "). Preview will refuse a stale edit \u2014 discard and redo it.") : null, /* @__PURE__ */ h("main", { className: "fm-main" }, tab === "fleet" ? /* @__PURE__ */ h(FleetView, { state, doc, usage, onOpen: (p) => {
        setAgent(p);
        setTab("agent");
      } }) : null, tab === "agent" ? /* @__PURE__ */ h(AgentView, { state, draft, setDraft, p: agent, setP: setAgent }) : null, tab === "models" ? /* @__PURE__ */ h(ModelsView, { draft, setDraft, usage, sel: modelSel, setSel: setModelSel }) : null, tab === "costs" ? /* @__PURE__ */ h(CostsView, { doc, usage, days, setDays }) : null, tab === "decisions" ? /* @__PURE__ */ h(DecisionsView, { state, draft, setDraft, onRevert: revert }) : null), dirty ? /* @__PURE__ */ h("div", { className: "fm-dock" }, /* @__PURE__ */ h("span", null, /* @__PURE__ */ h("b", null, "Unsaved changes"), " ", /* @__PURE__ */ h("span", { className: "fm-muted" }, "\u2014 nothing reaches the fleet until you apply")), /* @__PURE__ */ h("span", { className: "fm-row" }, /* @__PURE__ */ h("button", { className: "fm-btn", onClick: () => {
    ...
    var cls2 = cls, Pill2 = Pill, Chain2 = Chain, ChainEditor2 = ChainEditor, Stat2 = Stat, Badge2 = Badge, Section2 = Section, helperGroups2 = helperGroups, AgentCard2 = AgentCard, usageByProfile2 = usageByProfile, FleetView2 = FleetView, LiveChain2 = LiveChain, SlotRow2 = SlotRow, listInput2 = listInput, parseList2 = parseList, AgentView2 = AgentView, usedBy2 = usedBy, HostTable2 = HostTable, ModelDetail2 = ModelDetail, AddModel2 = AddModel, ModelsView2 = ModelsView, CostsView2 = CostsView, DecisionsView2 = DecisionsView, PlanPanel2 = PlanPanel, ModelsPage2 = ModelsPage;
    const { React } = SDK;
