...
(() => {
  ...
  "en": {
    ...
    "coordinateWork": "Enable work coordination",
    "coordinationHint": "Explicit work declarations coordinate immediately. The delay is a fallback when multiple agents process the same message without declaring work. Separate assignments in one message continue in parallel; coordination does not automatically stop agents.",
    "coordinationDelay": "Fallback delay (seconds, > 0 to 300)",
    "outbound": "OUTBOUND",
  ...
  "de": {
    ...
    "coordination": "Arbeitskoordination",
    "coordinateWork": "Arbeitskoordination aktivieren",
    "coordinationHint": "Explizite Arbeitsankündigungen koordinieren sofort. Die Wartezeit greift ersatzweise, wenn mehrere Agenten dieselbe Nachricht ohne Arbeitsankündigung bearbeiten. Getrennte Aufträge in einer Nachricht laufen parallel weiter; die Koordination stoppt Agenten nicht automatisch.",
    "coordinationDelay": "Ersatzwartezeit (Sekunden, > 0 bis 300)",
    "outbound": "AUSGANG",
    "guard": "Pingpong-Guard",
  ...
  function Groupchat() {
    ...
    return h("div", { className: "gc-page" },
      ...
      !draft ? h("p", { role: "status" }, error ? t("loadError") : t("loading")) : h(React.Fragment, null,
        ...
        h("section", { className: "gc-card" }, h("h2", null, t("coordination")),
          toggle(t("coordinateWork"), draft.coordination?.enabled ?? false, value => update("coordination", "enabled", value)),
          h("p", { className: "gc-note" }, t("coordinationHint")),
          h("label", { className: "gc-field" }, h("span", null, t("coordinationDelay")),
            h("input", { type: "number", min: 0, max: 300, step: "any", value: draft.coordination?.fallback_delay_seconds ?? 10,
              onChange: e => update("coordination", "fallback_delay_seconds", Number(e.target.value)), disabled: busy }))),
