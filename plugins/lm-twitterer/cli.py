...
def register_cli(subparser: argparse.ArgumentParser) -> None:
    ...
    edge_direct = subs.add_parser(
        "auth-edge-direct",
        help="Open Edge directly and read X cookies through local CDP after manual login",
    )
    ...
    edge = subs.add_parser(
        "import-edge-cookies",
        help="Import X cookies from a Microsoft Edge profile without printing secrets",
    )
