...
CONFIG_SCHEMA = ProviderConfigSchema(
    ...
    fields=(
        ...
        # — Message writing —
        _field("saveMessages", "Save messages", KIND_BOOL, "Enable automatic Honcho writes, including conversation messages and mirrored conclusions.",
               default="true", group="Message writing"),
        _field("saveAssistantMessages", "Save assistant messages", KIND_BOOL, "Include assistant replies in saved conversation turns. Requires Save messages; user messages still save when disabled.",
               default="true", group="Message writing"),
        ...
        _field("dialecticMaxChars", "Max result chars", KIND_NUMBER, "Max chars of dialectic result included in injected memory context.",
