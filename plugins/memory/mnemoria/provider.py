...
Wraps mnemoria.store.MnemoriaStore as a pluggable hermes-agent memory provider.
Uses threading.local() for per-thread store instances.
"""
...
class MnemoriaMemoryProvider(MemoryProvider):
    ...
    def sync_turn(self, user_content: str, assistant_content: str, *, session_id: str = "") -> None:
        """No-op: fact extraction is handled by the agent loop, same as BuiltinMemoryProvider."""
        pass
