"""Volcengine Ark (火山引擎) / BytePlus — ByteDance unified model platform.
...
Two regional variants exist:
  - Volcengine Ark (China mainland):   ark.cn-beijing.volces.com
  - BytePlus (International/Southeast Asia): ark.ap-southeast.bytepluses.com

Both use the same API key format (ark-...) and the same /api/coding protocol.
...
volcengine_ark = VolcengineArkProfile(
    ...
    display_name="Volcengine Ark / BytePlus (火山引擎)",
    description="ByteDance model platform — doubao-seed, deepseek-v4, glm-5.2, kimi-k2, minimax (China mainland + International)",
