...
from plugins.platforms.discord.adapter_inbound import DiscordInboundMixin


class DiscordAdapter(DiscordInboundMixin, DiscordMediaMixin, BasePlatformAdapter):
