...
def _multiplex_active() -> bool:
    ...
    this (issue #72348). The check stays defined in the adapter, which owns the
    rest of the profile-scoping helpers; delegating rather than copying keeps
    the two modules from drifting apart. The import is deferred to call time
    because the adapter imports this module while it is still executing.
    """
