...
try:  # sibling module; support both package and flat plugin-dir import
    from .slash_command import _slash_user_id, handle_slash_command
except ImportError:  # pragma: no cover - plugin loaded outside package context
    from slash_command import _slash_user_id, handle_slash_command  # type: ignore
...
class SlackAdapter(BasePlatformAdapter):
    ...
    async def _handle_slack_message_impl(
        ...
        source = self.build_source(
            ...
            # Reuse the resolved drop-gate predicate: api_human_users remain
            # human, while users.info-resolved Bot users stay Bot-authored.
