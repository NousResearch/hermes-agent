...
def check_telegram_requirements() -> bool:
    ...
    try:
        ...
        logger.warning("Telegram lazy install skipped: %s", exc)
        return False
    try:
        import importlib
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        install_hint="Run `hermes pm install --extra telegram` to install Telegram support.", setup_fn=interactive_setup, apply_yaml_config_fn=_apply_yaml_config,
