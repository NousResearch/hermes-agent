...
from plugins.platforms.telegram.authz_mixin import _scoped_gate_env
...
from plugins.platforms.telegram.authz_mixin import TelegramAuthorizationMixin
from plugins.platforms.telegram.config_mixin import ConfigMixin
from plugins.platforms.telegram.init_guards import (
    _LOOP_BLOCKED_DUMP_GRACE,
    _await_with_thread_deadline,
    _consume_abandoned_task,
    _dump_loop_blocked_diagnostics,
    _first_completed,
    _run_abandon_cleanup,
    _shutdown_abandoned_app,
)
from plugins.platforms.telegram.network_mixin import NetworkMixin
from plugins.platforms.telegram.rich_mixin import RichMixin
from plugins.platforms.telegram.text_format import (
    _escape_mdv2,
    _separate_chunk_indicator_from_fence,
    _strip_mdv2,
)
from plugins.platforms.telegram.topics_mixin import TopicsMixin
