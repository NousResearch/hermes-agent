...
class TelegramAdapter(BasePlatformAdapter):
        ...
        try:
            ...
            await _await_with_thread_deadline(
                app.updater.start_polling(
                    allowed_updates=_ALLOWED_UPDATES_WITH_GUEST, drop_pending_updates=drop_pending_updates, error_callback=_generation_error_callback),
    ...
    async def _start_webhook_mode(self, webhook_url: str, *, is_reconnect: bool) -> None:
        ...
        await self._app.updater.start_webhook(
            ...
            secret_token=webhook_secret, allowed_updates=_ALLOWED_UPDATES_WITH_GUEST,
