        ...
        for _attempt in range(_max_connect):
            ...
            try:
                ...
                if rebuild_app and _attempt < _max_connect - 1:
                    ...
                    # Same order as connect(): privacy observer, then plugin handlers (the wired-set is
                    # keyed per app, so the rebuilt app gets them again), then ordinary core handlers.
                    # The observer is deliberately outside late-plugin reordering.
