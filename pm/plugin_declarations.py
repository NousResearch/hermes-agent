...
def read_python_declaration(plugin_dir: Path) -> PythonDeclaration:
    ...
    A pyproject with project metadata owns packaging. Legacy manifests bridge
    plugins without one, including tooling-only and old PM-generated pyprojects.
    Both YAML suffixes and both dependency aliases have identical semantics.
    Reading never initializes a home, discovers code, or depends on the caller's CLI import state.
    """
