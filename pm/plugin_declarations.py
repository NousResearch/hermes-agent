...
def read_python_declaration(plugin_dir: Path) -> PythonDeclaration:
    ...
    if text is not None:
        ...
        if "GENERATED by pm" not in text:
            ...
            # A tooling-only pyproject does not own packaging or supersede
            # manifest dependencies. Keep it in files for currency tracking.
            if "project" in document or "build-system" in document:
