# Development Environment and Project Structure Reference

> Normative companion to the root `AGENTS.md`. Read this before choosing files, setting up a checkout, or changing TypeScript structure.
...
├── plugins/              # Plugin system (see plugins-and-skills.md)
