...
> Normative companion to the root `AGENTS.md`. Read this before changing plugin discovery, provider surfaces, skills, or skill review standards.
...
lives inside the `hermes-agent-dev` skill as
`references/new-skill-pr-salvage.md` — load that skill reference before polishing
