# Tools, Configuration, Dependencies, and Themes Reference

> Normative companion to the root `AGENTS.md`. Read the relevant section before adding tools, dependencies, configuration, working-directory behavior, or skins.
> The root invariants still apply.

## Adding New Tools

Before adding any tool, settle the footprint question first (see the [Footprint Ladder](contribution-and-footprint.md#the-footprint-ladder-new-capability-decision)): most capabilities should NOT
