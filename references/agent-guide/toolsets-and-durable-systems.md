# Toolsets and Durable Systems Reference

> Normative companion to the root `AGENTS.md`. Read the relevant section before changing toolsets, delegation, curator, cron, or kanban.
