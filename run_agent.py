...
class AIAgent:
    ...
    def __init__(
        ...
        Args:
            ...
            skip_context_files (bool): If True, skip auto-injection of AGENTS.md and .cursorrules
                into the system prompt. Use this for subagent delegation and batch processing
                to avoid polluting trajectories with user-specific persona or project instructions.
            skip_soul (bool): If True, skip loading SOUL.md as the agent identity. Use this
                for batch/delegation subagents that should use the default identity. Cron jobs
                should always load SOUL.md (skip_soul=False, which is the default).
        """
        _install_safe_stdio()
    ...
    def _build_system_prompt(self, system_message: str = None) -> str:
        ...
        # Try SOUL.md as primary identity (controlled by skip_soul, not skip_context_files)
        _soul_loaded = False
        if not getattr(self, 'skip_soul', False):
