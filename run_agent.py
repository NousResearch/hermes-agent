...
class AIAgent:
    ...
    _COMBINED_REVIEW_PROMPT = (
        ...
        "which always-relevant safety/routing boundaries apply'; "
        "skills say 'how to do this class of task for this user'. Both "
        "should carry user-preference lessons when relevant. Do not save "
        "project state, service topology, task progress, or secrets to built-in memory.\n\n"
