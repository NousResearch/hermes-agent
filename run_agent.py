...
class AIAgent:
    ...
    def __init__(
        ...
        init_agent(
            ...
            provider=provider,
            api_mode=api_mode,
            claude_oauth_proxy=claude_oauth_proxy,
    ...
    def switch_model(self, new_model, new_provider, api_key='', base_url='', api_mode='', claude_oauth_proxy=False):
