...
class AIAgent:
    ...
    def _run_claude_subprocess_turn(
        self,
        *,
        user_message: str,
        original_user_message: Any,
        ...
        """Forwarder — see ``agent.claude_runtime.run_claude_subprocess_turn``."""
        from agent.claude_runtime import run_claude_subprocess_turn
        return run_claude_subprocess_turn(self, user_message=user_message, original_user_message=original_user_message, messages=messages, effective_task_id=effective_task_id, should_review_memory=should_review_memory)
