...
class RunBundle:
    ...
    def _run_domain_surfaces(self) -> None:
        ...
        json_path = os.path.join(self.bundle_dir, "domain-surfaces.json")
        with open(json_path, "w", encoding="utf-8") as f:
            json.dump(self.domain_surfaces_data, f, indent=2)
            f.write("\n")
        self.artifact_paths["domain-surfaces.json"] = json_path
        ...
        *status* is "complete" for successful runs or "failed" for partial
        ...
        manifest = {
            ...
            "script_versions": {
                ...
                "domain_surfaces.py": _script_hash(
                    _SCRIPT_DIR / "domain_surfaces.py"
                ),
    ...
    def run(self) -> dict:
        ...
        try:
            ...
            # Stage 1b: Domain surface inventory
