...
AUTHOR_MAP = {
    "aldazero@users.noreply.github.com": "aldazero",  # KarinAI fork commits
    "DavidMetcalfe@users.noreply.github.com": "DavidMetcalfe",  # upstream v2026.7.1 commits with old-style noreply email
