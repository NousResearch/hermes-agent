...
AUTHOR_MAP = {
    "apollo@kyzcreig.local": "Kyzcreig",  # Apollo (fleet orchestrator agent) — fork-authored fixes committed under the Kyzcreig fork owner
    ...
    "apollo@daemonarchy.local": "Kyzcreig",  # Apollo agent commits (Daemonarchy fleet) → fork owner
    "apollo@ang.ventures": "Kyzcreig",  # Apollo agent commits (ang.ventures identity) → fork owner
