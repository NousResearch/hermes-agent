...
LEGACY_AUTHOR_MAP = {
    ...
    "abc15826295220@163.com": "tangtaizong666",  # PR #56809 (vertex: prepend mandatory google/ publisher prefix to bare model names so the OpenAI-compat endpoint doesn't reject them with HTTP 400 "Malformed publisher model"; #56778)
