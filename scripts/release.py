...
AUTHOR_MAP = {
    "1848505943@qq.com": "cxxCoolStar",  # PR #13343 (release: map personal author email)
    "chenxx@seclead.cn": "cxxCoolStar",  # PR #13343 (skills: consume related_skills in activation flow)
