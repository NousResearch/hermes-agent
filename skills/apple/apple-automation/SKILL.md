...
description: "macOS Apple app automation umbrella: Notes, Reminders, Messages/iMessage, Find My, and GUI control via Accessibility/AppleScript. Use when managing local Apple apps or user data on macOS."
---
