...
Delegate coding tasks to [Codex](https://github.com/openai/codex) via the HT AI Agent terminal. Codex is OpenAI's autonomous coding agent CLI.
...
For HT AI Agent itself, `model.provider: openai-codex` uses HT AI Agent-managed Codex
...
## HT AI Agent Gateway Caveat

When invoking the Codex CLI from a HT AI Agent gateway/service context (for example,
