...
> **Source skill:** `creative/ascii-video` — archived. Full content preserved here.
> **Umbrella skill:** `creative/ascii-art` — use this for all ASCII art requests including video.
> **Decision entry:** `references/ascii-video.md` (this file)
