...
curl -s -X POST \
  ...
  -d "{
    \"commit_id\": \"$HEAD_SHA\",
    \"event\": \"COMMENT\",
    \"body\": \"Code review from HT AI Agent\",
    \"comments\": [
...
gh pr review $PR_NUMBER --approve --body "Reviewed by HT AI Agent. Code looks clean — good test coverage, no security concerns."
