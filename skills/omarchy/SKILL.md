...
- [`hyprland.md`](references/hyprland.md) - keybindings, monitors, window rules, and other Hyprland config
- [`plugins.md`](references/plugins.md) - the Omarchy shell: bar layout, widgets, plugins, idle behavior
- [`theming.md`](references/theming.md) - themes, backgrounds, and fonts
- [`hooks.md`](references/hooks.md) - automation hooks that run on system events
- [`capture.md`](references/capture.md) - screenshots, screen recordings, OCR text capture, and file sharing
...
3. Theme customization? Follow [`theming.md`](references/theming.md) and create a NEW custom theme directory.
4. Automation? Follow [`hooks.md`](references/hooks.md), using `omarchy hook install`.
5. Package install? Use `omarchy pkg add <pkgs...>` or `omarchy pkg aur add <pkgs...>`.
6. Built-in shell/plugin code? Follow [`plugins.md`](references/plugins.md); clone it with `omarchy plugin clone`.
