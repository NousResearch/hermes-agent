---
name: facops-invoice-to-autonomo-excel
description: Use when invoices, receipts, school payments, or billing emails need extraction and handoff to Jaime's autónomo Excel/accounting workflow via the FacOps profile without mixing personal Gmail state.
version: 1.0.0
author: Hermes Agent
license: MIT
