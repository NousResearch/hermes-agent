...
Script path: `${HERMES_HOME:-~/.hermes}/skills/maps/scripts/maps_client.py`

## Commands

```bash
MAPS=${HERMES_HOME:-~/.hermes}/skills/maps/scripts/maps_client.py
```
...
```bash
python ${HERMES_HOME:-~/.hermes}/skills/maps/scripts/maps_client.py search "Statue of Liberty"
# Should return lat ~40.689, lon ~-74.044

python ${HERMES_HOME:-~/.hermes}/skills/maps/scripts/maps_client.py nearby --near "Times Square" --category restaurant --limit 3
