...
Usage:
    python scripts/extract_paddleocr_layout.py --file-url "URL"
    python scripts/extract_paddleocr_layout.py --file-path "document.pdf"
    python scripts/extract_paddleocr_layout.py --file-path "doc.pdf" --pretty
"""
...
from paddleocr_lib import parse_document
...
Examples:
  ...
  python scripts/extract_paddleocr_layout.py --file-url "https://example.com/document.pdf"

  # Parse local file (result is auto-saved to the system temp directory)
  python scripts/extract_paddleocr_layout.py --file-path "./invoice.pdf"

  # Save result to a custom file path
  python scripts/extract_paddleocr_layout.py --file-url "URL" --output "./result.json" --pretty

  # Print JSON to stdout without saving a file
  python scripts/extract_paddleocr_layout.py --file-url "URL" --stdout --pretty
Configuration:
