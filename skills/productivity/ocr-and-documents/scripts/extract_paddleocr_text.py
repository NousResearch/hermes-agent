...
Usage:
    python scripts/extract_paddleocr_text.py --file-url "URL"
    python scripts/extract_paddleocr_text.py --file-path "image.png" --pretty
"""
...
Examples:
  ...
  python scripts/extract_paddleocr_text.py --file-url "https://example.com/image.png"

  # OCR local file (result is auto-saved to the system temp directory)
  python scripts/extract_paddleocr_text.py --file-path "./document.pdf" --pretty

  # OCR with explicit file type override
  python scripts/extract_paddleocr_text.py --file-url "URL" --file-type 1 --pretty

  # Save result to a custom file path
  python scripts/extract_paddleocr_text.py --file-url "URL" --output "./result.json" --pretty

  # Print JSON to stdout without saving a file
  python scripts/extract_paddleocr_text.py --file-url "URL" --stdout --pretty
Configuration:
