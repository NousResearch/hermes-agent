...
This skill is designed for the Jade agent. It uses Jade tools, delegation, scheduling, and memory for the full research lifecycle.

### Related Skills

Compose this skill with other Jade skills for specific phases:
