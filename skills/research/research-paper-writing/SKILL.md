...
This skill is designed for the HT AI Agent. It uses HT AI Agent tools, delegation, scheduling, and memory for the full research lifecycle.

### Related Skills

Compose this skill with other HT AI Agent skills for specific phases:
