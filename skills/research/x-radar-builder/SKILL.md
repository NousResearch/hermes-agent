---
name: x-radar-builder
description: Use when creating or tuning X/Twitter radar jobs that monitor scoped topics, dedupe repeats, prefer primary sources, stay silent when there is no signal, and report concise reliability-labeled updates.
version: 1.0.0
author: Hermes Agent
license: MIT
