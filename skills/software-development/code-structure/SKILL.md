---
name: code-structure
description: "Use when AI-generated code works but is messy, oversized, tightly coupled, or hard for humans/future agents to continue. Restructure into clean boundaries without changing behavior."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    ...
    related_skills: [gpt-loop, code-simplifier, requesting-code-review]
---
...
5. Use `gpt-loop` or `requesting-code-review` before shipping non-trivial refactors.
