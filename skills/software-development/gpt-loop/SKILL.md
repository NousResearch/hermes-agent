---
name: gpt-loop
description: "Use when a feature, refactor, or generated implementation needs iterative reviewer feedback. Run implement/test/review/fix cycles until the change is accepted instead of shipping the first draft."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    ...
    related_skills: [requesting-code-review, code-structure, code-simplifier, subagent-driven-development]
---
...
This skill complements `requesting-code-review`: use `gpt-loop` while converging on the solution, then use `requesting-code-review` as the final pre-commit/pre-push gate.
...
- the user asks for “review loop”, “GPT loop”, “iterate until clean”, or “don’t ship the first draft”
