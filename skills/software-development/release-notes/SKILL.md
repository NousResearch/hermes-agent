---
name: release-notes
description: "Use when drafting release notes or changelog summaries from git history. Fix the range first, gather evidence from commits/diffs/PRs, and write grounded notes without inventing impact."
version: 1.0.0
author: Hermes Agent
license: MIT
metadata:
  hermes:
    ...
    related_skills: [github-pr-workflow, github-repo-management, humanizer]
---
