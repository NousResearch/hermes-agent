...
# Use DesignSystem (v1.1 · 2026-07-05)
...
คู่กับมาตรฐานกลาง 60-Design/design-systems/design-system-standard.md (และชุดใหม่
design-system-standard-v2 เมื่อประกาศใช้) · อ้าง Memory Schema v1.2
...
- [ด่านไฟล์เข้า git จริง — บังคับหลังสร้าง/แก้] รัน `git check-ignore -v .project/DesignSystem.md`
...
ข้อห้าม: คิดสี/ฟอนต์ใหม่เองที่ไม่ได้มาจากโค้ด/เจ้าของ · claim ว่าหน้าจอตรงดีไซน์โดยไม่ตรวจภาพ · แก้ธีมกลางโดยไม่ถาม (เทียบ INC-9085 in-place vs showcase) · ปิดงานโดยไม่ผ่านด่านไฟล์เข้า git จริง · สรุปด้วยศัพท์เทคนิคโดยไม่แปล
```

## Changelog

- v1.1 (2026-07-05): **กู้คืนจากการถูกถอนกลับ** (commit `fff10805b` ถอน `f22b6f3bd` เมื่อ 2026-06-28 โดยไม่มีบันทึกเหตุผล) · อัปอ้างอิงเป็น Memory Schema v1.2 · เพิ่มด่าน "ไฟล์เข้า git จริง" + อ้างชุดมาตรฐานใหม่ design-system-standard-v2
