...
# 添加 AIWriteX 虚拟环境的 site-packages
VENV_SITE_PACKAGES = AIWRITE_X_PATH / ".venv/lib/python3.12/site-packages"
if VENV_SITE_PACKAGES.exists():
    sys.path.insert(0, str(VENV_SITE_PACKAGES))

# 添加适配器路径
ADAPTER_PATH = Path.home() / "Downloads/workspace/hermes-agent/optional-skills/aiwrite-x"
...
def test_platform_list():
    ...
    try:
        ...
        print(f"✓ 获取到 {len(platforms)} 个支持平台")
