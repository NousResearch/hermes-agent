...
class TestBuildCodexClient:
    ...
    def test_pool_honors_codex_base_url_override(self):
        ...
        with (
            ...
            patch(
                ...
                return_value="https://proxy.example/codex/",
            ),
            patch("agent.auxiliary_client.OpenAI") as mock_openai,
        ):
            mock_openai.return_value = MagicMock()
        ...
        assert client is not None
        assert model == "gpt-5.4"
        assert mock_openai.call_args.kwargs["base_url"] == "https://proxy.example/codex"
