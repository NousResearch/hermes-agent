...
class TestConsolidationProposalSurfaces:
    ...
    def _store(self, tmp_path, monkeypatch):
        ...
        # This class tests budget rejection and the background-review delete gate specifically,
        # not the general write-approval gate (which defaults to on, fail-closed, with no config).
        # _background_delete_gate's own staging (replace/remove under background_review origin) is
        # independent of this and still exercised normally.
