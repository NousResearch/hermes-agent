...
def test_references_run_in_parallel(monkeypatch):
    ...
    Both successful references must enter before either can finish. Order is
    preserved and a failing reference is isolated, independent of runner load.
    """
    ...
    concurrent_calls = Barrier(2, timeout=5)
