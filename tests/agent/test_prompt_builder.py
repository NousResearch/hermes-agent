...
class TestEnvironmentHints:
    ...
    def test_build_environment_hints_suppresses_host_for_apple_container(
        self, monkeypatch
    ):
        import agent.prompt_builder as _pb
    ...
    def test_probe_remote_backend_imports_real_factory(self, monkeypatch):
        ...
        real factory is ``_create_environment`` in ``tools.terminal_tool_backends``;
    ...
    def test_probe_remote_backend_passes_apple_configuration(self, monkeypatch):
        ...
        import tools.terminal_tool_backends as _backends
    ...
    def test_probe_remote_backend_cleans_up_temporary_environment(self, monkeypatch):
        ...
        monkeypatch.setattr(_backends, "_create_environment", lambda **_kwargs: FakeEnvironment())
