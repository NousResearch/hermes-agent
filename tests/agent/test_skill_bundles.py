    ...
    def test_preserves_non_missing_member_load_failure(self, bundles_env, monkeypatch):
        ...
        def skill_view(name, *args, **kwargs):
            if name == "broken-skill":
                return json.dumps({"success": False, "error": "Object of type date is not JSON serializable"})
        ...
        assert "broken-skill: Object of type date is not JSON serializable" in message
