...
class TestContextFileCwd:
    ...
    def test_process_cwd_soul_loads_when_terminal_cwd_unset(
        ...
        local_home = tmp_path / ".hermes"
        local_home.mkdir()
        (local_home / "soul.md").write_text("Launch directory soul.", encoding="utf-8")
        ...
        assert "Launch directory soul." in parts["stable"]
        assert "Global profile soul." not in parts["stable"]
        assert parts["stable"].index("Launch directory soul.") == 0
