...
def test_registry_names_resolve_into_the_table():
    ...
    # Every legacy inline command remains dispatched. New commands may also have handlers;
    # this is a migration-parity guard, not a frozen command-catalog snapshot.
