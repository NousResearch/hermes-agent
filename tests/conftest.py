...
_HERMES_BEHAVIORAL_VARS = frozenset({
    ...
    # YouPet POC bridge settings alter WeCom callback adapter dispatch.
    "YOUPET_WECOM_BRIDGE_ENABLED",
    "YOUPET_CORE_BASE_URL",
    "YOUPET_ACTOR_ID",
    "YOUPET_WECOM_SOURCE",
    "YOUPET_OUTBOX_CONSUMER",
    "YOUPET_OUTBOX_POLL_ENABLED",
    "YOUPET_OUTBOX_POLL_INTERVAL_SECONDS",
    "YOUPET_OUTBOX_LIMIT",
    "YOUPET_WECOM_SKIP_AGENT_DISPATCH",
    "YOUPET_OUTBOX_ACK_UNHANDLED_EVENTS",
    "YOUPET_WECOM_DEFAULT_CHAT_ID",
    "YOUPET_WECOM_USER_CHAT_MAP_JSON",
})
