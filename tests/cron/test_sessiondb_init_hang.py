        ...
        try:
            with patch("cron.scheduler._hermes_home", tmp_path), \
                 ...
                 patch.object(
                     ...
                     return_value="claim-sessiondb-hang",
                 ), \
                 patch.object(sched, "heartbeat_fire_claim", return_value=True), \
                patch.object(
                    sched,
                    "_run_job_in_killable_process",
                    side_effect=lambda active_job, **_kwargs: sched.run_job(active_job),
                ), \
