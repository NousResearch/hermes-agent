...
class TestPostRegistration:
    ...
    @patch("gateway.platforms.feishu.qr_register.urlopen")
    def test_post_registration_returns_parsed_json(self, mock_urlopen_fn):
        from gateway.platforms.feishu.qr_register import _post_registration
...
class TestInitRegistration:
    ...
    def test_init_succeeds_when_client_secret_supported(self, mock_urlopen_fn):
        from gateway.platforms.feishu.qr_register import _init_registration
...
class TestBeginRegistration:
    ...
    def test_begin_returns_device_code_and_qr_url(self, mock_urlopen_fn):
        from gateway.platforms.feishu.qr_register import _begin_registration
...
class TestPollRegistration:
    ...
    @patch("gateway.platforms.feishu.qr_register.time")
    @patch("gateway.platforms.feishu.qr_register.urlopen")
    def test_poll_returns_credentials_on_success(self, mock_urlopen_fn, mock_time):
        from gateway.platforms.feishu.qr_register import _poll_registration
...
class TestRenderQr:
    ...
    @patch("gateway.platforms.feishu.qr_register._qrcode_mod", create=True)
    def test_render_qr_returns_true_on_success(self, mock_qrcode_mod):
        from gateway.platforms.feishu.qr_register import _render_qr
    ...
    def test_render_qr_returns_false_when_qrcode_missing(self):
        ...
        with patch("gateway.platforms.feishu.qr_register._qrcode_mod", None):
...
class TestProbeBot:
    ...
    @patch("gateway.platforms.feishu.qr_register.FEISHU_AVAILABLE", True)
    def test_probe_returns_bot_info_on_success(self):
        from gateway.platforms.feishu.qr_register import probe_bot

        with patch("gateway.platforms.feishu.qr_register._probe_bot_sdk") as mock_sdk:
    ...
    @patch("gateway.platforms.feishu.qr_register.FEISHU_AVAILABLE", False)
    @patch("gateway.platforms.feishu.qr_register.urlopen")
...
class TestQrRegister:
    ...
    @patch("gateway.platforms.feishu.qr_register.probe_bot")
    @patch("gateway.platforms.feishu.qr_register._render_qr")
    @patch("gateway.platforms.feishu.qr_register._poll_registration")
    @patch("gateway.platforms.feishu.qr_register._begin_registration")
    @patch("gateway.platforms.feishu.qr_register._init_registration")
    def test_qr_register_success_flow(
        self, mock_init, mock_begin, mock_poll, mock_render, mock_probe
    ):
        from gateway.platforms.feishu.qr_register import qr_register
