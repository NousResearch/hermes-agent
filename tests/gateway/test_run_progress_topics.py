...
# Fragment egress contracts carried forward from #70093.
...
async def test_noneditable_interim_commentary_forces_terminal_redaction(
    ...
    # Exercise the direct callback when the optional stream consumer is unavailable.
    monkeypatch.setattr("gateway.stream_consumer.GatewayStreamConsumer", _unavailable_stream_consumer)
...
def _unavailable_stream_consumer(**kwargs):
    raise RuntimeError("simulated unavailable stream consumer")
