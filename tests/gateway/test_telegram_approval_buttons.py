...
class TestTelegramExecApproval:
    ...
    async def test_send_update_prompt_escapes_dynamic_prompt(self):
        ...
        assert "MARKDOWN_V2" in parse_mode_repr or str(sent["parse_mode"]) == "MarkdownV2"
...
class TestTelegramApprovalCallback:
    ...
    async def test_approval_callback_escapes_dynamic_user_name(self):
        ...
        parse_mode_repr = repr(edit_kwargs["parse_mode"])
        assert "MARKDOWN_V2" in parse_mode_repr or str(edit_kwargs["parse_mode"]) == "MarkdownV2"
