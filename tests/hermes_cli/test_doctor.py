    ...
    def _run_doctor_and_capture(
        ...
        *,
        ...
        try:
            ...
            monkeypatch.setattr(_auth_mod, "get_codex_auth_status_local", lambda: {})
            monkeypatch.setattr(_auth_mod, "get_xai_oauth_auth_status_local", lambda: {})
        except Exception:
            pass
...
def _run_doctor_with_healthy_oauth_fallback(
    ...
    *,
    ...
    monkeypatch.setattr(_auth_mod, "get_xai_oauth_auth_status_local", lambda: _xai_status)
...
class TestDoctorXaiOAuthStatus:
    ...
    def _run(self, monkeypatch, tmp_path, *, xai_auth_fn) -> str:
        ...
        monkeypatch.setattr(_auth_mod, "get_codex_auth_status_local", lambda: {"logged_in": False})
        monkeypatch.setattr(_auth_mod, "get_minimax_oauth_auth_status", lambda: {"logged_in": False})
        monkeypatch.setattr(_auth_mod, "get_xai_oauth_auth_status_local", xai_auth_fn)
    ...
    def test_import_failure_does_not_affect_other_providers(self, monkeypatch, tmp_path):
        ...
        monkeypatch.setattr(_auth_mod, "get_codex_auth_status_local", lambda: {"logged_in": False})
        monkeypatch.setattr(_auth_mod, "get_minimax_oauth_auth_status", lambda: {"logged_in": False})
        monkeypatch.delattr(_auth_mod, "get_xai_oauth_auth_status_local", raising=False)
...
class TestDoctorCodexCliHintPlacement:
    ...
    def _run(self, monkeypatch, tmp_path, *, codex_logged_in: bool, codex_cli_present: bool) -> str:
        ...
        from hermes_cli import auth as _auth_mod
        monkeypatch.setattr(_auth_mod, "get_nous_auth_status_local", lambda: {"logged_in": False})
        monkeypatch.setattr(_auth_mod, "get_codex_auth_status_local", lambda: {"logged_in": codex_logged_in})
        monkeypatch.setattr(_auth_mod, "get_minimax_oauth_auth_status", lambda: {"logged_in": False})
        monkeypatch.setattr(_auth_mod, "get_xai_oauth_auth_status_local", lambda: {"logged_in": False})
