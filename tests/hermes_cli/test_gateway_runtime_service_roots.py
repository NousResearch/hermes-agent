...
def test_service_start_does_not_decode_irrelevant_supervisor_output():
    from gateway.runtime_service import ExistingService, start_existing_gateway_service
...
def test_malformed_installed_plist_has_a_bounded_refusal():
    import plistlib
    from gateway.runtime_service import _verify_binding, RuntimeStartError
