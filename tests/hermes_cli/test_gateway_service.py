...
class TestSystemdServiceRefresh:
    def test_systemd_install_repairs_outdated_unit_without_force(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr(gateway_cli, "get_systemd_unit_path", lambda system=False, hermes_home=None: unit_path)
...
class TestGatewayServiceDetection:
    ...
    def test_is_service_running_returns_false_when_systemctl_missing(self, monkeypatch):
        ...
        monkeypatch.setattr(
            gateway_cli,
            "get_systemd_unit_path",
            lambda system=False, hermes_home=None: unit,
        )
...
class TestGatewaySystemServiceRouting:
    ...
    def test_systemd_status_surfaces_planned_restart_failure(self, monkeypatch, capsys):
        unit = SimpleNamespace(exists=lambda: True)
        monkeypatch.setattr(gateway_cli, "_select_systemd_scope", lambda system=False: False)
        monkeypatch.setattr(gateway_cli, "get_systemd_unit_path", lambda system=False, hermes_home=None: unit)
    ...
    def test_gateway_status_dispatches_full_flag(self, monkeypatch):
        ...
        monkeypatch.setattr(
            gateway_cli,
            "systemd_status",
            lambda deep=False, system=False, full=False, hermes_home=None: calls.append((deep, system, full, hermes_home)),
        )
        ...
        assert calls == [(False, False, True, None)]
    ...
    def test_gateway_status_prefers_system_service_when_only_system_unit_exists(self, monkeypatch):
        ...
        assert calls == [(False, False, False, None)]
    ...
    def test_gateway_status_reports_manual_process_when_service_is_stopped(self, monkeypatch, capsys):
        ...
        monkeypatch.setattr(
            gateway_cli,
            "systemd_status",
            lambda deep=False, system=False, full=False, hermes_home=None: print("service stopped"),
        )
        monkeypatch.setattr(
            gateway_cli,
            "get_gateway_runtime_snapshot",
...
class TestSystemdInstallOffersLegacyRemoval:
    ...
    def test_install_offers_removal_when_legacy_detected(
        ...
        unit_path = tmp_path / "hermes-gateway.service"
        monkeypatch.setattr(
            gateway_cli, "get_systemd_unit_path", lambda system=False, hermes_home=None: unit_path
        )
        monkeypatch.setattr(
            gateway_cli,
