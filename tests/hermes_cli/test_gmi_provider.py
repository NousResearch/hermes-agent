...
class TestGmiAuxiliary:
    def test_resolve_provider_client_uses_gmi_aux_default(self, monkeypatch):
        ...
        # GMI profile declares default_headers with an HTAIAgent User-Agent
        ...
        assert headers.get("User-Agent", "").startswith("HTAIAgent/")

    def test_gmi_profile_declares_hermes_user_agent(self):
        """The GMI plugin sets an HTAIAgent/<ver> User-Agent on its profile."""
