...
def test_decompose_fanout_children_inherit_root_assignee_when_unrouted(kanban_home):
    """#114294: unrouted children fall back to the ROOT task's assignee, not
    the decomposer's active profile. The active profile here is ``private``
...
def test_decompose_explicit_default_assignee_wins_over_root_assignee(kanban_home):
    """#114294: an explicitly configured ``kanban.default_assignee`` stays
