        ...
        monkeypatch.setattr(
            ...
            lambda: type(
                ...
                (),
                {
                    ...
                    "get_portable_mcp_server_plugins": lambda self: {"shared": "shared-plugin"},
                },
            )(),
        )
...
class TestConfigHelpers:
    ...
    def test_portable_plugin_mcp_servers_are_visible(self, monkeypatch):
        ...
        import hermes_cli.plugins as plugins_mod
        from hermes_cli.mcp_config import _get_visible_mcp_servers
        ...
        monkeypatch.setattr(
            ...
            lambda: type(
                ...
                (),
                {
                    ...
                    "get_portable_mcp_server_plugins": lambda self: {"supabase": "supabase-plugin"},
                },
            )(),
        )
        ...
        assert servers["supabase"]["auth"] == "oauth"

    def test_native_server_wins_name_collision_with_portable(self, monkeypatch):
        from hermes_cli.mcp_config import _save_mcp_server, _get_visible_mcp_servers
        import hermes_cli.plugins as plugins_mod
