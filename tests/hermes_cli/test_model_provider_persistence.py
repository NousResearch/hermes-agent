...
class TestSaveModelChoiceAlwaysDict:
    def test_string_model_becomes_dict(self, config_home):
        ...
        from hermes_agent.cli.auth import _save_model_choice
...
class TestProviderPersistsAfterModelSave:
    def test_api_key_provider_saved_when_model_was_string(self, config_home, monkeypatch):
        ...
        from hermes_agent.cli.main import _model_flow_api_key_provider
        ...
        with patch("hermes_agent.cli.auth._prompt_model_selection", return_value="kimi-k2.5"), \
             patch("hermes_agent.cli.auth.deactivate_provider"), \
    ...
    def test_copilot_provider_saved_when_selected(self, config_home):
        ...
        from hermes_agent.cli.main import _model_flow_copilot
        from hermes_agent.cli.config import load_config
    ...
    def test_copilot_acp_provider_saved_when_selected(self, config_home):
        ...
        from hermes_agent.cli.main import _model_flow_copilot_acp
        from hermes_agent.cli.config import load_config
    ...
    def test_opencode_go_models_are_selectable_and_persist_normalized(self, config_home, monkeypatch):
        ...
        with patch("hermes_agent.cli.models.fetch_api_models", return_value=["opencode-go/kimi-k2.5", "opencode-go/minimax-m2.7"]), \
             patch("hermes_agent.cli.auth._prompt_model_selection", return_value="kimi-k2.5"), \
             patch("hermes_agent.cli.auth.deactivate_provider"), \
             patch("builtins.input", return_value=""):
    ...
    def test_opencode_go_same_provider_switch_recomputes_api_mode(self, config_home, monkeypatch):
        ...
        with patch("hermes_agent.cli.models.fetch_api_models", return_value=["opencode-go/kimi-k2.5", "opencode-go/minimax-m2.5"]), \
             patch("hermes_agent.cli.auth._prompt_model_selection", return_value="minimax-m2.5"), \
             patch("hermes_agent.cli.auth.deactivate_provider"), \
             patch("builtins.input", return_value=""):
...
class TestBaseUrlValidation:
    ...
    def test_invalid_base_url_rejected(self, config_home, monkeypatch, capsys):
        ...
        from hermes_agent.cli.main import _model_flow_api_key_provider
        from hermes_agent.cli.config import load_config, get_env_value

        # User types a shell command instead of a URL at the base URL prompt
        with patch("hermes_agent.cli.auth._prompt_model_selection", return_value="glm-5"), \
             patch("hermes_agent.cli.auth.deactivate_provider"), \
    ...
    def test_stepfun_provider_saved_with_selected_region(self, config_home, monkeypatch):
        from hermes_agent.cli.main import _model_flow_stepfun
        from hermes_agent.cli.config import load_config, get_env_value
