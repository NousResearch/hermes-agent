...
class TestCreateProfile:
    ...
    def test_seeds_placeholder_env_file(self, profile_env):
        ...
        if sys.platform != "win32":
            ...
            # read-only attribute, so 0o600 is unenforceable.
            assert mode == 0o600
...
class TestPruneClonedBundledManifest:
    """Unit coverage for _prune_cloned_bundled_manifest()."""
    ...
    def test_frontmatter_name_matches_manifest_key(self, tmp_path):
        # Manifest keys are frontmatter names; the directory basename may differ.
        skills_dir = tmp_path / "skills"
...
class TestClonePrunesStaleManifest:
    ...
    def test_clone_config_drops_ghost_entries(self, profile_env):
        ...
        (default_home / "skills" / "ghost").mkdir()
        ...
        cloned = (profile_dir / "skills" / ".bundled_manifest").read_text(encoding="utf-8")
