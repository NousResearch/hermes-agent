...
class TestResolveHermesBinPosixPyGuard:
    """Exercise the source-install regressions on each real POSIX CI host."""

    def test_posix_python_launcher_falls_through_to_path(self, monkeypatch, tmp_path, _host):
    ...
    def test_posix_python_launcher_on_path_falls_back_to_current_python(
        self, monkeypatch, tmp_path, _host
    ):
