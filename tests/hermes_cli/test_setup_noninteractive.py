...
class TestNonInteractiveSetup:
    ...
    def test_cmd_setup_allows_noninteractive_flag_without_tty(self):
        ...
        with (
            patch("hermes_agent.cli.setup.run_setup_wizard") as mock_run_setup,
    ...
    def test_non_interactive_flag_skips_wizard(self, capsys):
        ...
        with (
            patch("hermes_agent.cli.setup.ensure_hermes_home"),
            patch("hermes_agent.cli.setup.load_config", return_value={}),
            patch("hermes_agent.cli.setup.get_hermes_home", return_value="/tmp/.hermes"),
            patch("hermes_agent.cli.auth.get_active_provider", side_effect=AssertionError("wizard continued")),
    ...
    def test_returning_user_terminal_menu_choice_dispatches_terminal_section(self, tmp_path):
        ...
        with (
            ...
            patch("hermes_agent.cli.auth.get_active_provider", return_value=None),
