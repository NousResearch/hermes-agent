...
class TestPluginAPIAuth:
    ...
    def test_plugin_route_allows_auth(self):
        ...
        Use the kanban board route because the kanban plugin is always loaded
        in tests. With a valid token the handler should run (200); without one
        the middleware should 401 before the handler is reached.
        """
