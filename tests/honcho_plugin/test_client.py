...
class TestObservationOptOutPhrases:
    ...
    def test_root_level_phrases(self, tmp_path):
        cfg_file = tmp_path / "config.json"
        cfg_file.write_text(json.dumps({
            "apiKey": "k",
    ...
    def test_non_list_value_ignored(self, tmp_path):
        cfg_file = tmp_path / "config.json"
        cfg_file.write_text(json.dumps({
            "apiKey": "k",
    ...
    def test_explicit_invalid_host_string_fails_closed(self, tmp_path):
    ...
    def test_explicit_null_host_fails_closed(self, tmp_path):
