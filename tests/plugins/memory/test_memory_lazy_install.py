...
# NOTE (2026-06-29 upstream-parity merge): TestMem0EnsureCalled removed — it asserted
# upstream's thin-backend mem0 arch (provider._create_backend + ensure()). The fork's
# mem0 is self-contained (pip_dependencies in plugin.yaml, no _create_backend). The
# allowlist test below still covers memory.mem0 being in LAZY_DEPS.
