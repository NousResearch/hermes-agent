...
class TestOpenCodeGoGLM53Reasoning:
    ...
    def test_mid_efforts_map_to_high(self, opencode_go_profile, effort):
        extra_body, top_level = opencode_go_profile.build_api_kwargs_extras(
            reasoning_config={"enabled": True, "effort": effort},
            model="glm-5.3",
        )
    ...
    def test_strong_efforts_map_to_max(self, opencode_go_profile, effort):
        extra_body, top_level = opencode_go_profile.build_api_kwargs_extras(
            reasoning_config={"enabled": True, "effort": effort},
            model="glm-5.3",
        )
    ...
    @pytest.mark.parametrize("model", ["opencode-go/glm-5.3", "glm-5-3", "glm-5p3"])
    def test_alias_spellings_recognized(self, opencode_go_profile, model):
        extra_body, top_level = opencode_go_profile.build_api_kwargs_extras(
    ...
    def test_glm_5_2_disabled_still_omits(self, opencode_go_profile):
        extra_body, top_level = opencode_go_profile.build_api_kwargs_extras(
            reasoning_config={"enabled": False},
            model="glm-5.2",
        )
...
class TestOpenCodeGoFullKwargsIntegration:
    ...
    def test_glm_5_3_off_reaches_enabled_plus_low(self, opencode_go_profile):
        from agent.transports.chat_completions import ChatCompletionsTransport
