...
def test_agent_reuses_one_affinity_across_all_anthropic_client_paths(
    ...
    with (
        ...
        initial_headers = mock_sdk.Anthropic.call_args.kwargs["default_headers"]

        agent._create_request_anthropic_client(reason="test")
        request_headers = mock_sdk.Anthropic.call_args.kwargs["default_headers"]

        agent._rebuild_anthropic_client()
        rebuilt_headers = mock_sdk.Anthropic.call_args.kwargs["default_headers"]
        ...
        credential_headers = mock_sdk.Anthropic.call_args.kwargs["default_headers"]
        ...
        recovery_headers = mock_sdk.Anthropic.call_args.kwargs["default_headers"]
        ...
        restore_headers = mock_sdk.Anthropic.call_args.kwargs["default_headers"]
        ...
        switch_headers = mock_sdk.Anthropic.call_args.kwargs["default_headers"]
        ...
        fallback_headers = mock_sdk.Anthropic.call_args.kwargs["default_headers"]
