...
def test_load_enabled_toolsets_rejects_disabled_mcp_env(monkeypatch, capsys):
    ...
    # Sorted; `kanban` / `data_viz` are auto-recovered by _get_platform_tools
    # when their tools live in the platform default universe but outside the
    # configurable checklist (see toolsets.py).
    assert server._load_enabled_toolsets() == ["data_viz", "kanban", "memory"]
