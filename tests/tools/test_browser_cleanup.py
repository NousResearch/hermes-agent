...
class TestBrowserCleanup:
    ...
    def test_explicit_session_forwards_verified_daemon_start_guard(self, tmp_path):
        ...
        with (
            ...
            patch("tools.browser_tool_lifecycle._reap_session_chromium"),
            patch("tools.browser_tool_lifecycle._remove_browser_socket_dir_if_safe") as remove_socket,
        ):
            bt_lifecycle.cleanup_browser("task-1")
    ...
    def test_emergency_cleanup_clears_all_tracking_state(self):
        ...
        with (
            patch("tools.browser_tool_lifecycle.cleanup_all_browsers") as mock_cleanup_all,
            patch("tools.browser_tool_lifecycle._reap_orphaned_browser_chromes") as mock_chrome_reaper,
            patch("tools.browser_tool_lifecycle._reap_orphaned_browser_sessions") as mock_daemon_reaper,
        ):
