...
class TestSchema:
    ...
    def test_schema_exposes_delivery_mode_for_action_escalation(self):
        from tools.computer_use.schema import COMPUTER_USE_SCHEMA

        delivery = COMPUTER_USE_SCHEMA["parameters"]["properties"]["delivery_mode"]
        assert delivery["type"] == "string"
        assert set(delivery["enum"]) == {"background", "foreground"}
