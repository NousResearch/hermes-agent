...
# Behavioral coverage for the system-prompt active-profile hint lives in
# tests/agent/test_system_prompt.py::TestActiveProfileHint (calls
# build_system_prompt_parts end-to-end; do not reintroduce source-text
# change-detector checks here).
