...
class TestWriteFileHandler:
    ...
    def test_writes_content(self, mock_get):
        ...
        mock_ops.write_file.assert_called_once_with(_real("/tmp/out.txt"), "hello world!\n")
...
class TestPatchHandler:
    ...
    def test_replace_mode_calls_patch_replace(self, mock_get):
        ...
        assert result["status"] == "ok"
        mock_ops.patch_replace.assert_called_once_with(_real("/tmp/f.py"), "foo", "bar", False)
    ...
    def test_replace_mode_replace_all_flag(self, mock_get):
        ...
        mock_ops.patch_replace.assert_called_once_with(_real("/tmp/f.py"), "x", "y", True)
