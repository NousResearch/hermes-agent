...
class TestReadFileHandler:
    ...
    def test_returns_file_content(self, mock_get):
        ...
        from tools.core.file_tools import read_file_tool
...
class TestWriteFileHandler:
    ...
    def test_missing_content_key_returns_error(self):
        ...
        from tools.core.file_tools import _handle_write_file
...
class TestSearchHandler:
    ...
    def test_search_calls_file_ops(self, mock_get):
        ...
        from tools.core.file_tools import search_tool
...
class TestSearchHints:
    ...
    def setup_method(self):
        ...
        from tools.core.file_tools import _read_tracker
        _read_tracker.clear()
