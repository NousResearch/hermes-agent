...
_HARDLINE_BLOCK = [
    ...
    '$(printf "\\155kfs.ext4") /dev/sda1',
    '$(printf "\\x6dkfs.ext4") /dev/sda1',
    # Raw block device overwrites
    "dd if=/dev/zero of=/dev/sda bs=1M",
    "dd if=/dev/urandom of=/dev/nvme0n1",
    "dd if=anything of=/dev/hda",
    '$(printf "\\144d") if=/dev/zero of=/dev/sda bs=1M',
    "echo bad > /dev/sda",
...
_HARDLINE_ALLOW = [
    ...
    "FOO=`printf 1` echo ok",
    'echo $(printf "\\162m") -rf /',
    'echo $(printf "\\155kfs.ext4") /dev/sda1',
    'echo $(printf "\\144d") if=/dev/zero of=/dev/sda bs=1M',
    'echo $(printf "\\153ill") -9 -1',
    "echo ${unset:-rm} -rf /",
    'echo "( $(echo rm) -rf / )"',
