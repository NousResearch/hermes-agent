...
class TestHeartbeatStaleThresholds:
    ...
    def test_idle_cycles_value(self):
        ...
        from tools.delegation.delegate_tool import _HEARTBEAT_STALE_CYCLES_IDLE
        assert _HEARTBEAT_STALE_CYCLES_IDLE == 15

    def test_in_tool_cycles_value(self):
        """IN_TOOL stale cycles should be 40 (40 * 30s = 1200s)."""
        from tools.delegation.delegate_tool import _HEARTBEAT_STALE_CYCLES_IN_TOOL
    ...
    def test_idle_timeout_seconds(self):
        ...
        from tools.delegation.delegate_tool import _HEARTBEAT_STALE_CYCLES_IDLE, _HEARTBEAT_INTERVAL
    ...
    def test_in_tool_timeout_seconds(self):
        ...
        from tools.delegation.delegate_tool import _HEARTBEAT_STALE_CYCLES_IN_TOOL, _HEARTBEAT_INTERVAL
    ...
    def test_interval_unchanged(self):
        ...
        from tools.delegation.delegate_tool import _HEARTBEAT_INTERVAL
