...
class TestSchemaConversion:
    ...
    def test_missing_type_on_object_is_coerced(self):
        ...
        from tools.mcp.mcp_tool import _normalize_mcp_input_schema
...
class TestCheckFunction:
    def test_disconnected_returns_false(self):
        from tools.mcp.mcp_tool import _make_check_fn, _servers
...
class TestDiscoverAndRegister:
    def test_tools_registered_in_registry(self):
        ...
        from tools.mcp.mcp_tool import _discover_and_register_server, _servers, MCPServerTask
...
class TestShutdown:
    def test_no_servers_safe(self):
        ...
        from tools.mcp.mcp_tool import shutdown_mcp_servers, _servers
    ...
    def test_shutdown_deregisters_registered_tools(self):
        ...
        import tools.mcp_tool as mcp_mod
        from tools.mcp.mcp_tool import MCPServerTask, shutdown_mcp_servers, _servers
...
class TestBuildSafeEnv:
    ...
    def test_only_safe_vars_passed(self):
        ...
        from tools.mcp.mcp_tool import _build_safe_env
...
class TestSanitizeError:
    ...
    def test_strips_github_pat(self):
        from tools.mcp.mcp_tool import _sanitize_error
...
class TestHTTPConfig:
    ...
    def test_http_seeds_initial_protocol_header(self):
        from tools.mcp.mcp_tool import LATEST_PROTOCOL_VERSION, MCPServerTask
...
class TestReconnection:
    ...
    def test_no_reconnect_on_initial_failure(self):
        ...
        """
        from tools.mcp.mcp_tool import MCPServerTask, _MAX_INITIAL_CONNECT_RETRIES
...
class TestConfigurableTimeouts:
    ...
    def test_default_timeout(self):
        ...
        from tools.mcp.mcp_tool import MCPServerTask, _DEFAULT_TOOL_TIMEOUT
...
class TestUtilitySchemas:
    ...
    def test_builds_four_utility_schemas(self):
        from tools.mcp.mcp_tool import _build_utility_schemas
...
class TestUtilityHandlers:
    ...
    def test_list_resources_success(self):
        from tools.mcp.mcp_tool import _make_list_resources_handler, _servers
    ...
    def test_read_resource_success(self):
        from tools.mcp.mcp_tool import _make_read_resource_handler, _servers
    ...
    def test_list_prompts_success(self):
        from tools.mcp.mcp_tool import _make_list_prompts_handler, _servers
    ...
    def test_get_prompt_success(self):
        from tools.mcp.mcp_tool import _make_get_prompt_handler, _servers
...
class TestMCPServerTaskSamplingIntegration:
    def test_sampling_handler_created_when_enabled(self):
        ...
        from tools.mcp.mcp_tool import MCPServerTask, _MCP_SAMPLING_TYPES
...
class TestDiscoveryFailedCount:
    ...
    def test_failed_server_increments_failed_count(self):
        ...
        from tools.mcp.mcp_tool import discover_mcp_tools, _servers, _ensure_mcp_loop
...
class TestMCPSelectiveToolLoading:
    ...
    def test_existing_tool_names_reflect_registered_subset(self):
        from tools.mcp.mcp_tool import _existing_tool_names, _servers, _discover_and_register_server
        from tools.registry import ToolRegistry
...
class TestSanitizeMcpNameComponent:
    ...
    def test_hyphens_replaced(self):
        from tools.mcp.mcp_tool import sanitize_mcp_name_component
...
class TestRegisterMcpServers:
    ...
    def test_skips_already_connected_servers(self):
        from tools.mcp.mcp_tool import register_mcp_servers, _servers
    ...
    def test_connects_new_servers(self):
        from tools.mcp.mcp_tool import register_mcp_servers, _servers, _ensure_mcp_loop
...
class TestMcpParallelToolCalls:
    ...
    def test_is_mcp_tool_parallel_safe_non_mcp_tool(self):
        ...
        from tools.mcp.mcp_tool import is_mcp_tool_parallel_safe
