...
class TestSendMessageTool:
    def test_resolved_opaque_plugin_target_uses_directory_id(self):
    ...
    def test_unresolved_opaque_plugin_target_passes_through_verbatim(self):
        from gateway.platform_registry import PlatformEntry, platform_registry
    ...
    def test_unresolved_builtin_target_keeps_directory_error(self):
