...
def _scan_boundary(monkeypatch):
    """Acquisition is exercised by test_security_consumers; isolate verdict rules."""
    monkeypatch.setattr(_tirith_mod, "_resolve_tirith_path", lambda configured: "tirith")
    monkeypatch.setattr(_tirith_mod, "_crash_count", 0)
    monkeypatch.setattr(_tirith_mod, "_circuit_open", False)
