...
class TestGetProvider:
    ...
    def test_local_when_available(self):
        with patch("tools.transcription_tools._HAS_FASTER_WHISPER", True):
            from tools.media.transcription_tools import _get_provider
...
class TestValidateAudioFile:
    ...
    def test_missing_file(self, tmp_path):
        from tools.media.transcription_tools import _validate_audio_file
    ...
    def test_too_large(self, tmp_path):
        f = tmp_path / "big.ogg"
        f.write_bytes(b"x")
        from tools.media.transcription_tools import _validate_audio_file, MAX_FILE_SIZE
        real_stat = f.stat()
...
class TestTranscribeLocal:
    ...
    def test_successful_transcription(self, tmp_path):
        ...
        with patch("tools.transcription_tools._HAS_FASTER_WHISPER", True), \
            ...
            from tools.media.transcription_tools import _transcribe_local
...
class TestTranscribeOpenAI:
    ...
    def test_no_key(self, monkeypatch):
        monkeypatch.delenv("VOICE_TOOLS_OPENAI_KEY", raising=False)
        from tools.media.transcription_tools import _transcribe_openai
...
class TestNormalizeLocalModel:
    ...
    def test_openai_model_name_maps_to_default(self):
        from tools.media.transcription_tools import _normalize_local_model, DEFAULT_LOCAL_MODEL
    ...
    def test_valid_local_model_preserved(self):
        from tools.media.transcription_tools import _normalize_local_model
