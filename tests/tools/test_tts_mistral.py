...
class TestGenerateMistralTts:
    def test_missing_api_key_raises_value_error(self, tmp_path, mock_mistral_module):
        from tools.media.tts_tool import _generate_mistral_tts
    ...
    def test_default_voice_id_when_absent(
        ...
        from tools.media.tts_tool import DEFAULT_MISTRAL_TTS_VOICE_ID, _generate_mistral_tts
    ...
    def test_default_model_used(self, tmp_path, mock_mistral_module, monkeypatch):
        from tools.media.tts_tool import DEFAULT_MISTRAL_TTS_MODEL, _generate_mistral_tts
