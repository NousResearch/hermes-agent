...
# Snapshot YOLO mode at import time so subprocesses cannot export
# HERMES_YOLO_MODE=1 to bypass approval in later commands within the
# same session.
_YOLO_AT_STARTUP = is_truthy_value(os.getenv("HERMES_YOLO_MODE"))
