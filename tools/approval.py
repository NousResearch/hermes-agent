...
_SENSITIVE_WRITE_TARGET = (
    ...
    rf'{_HERMES_ENV_PATH}|'
    rf'{_HASOS_RUNTIME_POLICY_TARGET}|'
    rf'{_SHELL_RC_FILES}|'
...
DANGEROUS_PATTERNS = [
    ...
    (rf'\b(cp|mv|install)\b.*\s["\']?{_SENSITIVE_WRITE_TARGET}["\']?{_COMMAND_TAIL}', "overwrite sensitive file"),
