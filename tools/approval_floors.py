...
def _sudo_stdin_block_result(description: str) -> dict:
    ...
    return {"approved": False, "message": (
        ...
        "attack vector. If the agent needs passwordless sudo, add a scoped NOPASSWD rule "
        "for the specific commands it needs via `visudo -f /etc/sudoers.d/hermes`, or run "
        "the sudo command manually in your own terminal.")}
