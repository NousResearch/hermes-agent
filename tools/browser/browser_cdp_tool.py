...
def _resolve_cdp_endpoint() -> str:
    ...
    """
    try:
        from tools.browser.browser_tool import _get_cdp_override  # type: ignore[import-not-found]
...
def _browser_cdp_via_supervisor(
    ...
    """
    try:
        from tools.browser.browser_supervisor import SUPERVISOR_REGISTRY  # type: ignore[import-not-found]
    except Exception as exc:  # pragma: no cover — defensive
        return tool_error(
...
def _browser_cdp_check() -> bool:
    ...
    """
    try:
        from tools.browser.browser_tool import (  # type: ignore[import-not-found]
            _get_cdp_override,
