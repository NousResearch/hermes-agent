...
Usage:
    from tools.browser.browser_tool import browser_navigate, browser_snapshot, browser_click
...
try:
    from tools.browser.browser_camofox import is_camofox_mode as _is_camofox_mode
except ImportError:
...
def _get_dialog_policy_config() -> Tuple[str, float]:
    ...
    from tools.browser.browser_supervisor import (
...
def browser_navigate(url: str, task_id: Optional[str] = None) -> str:
    ...
    if _is_camofox_mode():
        from tools.browser.browser_camofox import camofox_navigate
...
def browser_snapshot(
    ...
    """
    if _is_camofox_mode():
        from tools.browser.browser_camofox import camofox_snapshot
...
def browser_click(ref: str, task_id: Optional[str] = None) -> str:
    ...
    """
    if _is_camofox_mode():
        from tools.browser.browser_camofox import camofox_click
...
def browser_type(ref: str, text: str, task_id: Optional[str] = None) -> str:
    ...
    """
    if _is_camofox_mode():
        from tools.browser.browser_camofox import camofox_type
...
def browser_scroll(direction: str, task_id: Optional[str] = None) -> str:
    ...
    if _is_camofox_mode():
        from tools.browser.browser_camofox import camofox_scroll
...
def browser_back(task_id: Optional[str] = None) -> str:
    ...
    """
    if _is_camofox_mode():
        from tools.browser.browser_camofox import camofox_back
...
def browser_press(key: str, task_id: Optional[str] = None) -> str:
    ...
    """
    if _is_camofox_mode():
        from tools.browser.browser_camofox import camofox_press
...
def browser_console(clear: bool = False, expression: Optional[str] = None, task_id: Optional[str] = None) -> str:
    ...
    if _is_camofox_mode():
        from tools.browser.browser_camofox import camofox_console
...
def _camofox_eval(expression: str, task_id: Optional[str] = None) -> str:
    ...
    from tools.browser.browser_camofox import _ensure_tab, _post
    try:
...
def browser_get_images(task_id: Optional[str] = None) -> str:
    ...
    """
    if _is_camofox_mode():
        from tools.browser.browser_camofox import camofox_get_images
...
def browser_vision(question: str, annotate: bool = False, task_id: Optional[str] = None) -> Union[str, Dict[str, Any]]:
    ...
    """
    if _is_camofox_mode():
        from tools.browser.browser_camofox import camofox_vision
...
def _cleanup_single_browser_session(task_id: str) -> None:
    ...
    if _is_camofox_mode():
        try:
            from tools.browser.browser_camofox import camofox_close, camofox_soft_cleanup
...
if __name__ == "__main__":
    ...
    print("\n💡 Usage:")
    print("  from tools.browser.browser_tool import browser_navigate, browser_snapshot")
