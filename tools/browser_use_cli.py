...
_HELPERS_DIGEST = (
    ...
    "snapshot_table() renders it, find_entry(snap, needle) finds controls, point(entry) gives click_at_xy "
    "coordinates, so re-snapshot after acting (cdp AX tree only for shadow DOM, iframes, canvas). "
