...
BROWSER_VAULT_LIST_SCHEMA = {
    ...
    "description": (
        ...
        "Keychain (dedicated file, `kc:` handles, Mac hosts only), and any installed password manager "
        "(1Password, Bitwarden are detected automatically). A locked source appears under `locked`; call "
