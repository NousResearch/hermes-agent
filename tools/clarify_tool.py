...
CLARIFY_SCHEMA = {
    ...
    "description": (
        ...
        "- You offer any optional next step or invite a reply. If you would say "
        "'I can look deeper', 'Want me to continue?', 'Let me know if you want...', "
        "or similar, you MUST call this tool instead of ending with that prose. "
        "Do not leave optional next-step offers as prose the user cannot click. "
        "When the offer is specific, include the offered action in `choices` and "
        "let the UI append Other so the user can accept, decline, redirect, or "
        "write feedback.\n\n"
