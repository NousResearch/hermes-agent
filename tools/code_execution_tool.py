...
def _error_result(error: str, *, tool_calls_made: int = 0,
                  mcp_tool_calls_made: int = 0, duration: float = 0,
                  user_summary: Optional[str] = None) -> str:
    body = {"status": "error", "error": error, "tool_calls_made": tool_calls_made,
            "mcp_tool_calls_made": mcp_tool_calls_made, "duration_seconds": duration}
    if user_summary:
