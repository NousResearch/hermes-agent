...
def build_execute_code_schema(enabled_sandbox_tools: set = None,
    ...
    description = (
        ...
        "is available for processing. Prefer direct Python filesystem parsing "
        "over embedding Python inside terminal() commands; nested quoting can "
        "hide the command's real stderr. Terminal results include output, "
        "exit_code, and error — check exit_code before parsing output.\n\n"
