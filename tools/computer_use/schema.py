        ...
        "properties": {
            ...
            "delivery_mode": {
                ...
                "description": (
                    ...
                    "restores the prior frontmost app. On KDE Plasma X11, native "
                    "input is forced to foreground because CUA's background uinput "
                    "pointer can destabilize the desktop session. A `confirmed` effect is "
