...
Usage:
    ...
    from tools.core.terminal_tool import _active_environments
...
# Pattern for parsing grep/rg output lines: drive:path:line:content
_GREP_LINE_RE = re.compile(r'^([A-Za-z]:)?(.*?):(\d+):(.*)$')
