        ...
        "properties": {
            ...
            "inputs": {
                ...
                "description": (
                    ...
                    "page/section), 'postgres' (a table/db it reads, e.g. 'postgres:analytics.events'), "
                    "and 'cron-output:<job_id>' (the most-recent output of an "
            ...
            "outputs": {
                ...
                "description": (
                    ...
                    "updates, e.g. 'wiki:reports/daily'), 'file' (a path it writes), and 'postgres' "
                    "(a table/db it writes, e.g. 'postgres:analytics.events'). These are "
