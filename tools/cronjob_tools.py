...
Use for: reminders, periodic checks, scheduled reports, automated maintenance.""",
    "parameters": {
        ...
        "properties": {
            ...
            "deliver": {
                "type": "string",
                "description": "Where to send output: 'origin' (back to this chat), 'local' (files only), 'telegram', 'discord', 'signal', 'matrix', or 'platform:chat_id'"
            }
        },
