...
registry.register(
    ...
    handler=lambda args, **kw: cronjob(
        ...
        # Per-job inference pins are user-owned. The model-callable surface
        # intentionally ignores model/provider/base_url even if supplied by a
        # stale client; operator CLI/dashboard and direct cronjob() callers
        # retain pin authority.
