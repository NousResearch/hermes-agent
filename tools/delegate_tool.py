...
def _build_child_agent(
    ...
    #
    # KENSEI CUSTOM — profile-level fallback first: a profile's
    # ``fallback_providers`` config overrides the parent's inherited chain,
    # so a profile-scoped child recovers with the profile's own fallbacks.
