...
def _build_child_agent(
    ...
    override_auth_scheme: Optional[str] = None,
    ...
    if override_auth_scheme is not None:
        effective_auth_scheme = override_auth_scheme
    elif effective_provider == _parent_provider:
        effective_auth_scheme = getattr(parent_agent, "_anthropic_auth_scheme", None)
    else:
        effective_auth_scheme = None
    ...
    try:
        for i, t in enumerate(task_list):
            ...
            child = _build_child_agent(
                ...
                override_auth_scheme=creds.get("auth_scheme"),
