        ...
        for entry in results:
            ...
            try:
                ...
                _invoke_hook(
                    ...
                    # [jb] attribution par casquette (fil d'équipe D2/D3) : identifiant du
                    # sous-agent + département posés par _build_child_agent — consommés par
                    # le hook subagent_stop du plugin jb_outbound (delegation_activity).
