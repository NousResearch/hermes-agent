...
class HandoffResult:
    ...
    # Timeout-specific metadata (None for non-timeout outcomes so consumers
    # can key on presence rather than parsing the error string — #51690).
    ...
    def to_dict(self, *, include_private: bool = True) -> Dict[str, Any]:
        ...
        payload: Dict[str, Any] = {
            ...
            "timed_out_after_seconds": self.timed_out_after_seconds,
