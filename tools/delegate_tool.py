...
def delegate_task(
    ...
    try:
        ...
        # Per-task route override for round-robin:
        # Even indices → Primary, Odd indices → Fallback 1
        for i, t in enumerate(task_list):
            ...
            # route_config["primary_resolved"] is True when _resolve_model_route
            # found a task_type route or explicit model/provider override (vs.
            # falling through to the delegation default).
            ...
            # vLLM disable thinking: for qwen3.6-27b
            vllm_disable_thinking = (task_model == "qwen3.6-27b")
...
def _resolve_route_credentials(route_provider: str, route_model: str, base_creds: dict) -> dict:
    ...
    try:
        ...
        # so at least the model name is correct (key/base_url may be wrong
        # but this is better than aborting the entire delegation).
