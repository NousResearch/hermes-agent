...
def _is_hermes_provider_credential(name: str) -> bool:
    ...
    from agent.secret_scope import profile_env_name
    policy_name = profile_env_name(name)
    return _is_hermes_internal_secret(policy_name) or _is_provider_env_blocklisted(policy_name)
