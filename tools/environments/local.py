    ...
    def _stage_command_script(self, cmd_string: str) -> str:
        ...
        try:
            with os.fdopen(fd, "wb") as handle:
                # Commands can contain surrogateescaped bytes inherited from
                # decoded filesystem or subprocess data.  Preserve those bytes
                # instead of silently replacing them before Bash reads the file.
