...
def _resolve_path_for_task(filepath: str, task_id: str = "default", profile_home: Optional[Path] = None) -> Path | PurePosixPath:
    ...
    """
    container_paths = _uses_container_paths(task_id)
    expanded = _expand_tilde(filepath, profile_home=profile_home)
    if container_paths:
