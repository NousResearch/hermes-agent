...
def _protected_instruction_reason(filepath: str, task_id: str = "default",
    ...
    # Ordinary files in the active Hermes home are governed by its other guards.
    # Exempt that home only from the broad ``.hermes`` parent rule below:
    # protected basenames (including the active profile's own SOUL.md) and
    # configured patterns must still require approval there.
