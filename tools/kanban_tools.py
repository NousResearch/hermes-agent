...
KANBAN_COMPLETE_SCHEMA = {
    ...
    "description": (
        ...
        "tests_run, decisions, findings, etc). If you touched files, "
        "list your claimed paths in metadata.changed_files; Hermes will "
        "independently add metadata.evidence_manifest for git workspaces "
        "with the verified commit, diff hash, and per-file SHA256s. At least one of "
