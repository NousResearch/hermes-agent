...
_TASK_FIELDS = tuple(
    ...
    "provider_override completion_contract context_isolation last_failure_error".split())
...
_CREATED_FIELDS = (
    "status", "workspace_kind", "workspace_path", "project_id", "context_isolation",
)
...
def _handle_create(args: dict, **kw) -> str:
    ...
    context_isolation = args.get("context_isolation", "none")
