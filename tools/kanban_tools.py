...
_TASK_FIELDS = tuple(
    ...
    "provider_override reasoning_effort completion_contract last_failure_error".split())
...
_CREATED_FIELDS = ("status", "workspace_kind", "workspace_path", "project_id", "reasoning_effort")
