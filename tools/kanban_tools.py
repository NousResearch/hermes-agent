...
_TASK_FIELDS = tuple(
    ...
    "start_ref created_at started_at completed_at result current_run_id model_override "
    "provider_override completion_contract last_failure_error".split())
_TASK_SUMMARY_FIELDS = tuple(
    "id title assignee status priority tenant workspace_kind workspace_path start_ref project_id created_by "
...
_CREATED_FIELDS = ("status", "workspace_kind", "workspace_path", "start_ref", "project_id")
...
def _handle_create(args: dict, **kw) -> str:
    ...
    with _board(args.get("board")) as (kb, conn):
        ...
        new_tid = kb.create_task(
            ...
            start_ref=args.get("start_ref"), project_id=project_id,
