...
KANBAN_COMPLETE_SCHEMA = {
    ...
    "description": (
        ...
        "inside this task's workspace in ``artifacts`` — the gateway "
        "notifier will upload them as "
        ...
        "properties": {
            ...
            "artifacts": {
                ...
                "description": (
                    ...
                    "files inside this task's workspace that you produced "
                    "during this run — generated "
                    "charts, PDFs, spreadsheets, images, archives. "
                    "Examples: [\"/workspace/q3-revenue.png\", "
                    "\"/workspace/report.pdf\"]. The gateway notifier "
