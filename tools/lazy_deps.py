...
LAZY_DEPS: dict[str, tuple[str, ...]] = {
    ...
    # ─── Credential vaults ────────────────────────────────────────────────
    # The SDK keeps create/update secret values out of process argv. The bws
    # CLI currently accepts those values only as positional arguments.
    "vault.bitwarden_secrets": ("bitwarden-sdk==2.1.0",),
