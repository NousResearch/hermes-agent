...
LAZY_DEPS: dict[str, tuple[str, ...]] = {
    ...
    "platform.discord": (
        "discord.py==2.7.1",  # Voice is excluded until discord.py supports PyNaCl>=1.6.2.
        "brotlicffi==1.2.0.1",
    ...
    "tool.dashboard": (
        ...
        "starlette==1.3.1",  # Current CVE-fixed floor; keep in sync with pyproject [web]
    ...
    "tool.computer_use": (
        "mcp==1.26.0",
        "starlette==1.3.1",  # Current CVE-fixed floor; keep in sync with pyproject [computer-use]
    ),
