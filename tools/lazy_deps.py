...
LAZY_DEPS: dict[str, tuple[str, ...]] = {
    ...
    "tool.dashboard": (
        ...
        "starlette==1.3.1",  # HIGH advisory floor — keep lazy-install in sync with pyproject [web]
        "python-multipart==0.0.31",  # GHSA-5rvq-cxj2-64vf; FastAPI UploadFile/Form
    ),
    ...
    "tool.computer_use": (
        "mcp==1.28.1",
        "starlette==1.3.1",  # HIGH advisory floor — keep in sync with pyproject [computer-use]
    ),
