...
LAZY_DEPS: dict[str, tuple[str, ...]] = {
    ...
    "platform.slack": (
        "slack-bolt==1.27.0",
        "slack-sdk==3.40.1",
        "aiohttp==3.14.1",  # CVE-2026-34993, CVE-2026-47265 + 3.14.x advisory batch
    ),
    "platform.matrix": (
    ...
    "tool.dashboard": (
        ...
        "starlette==1.3.1",  # CVE-2026-48710 + post-1.0.1 Starlette advisories — sync with pyproject [web]
    ),
