...
class MCPServerTask:
    ...
    async def _run_stdio(self, config: dict):
        ...
        from tools.security.osv_check import check_package_for_malware
    ...
    async def _run_http(self, config: dict):
        ...
        if self._auth_type == "oauth":
            try:
                from tools.mcp.mcp_oauth_manager import get_manager
...
def _get_auth_error_types() -> tuple:
    ...
    try:
        ...
        pass
    try:
        from tools.mcp.mcp_oauth import OAuthNonInteractiveError
