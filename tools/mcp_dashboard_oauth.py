...
class DashboardOAuthFlow:
    ...
    # (code, state, iss) — iss is the RFC 9207 authorization-response issuer.
    ...
    def deliver_callback(
        ...
        *,
        ...
        ``iss`` is the RFC 9207 authorization-response issuer. mcp 2.0 rejects the
        response when the AS advertised ``authorization_response_iss_parameter_supported``
        and the host dropped this parameter (#105895).
        """
        with self._lock:
