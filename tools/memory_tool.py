...
def load_on_disk_store() -> "MemoryStore":
    ...
    Use this from any context that has no live agent but still needs to read or
    mutate memory. Falls back to the built-in defaults if config can't be loaded.
    """
