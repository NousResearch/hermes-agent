...
- Reference Models: -opus-4, gemini-2.5-pro, gpt-4.1, deepseek-r1
- Aggregator Model: -opus-4 (highest capability for synthesis)
...
AGGREGATOR_MODEL = "anthropic/-opus-4.5"  # Use highest capability model for aggregation
