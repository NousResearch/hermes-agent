...
class ProcessCheckpointMixin:
    ...
    def recover_from_checkpoint(self) -> int:
        ...
        from tools.process_registry_scope import _stop_systemd_unit
        from tools.process_registry import ProcessSession, _CHECKPOINT_FIELDS, _checkpoint_path, _CHECKPOINT_DEFAULTS, _WATCHER_ROUTE_KEYS
