...
SKILL_MANAGE_SCHEMA = {
    ...
    "description": (
        ...
        "memory — reviewed reusable approaches for recurring task types. "
        f"New skills go to {display_hermes_home()}/skills/; existing skills can be modified wherever they live.\n\n"
        "Actions: create (full SKILL.md + optional category), "
        "patch (old_string/new_string — preferred for fixes), "
        "edit (full SKILL.md rewrite — major overhauls only), "
        "delete, write_file, remove_file.\n\n"
        "Create only when the user explicitly asks you to save a procedure "
        "or the current task is specifically about maintaining skills.\n"
        "Update when: instructions stale/wrong, OS-specific failures, "
        "missing steps or pitfalls found during approved skill maintenance. "
        "If you used a skill and hit issues not covered by it, report the issue "
        "and patch only when the user approves.\n\n"
