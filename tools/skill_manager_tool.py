...
SKILL_MANAGE_SCHEMA = {
    ...
    "description": (
        ...
        f"New skills go to {display_hermes_home()}/skills/. Existing skills may "
        "be modified when the user's intent and active workspace ownership rules allow it.\n\n"
        ...
        "Create or update when the user requests it, subject to the active "
        "workspace contract when present and the tool's write approval gate.\n\n"
