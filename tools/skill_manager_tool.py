...
SKILL_MANAGE_SCHEMA = {
    "name": "skill_manage",
    "description": (
        "Manage skills. Skills are your procedural "
        "memory — reusable approaches for recurring task types. "
        f"New skills go to {display_hermes_home()}/skills/; existing skills can be modified wherever they live.\n\n"
        "Actions fall into two categories:\n\n"
        "  SURGICAL (safe — file-level, reversible):\n"
        "    write_file  — Add or overwrite a supporting file (reference/template/script) in a skill.\n"
        "    remove_file — Remove a single supporting file from a skill. NOT the same as 'delete'.\n"
        "    patch       — Find-and-replace text in a skill file (SKILL.md or supporting file).\n"
        "    edit        — Full rewrite of a skill's SKILL.md content.\n\n"
        "  DESTRUCTIVE (irreversible — directory-level):\n"
        "    delete      — ⚠️ Permanently removes the ENTIRE skill directory via shutil.rmtree().\n"
        "                  This is NOT the same as removing a single file.\n"
        "                  Use 'remove_file' to delete an individual file.\n"
        "                  Only use 'delete' when you intend to destroy the entire skill.\n"
        "                  Once deleted, a skill cannot be recovered (unlike curator archives).\n"
        ...
        "When unsure, use 'remove_file' for individual files and 'delete' only for whole-skill removal.\n\n"
