...
# v7: U+200D inside an emoji ZWJ sequence is no longer an `invisible_unicode`
# finding. v6 is already taken on main (env-var-name secret carve-out + new patterns),
# so this detection change gets its own version.
