    ...
    for skill_name, skill_src in bundled_skills:
        ...
        if skill_name not in manifest:
            ...
            if origin_hash and bundled_hash == origin_hash:
                # A pre-fix copy can be content-identical yet retain mode bits
                # inherited from a read-only bundled source. It is still a
                # content no-op, but repair the local copy in place.
