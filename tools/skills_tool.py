...
def _skill_search_dirs() -> Tuple[list, list, Path]:
    ...
    from agent.skill_utils import get_external_skills_dirs, get_extra_skills_dirs, get_project_skills_dirs
    project_dirs = list(get_project_skills_dirs())
    active_skills_dir = _skills_dir()
    all_dirs = project_dirs + ([active_skills_dir] if active_skills_dir.exists() else [])
    all_dirs += [d for d in get_extra_skills_dirs() + get_external_skills_dirs() if d not in all_dirs]
