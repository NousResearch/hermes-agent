...
def terminal_tool(
    ...
    try:
        ...
        # Elevated execution via UAC (Windows only) — runs after shared
        # security guard decision so blocked/pending-approval commands
        # never reach the elevated executor.
        if elevated:
