...
def _write_to_sandbox(content: str, remote_path: str, env) -> bool:
    ...
    Stdin is byte-exact on every backend (``BaseEnvironment._embed_stdin_heredoc``
    re-emits the body minus the heredoc's own trailing newline), so no size
    allowance exists: any drift is a real loss."""
