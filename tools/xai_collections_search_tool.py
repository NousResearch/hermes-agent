...
Search-only over existing xAI Collections / vector stores. Does not create
collections, upload files, or manage collection metadata.
...
DEFAULT_XAI_COLLECTIONS_SEARCH_MODEL = "grok-4.5"
