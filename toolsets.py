...
_HERMES_CORE_TOOLS = [
    ...
    # Cronjob management
    "cronjob",
    # Cross-platform messaging and direct local profile messaging
    "send_message", "agent_message",
...
TOOLSETS = {
    ...
    "messaging": {
        "description": "Cross-platform messaging and direct local profile-to-profile requests",
        "tools": ["send_message", "agent_message"],
        "includes": []
    },
