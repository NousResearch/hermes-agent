...
TOOLSETS = {
    ...
    "hermes-linear": {
        "description": "Linear gateway toolset - issue/comment driven Hermes interface",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
