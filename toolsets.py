...
TOOLSETS = {
    ...
    "matrix": _ts("Matrix room history, reactions and account presence", ["matrix"]),
    "matrix_admin": _ts("Matrix redaction, invitations and room creation (config gated)", ["matrix_admin"]),
    ...
    "hermes-matrix": _bundle("Matrix bot toolset - decentralized encrypted messaging (full access)", ["matrix", "matrix_admin"]),
