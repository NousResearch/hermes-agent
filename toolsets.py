...
_HERMES_CORE_TOOLS = [
    ...
    "execute_code", "delegate_task", "aider_subagent", "pr_agent",
    # Cronjob management
    "cronjob",
...
TOOLSETS = {
    ...
    "aider": {
        "description": "Delegate code-writing tasks to a local Aider subprocess",
        "tools": ["aider_subagent"],
        "includes": []
    },

    "pr_agent": {
        "description": "Run PR-Agent against GitHub pull requests before Aider follow-up edits",
        "tools": ["pr_agent"],
        "includes": []
    },
