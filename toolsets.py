...
TOOLSETS = {
    ...
    "hermes-wechat": {
        "description": "WeChat bot toolset - interact with Hermes via WeChat (WeixinClawBot)",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
    ...
    "hermes-gateway": {
        ...
        "tools": [],
        "includes": ["hermes-telegram", "hermes-discord", "hermes-whatsapp", "hermes-slack", "hermes-signal", "hermes-homeassistant", "hermes-email", "hermes-sms", "hermes-wechat"]
    }
}
