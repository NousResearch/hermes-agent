...
TOOLSETS = {
    ...
    "hermes-api": {
        "description": "REST/WebSocket API toolset - HTTP interface for any frontend or service",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
    ...
    "hermes-gateway": {
        ...
        "tools": [],
        "includes": ["hermes-telegram", "hermes-discord", "hermes-whatsapp", "hermes-slack", "hermes-signal", "hermes-homeassistant", "hermes-email", "hermes-api"]
    }
}
