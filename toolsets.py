...
_HERMES_CORE_TOOLS = [
    ...
    "kanban_complete", "kanban_submit_project_verdict", "kanban_block", "kanban_heartbeat",
...
TOOLSETS = {
    ...
    "kanban": {
        ...
        "tools": [
            "kanban_show", "kanban_list", "kanban_complete", "kanban_submit_project_verdict", "kanban_block",
