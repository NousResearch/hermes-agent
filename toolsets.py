...
_HERMES_CORE_TOOLS = [
    ...
    "browser_vault_list", "browser_vault_unlock", "browser_vault_fill", "browser_vault_save_login", "browser_vault_enter_code", "browser_vault_fill_export_password",  # ride with the browser
