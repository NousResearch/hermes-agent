...
TOOLSETS = {
    ...
    "hermes-msteams": {
        "description": "Microsoft Teams bot toolset - enterprise messaging, channels, group chats (full access)",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
