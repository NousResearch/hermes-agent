...
TOOLSETS = {
    ...
    "delegation": _ts("Spawn subagents with isolated context or persistent external-agent sessions", ["delegate_task", "delegate_session"]),
    "delegation_session": _ts("Persistent external-agent delegation sessions (internal scoping surface)", ["delegate_session"]),
