...
_HERMES_CORE_TOOLS = [
    ...
    "kanban_verify", "kanban_advance_acceptance", "kanban_reviews",
    "kanban_review", "kanban_plan_review",
...
TOOLSETS = {
    ...
    "kanban": {
        "description": (
            ...
            "orchestrators) list, inspect progress, review evidence, "
            "unblock, and fan out tasks."
        ),
        "tools": [
            "kanban_show", "kanban_list", "kanban_progress", "kanban_acceptance",
            "kanban_verify", "kanban_advance_acceptance", "kanban_reviews",
