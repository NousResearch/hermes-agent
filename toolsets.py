...
TOOLSETS = {
    ...
    "hermes-matrix": {
        "description": "Matrix bot toolset - federated open-standard messaging protocol (full access)",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
    ...
    "hermes-gateway": {
        ...
        "tools": [],
        "includes": ["hermes-telegram", "hermes-discord", "hermes-whatsapp", "hermes-slack", "hermes-signal", "hermes-homeassistant", "hermes-email", "hermes-matrix"]
    }
}
