...
def _agent_cbs(sid: str) -> dict:
    ...
    callbacks = {
        ...
        # clarify_form (dashboard): one card with several questions; the renderer answers
        # clarify_form.respond with a JSON map of question id -> answer.
        "clarify_form_callback": lambda questions: _block("clarify_form.request", sid, {"questions": questions}),
