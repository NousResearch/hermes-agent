...
def _agent_cbs(sid: str) -> dict:
    ...
    callbacks = {
        ...
        # clarify_form (dashboard): one card with several questions; the response carries a
        # JSON map of question id -> answer under ``answers``.
        "clarify_form_callback": lambda questions: _clarify_form_block(sid, questions),
