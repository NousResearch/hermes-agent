...
def _(rid, params: dict) -> dict:
    ...
    try:
        ...
        # message would. (Nested per method_ctx rebinding.) The staged media
        # refs above are rewritten to THIS gateway's local paths, so the live
        # turn keeps its MEDIA: lines — submit the enriched message.
        ...
        if live_sid:
            ...
            submitted = _methods["prompt.submit"](rid, {"session_id": live_sid, "text": turn_message, "queued": True})
