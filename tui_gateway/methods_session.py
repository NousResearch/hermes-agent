...
def _(rid, params: LlmOneshotParams) -> LlmOneshotResult | dict:
    """Stateless one-shot completion; a live session lends its model."""
...
def _(rid, params: SessionContextBreakdownParams, session: dict) -> SessionContextBreakdownResult | dict:
    ...
    try:
        ...
        return SessionContextBreakdownResult.model_validate(compute_session_context_breakdown(agent, history))
    except Exception as exc:
