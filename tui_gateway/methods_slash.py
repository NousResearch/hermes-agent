...
_LIVE_SLASH_OUTPUT = {
    ...
    "prompt": (_NO_AGENT, "Desktop compose: use ⌘I (Ctrl+I) to write a message for the current agent."),
    "compose": (_NO_AGENT, "Desktop compose: use ⌘I (Ctrl+I) to write a message for the current agent."),
