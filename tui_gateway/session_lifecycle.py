...
def _publish_session_identity(sid: str, session: dict, *, session_origin="resume") -> None:
    ...
    # Only the actual unseeded create caller can assert freshness. Reattachment,
    # compression and every resume publisher default to historical provenance.
    identity["session_origin"] = session_origin
