...
def _lease_metadata(live_session_id: str, *, pending_title: str | None = None) -> dict:
    ...
    if pending_title is not None:
        metadata["pending_title"] = pending_title
    return metadata
...
def _claim_active_session_slot(
    ...
    try:
        ...
        return try_acquire_active_session(
            ...
            metadata=_lease_metadata(live_session_id, pending_title=pending_title),
