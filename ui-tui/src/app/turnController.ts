  ...
  upsertSubagent(
    ...
    patchTurnState(state => {
      ...
      const next: SubagentProgress = {
        ...
        errorAuthoritative: p.error_authoritative ?? base.errorAuthoritative,
        ...
        schemaErrors: p.schema_errors ?? base.schemaErrors,
        schemaRetries: p.schema_retries ?? base.schemaRetries,
        schemaValid: p.schema_valid ?? base.schemaValid,
