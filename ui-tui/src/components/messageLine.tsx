...
export const MessageLine = memo(function MessageLine({
  ...
  // The stamp now shares the message row, so the body yields exactly its visible
  // width plus one separating space. Floor at one column on very narrow terminals.
