...
|-------|------|------------|----------|
| `copilot-limits/agent_model_metadata.py` | `# token (account 94125662): gpt-5.4 ...` | account ID in a provenance comment | "a ChatGPT Pro account" |
| `private-feature-mixed/agent_models_dev.py` | `#   /mnt/devvm/custom/hermes/review-copilot-opus-context/AUTHORITATIVE_LIMITS.md` | personal path in a comment | drop the path |
...
| `private-feature-mixed/tests_..._opus_context_fix_...py` | `review at /mnt/devvm/.../review-copilot-opus-context/.` | personal path in a docstring | drop |
| `private-feature-mixed/tests_probe_prelude_e2e.py` | `WT = "/mnt/devvm/.../review-sysprompt-prelude"` | personal worktree path in a dev-probe | env var |
