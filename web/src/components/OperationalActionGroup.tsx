 ...
 * existing compact inline layout returns at the small breakpoint.
 */
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "sm:ml-auto sm:flex sm:w-auto sm:shrink-0 sm:flex-wrap sm:items-center sm:gap-1 sm:[&_button]:min-h-0 sm:[&_a]:min-h-0",
