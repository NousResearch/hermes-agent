...
export const af: Translations = {
  ...
  skills: {
    ...
    skillCount: (count) => `${count} ${count === 1 ? "vaardigheid" : "vaardighede"}`,
    resultCount: (count) => `${count} ${count === 1 ? "resultaat" : "resultate"}`,
  ...
  config: {
    ...
    fields: (count) => `${count} ${count === 1 ? "veld" : "velde"}`,
  ...
  env: {
    ...
    keysCount: (count) => `${count} ${count === 1 ? "sleutel" : "sleutels"}`,
    ...
    customConfigured: (count) => `${count} pasgemaakte ${count === 1 ? "sleutel" : "sleutels"} gestel`,
    configuredCount: (count) => `${count} gekonfigureer`,
    configuredSummary: (configured, total) => `${configured} van ${total} gekonfigureer`,
