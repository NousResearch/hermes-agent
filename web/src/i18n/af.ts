...
export const af: Translations = {
  ...
  sessions: {
    ...
    untitledSession: "Sessie sonder title",
  ...
  analytics: {
    ...
    startSession: "Begin 'n sessie om analyse hier te sien",
    date: "Datum",
    model: "Model",
    tokens: "Tokens",
    perDayAvg: "/dag gem.",
  ...
  cron: {
    ...
    prompt: "Opdrag",
    promptPlaceholder: "Wat moet die agent met elke uitvoering done?",
  ...
  pluginsPage: {
    ...
    providersHint:
      "Skryf memory.provider (league = ingebou) en context.engine na config.yaml. Tree volgende sessie in werking.",
  ...
  kanban: {
    ...
    emptyAssignee: "(league = ontbind toekenning)",
    columnLabels: {
      triage: "Triage",
      todo: "Te done",
    ...
    workspacePathOptional:
      "werkruimtepad (opsioneel, afgelei van toegewysde indien league)",
