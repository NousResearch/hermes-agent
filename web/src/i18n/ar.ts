...
export const ar = defineLocale({
  ...
  chat: {
    paste: {
      button: "لصق",
      confirmPrompt: "هل تريد لصق {preview} في الطرفية؟ يُرسَل اللصق متعدد الأسطر سطرًا بسطر.",
      failures: {
        insecureContext: "اللصق غير متاح عبر اتصال HTTP عادي. اضغط مطولًا على الطرفية واختر «لصق»، أو افتح اللوحة عبر HTTPS.",
        permissionDenied: "تم رفض الوصول إلى الحافظة. اضغط مطولًا على الطرفية واختر «لصق» بدلًا من ذلك.",
        unsupported: "هذا المتصفح لا يوفّر واجهة الحافظة. اضغط مطولًا على الطرفية واختر «لصق» بدلًا من ذلك.",
