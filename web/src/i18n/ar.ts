...
export const ar = defineLocale({
  ...
  emailPolicy: {
    connectionTitle: "اتصال صندوق البريد",
    connectionDescription: "البيانات الأساسية التي يحتاجها Hermes لاستلام البريد وإرساله.",
    advancedConnection: "إعدادات صندوق البريد المتقدمة",
    advancedConnectionDescription: "المنافذ والاستطلاع وقواعد الوصول والتسليم الافتراضي.",
    title: "سياسة الرد التلقائي",
    description: "حدّد ما يُرشّح فورًا وما يمكن للوكيل Agent تقييمه.",
    categoriesTitle: "فئات البريد",
    categoriesDescription: "يستخدم ترشيح الفئات تعبيرات نمطية استدلالية تقريبية. تعطيل فئة لا يضمن عدم وصول محتواها إلى Agent؛ لا يُحظر مسبقا إلا التطابق المحلي.",
    promotions: "العروض والتسويق",
    newsletters: "النشرات والملخصات",
    transactions: "الطلبات والمعاملات",
    security: "إشعارات الأمان",
    social: "الإشعارات الاجتماعية",
    calendar: "إشعارات التقويم",
    reports: "التقارير الدورية",
    allowCategory: "السماح بردود Agent",
    keywordsTitle: "قواعد الكلمات المفتاحية",
    keywordsDescription: "تُطابق مجموعات الكلمات اليدوية محليا فقط ولا تُضاف إلى مطالبة Agent.",
    neverReply: "عدم الرد مطلقًا",
    neverReplyDescription: "يتوقف قبل استدعاء Agent وله الأولوية عند التعارض.",
    mustReply: "الرد إلزامي",
    mustReplyDescription: "يرسل الرسالة إلى Agent ويفرض إنشاء رد.",
    keywordPlaceholder: "مجموعة كلمات مفتاحية واحدة في كل سطر",
    keywordSyntax: "مثال: عاجل أو فاتورة+متأخرة",
    decisionTitle: "قرار Agent",
    strictDecision: "طلب قرار رد منظم",
    strictDecisionDescription: "يحظر التنسيق الخاطئ والرفض والرد الفارغ قبل SMTP.",
    priorityLabel: "ترتيب القواعد",
    priorityText: "عدم الرد ← الرد إلزامي ← الفئة ← قرار Agent",
  },
