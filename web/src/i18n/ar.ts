...
export const ar = defineLocale({
  ...
  skills: {
    ...
    skillCount: (count) => `المهارات: ${count}`,
    resultCount: (count) => `النتائج: ${count}`,
  ...
  env: {
    ...
    notSet: "غير معيّن",
    keysCount: (count) => `المفاتيح: ${count}`,
    enterValue: "أدخل القيمة...",
    replaceCurrentValue: "استبدال القيمة الحالية ({preview})",
    showValue: "إظهار القيمة الحقيقية",
    hideValue: "إخفاء القيمة",
    customConfigured: (count) => `المفاتيح المخصصة المُعدّة: ${count}`,
    configuredCount: (count) => `تم إعداد ${count}`,
    configuredSummary: (configured, total) => `تم إعداد ${configured} من ${total}`,
  },
