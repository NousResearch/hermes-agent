...
export const de: Translations = {
  ...
  env: {
    ...
    keysCount: (count) => `${count} Schlüssel`,
    ...
    customConfigured: (count) => `${count} benutzerdefinierte${count === 1 ? "r Schlüssel" : " Schlüssel"} gesetzt`,
    configuredCount: (count) => `${count} konfiguriert`,
    configuredSummary: (configured, total) => `${configured} von ${total} konfiguriert`,
