...
export const de: Translations = {
  ...
  emailPolicy: {
    connectionTitle: "Postfachverbindung",
    connectionDescription: "Die Grunddaten, die Hermes zum Empfangen und Senden benötigt.",
    advancedConnection: "Erweiterte Postfacheinstellungen",
    advancedConnectionDescription: "Ports, Abrufintervall, Zugriffsregeln und Standardzustellung.",
    title: "Richtlinie für automatische Antworten",
    description: "Bestimme, was sofort gefiltert wird und was der Agent prüfen darf.",
    categoriesTitle: "Nachrichtenkategorien",
    categoriesDescription: "Die Kategoriefilterung nutzt ungefähre heuristische Regexe. Eine deaktivierte Kategorie garantiert nicht, dass Inhalte den Agent nie erreichen; nur lokale Treffer werden vorher blockiert.",
    promotions: "Werbung & Marketing",
    newsletters: "Newsletter & Zusammenfassungen",
    transactions: "Bestellungen & Transaktionen",
    security: "Sicherheitshinweise",
    social: "Soziale Benachrichtigungen",
    calendar: "Kalenderhinweise",
    reports: "Regelmäßige Berichte",
    allowCategory: "Agent-Antworten erlauben",
    keywordsTitle: "Schlüsselwortregeln",
    keywordsDescription: "Manuelle Schlüsselwortgruppen werden nur lokal wörtlich abgeglichen und nicht zum Agent-Prompt hinzugefügt.",
    neverReply: "Nie antworten",
    neverReplyDescription: "Stoppt vor dem Agent und hat bei Konflikten Vorrang.",
    mustReply: "Immer antworten",
    mustReplyDescription: "Leitet die Mail an den Agent weiter und erzwingt eine Antwort.",
    keywordPlaceholder: "Eine Schlüsselwortgruppe pro Zeile",
    keywordSyntax: "Beispiel: dringend oder rechnung+überfällig",
    decisionTitle: "Agent-Entscheidung",
    strictDecision: "Strukturierte Antwortentscheidung verlangen",
    strictDecisionDescription: "Blockiert fehlerhafte, negative und leere Antworten vor SMTP.",
    priorityLabel: "Regelreihenfolge",
    priorityText: "Nie antworten → Immer antworten → Kategorie → Agent-Entscheidung",
  },
