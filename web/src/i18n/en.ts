...
export const en: Translations = {
  ...
  sessions: {
    ...
    exportSessionAria: "Export session",
    ...
    prunedSessionsOne: "Pruned {count} session",
    prunedSessionsOther: "Pruned {count} sessions",
  ...
  filesPage: {
    ...
    uploadedOne: "{count} file uploaded",
    uploadedOther: "{count} files uploaded",
  ...
  channelsPage: {
    ...
    gatewayNotRunningAfter: " (or the Restart button above).",
    configuredCount:
    ...
    telegramManualOpen: "Open",
    telegramManualSend: ", send",
    telegramManualFollow: ", and follow its prompts.",
    telegramManualCopyToken:
      "Copy the complete bot token BotFather gives you.",
    telegramManualMessage: "Message",
    ...
    findTelegramId: "Find my user ID",
    ...
    restartManually: "Gateway restart failed (exit {code}) — restart manually",
    ...
    starting: "Starting…",
    // Lowercase variant for the WhatsApp setup status line, beside
    // `preparing` / `waiting`.
    startingStatus: "starting",
    setupQr: "Set up with QR",
    telegramConfigured: "Existing Telegram credentials are configured.",
    telegramConnectHeading: "Choose how to connect your Telegram bot",
    ...
    telegramCreateQr: "Create with QR",
  ...
  webhooksPage: {
    ...
    restartRequestFailed: "Failed to restart",
    webhooksEnabledRestartFailed:
      "Webhooks enabled; gateway restart failed",
  ...
  systemPage: {
    ...
    pastesUploadedOne: "Uploaded {count} paste{redacted}",
    pastesUploadedOther: "Uploaded {count} pastes{redacted}",
    redactedSuffix: " (redacted)",
    debugShareFailed: "Debug share failed: {error}",
    updateAvailableBehindOne: "Update available — {count} commit behind",
    updateAvailableBehindOther: "Update available — {count} commits behind",
    updateAvailable: "Update available",
    // Lowercase variant for the status badge row, which sits beside the
    // lowercase `latest` / `running` / `stopped` badges.
    ...
    dockerUpdateUnsupported: "Updates don't apply from this dashboard.",
    ...
    updateDialogBehindOne:
      "This will run 'hermes update' ({command}) and pull {count} new commit. The gateway restarts when the update finishes; the current session keeps its prompt cache until then.",
    updateDialogBehindOther:
      "This will run 'hermes update' ({command}) and pull {count} new commits. The gateway restarts when the update finishes; the current session keeps its prompt cache until then.",
    updateDialogDefault:
    ...
    hourUnit: "h",
    minuteUnit: "m",
    psutilHintBefore: "Install the ",
    psutilHintAfter: " extra for CPU / memory / disk metrics.",
    ...
    portalLoginHintBefore: "Log in with ",
    portalLoginHintAfter: ".",
  ...
  profileBuilderPage: {
    ...
    createdWithInstallsOne:
      'Profile "{name}" created — {count} hub skill installing',
    createdWithInstallsOther:
  ...
  mcpPage: {
    ...
    disabled: "disabled",
    envCountOne: "{count} env var",
    envCountOther: "{count} env vars",
    ...
    authenticationAria: "HTTP authentication",
    authNone: "None",
  ...
  modelsPage: {
    ...
    reasoning: "Reasoning",
    // Lowercase inline variant for the ReasoningPicker row, which sits
    // beside a lowercase "model" label.
    ...
    unset: "(unset)",
    overridesSummaryOne: "{overrides} override · {auto} auto",
    overridesSummaryOther: "{overrides} overrides · {auto} auto",
    ...
    analyticsHiddenMiddle: " in ",
    analyticsHiddenConfigLink: "Config",
    analyticsHiddenAfter: " to show the local debug estimate anyway.",
  ...
  chatPage: {
    ...
    chatUnavailable: "Chat websocket unavailable on this server.",
    ...
    reconnect: "reconnect tools feed",
    switchModel: "switch model",
    stateIdle: "idle",
  ...
  toolsetDrawer: {
    ...
    keysSavedOne: "Saved {count} key",
    keysSavedOther: "Saved {count} keys",
    ...
    enableToolsetFor: "Enable toolset for {platform}",
    ...
    getKey: "Get a key",
    saveKeys: "Save keys",
    setupDescriptionBefore: "This backend needs a one-time install ",
    setupDescriptionAfter:
  ...
  skillsHub: {
    ...
    openNamed: "Open {name}",
    installed: "Installed",
    // Lowercase variant for the result badge row, beside `trusted` /
    // `builtin` / `community`.
    ...
    sourceFindingsOne: "{trust} source · {count} finding",
    sourceFindingsOther: "{trust} source · {count} findings",
  ...
  analytics: {
    ...
    // Split around the monospace `usage` token the caller renders.
    hiddenBody1Before:
    ...
    // Split around the monospace `dashboard.show_token_analytics: true` token.
