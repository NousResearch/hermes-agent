...
export const en: Translations = {
  ...
  conversations: {
    title: "Conversations",
    subtitle: "Cleaned conversation browsing built on top of Sessions.",
    searchPlaceholder: "Search conversations...",
    searching: "Searching...",
    active: "Active",
    recent: "Recent",
    noConversations: "No conversations available.",
    noMatch: "No conversations match your current search or source filter.",
    selectConversation: "Select a conversation to inspect its human-visible transcript.",
    noVisibleMessages: "No human-visible messages in this conversation.",
