...
export const en: Translations = {
  ...
  openDesign: {
    title: "Open Design",
    description: "Connect the dashboard to an Open Design repo, control its dev server, and push briefs into a workspace.",
    statusLabel: "Status",
    healthy: "Healthy",
    ...
    restart: "Restart",
    openUi: "Open UI",
    started: "Open Design started",
    stopped: "Open Design stopped",
    restarted: "Open Design restarted",
    opened: "Open Design UI opened",
    connection: "Connection",
    connectionDescription: "Set the repo path, start command, health URL, and workspace used for generated briefs and artifacts.",
    ...
    configSaved: "Open Design config saved",
    configSaveFailed: "Failed to save Open Design config",
    loadFailed: "Failed to load Open Design data",
    briefTitle: "Push brief",
    briefDescription: "Create a project folder with brief.md, brief.json, and optional DESIGN.md inside the configured workspace.",
    projectName: "Project name",
    skillLabel: "Skill / mode",
    briefLabel: "Brief",
    briefPlaceholder: "Describe what should be designed or built...",
    designSystem: "Design system notes",
    designSystemPlaceholder: "Optional design system or visual rules...",
    pushBrief: "Push brief",
    pushing: "Pushing...",
    briefRequired: "Brief is required",
    briefPushed: "Brief pushed",
    briefPushFailed: "Failed to push brief",
    artifactsTitle: "Artifacts",
    artifactsDescription: "Recent files from the configured artifacts/workspace directories.",
    noArtifacts: "No artifacts found yet.",
    download: "Open",
    environmentTitle: "Environment overrides",
    environmentDescription: "Environment variables saved with this Open Design integration.",
    noEnv: "No environment overrides configured.",
  },
