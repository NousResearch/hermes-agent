...
export const en: Translations = {
  ...
  kanban: {
    ...
    taskCountZero: "0 tasks",
    taskCountOne: "1 task",
    taskCountMany: "{n} tasks",
    archivedCountOne: "1 archived",
    archivedCountMany: "{n} archived",
    archivedHiddenHint:
      "Archived tasks are hidden from the board by default. Enable Show archived to view them.",
    archivedHiddenOne: "1 archived task is hidden.",
    archivedHiddenMany: "{n} archived tasks are hidden.",
