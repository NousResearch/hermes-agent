...
export const en: Translations = {
  ...
  sessions: {
    ...
    prune: "Prune",
    statsTotal: "Total",
    statsActiveInStore: "Active in store",
  ...
  skills: {
    ...
    learnDirPlaceholder: "~/projects/some-sdk  (read with read_file / search_files)",
    url: "URL",
  ...
  mcp: {
    ...
    removeDescriptionNamed: "\"{name}\" — this will remove the server.",
    ...
    installRequiresEnv: "This MCP requires the following values to be configured.",
  ...
  channels: {
    ...
    restartToApply: "Changes are saved. Restart the gateway for them to take effect.",
    ...
    linked: "Linked",
    existingWhatsappSession: "Existing WhatsApp session found",
    waitingForQr: "Waiting for WhatsApp to provide a QR code…",
    scanWithLinkedDevices: "Scan with WhatsApp Linked Devices, not the camera app.",
    ...
    addAtLeastOneUserId: "Add at least one Telegram user ID.",
