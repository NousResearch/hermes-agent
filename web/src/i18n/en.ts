...
export const en: Translations = {
  ...
  config: {
    ...
    fields: (count) => `${count} field${count === 1 ? "" : "s"}`,
  ...
  env: {
    ...
    notSet: "Not set",
    keysCount: (count) => `${count} key${count === 1 ? "" : "s"}`,
    ...
    customConfigured: (count) => `${count} custom key${count === 1 ? "" : "s"} set`,
    configuredCount: (count) => `${count} configured`,
    configuredSummary: (configured, total) => `${configured} of ${total} configured`,
