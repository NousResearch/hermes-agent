...
export const en: Translations = {
  ...
  sharedGateway: {
    restartTitle: "Restart the shared gateway?",
    restartDescription: "All bots on this device reconnect: {profiles}",
    restartAll: "Restart all",
    restarted: "Shared gateway restarted ({count} bots)",
    servedWith: "Served by the shared gateway with {profiles}.",
    migrating: "Migrating to a single multiplexed gateway",
    ...
    migrate: "Migrate to a single multiplexed gateway",
  ...
  sessions: {
    ...
    pruneSkippedOpen:
      "Skipped {count} open session(s); prune only removes ended sessions.",
  ...
  achievements: {
    ...
    metrics: {
      ...
      max_distinct_tools_in_session:
        "distinct Hermes tools used in one session",
      ...
      max_web_browser_calls_in_session:
        "web search/extract or browser calls in one session",
      ...
      tiny_patch_after_errors_events:
        "tiny typo-style fixes after error clusters",
    ...
    definitions: {
      let_him_cook: {
        name: "Let Him Cook",
        description:
          "Let Hermes run a serious autonomous tool chain in one session.",
      },
      autonomous_avalanche: {
        name: "Autonomous Avalanche",
        description:
          "Accumulate a lifetime avalanche of Hermes tool calls across sessions.",
      },
      toolchain_maxxer: {
        name: "Toolchain Maxxer",
        description:
          "Use a wide spread of distinct Hermes tools in one session.",
      },
      full_send: {
        name: "Full Send",
        description:
          "Terminal, files, and web/browser all get involved in one real run.",
      },
      subagent_commander: {
      ...
      red_text_connoisseur: {
        ...
        description:
          "Encounter enough errors to develop a palate for red text.",
      },
      ...
      port_3000_taken: {
        ...
        description:
          "Discover dev-server port conflict patterns enough times to become numb.",
      },
      ...
      the_fix_was_restarting: {
        ...
        description:
          "Restart after enough error clusters to call it a technique.",
      },
      forgot_the_env_var: {
        name: "Forgot The Env Var",
        description:
          "Auth or configuration failed because an environment variable was missing.",
      },
      yaml_colon_incident: {
      ...
      one_more_small_change: {
        ...
        description:
          "Make enough file edits in one session to invalidate the phrase small change.",
      },
      vibe_architect: {
        name: "Vibe Architect",
      ...
      skill_issue_skill_created: {
        ...
        description:
          "Create or patch durable procedures instead of repeating yourself.",
      },
      memory_keeper: {
        name: "Memory Keeper",
      ...
      context_dragon: {
        name: "Context Dragon",
        description:
          "Brush against compression, huge context, or token pressure repeatedly.",
      },
      gateway_dweller: {
      ...
      plugin_goblin: {
        name: "Plugin Goblin",
        description:
          "Use or develop plugins enough that the dashboard notices.",
      },
      rollback_wizard: {
      ...
      rabbit_hole_certified: {
        ...
        description:
          "Search or extract enough web content to qualify as a research spiral.",
      },
      citation_goblin: {
      ...
      model_hopper: {
        name: "Model Hopper",
        description:
          "Switch or inspect providers/models enough to count as a habit.",
      },
      openrouter_enjoyer: {
      ...
      codex_conjurer: {
        name: "Codex Conjurer",
        description:
          "Summon Codex-flavored assistance often enough for a ritual.",
      },
      multi_model_mage: {
        name: "Multi-Model Mage",
        description:
          "Use a real spread of distinct model names across Hermes history.",
      },
      five_model_flight: {
        name: "Five-Model Flight",
        description:
          "Try at least five distinct LLMs instead of marrying the first model that answers.",
      },
      provider_polyglot: {
        name: "Provider Polyglot",
        description:
          "Use models from multiple providers across Hermes history.",
      },
      model_sommelier: {
        name: "Model Sommelier",
        description:
          "Taste enough model/provider conversations to develop preferences.",
      },
      claude_confidant: {
        name: "Claude Confidant",
        description:
          "Bring Claude-flavored reasoning into the workflow repeatedly.",
      },
      gemini_cartographer: {
      ...
      open_weights_pilgrim: {
        ...
        description:
          "Actually chat with local/open-weight models through Hermes session metadata.",
      },
      toolset_cartographer: {
        name: "Toolset Cartographer",
        description:
          "Navigate Hermes toolsets deliberately instead of treating tools as a blur.",
      },
      config_surgeon: {
        name: "Config Surgeon",
        description:
          "Operate on real config files, manifests, env files, and dashboard settings without flinching.",
      },
      rebase_acrobat: {
        name: "Rebase Acrobat",
        description:
          "Handle real git history surgery: rebase, conflict, merge, fetch, push.",
      },
      test_suite_tamer: {
      ...
      screenshot_hunter: {
        ...
        description:
          "Capture, inspect, and polish visual proof instead of just claiming it works.",
      },
      marathon_operator: {
      ...
      weekend_warrior: {
        ...
        description:
          "Run Hermes on weekends enough times to make it a lifestyle.",
      },
  ...
  kanban: {
    ...
    hints: {
      ...
      goalMaxTurns:
        "Turn budget for the goal loop. Blank uses the backend default of 20.",
      goalMode:
