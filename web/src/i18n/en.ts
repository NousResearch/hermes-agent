...
export const en: Translations = {
  ...
  chatSidebar: {
    ...
    eventsDisconnected: 'events feed disconnected — the chat title may not update',
    eventsReconnecting: 'events feed disconnected — reconnecting in {seconds}s…',
    eventsGaveUp: 'events feed disconnected — gave up after {attempts} attempts, reload the page',
    ...
    reasoningEffortSet: 'Reasoning effort set to {effort}. Run /new or refresh the page to apply it to this chat.',
    modelSetRequiresReload: 'Model set to {model}. Run /new or refresh the page to apply it to this chat.',
    reconnecting: 'Chat is reconnecting.',
    reconnectingCode: 'Chat connection interrupted (code {code}). Reconnecting…',
    reconnectingInput: 'Chat is reconnecting. Input will resume when connected.',
  ...
  sessions: {
    ...
    importFailed: 'Import failed. Check the exported session file and try again.',
    ...
    sourceCron: 'Cron',
    sourceTool: 'Tool',
    sourceHermesFlow: 'Hermes Flow',
    sourceVulcanDelegate: 'Vulcan delegate',
    roles: {
      user: 'User',
      assistant: 'Assistant',
      system: 'System',
  ...
  modelSettings: {
    ...
    remove: 'Remove',
    resetAll: 'Reset all',
    resetAuxDescription: 'Reset every auxiliary task to auto? This replaces every per-task override you have set.',
  ...
  channels: {
    ...
    invalidTelegramBotToken: 'Paste the complete token from @BotFather (for example, 123456789:ABC…).',
    invalidTelegramUserId: '{value} is not a numeric Telegram user ID.',
    invalidSlackTokenPrefix: '{field} must start with {prefix}',
    invalidSlackMemberId: '{value} does not look like a Slack member ID. Use IDs like U01ABC2DEF3.',
    gatewayNotRunning:
    ...
    telegramManualIntro: 'Connect a bot you already own, or create one in Telegram before filling in this form.',
    telegramManualCreateBot: 'Open @BotFather, send /newbot, and follow its prompts.',
    ...
    onboarding: {
      ...
      cancel: 'Cancel',
      connected: 'Connected',
      existingTelegramConfigured: 'Existing Telegram credentials are configured.',
      existingWhatsAppConfigured: 'Existing WhatsApp settings are configured.',
      expired: 'expired',
      gatewayRestartFailed: 'Gateway restart failed: {error}',
      gatewayRestartFailedExit: 'Gateway restart failed (exit {code}) — restart manually',
      linked: 'Linked',
      ...
      telegramFinishQrFirst: 'Finish or cancel the current QR setup before switching methods.',
      ...
      waiting: 'waiting',
      whatsappAccountDetailKnown: 'This is the WhatsApp account Hermes is now logged into.',
      whatsappAccountDetailScanned: 'Hermes is logged into the WhatsApp account that scanned the QR code.',
      whatsappBridgePreparing: 'Preparing the WhatsApp bridge. The QR code will appear here when it is ready.',
      whatsappBridgeStarting: 'Starting the WhatsApp pairing bridge. The QR code will appear here when it is ready.',
      ...
      whatsappQrScanHint: 'Scan with WhatsApp Linked Devices, not the camera app.',
      whatsappSaveFirst: 'Save and restart the gateway.',
      whatsappSelfChatAutoAllow: 'Self-chat mode will allow the linked account automatically when you save.',
  ...
  profiles: {
    ...
    modelSaveAfterCreateFailed: 'Profile created, but the model could not be saved — set it from the profile editor.',
    build: 'Build',
    actions: 'Actions',
    manageSkills: 'Manage skills & tools',
    activeSetHint: 'Dashboard switched to manage {name}. New CLI and gateway runs will use this profile too.',
    activeSetToast: 'Active profile set to {name}. Dashboard management and future CLI/gateway runs now use it.'
  },
  ...
  pluginsPage: {
    ...
    descriptions: {
      achievements: 'Steam-style achievements for vibe coding and agentic Hermes workflows.',
      kanban:
    ...
    missingActiveProvider: 'Active provider {provider} is no longer installed. Select another provider and save.',
    ...
    catalogConfirmInstallNote: 'Plugins install disabled; enable it after install to activate.',
  ...
  oauth: {
    ...
    notConnectedHint: 'Not connected. Use Login when available, or run the command below in a terminal.',
  ...
  mcp: {
    ...
    bearerTokenStorageHint: "Stored in this profile's .env; config.yaml keeps only an environment-variable reference.",
    oauthAddHint:
    ...
    oauthPopupBlocked: 'OAuth popup was blocked — allow popups for this dashboard and retry',
    ...
    oauthWindowClosed: 'OAuth authorization window was closed before completion',
  ...
  webhooks: {
    ...
    createdSecretHint: 'Subscription created. Copy the secret now — it is only shown once.',
    ...
    needsRestart: 'Webhooks are enabled, but the gateway still needs a restart before the receiver can come online.',
  ...
  profileBuilder: {
    ...
    mcpHint: 'Add MCP servers for this profile. HTTP servers take a URL; stdio servers take a command and arguments.',
    mcpConfigured: '{count} configured',
    serverName: 'Server name',
    serverNamePlaceholder: 'e.g. project-tools',
    bearerTokenStorageHint: "The token is saved with this profile's MCP configuration.",
    oauthAfterCreateHint: 'Create the profile first, then complete OAuth from the MCP page.',
  ...
  toolsetConfig: {
    ...
    getKey: 'Get a key',
    saveKeys: 'Save keys',
    installHint: 'This backend needs a one-time install ({command}). Runs on this host — may take a few minutes.',
    installing: 'Installing…',
    runSetup: 'Run setup',
  ...
  systemPage: {
    ...
    confirm: {
      ...
      updateDescription: "This will run 'hermes update' ({command}) and restart the gateway when it finishes.",
