...
export const en: Translations = {
  ...
  grafana: {
    ...
    subtitle: "Embed existing Grafana panels with incident and service context while keeping Grafana authentication and permissions outside the browser config.",
    contextTitle: "Incident Context",
    contextDescription: "These values map to Grafana variables and time range query parameters for the generated panel URLs.",
    notConfiguredBadge: "Not configured",
    failedToLoad: "Failed to load Grafana configuration",
    emptyTitle: "Grafana embed is not configured",
    emptyDescription: "Set the non-secret Grafana coordinates in Config under aiops.grafana before panels can render here.",
    securityNote: "Do not store Grafana API keys, service-account tokens, or session cookies in this config. Users must already have access through Grafana, SSO, or an enterprise Gateway/reverse-proxy path.",
    embedBlocked: "Grafana did not confirm iframe loading",
    openPanel: "Open in Grafana",
    panel: "Panel",
    defaultFallbackText: "Grafana embed may be blocked by CSP, same-site cookies, or missing login. Open the panel in Grafana using the fallback link.",
  },
