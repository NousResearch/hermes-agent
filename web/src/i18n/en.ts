...
export const en: Translations = {
  ...
  skills: {
    ...
    hubUpdateFailed: "Update failed: {error}",
  ...
  chat: {
    ...
    copyLastShort: "copy last response",
    copied: "copied",
  ...
  fields: {
    ...
    allAuxiliaryTasks: "All auxiliary tasks",
    whatFor: "What this agent profile is for",
    enterServerName: "Enter server name",
    addFromSkillsHub: "Add from the skills hub",
    newProfile: "New profile",
    restoreFromBackupUpload: "Restore from backup upload",
    restoreFromBackupsPath: "Restore from backups path",
  ...
  actions: {
    // Icon-button tooltips/aria-labels used across pages and dialogs.
    setDefault: "Set default",
    deletePreset: "Delete",
    addPreset: "Add preset",
    remove: "Remove",
    ...
    removeShellHook: "Remove shell hook",
  ...
  profileBuilder: {
    ...
    defaultModelLater: "Default (set later)",
    fullDefaultBundle: "Full default bundle",
    keptSkillsCount: "{n} built-in/optional kept",
    plusHub: " + {n} hub",
    hubLabel: "Hub: {names}",
  ...
  system: {
    ...
    credProviderLabel: "Provider",
    credLabelLabel: "Label",
    fullBackup: "Full backup",
    restoreFromBackupUpload: "Restore from backup upload",
    restoreFromBackupsPath: "Restore from backups path",
    resetMemory: "Reset memory",
    ...
    gatewayActionStarted: "Gateway {verb}",
    ...
    debugShareUploaded: "Uploaded {count} paste(s){redacted}",
    debugShareRedacted: " (redacted)",
    ...
    opCuratorReview: "Curator review",
    opDoctor: "Doctor",
    opSecurityAudit: "Security audit",
    opSkillsUpdate: "Skills update",
    opPromptSize: "Prompt size",
    opSupportDump: "Support dump",
    opConfigMigrate: "Config migrate",
  ...
  mcp: {
    loadFailed: "Could not load MCP servers: {error}",
    catalogLoadFailed: "Could not load the MCP catalog: {error}",
    addFailed: "Could not add MCP server: {error}",
    testFailed: "Could not test the MCP server: {error}",
    signInFailed: "Could not sign in to the MCP server: {error}",
    updateFailed: "Could not update the MCP server: {error}",
    removed: "Delete: \"{name}\"",
    removeFailed: "Could not remove the MCP server: {error}",
    installingInBackground: "Installing in background…",
  ...
  files: {
    ...
    deleteUntitledTitle: "Delete item?",
  ...
  channels: {
    ...
    updateFailed: "Could not update the channel: {error}",
    testFailed: "Could not test the channel: {error}",
    gatewayRestarting: "Gateway restarting…",
    restartFailed: "Failed to restart: {error}",
    whatsappSavedRestarting: "WhatsApp saved; gateway restarting…",
    whatsappRestartFailed: "WhatsApp saved; gateway restart failed{detail}",
