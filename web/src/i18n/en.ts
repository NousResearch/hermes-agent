...
export const en: Translations = {
  ...
  kanban: {
    ...
    inlineChatPlaceholder: "Tell the board what to do...",
    microphoneStart: "Start voice input",
    microphoneStop: "Stop voice input",
    recordingIndicator: "Recording...",
    voiceTranscribing: "Transcribing voice input...",
    inlineChatHistory: "Board inline chat",
    clearHistory: "Clear history",
    unsupportedBrowser: "Voice input is unavailable in this browser. Please use text input.",
    microphonePermissionDenied: "Microphone permission was denied.",
    microphoneError: "Microphone input stopped.",
    whisperDownloadConfirm: "Voice input downloads the Whisper small model (~244 MB) on first use and caches it in IndexedDB. Continue?",
    ttsToggle: "Read responses aloud",
    ttsPlaying: "Playing response audio",
    ttsBlocked: "Audio playback was blocked by the browser",
    ttsFailed: "TTS failed: ",
    inlineDispatchDone: "Dispatch complete.",
    inlineDispatchCreated: "Created: ",
    inlineDispatchFailed: "Inline dispatch failed: ",
    inlineDispatchSending: "Sending...",
    send: "Send",
    you: "You",
