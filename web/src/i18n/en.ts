...
export const en: Translations = {
  ...
  kanban: {
    ...
    skills: "Skills",
    goalMode: "Goal mode",
    goalModeDescription: "The worker keeps going until a judge agrees the task is done.",
    goalTurnBudget: "Goal turn budget",
    goalTurnBudgetDescription: "Maximum worker turns. Leave blank to use the engine default.",
    goalTurnBudgetDefault: "Engine default",
    goalTurnBudgetValidation: "Enter a positive whole number.",
    goalConfigurationLocked: "Goal settings are locked because this task has already had a run.",
