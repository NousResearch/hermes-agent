...
export const en: Translations = {
  ...
  emailPolicy: {
    connectionTitle: "Mailbox connection",
    connectionDescription: "The essentials Hermes needs to receive and send mail.",
    advancedConnection: "Advanced mailbox settings",
    advancedConnectionDescription: "Ports, polling, access rules, and delivery defaults.",
    title: "Automatic reply policy",
    description: "Decide what is filtered immediately and what may ask the Agent for a reply.",
    categoriesTitle: "Message categories",
    categoriesDescription: "Category filtering uses approximate heuristic regexes. Disabling a category does not guarantee its messages will never reach the Agent; only local regex matches are blocked first.",
    ...
    allowCategory: "Allow Agent replies",
    keywordsTitle: "Keyword rules",
    keywordsDescription: "Manual keyword groups use local literal matching and are not added to the Agent prompt.",
    neverReply: "Never reply",
    neverReplyDescription: "Stops before the Agent is called. This rule wins conflicts.",
    mustReply: "Must reply",
    mustReplyDescription: "Forces the message through and requires a reply.",
    keywordPlaceholder: "One keyword group per line",
    keywordSyntax: "Example: urgent or invoice+overdue",
    ...
    strictDecisionDescription: "Blocks malformed output, false decisions, and empty replies before SMTP.",
    priorityLabel: "Rule order",
