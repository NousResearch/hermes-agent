...
export const es: Translations = {
  ...
  skills: {
    ...
    skillCount: (count) => `${count} habilidad${count === 1 ? "" : "s"}`,
  ...
  env: {
    ...
    keysCount: (count) => `${count} clave${count === 1 ? "" : "s"}`,
    ...
    customConfigured: (count) =>
      `${count} ${count === 1 ? "clave personalizada configurada" : "claves personalizadas configuradas"}`,
    configuredCount: (count) => `Configuradas: ${count}`,
    configuredSummary: (configured, total) => `${configured} de ${total} configuradas`,
