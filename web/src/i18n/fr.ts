...
export const fr: Translations = {
  ...
  channels: {
    ...
    gatewayNotRunning: "La passerelle ne fonctionne pas. Configurez les canaux ici, puis démarrez la passerelle avec {command} ou le bouton Redémarrer ci-dessus.",
