...
export const fr: Translations = {
  ...
  kanban: {
    ...
    goalModeDescription: "Le worker continue jusqu’à ce qu’un évaluateur confirme que la tâche est terminée.",
    goalTurnBudget: "Limite de tours de l’objectif",
    goalTurnBudgetDescription: "Nombre maximal de tours du worker. Laissez vide pour utiliser la valeur par défaut du moteur.",
    goalTurnBudgetDefault: "Valeur par défaut du moteur",
    goalTurnBudgetValidation: "Saisissez un nombre entier positif.",
    goalConfigurationLocked: "Les paramètres d’objectif sont verrouillés car cette tâche a déjà été exécutée.",
    createdBy: "Créé par",
    result: "Result",
