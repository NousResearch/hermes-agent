...
export const fr: Translations = {
  ...
  emailPolicy: {
    connectionTitle: "Connexion à la boîte mail",
    connectionDescription: "Les informations essentielles pour recevoir et envoyer des e-mails.",
    advancedConnection: "Paramètres avancés de la boîte mail",
    advancedConnectionDescription: "Ports, relève, règles d’accès et destination par défaut.",
    title: "Politique de réponse automatique",
    description: "Choisissez ce qui est filtré immédiatement et ce que l’Agent peut examiner.",
    categoriesTitle: "Catégories d’e-mails",
    categoriesDescription: "Le filtrage utilise des regex heuristiques approximatives. Désactiver une catégorie ne garantit pas que son contenu n’atteindra jamais l’Agent ; seuls les résultats locaux sont bloqués avant.",
    promotions: "Promotions et marketing",
    newsletters: "Newsletters et résumés",
    transactions: "Commandes et transactions",
    security: "Alertes de sécurité",
    social: "Notifications sociales",
    calendar: "Notifications de calendrier",
    reports: "Rapports périodiques",
    allowCategory: "Autoriser les réponses de l’Agent",
    keywordsTitle: "Règles par mots-clés",
    keywordsDescription: "Les groupes de mots-clés manuels sont comparés localement et ne sont pas ajoutés au prompt de l’Agent.",
    neverReply: "Ne jamais répondre",
    neverReplyDescription: "Arrête le traitement avant l’Agent et l’emporte en cas de conflit.",
    mustReply: "Réponse obligatoire",
    mustReplyDescription: "Transmet le message à l’Agent et impose une réponse.",
    keywordPlaceholder: "Un groupe de mots-clés par ligne",
    keywordSyntax: "Exemple : urgent ou facture+en retard",
    decisionTitle: "Décision de l’Agent",
    strictDecision: "Exiger une décision structurée",
    strictDecisionDescription: "Bloque les formats invalides, les refus et les réponses vides avant SMTP.",
    priorityLabel: "Ordre des règles",
    priorityText: "Ne jamais répondre → Réponse obligatoire → Catégorie → Décision de l’Agent",
  },
