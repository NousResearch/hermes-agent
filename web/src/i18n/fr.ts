...
export const fr: Translations = {
  ...
  skills: {
    ...
    skillCount: (count) => `${count} compétence${count === 1 ? "" : "s"}`,
  ...
  config: {
    ...
    fields: (count) => `${count} champ${count === 1 ? "" : "s"}`,
  ...
  env: {
    ...
    notSet: "Non défini",
    keysCount: (count) => `${count} clé${count === 1 ? "" : "s"}`,
    ...
    customConfigured: (count) =>
      `${count} ${count === 1 ? "clé personnalisée définie" : "clés personnalisées définies"}`,
    configuredCount: (count) => `${count} configurée${count === 1 ? "" : "s"}`,
    configuredSummary: (configured, total) =>
      `${configured} sur ${total} configurée${configured === 1 ? "" : "s"}`,
