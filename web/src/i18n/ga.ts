...
export const ga: Translations = {
  ...
  kanban: {
    ...
    skills: "Scileanna",
    goalMode: "Mód sprice",
    goalModeDescription: "Leanann an t-oibrí ar aghaidh go dtí go n-aontaíonn moltóir go bhfuil an tasc críochnaithe.",
    goalTurnBudget: "Teorainn babhtaí na sprice",
    goalTurnBudgetDescription: "Uasmhéid babhtaí an oibrí. Fág bán chun réamhshocrú an innill a úsáid.",
    goalTurnBudgetDefault: "Réamhshocrú an innill",
    goalTurnBudgetValidation: "Cuir slánuimhir dheimhneach isteach.",
    goalConfigurationLocked: "Tá socruithe na sprice faoi ghlas mar ritheadh an tasc seo cheana.",
