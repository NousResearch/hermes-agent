...
export const ga: Translations = {
  ...
  emailPolicy: {
    connectionTitle: "Ceangal bosca poist",
    connectionDescription: "Na bunsonraí a theastaíonn ó Hermes chun ríomhphost a fháil agus a sheoladh.",
    advancedConnection: "Ardsocruithe bosca poist",
    advancedConnectionDescription: "Poirt, vótaíocht, rialacha rochtana agus seachadadh réamhshocraithe.",
    title: "Polasaí uathfhreagartha",
    description: "Roghnaigh cad a scagtar láithreach agus cad a mheasfaidh an Agent.",
    categoriesTitle: "Catagóirí ríomhphoist",
    categoriesDescription: "Úsáideann an scagaire regex heorastúil neasach. Ní ráthaíonn díchumasú catagóire nach sroichfidh an t-ábhar an Agent; ní bhlocáiltear roimh ré ach meaitseálacha áitiúla.",
    promotions: "Fógraíocht agus margaíocht",
    newsletters: "Nuachtlitreacha agus achoimrí",
    transactions: "Orduithe agus idirbhearta",
    security: "Fógraí slándála",
    social: "Fógraí sóisialta",
    calendar: "Fógraí féilire",
    reports: "Tuarascálacha rialta",
    allowCategory: "Ceadaigh freagraí ón Agent",
    keywordsTitle: "Rialacha eochairfhocal",
    keywordsDescription: "Ní mheaitseáiltear grúpaí eochairfhocal láimhe ach go háitiúil agus ní chuirtear le leid an Agent iad.",
    neverReply: "Ná freagair riamh",
    neverReplyDescription: "Stopann sé roimh an Agent agus bíonn tosaíocht aige.",
    mustReply: "Freagra riachtanach",
    mustReplyDescription: "Seolann sé chuig an Agent agus éilíonn sé freagra.",
    keywordPlaceholder: "Grúpa eochairfhocal amháin in aghaidh na líne",
    keywordSyntax: "Sampla: práinneach nó sonrasc+thar téarma",
    decisionTitle: "Cinneadh an Agent",
    strictDecision: "Éiligh cinneadh struchtúrtha",
    strictDecisionDescription: "Cuireann sé bac ar fhormáid neamhbhailí, diúltú nó freagra folamh roimh SMTP.",
    priorityLabel: "Ord na rialacha",
    priorityText: "Ná freagair → Freagra riachtanach → Catagóir → Cinneadh Agent",
  },
