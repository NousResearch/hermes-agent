...
export const ga: Translations = {
  ...
  skills: {
    ...
    skillCount: (count) => `Scileanna: ${count}`,
    resultCount: (count) => `Torthaí: ${count}`,
  ...
  env: {
    ...
    notSet: "Gan socrú",
    keysCount: (count) => `Eochracha: ${count}`,
    ...
    customConfigured: (count) => `Eochracha saincheaptha socraithe: ${count}`,
    configuredCount: (count) => `Cumraithe: ${count}`,
    configuredSummary: (configured, total) => `Cumraithe: ${configured}/${total}`,
