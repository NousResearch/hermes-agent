...
export const hu: Translations = {
  ...
  skills: {
    ...
    skillCount: (count) => `${count} készség`,
    resultCount: (count) => `${count} találat`,
  ...
  env: {
    ...
    customConfigured: (count) => `${count} egyéni kulcs beállítva`,
    configuredCount: (count) => `${count} beállítva`,
    configuredSummary: (configured, total) => `${configured} / ${total} beállítva`,
