...
export const it: Translations = {
  ...
  ssh: {
    description:
      "Manage SSH keys for the agent under ~/.hermes/.ssh. Private keys are stored on disk and are never shown again in the dashboard after import.",
    keysTitle: "SSH Keys",
    keysHint:
      "Generate a new ed25519 keypair or import an existing private key. Use host aliases below so the agent can run ssh prod instead of typing IPs.",
    noKeys: "No SSH keys yet.",
    keyName: "Key file name",
    comment: "Comment",
    generateTitle: "Generate key",
    generateHint: "Creates an ed25519 keypair with an empty passphrase (recommended for automated agents).",
    generateAction: "Generate keypair",
    importTitle: "Import private key",
    importHint: "Paste a PEM or OpenSSH private key once. It will be validated and stored with chmod 600.",
    ...
    keyDeleted: "Deleted SSH key {name}",
    generateFailed: "Could not generate key",
    importFailed: "Could not import key",
    loadFailed: "Failed to load SSH settings",
    hostsTitle: "Host aliases",
    hostsHint:
      "Aliases are saved to config.yaml and synced to ~/.hermes/.ssh/config. Install the public key on each server first (ssh-copy-id).",
    addHost: "Add or update host",
    hostAlias: "Alias",
    ...
    saveHost: "Save host",
    hostSaved: "Host alias saved",
    hostSaveFailed: "Could not save host",
    hostDeleted: "Deleted host alias {alias}",
    testConnection: "Test",
    testFailed: "SSH test failed",
    deleteKeyTitle: "Delete SSH key?",
