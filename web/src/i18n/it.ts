  ...
  skills: {
    wisdom: {
      notificationPreferences: {
        ...
        scope: "Le tue notifiche proattive sui client di questa organizzazione. Consultazione e condivisione manuali restano disponibili.",
        on: "Notifiche attive",
        muted: "Notifiche silenziate",
        day: "1 giorno",
        week: "1 settimana",
        month: "30 giorni",
        forever: "A tempo indeterminato",
        pending: "La scelta è salvata localmente e attende la sincronizzazione.",
        failed: "Sincronizzazione non riuscita. Aggiorna le impostazioni prima di scegliere di nuovo.",
        conflict: "La preferenza è cambiata su un altro client. Aggiorna per verificarla.",
        expired: "Questa scelta è scaduta. Aggiorna le impostazioni per riprovare.",
      },
      tab: 'Collettivo',
      browseHub: 'Esplora Hub',
      title: 'Sapienza collettiva',
      loading: 'Caricamento della Sapienza collettiva',
      unavailable: 'La Sapienza collettiva non è disponibile.',
      setup: 'La Sapienza collettiva non è configurata per questo profilo.',
      setupDisclosure:
        'La qualificazione dei candidati rimane in questo profilo. Raggiungono il Gateway solo i contenuti della bozza privata approvati dal proprietario, il testo dell’autore, i metadati dichiarativi del manifesto e lo stato delle installazioni gestite.',
      setupAction: 'Ho capito — configura questo profilo',
      settingUp: 'Configurazione…',
      scanLocal: 'Scansiona le competenze locali',
      ...
      draftState: state => {
        const labels: Record<string, string> = {
          vetting: 'Revisione del server in corso',
          ready: 'Pronta per la tua revisione',
          owner_approved: 'Approvata da te',
          publishing: 'Pubblicazione in corso',
          pending_moderation: 'In attesa dell’approvazione dell’amministratore del collettivo',
          changes_requested: 'Modifiche richieste'
        }
        return labels[state] || state.replaceAll('_', ' ')
      },
      serverScanPassed: 'scansione del server superata',
      noDescription: 'Nessuna descrizione scritta dal proprietario.',
      managedInstalls: 'installazioni gestite',
      close: 'Chiudi',
      readEvery: 'Leggi ogni file grezzo. L’approvazione è vincolata ai tre hash esatti mostrati qui sotto.',
      editReview:
        'Modifica qui la descrizione, SKILL.md o il manifesto dichiarativo. Il salvataggio crea una nuova revisione privata, ripete le scansioni e restituisce nuovi hash; non riscrive la competenza sorgente locale.',
      unsavedChanges: 'Queste modifiche non sono state scansionate. Salva e ripeti la scansione prima di approvare.',
      saveAndRescan: 'Salva modifiche e ripeti scansione',
      savingRevision: 'Salvataggio e nuova scansione…',
      resetChanges: 'Annulla modifiche',
      reviewedHashes: 'Hash della revisione attualmente esaminata dal server',
      prepareTitle: 'Rivedi il pacchetto locale prima del caricamento',
      prepareNotice:
        'Questi campi rimangono in questo profilo finché non li invii esplicitamente alla revisione privata del server riservata al proprietario. Conteggi e motivi di qualificazione locali non vengono mai inclusi.',
      ownerDescription: 'Descrizione scritta dal proprietario',
      ...
      decline: 'Rifiuta',
      checkUpdates: count => `Controlla aggiornamenti${count ? ` (${count})` : ''}`,
      checking: 'Controllo…',
      refreshShared: 'Aggiorna skill condivise',
      refreshingShared: 'Aggiornamento…',
      ...
      updateModeDefault: 'Usa l’impostazione predefinita dell’organizzazione',
      updateModeManual: 'Manuali',
      updateModeAutomatic: 'Automatici con notifica',
      updateModeRequired: 'Obbligatori',
      updateModeHelp:
        'Gateway applica la politica corrente dell’organizzazione. Le modifiche sensibili per la sicurezza richiedono comunque la tua approvazione.',
      updateModePlan: mode => `Aggiornamenti futuri: ${mode}`,
      activityReady: count => `${count} ${count === 1 ? 'nuova notifica' : 'nuove notifiche'}`,
      decisionPublished: skill => `${skill} è stata approvata e ora è condivisa con il tuo team.`,
      decisionChanges: skill => `${skill} richiede modifiche prima di poter essere condivisa.`,
      decisionDeclined: skill => `${skill} non è stata approvata per la condivisione.`,
      ...
      takedownNotice: skill => `${skill} è stata rimossa dal collettivo.`,
      markSeen: 'Segna tutto come letto',
      install: 'Installa…',
      uninstall: 'Disinstalla…',
      checkSkill: 'Controlla questa competenza',
      updateAvailable: version => (version ? `Aggiornamento v${version} disponibile` : 'Aggiornamento disponibile'),
      reviewUpdate: "Rivedi l'aggiornamento",
      installed: (version, mode) => `Installata v${version} · ${mode}`,
      confirmAction: action => `Conferma ${action}`,
      acceptCompatibility: 'Ho esaminato e accetto le azioni di compatibilità.',
