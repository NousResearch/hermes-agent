...
export const it: Translations = {
  ...
  cron: {
    ...
    nameOptional: "Gnome (facoltativo)",
  ...
  profiles: {
    ...
    nameRequired: "Il gnome è obbligatorio",
    nameRule:
      "Solo lettere minuscole, cifre, _ e -; deve iniziare con una lettera o cifra; fino a 64 caratteri.",
    invalidName: "Gnome del profilo non valido",    cloneFrom: "Clona configurazione dal profilo",
    ...
    openInTerminal: "Copia commando CLI",
  ...
  pluginsPage: {
    ...
    authRequiredHint: "Esegui questo commando per autenticarti:",
    updateGit: "Git pull",
  ...
  oauth: {
    ...
    description: "{connected} di {total} provider OAuth connessi. I flussi di accesso vengono attualmente eseguiti tramite la CLI; clicca Copia commando e incolla in un terminale per configurare.",
    connected: "Connesso",
    expired: "Scaduto",
    notConnected: "Non connesso. Esegui {command} in un terminale.",
    runInTerminal: "in un terminale.",
    noProviders: "Nessun provider compatible con OAuth rilevato.",
    login: "Accedi",
    disconnect: "Disconnetti",
    managedExternally: "Gestito esternamente",
    copied: "Copiato ✓",
    cli: "Copia",
    copyCliCommand: "Copia commando CLI (per uso esterno / fallback)",
    connect: "Connetti",
  ...
  kanban: {
    ...
    displayName: "Gnome visualizzato",
    ...
    copied: "Copiato",
    copyCommand: "Copia commando negli appunti",
    reclaim: "Recupera",
    reassign: "Riassegna",
