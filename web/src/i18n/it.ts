...
export const it: Translations = {
  ...
  kanban: {
    ...
    workspace: "Workspace",
    skills: "Competenze",
    goalMode: "Modalità obiettivo",
    goalModeDescription: "Il worker continua finché un revisore non conferma che l’attività è completata.",
    goalTurnBudget: "Limite turni obiettivo",
    goalTurnBudgetDescription: "Numero massimo di turni del worker. Lascia vuoto per usare il valore predefinito del motore.",
    goalTurnBudgetDefault: "Predefinito del motore",
    goalTurnBudgetValidation: "Inserisci un numero intero positivo.",
    goalConfigurationLocked: "Le impostazioni dell’obiettivo sono bloccate perché questa attività è già stata eseguita.",
    createdBy: "Creato da",
    result: "Result",
    comments: "Commenti",
    events: "Eventi",
