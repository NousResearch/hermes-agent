...
export const it: Translations = {
  ...
  emailPolicy: {
    connectionTitle: "Connessione casella e-mail",
    connectionDescription: "I dati essenziali per ricevere e inviare e-mail.",
    advancedConnection: "Impostazioni avanzate",
    advancedConnectionDescription: "Porte, polling, regole di accesso e consegna predefinita.",
    title: "Criteri di risposta automatica",
    description: "Decidi cosa filtrare subito e cosa affidare all’Agent.",
    categoriesTitle: "Categorie di messaggi",
    categoriesDescription: "Il filtro usa regex euristiche approssimative. Disattivare una categoria non garantisce che i contenuti non raggiungano mai l’Agent; solo le corrispondenze locali vengono bloccate prima.",
    promotions: "Promozioni e marketing",
    newsletters: "Newsletter e riepiloghi",
    transactions: "Ordini e transazioni",
    security: "Avvisi di sicurezza",
    social: "Notifiche social",
    calendar: "Avvisi di calendario",
    reports: "Report periodici",
    allowCategory: "Consenti risposte dell’Agent",
    keywordsTitle: "Regole per parole chiave",
    keywordsDescription: "I gruppi di parole chiave manuali sono confrontati solo localmente e non vengono aggiunti al prompt dell’Agent.",
    neverReply: "Non rispondere mai",
    neverReplyDescription: "Si ferma prima dell’Agent e prevale nei conflitti.",
    mustReply: "Risposta obbligatoria",
    mustReplyDescription: "Invia il messaggio all’Agent e richiede una risposta.",
    keywordPlaceholder: "Un gruppo di parole chiave per riga",
    keywordSyntax: "Esempio: urgente oppure fattura+scaduta",
    decisionTitle: "Decisione dell’Agent",
    strictDecision: "Richiedi una decisione strutturata",
    strictDecisionDescription: "Blocca formati non validi, risposte negative o vuote prima di SMTP.",
    priorityLabel: "Ordine delle regole",
    priorityText: "Mai rispondere → Risposta obbligatoria → Categoria → Decisione Agent",
  },
