...
export const it: Translations = {
  ...
  skills: {
    ...
    skillCount: (count) => `${count} ${count === 1 ? "competenza" : "competenze"}`,
  ...
  config: {
    ...
    fields: (count) => `${count} ${count === 1 ? "campo" : "campi"}`,
  ...
  env: {
    ...
    keysCount: (count) => `${count} ${count === 1 ? "chiave" : "chiavi"}`,
    ...
    customConfigured: (count) =>
      `${count} ${count === 1 ? "chiave personalizzata impostata" : "chiavi personalizzate impostate"}`,
    configuredCount: (count) => `${count} configurat${count === 1 ? "a" : "e"}`,
    configuredSummary: (configured, total) =>
      `${configured} ${configured === 1 ? "configurata" : "configurate"} su ${total}`,
