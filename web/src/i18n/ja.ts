...
export const ja: Translations = {
  ...
  emailPolicy: {
    connectionTitle: "メールボックス接続",
    connectionDescription: "Hermes がメールを送受信するための基本設定です。",
    advancedConnection: "メールボックスの詳細設定",
    advancedConnectionDescription: "ポート、ポーリング、アクセスルール、既定の配信先。",
    title: "自動返信ポリシー",
    description: "すぐに除外するメールと、Agent に返信判断を任せるメールを決めます。",
    categoriesTitle: "メール分類",
    categoriesDescription: "カテゴリ判定は近似的なヒューリスティック正規表現です。無効にしても内容が Agent に届かない保証はなく、ローカル一致時のみ事前に遮断されます。",
    promotions: "広告・マーケティング",
    newsletters: "ニュースレター・ダイジェスト",
    transactions: "注文・取引通知",
    security: "セキュリティ通知",
    social: "ソーシャル通知",
    calendar: "予定・会議通知",
    reports: "定期レポート",
    allowCategory: "Agent の返信を許可",
    keywordsTitle: "キーワードルール",
    keywordsDescription: "手動キーワードグループはローカルでのみ文字列一致し、Agent のプロンプトには追加されません。",
    neverReply: "返信しない",
    neverReplyDescription: "Agent を呼び出す前に停止し、競合時に最優先されます。",
    mustReply: "必ず返信",
    mustReplyDescription: "Agent に渡し、返信を必須にします。",
    keywordPlaceholder: "1 行に 1 キーワードグループ",
    keywordSyntax: "例: urgent または invoice+overdue",
    decisionTitle: "Agent の判断",
    strictDecision: "構造化された返信判断を必須にする",
    strictDecisionDescription: "不正な形式、返信不要、空の返信を SMTP 前に遮断します。",
    priorityLabel: "ルール順序",
