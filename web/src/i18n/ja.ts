...
export const ja: Translations = {
  ...
  env: {
    ...
    customConfigured: (count) => `カスタムキーを ${count} 個設定済み`,
    configuredCount: (count) => `設定済み: ${count}`,
    configuredSummary: (configured, total) => `設定済み: ${configured}/${total}`,
