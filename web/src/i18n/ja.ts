...
export const ja: Translations = {
  ...
  kanban: {
    ...
    untitled: "（タイトルなし）",
    loadingDetail: "読み込み中…",
    inlineChatPlaceholder: "ボードに指示を入力...",
    microphoneStart: "音声入力を開始",
    microphoneStop: "音声入力を停止",
    recordingIndicator: "録音中...",
    voiceTranscribing: "音声を文字起こし中...",
    inlineChatHistory: "ボード内インラインチャット",
    clearHistory: "履歴をクリア",
    unsupportedBrowser: "このブラウザーでは音声入力を利用できません。text 入力をご利用ください。",
    microphonePermissionDenied: "マイクの許可が拒否されました。",
    microphoneError: "音声入力が停止しました。",
    whisperDownloadConfirm: "音声入力では初回に Whisper small model（約244MB）をダウンロードし、IndexedDB にキャッシュします。続行しますか？",
    ttsToggle: "応答を読み上げる",
    ttsPlaying: "応答音声を再生中",
    ttsBlocked: "ブラウザーにより音声再生がブロックされました",
    ttsFailed: "TTS に失敗しました: ",
    inlineDispatchDone: "ディスパッチが完了しました。",
    inlineDispatchCreated: "作成: ",
    inlineDispatchFailed: "インラインディスパッチに失敗しました: ",
    inlineDispatchSending: "送信中...",
    send: "送信",
    you: "あなた",
