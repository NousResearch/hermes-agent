...
export const ko: Translations = {
  ...
  env: {
    ...
    customConfigured: (count) => `사용자 지정 키 ${count}개 설정됨`,
    configuredCount: (count) => `${count}개 설정됨`,
    configuredSummary: (configured, total) => `${total}개 중 ${configured}개 설정됨`,
