...
export const ko: Translations = {
  ...
  kanban: {
    ...
    skills: "스킬",
    goalMode: "목표 모드",
    goalModeDescription: "검토자가 작업 완료에 동의할 때까지 워커가 계속 실행됩니다.",
    goalTurnBudget: "목표 턴 한도",
    goalTurnBudgetDescription: "워커의 최대 턴 수입니다. 비워 두면 엔진 기본값을 사용합니다.",
    goalTurnBudgetDefault: "엔진 기본값",
    goalTurnBudgetValidation: "양의 정수를 입력하세요.",
    goalConfigurationLocked: "이 작업은 이미 실행된 적이 있어 목표 설정이 잠겨 있습니다.",
    createdBy: "작성자",
    result: "결과",
    comments: "댓글",
    events: "이벤트",
