...
export const ko: Translations = {
  ...
  emailPolicy: {
    connectionTitle: "메일함 연결",
    connectionDescription: "Hermes가 메일을 받고 보내는 데 필요한 기본 정보입니다.",
    advancedConnection: "고급 메일함 설정",
    advancedConnectionDescription: "포트, 폴링, 접근 규칙과 기본 전송 대상입니다.",
    title: "자동 답장 정책",
    description: "즉시 걸러낼 메일과 Agent가 답장을 판단할 메일을 정합니다.",
    categoriesTitle: "메일 분류",
    categoriesDescription: "카테고리 필터는 근사 휴리스틱 정규식을 사용합니다. 카테고리를 꺼도 내용이 Agent에 절대 전달되지 않는 것은 아니며, 로컬에서 일치할 때만 먼저 차단됩니다.",
    promotions: "프로모션 및 마케팅",
    newsletters: "뉴스레터 및 요약",
    transactions: "주문 및 거래 알림",
    security: "보안 알림",
    social: "소셜 알림",
    calendar: "캘린더 알림",
    reports: "정기 보고서",
    allowCategory: "Agent 답장 허용",
    keywordsTitle: "키워드 규칙",
    keywordsDescription: "수동 키워드 그룹은 로컬에서만 문자 그대로 일치하며 Agent 프롬프트에 추가되지 않습니다.",
    neverReply: "답장하지 않음",
    neverReplyDescription: "Agent 호출 전에 중단하며 충돌 시 가장 우선합니다.",
    mustReply: "반드시 답장",
    mustReplyDescription: "메일을 Agent에 전달하고 답장을 요구합니다.",
    keywordPlaceholder: "한 줄에 한 키워드 그룹",
    keywordSyntax: "예: 긴급 또는 청구서+연체",
    decisionTitle: "Agent 판단",
    strictDecision: "구조화된 답장 판단 요구",
    strictDecisionDescription: "잘못된 형식, 답장 불필요, 빈 답장을 SMTP 전에 차단합니다.",
    priorityLabel: "규칙 순서",
    priorityText: "답장하지 않음 → 반드시 답장 → 분류 필터 → Agent 판단",
  },
