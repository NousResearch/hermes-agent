...
export const pt: Translations = {
  ...
  kanban: {
    ...
    goalModeDescription: "O worker continua até que um avaliador confirme que a tarefa está concluída.",
    goalTurnBudget: "Limite de turnos do objetivo",
    goalTurnBudgetDescription: "Número máximo de turnos do worker. Deixe em branco para usar o valor predefinido do motor.",
    goalTurnBudgetDefault: "Predefinição do motor",
    goalTurnBudgetValidation: "Introduza um número inteiro positivo.",
    goalConfigurationLocked: "As definições do objetivo estão bloqueadas porque esta tarefa já foi executada.",
