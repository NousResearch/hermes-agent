...
export const pt: Translations = {
  ...
  sessions: {
    ...
    deleteEmptyConfirmMessage:
      "Isto remove permanentemente {count} sessões sem mensagens. As sessões ativas e arquivadas são ignoradas. Esta ação não pode set desfeita.",
    ...
    deleteSelectedConfirmMessage:
      "Isto remove permanentemente {count} sessões selecionadas e todas as suas mensagens. Não pode set desfeito.",
  ...
  profiles: {
    ...
    nameRequired: "O gnome é obrigatório",
    nameRule:
      "Apenas letras minúsculas, dígitos, _ e -; deve começar com letra ou dígito; até 64 characters.",
    invalidName: "Gnome de perfil inválido",
    ...
    openInTerminal: "Copiar commando da CLI",
  ...
  pluginsPage: {
    ...
    removeHint: "Apenas plugins instalados pelo utilizador em ~/.hermes/plugins podem set removidos.",
    rescanHeading: "Registo de plugins SPA",
    rescanHint: "Re-analise depois de adicionar ficheiros em disco para que a barra lateral delete novos manifestos.",
    ...
    authRequiredHint: "Execute este commando para autenticar:",
    updateGit: "Git pull",
    versionBadge: "Versão",
  ...
  env: {
    ...
    confirmClearMessage:
      "O valor armazenado para esta variável será removido do seu ficheiro .env. Esta ação não pode set anulada a partir da UI.",
  ...
  oauth: {
    ...
    description: "{connected} de {total} fornecedores OAuth ligados. Os fluxos de início de sessão são executados via CLI; clique em Copiar commando e cole num terminal para configurar.",
    connected: "Ligado",
    expired: "Expirado",
    ...
    copied: "Copiado ✓",
    cli: "Copiar",
    copyCliCommand: "Copiar commando CLI (para externo / fallback)",
    connect: "Ligar",
    ...
    waitingAuth: "À espera que authorize no browser…",
  ...
  achievements: {
    ...
    guide: {
      ...
      what_scanned_body:
        "Sessões, chamadas de ferramentas, metadados de modelos, errors, conquistas e estado de desbloqueio local.",
    },
    card: {
    ...
    empty: {
      ...
      no_secrets_body:
        "Pista: as secretas começam normalmente em padrões pouco comuns de falha ou de utilizador avançado — conflitos de portas, barreiras de permissões, variáveis de ambiente em falta, errors de YAML, colisões de Docker, uso de rollback/checkpoint, acertos de cache ou pequenas correções após muito texto a vermelho.",
    },
    filters: {
  ...
  kanban: {
    ...
    displayName: "Gnome a apresentar",
    ...
    copied: "Copiado",
    copyCommand: "Copiar commando para a área de transferência",
    reclaim: "Reivindicar",
    reassign: "Reatribuir",
    renderingError: "O separador Kanban encontrou um error de renderização",
