...
export const pt: Translations = {
  ...
  emailPolicy: {
    connectionTitle: "Ligação da caixa de correio",
    connectionDescription: "Os dados essenciais para receber e enviar e-mails.",
    advancedConnection: "Definições avançadas",
    advancedConnectionDescription: "Portas, consulta, regras de acesso e entrega predefinida.",
    title: "Política de resposta automática",
    description: "Decida o que é filtrado e o que o Agent pode avaliar.",
    categoriesTitle: "Categorias de e-mail",
    categoriesDescription: "O filtro usa regex heurísticas aproximadas. Desativar uma categoria não garante que o conteúdo nunca chegue ao Agent; só correspondências locais são bloqueadas antes.",
    promotions: "Promoções e marketing",
    newsletters: "Newsletters e resumos",
    transactions: "Encomendas e transações",
    security: "Avisos de segurança",
    social: "Notificações sociais",
    calendar: "Avisos de calendário",
    reports: "Relatórios periódicos",
    allowCategory: "Permitir respostas do Agent",
    keywordsTitle: "Regras de palavras-chave",
    keywordsDescription: "Grupos manuais de palavras-chave são comparados apenas localmente e não entram no prompt do Agent.",
    neverReply: "Nunca responder",
    neverReplyDescription: "Para antes do Agent e vence em caso de conflito.",
    mustReply: "Resposta obrigatória",
    mustReplyDescription: "Encaminha ao Agent e exige uma resposta.",
    keywordPlaceholder: "Um grupo de palavras-chave por linha",
    keywordSyntax: "Exemplo: urgente ou fatura+vencida",
    decisionTitle: "Decisão do Agent",
    strictDecision: "Exigir uma decisão estruturada",
    strictDecisionDescription: "Bloqueia formato inválido, decisão negativa ou resposta vazia antes do SMTP.",
    priorityLabel: "Ordem das regras",
    priorityText: "Nunca responder → Resposta obrigatória → Categoria → Decisão do Agent",
  },
