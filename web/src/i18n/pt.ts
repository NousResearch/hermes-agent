...
export const pt: Translations = {
  ...
  skills: {
    ...
    skillCount: (count) => `${count} competência${count === 1 ? "" : "s"}`,
  ...
  config: {
    ...
    fields: (count) => `${count} campo${count === 1 ? "" : "s"}`,
  ...
  env: {
    ...
    notSet: "Não definido",
    keysCount: (count) => `${count} chave${count === 1 ? "" : "s"}`,
    ...
    customConfigured: (count) =>
      `${count} ${count === 1 ? "chave personalizada definida" : "chaves personalizadas definidas"}`,
    configuredCount: (count) => `${count} configurada${count === 1 ? "" : "s"}`,
    configuredSummary: (configured, total) =>
      `${configured} de ${total} configurada${configured === 1 ? "" : "s"}`,
