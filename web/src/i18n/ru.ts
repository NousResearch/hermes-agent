...
export const ru: Translations = {
  ...
  oauth: {
    ...
    pkceStep1: "В новой вкладке открыт claude.ai. Войдите и нажмите «Разрешить».",
    pkceStep2: "Скопируйте код, который появится после авторизации.",
  ...
  kanban: {
    ...
    nudgeDispatcher: "Подтолкнуть диспетчера",
    refresh: "Обновить",
    selected: "выбрано",
    complete: "Завершить",
    archive: "В архив",
    ...
    sendNotifications: "Отправлять уведомления о завершении / блокировке / отказе в",
    archiveBoardConfirm:
    ...
    reclaimedMessage: "{id} возвращена. Задача снова готова к работе.",
    ...
    columnHelp: {
      triage: "Сырые идеи — спецификатор подготовит спецификацию",
