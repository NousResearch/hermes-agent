...
export const ru: Translations = {
  common: {
    ...
    refresh: "Обновить",
    retry: "Повторить",
    loadFailed: "Не удалось загрузить {what}. Проверьте, запущен ли сервер панели управления, и нажмите «Повторить».",
    loadFailedDetails: "Подробности: {detail}",
    search: "Поиск...",
    loading: "Загрузка...",
    create: "Создать",
    creating: "Создание...",
  ...
  app: {
    ...
    gatewayStrip: {
      ...
      heartbeatStale: "Нет новых сигналов от шлюза",
      off: "Отключён",
      running: "Работает",
      starting: "Запуск",
      stopped: "Остановлен",
    ...
    multiplexStandaloneBanner:
      "Шлюз обслуживает только один профиль. Не обслуживаются: {profiles}. Причина: {reason}. Решение: hermes gateway migrate --multiplex",
    dismiss: "Скрыть",
  },
  ...
  cron: {
    loadWhat: "запланированные задачи",
    scriptRequired:
      "Для задачи в режиме «Только скрипт» нужен путь к скрипту. Заполните поле «Скрипт» или переключите задачу обратно в режим промпта.",
    confirmDeleteMessage:
    ...
    schedulerLastTicked: "Последний запуск планировщика: {when}. Задачи, срок которых наступил после этого, не запускались.",
    pause: "Пауза",
    resume: "Возобновить",
  ...
  profiles: {
    ...
    nameRule:
      "Только строчные латинские буквы, цифры, _ и -; имя должно начинаться с буквы или цифры и содержать не более 64 символов.",
  ...
  pluginsPage: {
    ...
    installHint: "Укажите owner/repo или полный адрес клонирования (https:// либо git@). Для плагина в подпапке добавьте путь: owner/repo/path/to/plugin или <url>#path/to/plugin.",
    ...
    updateConsentBody: (name: string, sha: string) =>
      `Новый закреплённый коммит из каталога для ${name} (${sha}) добавляет возможности, которых нет в установленной версии. Применяйте его, только если доверяете этим возможностям:`,
    versionBadge: "Версия",
    showInSidebar: "Показывать в боковой панели",
    hideFromSidebar: "Скрыть из боковой панели",
    catalogHeading: "Каталог плагинов",
    catalogHint: "Плагины из каталога проверены Nous и закреплены на конкретных коммитах. Устанавливайте отсюда проверенные версии.",
    catalogSearchPlaceholder: "Поиск по каталогу...",
    catalogEmpty: "Подходящих плагинов в каталоге нет.",
    catalogEmptyDocsLink: "О плагинах Hermes",
    catalogInstallBtn: "Установить",
    catalogInstalledBadge: "Установлен ✓",
    catalogUpdateBtn: "Доступно обновление",
    catalogRemovedBadge: "Удалён",
    catalogConfirmTitle: "Установить этот плагин?",
    catalogConfirmInstallNote: "Плагин устанавливается отключённым. Включите его после установки, чтобы начать использовать.",
    catalogRequiresEnv: "Нужны переменные окружения",
    removedFromCatalog: "Удалён из каталога",
  },
  ...
  skills: {
    ...
    loadWhat: "навыки",
    browseHub: "Открыть каталог навыков",
    createSkill: "Создать навык",
    enabledOf: "{enabled}/{total} включено",
    all: "Все",
    categories: "Категории",
    filters: "Фильтры",
    noSkills: "Навыков пока нет. Найдите их в каталоге или создайте здесь; в терминале можно также выполнить `hermes skills search <тема>`.",
  ...
  kanban: {
    ...
    show: "Показать",
    attention: "Внимание",
    tasksNeedAttention: "Задачи требуют внимания",
    ...
    markDone: "Отметить задачи как выполненные ({n})?",
    markArchived: "Архивировать задачи ({n})?",
