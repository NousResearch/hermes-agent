...
export const ru: Translations = {
  ...
  chat: {
    paste: {
      button: "Вставить",
      confirmPrompt: "Вставить {preview} в терминал? Многострочная вставка отправляется строка за строкой.",
      failures: {
        insecureContext: "Вставка недоступна при обычном HTTP-соединении. Удерживайте терминал и выберите «Вставить» или откройте панель по HTTPS.",
        permissionDenied: "Доступ к буферу обмена запрещён. Удерживайте терминал и выберите «Вставить».",
        unsupported: "Этот браузер не предоставляет API буфера обмена. Удерживайте терминал и выберите «Вставить».",
        notConnected: "Чат не подключён — вставка не отправлена. Переподключитесь и попробуйте снова.",
        tooLarge: "Содержимое буфера обмена слишком велико для вставки. Скопируйте меньший фрагмент.",
      },
      imageUploadFailed: "Не удалось загрузить изображение: {message}",
      imageNotConnected: "Изображение загружено, но чат не подключён — попробуйте снова.",
    },
  },
};
