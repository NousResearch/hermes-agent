...
export const ru: Translations = {
  ...
  skills: {
    ...
    skillCount: (count) => `Навыки: ${count}`,
    resultCount: (count) => `Результаты: ${count}`,
  ...
  env: {
    ...
    customConfigured: (count) => `Задано пользовательских ключей: ${count}`,
    configuredCount: (count) => `Настроено: ${count}`,
    configuredSummary: (configured, total) => `Настроено: ${configured}/${total}`,
