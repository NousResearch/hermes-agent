...
export const tr: Translations = {
  ...
  status: {
    ...
    stopped: "Durduruldu",
    updateHermes: "HT AI Agent'ı Güncelle",
    updatingHermes: "HT AI Agent güncelleniyor…",
  ...
  pluginsPage: {
    ...
    headline:
      "HT AI Agent eklentilerini keşfedin, yükleyin, etkinleştirin ve güncelleyin (`ht plugins` ile eşdeğer).",
  ...
  env: {
    ...
    customHint: ".env dosyanızda saklanan ve HT AI Agent'ın tanımadığı rastgele ortam değişkenleri. Bunları beceriler, MCP sunucuları veya kendi araçlarınız için ortam değişkenleri eklemek için kullanın.",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Gerçek oturum geçmişinden kazanılan, koleksiyonluk HT AI Agent rozetleri. Bilinen ama henüz tamamlanmamış başarılar Keşfedildi olarak gösterilir; Gizli başarılar ilk eşleşen davranış görünene kadar saklı kalır.",
      scan_subtitle:
        "HT AI Agent oturum geçmişi taranıyor. Büyük geçmişlerde ilk tarama 5–10 saniye sürebilir.",
    },
    actions: {
      rescan: "Yeniden tara",
    },
    stats: {
      ...
      latest: "En son",
      latest_hint_empty: "HT AI Agent'ı daha çok çalıştır",
      none_yet: "Henüz yok",
    },
    state: {
      unlocked: "Açıldı",
    ...
    guide: {
      ...
      secret_body:
        "Sırlar, tetikleyicilerini saklı tutar. HT AI Agent ilgili bir sinyal gördüğünde kart Keşfedildi durumuna geçer ve gereksinimini gösterir.",
      scan_status_header: "Tarama durumu",
      scan_status_body:
        "HT AI Agent yerel geçmişi bir kez tarıyor; sonra kartlar otomatik olarak görünür. Birkaç saniye sürmesi normaldir, hiçbir şey takılmadı.",
