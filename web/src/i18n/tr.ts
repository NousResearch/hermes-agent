...
export const tr: Translations = {
  ...
  skills: {
    ...
    skillCount: (count) => `${count} yetenek`,
  ...
  env: {
    ...
    customConfigured: (count) => `${count} özel anahtar ayarlandı`,
    configuredCount: (count) => `${count} yapılandırıldı`,
    configuredSummary: (configured, total) => `${configured} / ${total} yapılandırıldı`,
