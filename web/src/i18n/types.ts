...
export interface Translations {
  ...
  kanban: {
    ...
    inlineChatPlaceholder: string;
    microphoneStart: string;
    microphoneStop: string;
    recordingIndicator: string;
    voiceTranscribing: string;
    inlineChatHistory: string;
    clearHistory: string;
    unsupportedBrowser: string;
    microphonePermissionDenied: string;
    microphoneError: string;
    whisperDownloadConfirm: string;
    ttsToggle: string;
    ttsPlaying: string;
    ttsBlocked: string;
    ttsFailed: string;
    inlineDispatchDone: string;
    inlineDispatchCreated: string;
    inlineDispatchFailed: string;
    inlineDispatchSending: string;
    send: string;
    you: string;
    addComment: string;
    comment: string;
