...
export const uk: Translations = {
  ...
  emailPolicy: {
    connectionTitle: "Підключення поштової скриньки",
    connectionDescription: "Основні дані для отримання та надсилання листів.",
    advancedConnection: "Розширені налаштування",
    advancedConnectionDescription: "Порти, опитування, правила доступу та типова доставка.",
    title: "Політика автовідповідей",
    description: "Визначте, що фільтрувати одразу, а що передавати Agent.",
    categoriesTitle: "Категорії листів",
    categoriesDescription: "Фільтр використовує приблизні евристичні регулярні вирази. Вимкнення категорії не гарантує, що вміст ніколи не потрапить до Agent; заздалегідь блокуються лише локальні збіги.",
    promotions: "Реклама й маркетинг",
    newsletters: "Розсилки та дайджести",
    transactions: "Замовлення й транзакції",
    security: "Сповіщення безпеки",
    social: "Соціальні сповіщення",
    calendar: "Календарні сповіщення",
    reports: "Регулярні звіти",
    allowCategory: "Дозволити відповіді Agent",
    keywordsTitle: "Правила ключових слів",
    keywordsDescription: "Ручні групи ключових слів зіставляються лише локально й не додаються до промпту Agent.",
    neverReply: "Ніколи не відповідати",
    neverReplyDescription: "Зупиняє обробку до Agent і має найвищий пріоритет.",
    mustReply: "Відповідь обов’язкова",
    mustReplyDescription: "Передає лист Agent і вимагає відповіді.",
    keywordPlaceholder: "Одна група ключових слів на рядок",
    keywordSyntax: "Приклад: терміново або рахунок+прострочений",
    decisionTitle: "Рішення Agent",
    strictDecision: "Вимагати структуроване рішення",
    strictDecisionDescription: "Блокує хибний формат, відмову й порожню відповідь до SMTP.",
    priorityLabel: "Порядок правил",
    priorityText: "Не відповідати → Відповідь обов’язкова → Категорія → Рішення Agent",
  },
