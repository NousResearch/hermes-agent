...
export const uk: Translations = {
  ...
  skills: {
    ...
    skillCount: (count) => `Навички: ${count}`,
    resultCount: (count) => `Результати: ${count}`,
  ...
  env: {
    ...
    customConfigured: (count) => `Задано власних ключів: ${count}`,
    configuredCount: (count) => `Налаштовано: ${count}`,
    configuredSummary: (configured, total) => `Налаштовано: ${configured}/${total}`,
