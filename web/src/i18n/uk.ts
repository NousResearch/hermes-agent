  ...
  skills: {
    wisdom: {
      notificationPreferences: {
        ...
        scope: "Ваші проактивні сповіщення в усіх клієнтах цієї організації. Перегляд і поширення вручну залишаються доступними.",
        on: "Сповіщення ввімкнено",
        muted: "Сповіщення вимкнено",
        day: "1 день",
        week: "1 тиждень",
        month: "30 днів",
        forever: "Безстроково",
        pending: "Вибір збережено локально й очікує синхронізації.",
        failed: "Помилка синхронізації. Оновіть налаштування перед новим вибором.",
        conflict: "Налаштування змінено в іншому клієнті. Оновіть для перевірки.",
        expired: "Термін дії вибору минув. Оновіть налаштування та повторіть.",
      },
      tab: 'Колектив',
      browseHub: 'Переглянути Hub',
      title: 'Колективна мудрість',
      loading: 'Завантаження Колективної мудрості',
      unavailable: 'Колективна мудрість недоступна.',
      setup: 'Колективну мудрість не налаштовано для цього профілю.',
      setupDisclosure:
        'Кваліфікація кандидатів залишається в цьому профілі. До Gateway надходять лише схвалені власником дані приватної чернетки, авторський текст, декларативні метадані маніфесту та стан керованого встановлення.',
      setupAction: 'Зрозуміло — налаштувати цей профіль',
      settingUp: 'Налаштування…',
      scanLocal: 'Сканувати локальні навички',
      search: 'Шукати спільні навички…',
      potential: 'Запропоновані внески',
      potentialHelp:
        'Навички, локально кваліфіковані Hermes на основі використання або суттєвих удосконалень. До вашої перевірки нічого не поширюється.',
      noSuggestions: 'Наразі жодна локальна навичка не відповідає правилам автоматичної кваліфікації.',
      browseLocal: count => `Переглянути всі локальні навички (${count})`,
      browseLocalHelp: 'Ручний вибір не означає, що Hermes використовував або автоматично кваліфікував ці навички.',
      ownerReview: 'Ваші чернетки внесків',
      ownerReviewHelp: 'Чернетки, що очікують вашої перевірки, і подання, що очікують схвалення колективу.',
      noDrafts: 'Немає активних чернеток або подань внеску.',
      prepare: 'Почати внесок',
      ...
      draftState: state => {
        const labels: Record<string, string> = {
          vetting: 'Триває перевірка сервером',
          ready: 'Готово до вашої перевірки',
          owner_approved: 'Схвалено вами',
          publishing: 'Публікується',
          pending_moderation: 'Очікує схвалення адміністратора колективу',
          changes_requested: 'Запитано зміни'
        }
        return labels[state] || state.replaceAll('_', ' ')
      },
      serverScanPassed: 'серверне сканування пройдено',
      noDescription: 'Немає опису від власника.',
      managedInstalls: 'керованих встановлень',
      close: 'Закрити',
      readEvery: 'Прочитайте кожен необроблений файл. Схвалення прив’язане до трьох точних хешів нижче.',
      editReview:
        'Тут можна змінити опис, SKILL.md або декларативний маніфест. Збереження створює нову приватну редакцію, повторно запускає сканування та повертає нові хеші; локальна вихідна навичка не перезаписується.',
      unsavedChanges: 'Ці зміни ще не сканувалися. Збережіть і повторно проскануйте їх перед схваленням.',
      saveAndRescan: 'Зберегти зміни й повторно сканувати',
      savingRevision: 'Збереження й повторне сканування…',
      resetChanges: 'Відкинути зміни',
      reviewedHashes: 'Хеші редакції, яку наразі перевірив сервер',
      prepareTitle: 'Перевірте локальний пакет перед завантаженням',
      prepareNotice:
        'Ці поля залишаються в цьому профілі, доки ви явно не надішлете їх на приватну серверну перевірку власника. Локальні показники й причини кваліфікації ніколи не додаються.',
      ownerDescription: 'Опис від власника',
      ...
      decline: 'Відхилити',
      checkUpdates: count => `Перевірити оновлення${count ? ` (${count})` : ''}`,
      checking: 'Перевірка…',
      refreshShared: 'Оновити спільні навички',
      refreshingShared: 'Оновлення…',
      installReferenceLabel: 'Встановити за посиланням або ID навички',
      installReferencePlaceholder: 'Вставте посилання Portal, ID навички або skill-id@vN',
      installReferenceHelp: 'Hermes перевіряє точну версію та показує план сумісності перед установленням.',
      reviewInstall: 'Переглянути встановлення',
      planningInstall: 'Перевірка…',
      updateModeLabel: 'Майбутні оновлення',
      updateModeDefault: 'Використовувати налаштування організації',
      updateModeManual: 'Вручну',
      updateModeAutomatic: 'Автоматично зі сповіщенням',
      updateModeRequired: 'Обов’язково',
      updateModeHelp:
        'Gateway застосовує поточну політику організації. Зміни, чутливі до безпеки, і надалі потребують вашого схвалення.',
      updateModePlan: mode => `Майбутні оновлення: ${mode}`,
      activityReady: count => `${count} нових сповіщень`,
      decisionPublished: skill => `${skill} схвалено й тепер поширено для вашої команди.`,
      decisionChanges: skill => `${skill} потрібно змінити перед поширенням.`,
      ...
      takedownNotice: skill => `${skill} видалено з колективу.`,
      markSeen: 'Позначити все як прочитане',
      install: 'Встановити…',
      uninstall: 'Видалити…',
      checkSkill: 'Перевірити цю навичку',
      updateAvailable: version => (version ? `Доступне оновлення v${version}` : 'Доступне оновлення'),
      reviewUpdate: 'Переглянути оновлення',
      installed: (version, mode) => `Встановлено v${version} · ${mode}`,
      confirmAction: action => `Підтвердити: ${action}`,
      acceptCompatibility: 'Я перевірив(-ла) й приймаю дії щодо сумісності.',
