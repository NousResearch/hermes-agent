...
export const uk: Translations = {
  ...
  kanban: {
    ...
    skills: "Навички",
    goalMode: "Режим цілі",
    goalModeDescription: "Виконавець продовжує роботу, доки перевіряльник не підтвердить завершення завдання.",
    goalTurnBudget: "Ліміт ходів цілі",
    goalTurnBudgetDescription: "Максимальна кількість ходів виконавця. Залиште поле порожнім, щоб використати типове значення рушія.",
    goalTurnBudgetDefault: "Типове значення рушія",
    goalTurnBudgetValidation: "Введіть додатне ціле число.",
    goalConfigurationLocked: "Налаштування цілі заблоковано, оскільки це завдання вже запускалося.",
    createdBy: "Створив",
    result: "Результат",
    comments: "Коментарі",
    events: "Події",
