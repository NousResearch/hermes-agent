...
export const uk: Translations = {
  ...
  chat: {
    paste: {
      button: "Вставити",
      confirmPrompt: "Вставити {preview} у термінал? Багаторядкова вставка надсилається рядок за рядком.",
      failures: {
        insecureContext: "Вставлення недоступне через звичайне HTTP-з’єднання. Утримуйте термінал і виберіть «Вставити» або відкрийте панель через HTTPS.",
        permissionDenied: "Доступ до буфера обміну відхилено. Утримуйте термінал і виберіть «Вставити».",
        unsupported: "Цей браузер не надає API буфера обміну. Утримуйте термінал і виберіть «Вставити».",
        notConnected: "Чат не під’єднано — вставку не надіслано. Перепідключіться та спробуйте ще раз.",
        tooLarge: "Вміст буфера обміну завеликий для вставлення. Скопіюйте менший фрагмент.",
      },
      imageUploadFailed: "Не вдалося завантажити зображення: {message}",
      imageNotConnected: "Зображення завантажено, але чат не підключено — спробуйте ще раз.",
    },
  },
};
