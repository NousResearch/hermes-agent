...
export const zhHant: Translations = {
  ...
  achievements: {
    catalog: {
      ...
      toolchain_maxxer: { name: "百器通", description: "在一次會話中，調度廣泛而多樣的 Hermes 工具。" },
      full_send: { name: "全域投入", description: "在一次真正的工作流程裡，同時動用終端、檔案與網頁／瀏覽器。" },
      subagent_commander: { name: "分身統帥", description: "協調受委派的代理工作，使其各司其職。" },
      background_process_enjoyer: { name: "常駐觀測者", description: "啟動或掌控足夠多的長駐程序，當之無愧。" },
      ...
      one_more_small_change: { name: "再改一點點", description: "在一次會話中修改足夠多的檔案，讓「小改動」失去意義。" },
      vibe_architect: { name: "氛圍築師", description: "在一個專案會話裡，觸及廣闊的工作表面。" },
      pixel_goblin: { name: "像素精怪", description: "持續雕琢前端、CSS、SVG 或視覺細節。" },
      ship_first_ask_later: { name: "先交付再問", description: "在嚴整的工具鏈之後，留下 Git 的軌跡。" },
      ...
      open_weights_pilgrim: { name: "開放權重朝聖者", description: "依 Hermes 會話中繼資料，真正與本機或開放權重模型交談。" },
