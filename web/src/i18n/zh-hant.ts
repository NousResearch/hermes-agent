...
export const zhHant: Translations = {
  ...
  env: {
    ...
    customConfigured: (count) => `已設定 ${count} 個自訂密鑰`,
    configuredCount: (count) => `已設定 ${count} 項`,
    configuredSummary: (configured, total) => `已設定 ${configured}/${total} 項`,
    addCustomKey: "新增自訂密鑰",
    customKeyName: "變數名稱",
