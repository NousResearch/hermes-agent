...
export const zh: Translations = {
  ...
  conversations: {
    title: "会话浏览",
    subtitle: "在 Sessions 之上提供更干净的人类可读会话视图。",
    searchPlaceholder: "搜索会话...",
    searching: "搜索中...",
    active: "活跃",
    recent: "最近",
    noConversations: "暂无可用会话。",
    noMatch: "当前搜索或来源筛选下没有匹配的会话。",
    selectConversation: "选择一个会话以查看其人类可读转录。",
    noVisibleMessages: "此会话中没有人类可见消息。",
    loadingConversations: "正在加载会话...",
    loadingTranscript: "正在加载转录...",
    listError: "加载会话失败：",
    transcriptError: "加载转录失败：",
    transcript: "转录",
    backToList: "返回会话列表",
