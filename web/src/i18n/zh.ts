...
export const zh: Translations = {
  ...
  skills: {
    ...
    channelCapabilitiesDescription:
      "明确选择来自该渠道的消息可以使用哪些 Agent 工具集和 MCP 服务。",
    connected: "已连接",
    notConnected: "未连接",
    inheritedDefaults: "继承默认能力",
    customBoundary: "自定义能力边界",
    abilitiesEnabled: "启用的能力",
    highImpact: "高影响",
    requiredAbilities: "渠道必需能力",
    requiredAbilitiesDescription: "这些渠道原生能力始终会在该渠道中提供。",
    mcpAccess: "MCP 访问",
    mcpAll: "全部已启用 MCP 服务",
    mcpNone: "禁止所有 MCP 服务",
    mcpSelected: "仅允许选中的 MCP 服务",
    saveCapabilities: "保存能力配置",
    savingCapabilities: "正在保存…",
    changesNewSessions: "更改将在新的 Agent 会话中生效。",
    noMcpServers: "当前没有已启用的 MCP 服务。",
    channelCapabilitiesSaved: "渠道能力已保存。",
    channelCapabilitiesFailed: "保存渠道能力失败。",
