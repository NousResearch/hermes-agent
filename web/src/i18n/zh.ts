...
export const zh: Translations = {
  ...
  emailPolicy: {
    connectionTitle: "邮箱连接",
    connectionDescription: "Hermes 收发邮件所需的基本信息。",
    advancedConnection: "高级邮箱设置",
    advancedConnectionDescription: "端口、轮询、访问规则和默认投递地址。",
    title: "自动回复策略",
    description: "先决定哪些邮件直接保持安静，哪些邮件可以交给 Agent 判断是否回复。",
    categoriesTitle: "邮件类别过滤",
    categoriesDescription: "分类过滤采用近似的启发式正则。关闭某类邮件不保证其内容绝不进入大模型；只有本地正则命中时才会提前拦截。",
    promotions: "推广与营销",
    newsletters: "订阅与简报",
    transactions: "订单与交易通知",
    security: "安全通知",
    social: "社交通知",
    calendar: "日历与会议通知",
    reports: "周期性报告",
    allowCategory: "允许 Agent 回复",
    keywordsTitle: "关键词规则",
    keywordsDescription: "手动关键词仅在本地做字面匹配，不会加入 Agent 提示词。",
    neverReply: "绝不回复",
    neverReplyDescription: "命中后不会调用 Agent；与其他规则冲突时优先。",
    mustReply: "必须回复",
    mustReplyDescription: "命中后一定交给 Agent，并要求生成回复。",
    keywordPlaceholder: "每行输入一个关键词组",
    keywordSyntax: "示例：紧急，或 发票+逾期",
    ...
    strictDecisionDescription: "在 SMTP 前拦截格式错误、无需回复和空回复。",
    priorityLabel: "规则优先级",
