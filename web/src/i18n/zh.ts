...
export const zh: Translations = {
  ...
  grafana: {
    title: "Grafana 图表",
    subtitle: "按 incident 和 service 上下文嵌入既有 Grafana panel，同时把 Grafana 登录态和权限控制保留在企业 Grafana 或 Gateway 侧。",
    contextTitle: "Incident 上下文",
    contextDescription: "这些值会映射为 Grafana 变量和时间范围查询参数，用于生成 panel URL。",
    notConfiguredBadge: "未配置",
    failedToLoad: "加载 Grafana 配置失败",
    emptyTitle: "尚未配置 Grafana 嵌入",
    emptyDescription: "请先在配置页的 aiops.grafana 下填写非敏感的 Grafana 坐标，再在此渲染 panel。",
    securityNote: "不要在该配置中保存 Grafana API key、service-account token 或 session cookie。用户必须通过 Grafana、SSO 或企业 Gateway/反向代理路径获得授权访问。",
    embedBlocked: "Grafana iframe 未确认加载",
    openPanel: "在 Grafana 中打开",
    panel: "Panel",
    defaultFallbackText: "Grafana 嵌入可能被 CSP、SameSite Cookie 或未登录状态阻止。请使用备用链接在 Grafana 中打开 panel。",
  },
