...
export const zh: Translations = {
  ...
  env: {
    ...
    customConfigured: (count) => `已设置 ${count} 个自定义密钥`,
    configuredCount: (count) => `已配置 ${count} 项`,
    configuredSummary: (configured, total) => `已配置 ${configured}/${total} 项`,
