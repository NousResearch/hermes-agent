...
export const api = {
  ...
  updateProfileMetadata: (
    name: string,
    body: { display_name?: string; avatar_path?: string; description?: string; description_auto?: boolean },
  ) =>
    fetchJSON<{ ok: boolean }>(
...
export type FactoryProjectAction = "resume" | "pause" | "tick" | "reconcile" | "unblock";
