...
function replacementLineForMobileInput(currentLine: string, incoming: string): string | null {
  ...
  if (incomingFirst && incomingFirst.toLocaleLowerCase() === last.toLocaleLowerCase()) {
