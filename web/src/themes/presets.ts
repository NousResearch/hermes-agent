 ...
 * and a pixel-art sakura wind: 15 parallax streams of pixel petals drifting
 * in gusts. The petal effect is pure CSS (inline SVG data-URI tiles animated
 * on main::before / main::after), gated behind prefers-reduced-motion, and
...
export const neonSamuraiTheme: DashboardTheme = {
  ...
  label: "Neon Samurai",
  description:
    "Cyberpunk Osaka night — magenta & cyan neon on indigo black, pixel sakura in the wind",
  palette: {
