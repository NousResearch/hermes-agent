...
- Each agent gets its own budget. Subagents get independent budgets capped at `delegation.max_iterations` (default 10) — total iterations across parent + subagents can exceed the parent's cap
