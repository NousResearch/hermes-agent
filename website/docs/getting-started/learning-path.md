...
Generate Hermes Agent trajectory data for evaluation, supervised fine-tuning, or downstream reinforcement-learning workflows.
...
:::tip
Training-data generation works best when you already understand the basics of how Hermes Agent handles conversations and tool calls. Run through the Beginner path first if you're new.
:::
...
| **Training Data** | Generate trajectory data for evaluation and downstream fine-tuning workflows | [Batch Processing](/user-guide/features/batch-processing) |
