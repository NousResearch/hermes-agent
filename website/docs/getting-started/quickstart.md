...
Chat with Hermes from your phone or other surfaces via Telegram, Discord, Slack, WhatsApp, Signal, AAMP, Email, or Home Assistant:
...
- **[Messaging Gateway](../user-guide/messaging/index.md)** — Connect Telegram, Discord, Slack, WhatsApp, Signal, AAMP, Email, or Home Assistant
