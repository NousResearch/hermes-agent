...
When working with untrusted repositories or running unfamiliar code, use Docker, Daytona, or Tenki as your terminal backend. Set `TERMINAL_ENV=docker` in your `.env`. Destructive commands inside a container can't harm your host system.
