...
| 💬 **[Messaging Gateway](/docs/user-guide/messaging)** | Set up Telegram, Discord, Slack, WhatsApp, AAMP, and more |
...
- **Lives where you do** — CLI, Telegram, Discord, Slack, WhatsApp, Signal, AAMP, Matrix, Mattermost, Email, SMS, DingTalk, Feishu, WeCom, BlueBubbles, Home Assistant — 16+ platforms from one gateway
