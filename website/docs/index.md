...
- **Runs anywhere, not just your laptop** — 7 terminal backends: local, Docker, SSH, Singularity, Modal, Daytona, Vercel Sandbox. Daytona, Modal, and Vercel Sandbox offer serverless or remote persistence options — your environment can hibernate when idle, costing nearly nothing
