...
| 💬 **[Messaging Gateway](/docs/user-guide/messaging)** | Set up Telegram, Discord, Slack, WhatsApp, or Kasia |
...
- **Lives where you do** — CLI, Telegram, Discord, Slack, WhatsApp, Signal, and Kasia, all from one gateway
