...
- **[`/docs/llms.txt`](https://hermes-agent.nousresearch.com/docs/llms.txt)** — curated index of every doc page with short descriptions. ~17 KB, safe to load into an LLM context.
- **[`/docs/llms-full.txt`](https://hermes-agent.nousresearch.com/docs/llms-full.txt)** — every doc page concatenated into a single markdown file for one-shot ingestion. ~1.8 MB.
