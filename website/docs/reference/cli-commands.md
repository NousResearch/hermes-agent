...
| `set-priority <id> <priority>` | Set a task's non-negative integer dispatch priority. Higher values are dispatched first among ready tasks for the same assignee. |
