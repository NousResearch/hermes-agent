...
| `--ignore-rules` | Skip auto-injection of `AGENTS.override.md`, `AGENTS.md`, `SOUL.md`, `.cursorrules`, memory, and preloaded skills. |
...
| `--ignore-rules` | Skip auto-injection of `AGENTS.override.md`, `AGENTS.md`, `SOUL.md`, `.cursorrules`, persistent memory, and preloaded skills. Combine with `--ignore-user-config` for a fully isolated run. |
