...
| Variable | Description |
|----------|-------------|
| `TERMINAL_ENV` | Backend: `local`, `docker`, `apple_container`, `ssh`, `singularity`, `modal`, `daytona`, `vercel_sandbox` |
...
## Container Resources (Docker, Singularity, Modal, Daytona, Vercel Sandbox, Apple Container)
