...
| `WHATSAPP_CLOUD_SEND_READ_RECEIPTS` | Mark inbound messages read + show the typing indicator (default `true`); `false` disables both — Meta only exposes the typing indicator as part of the mark-as-read request |
