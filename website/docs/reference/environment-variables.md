...
| `HERMES_ROUTING_CONTEXT` | Compact JSON routing context set internally by the kanban dispatcher. The worker captures the resolved profile/provider/model and associates its routing decision with the active task run. Don't set manually. |
