...
| `HERMES_CONCURRENT_TOOL_TIMEOUT_S` | Wall-time ceiling for an in-flight tool, including silent tools and concurrent batches (default: `420` seconds). Set to `0` to disable. Healthy silent tools are also stopped when this ceiling expires. |
