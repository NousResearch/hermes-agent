...
| `TOKEN_KIOSK_API_KEY` | Token Kiosk API key ([agent-router.gaib.ai](https://agent-router.gaib.ai)) |
| `TOKEN_KIOSK_BASE_URL` | Override Token Kiosk base URL (default: `https://agent-router.gaib.ai/v1`) |
