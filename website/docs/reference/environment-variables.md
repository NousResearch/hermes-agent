...
| `CURSOR_ACCESS_TOKEN` | Cursor access token override for the `cursor` provider. Usually set automatically by `hermes auth add cursor`; useful for headless or externally managed auth setups. |
