...
| `TOGETHER_API_KEY` | Together AI API key ([api.together.ai](https://api.together.ai/settings/api-keys)). Configure endpoint overrides with `model.base_url` in `config.yaml`. |
