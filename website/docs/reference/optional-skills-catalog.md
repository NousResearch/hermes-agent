...
| [**swarm-moa-approach**](/docs/user-guide/skills/optional/software-development/software-development-swarm-moa-approach) | Use when planning or reviewing complex agentic work with a MoA-backed swarm checkpoint: run a bounded Mixture-of-Agents planning/review pass, then execute with normal Hermes delegation, Kanban, worktrees, and parent-owned verification. |
