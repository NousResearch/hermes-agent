...
| [**web3-chain-tools**](/docs/user-guide/skills/optional/mcp/mcp-web3-chain-tools) | MCP stdio server for Ethereum (web3.py) and Solana (solana-py): balances, eth_call, gas estimates, pre-signed broadcasts, SQLite log snapshots, optional WS listener. |
