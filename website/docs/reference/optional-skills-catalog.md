...
| [**discrete-decision-gate**](../user-guide/skills/optional/autonomous-ai-agents/autonomous-ai-agents-discrete-decision-gate.md) | Gate agent routing with typed decision models. |
