...
| [**claude-code-sdk**](/docs/user-guide/skills/optional/autonomous-ai-agents/autonomous-ai-agents-claude-code-sdk) | Orchestrate Claude Code through its official Python SDK. |
