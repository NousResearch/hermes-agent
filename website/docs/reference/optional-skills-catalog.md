...
| [**multi-session-coordination**](/docs/user-guide/skills/optional/autonomous-ai-agents/autonomous-ai-agents-multi-session-coordination) | Coordinate concurrent sessions: claim shared resources. |
