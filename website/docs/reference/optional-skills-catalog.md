...
| [**multi-session-coordination**](../user-guide/skills/optional/autonomous-ai-agents/autonomous-ai-agents-multi-session-coordination.md) | Coordinate concurrent sessions: claim shared resources. |
