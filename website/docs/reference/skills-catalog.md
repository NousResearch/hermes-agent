...
| [`cursor-cloud-agents`](../user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-cursor-cloud-agents.md) | Launch and manage Cursor Cloud Agents from Hermes. | `autonomous-ai-agents\cursor-cloud-agents` |
