...
| [`code-review`](/docs/user-guide/skills/bundled/code-review) | Review pull requests — diff analysis, impact assessment, backward compat, and test execution. | `code-review` |
