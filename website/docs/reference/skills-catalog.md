...
| [`release-notes`](/docs/user-guide/skills/bundled/software-development/software-development-release-notes) | Use when drafting release notes or changelog summaries from git history. Fix the range first, gather evidence from commits/diffs/PRs, and write grounded notes without inventing impact. | `software-development/release-notes` |
