...
| [`release-notes`](/docs/user-guide/skills/bundled/software-development/software-development-release-notes) | Draft release notes/changelogs from git history. | `software-development/release-notes` |
