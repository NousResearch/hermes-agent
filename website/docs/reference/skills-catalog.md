...
| [`rendered-ux-reviewer`](/docs/user-guide/skills/bundled/software-development/software-development-rendered-ux-reviewer) | Review rendered user-facing artifacts: UX, product copy, page comprehension. | `software-development/rendered-ux-reviewer` |
