...
| `/router` | Show the [Model Router](/user-guide/features/model-router) preset for this session: classifier, tiers, fallbacks, and the last routing decision. To switch onto the router, pick `Model Router` in the model picker. |
