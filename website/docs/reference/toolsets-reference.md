...
| `computer_use` | `computer_use_list_apps`, `computer_use_launch_app`, `computer_use_get_app_state`, `computer_use_click`, `computer_use_perform_secondary_action`, `computer_use_scroll`, `computer_use_drag`, `computer_use_type_text`, `computer_use_set_value`, `computer_use_press_key`, `computer_use_select_text` | First-class macOS desktop control — launch, state, act, verify without stealing cursor/focus during normal operation. |
