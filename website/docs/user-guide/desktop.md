...
- **In-app toast position** — choose any window corner under **Settings → Notifications** for routine confirmations and activity notices. Errors, warnings, and notifications with actions remain top-center so they stay prominent.
