...
| **Zinc** (`zinc`) | Flat dark zinc (shadcn/ui-style) | Geist + Geist Mono, 14px | 0.625rem radius, comfortable |
| **Neon Samurai** (`neon-samurai`) | Indigo black + magenta & cyan neon, pixel sakura | Geist + Geist Mono, 14px | 0.625rem radius, comfortable |
