...
| `callback_query` | telegram | `data: str`, `chat_id: str`, `message_id: str \| None`, `message_text: str`, `user_id: str`, `user_name: str \| None`. Plugins may return an action envelope: `{"action": "handled", "answer": str \| None, "edit": {"text": str, "buttons": [[{"label": str, "data": str}]] \| [] \| None}}`. |
