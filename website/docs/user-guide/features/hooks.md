...
| [`pre_approval_request`](#pre_approval_request) | An owner approval decision is requested | ignored |
...
Fires before an owner approval decision is requested. It covers interactive CLI, Ink TUI, gateway platforms, and ACP clients.
...
Fires after a prompted owner approval decision (or after a prompt times out).
