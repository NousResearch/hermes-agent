...
| `decomposer_context_budget_tokens` | `150000` | Rough maximum fresh-worker context used to size the largest valid semantic pieces. It is a planning guardrail, not a runtime token limit. |
