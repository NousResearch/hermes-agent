...
- **[Batch Processing](/docs/user-guide/features/batch-processing)** — Generate trajectory data from agent sessions for training, evaluation, and fine-tuning workflows.
