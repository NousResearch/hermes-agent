...
- **[Image Generation](/user-guide/features/image-generation)** — Generate images from text prompts using FAL.ai. Nine models supported (FLUX 2 Klein/Pro, GPT-Image 1.5/2, Nano Banana Pro, Ideogram V3, Recraft V4 Pro, Qwen, Z-Image Turbo); pick one via `hermes tools`.
...
- **[Batch Processing](/user-guide/features/batch-processing)** — Run prompts in bulk and generate structured trajectory data for evaluation, supervised fine-tuning, or downstream reinforcement-learning workflows.
