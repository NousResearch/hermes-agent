...
- **[Cross-Engineering Memory](engineering-memory.md)** — A local, reviewed index that shares bounded engineering evidence between Hermes, Claude, and Codex without mixing in private profile memory.
