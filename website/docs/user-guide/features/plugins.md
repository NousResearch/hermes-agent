...
| A **terminal execution backend** (cloud sandbox, remote runtime, or container service) | Backend plugin — `ctx.register_terminal_backend()` | [Terminal Backend Plugins](/developer-guide/terminal-backend-plugin) |
