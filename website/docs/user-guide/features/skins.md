...
| `hades` | Underworld theme — deep blue and violet | `Hades Agent` | Deep blue-violet surfaces with cool royal-blue accents. Underworld spinner verbs, HADES-AGENT block logo, and moon/Pluto/gate iconography. |
