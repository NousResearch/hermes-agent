...
| `nous-blue-contrast` | Nous Blue — high contrast | `Hermes Agent` | Vivid Nous-blue accents, cool white text, and navy menu and status surfaces for dark terminal canvases. |
