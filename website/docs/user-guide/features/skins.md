...
| `vanta-black` | Omarchy Vanta Black — near-black with acid-lime accents | `Vanta Black Agent` | Near-black surfaces, ink-white text, grayscale hierarchy, and acid-lime focus accents inspired by Omarchy's Vanta Black theme. Includes a tuned light-terminal palette. |
| `vanta-black-light` | Omarchy Vanta Black Light — white with ink and acid-lime accents | `Vanta Black Light Agent` | White surfaces, near-black text, grayscale hierarchy, and acid-lime focus accents for bright terminals. |
