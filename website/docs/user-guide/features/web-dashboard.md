...
- **Group by category** — jobs can carry an optional free-form `category` (set in the create/edit dialog); when any job has one the list offers a grouping toggle and renders the jobs under one heading per category
