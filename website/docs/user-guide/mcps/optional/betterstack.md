...
id: betterstack
title: "betterstack"
sidebar_label: "betterstack"
description: "Better Stack: logs, uptime monitors, incidents, and status pages."
---

<!-- This page is auto-generated from optional-mcps/betterstack/manifest.yaml by website/scripts/generate-mcp-catalog-docs.py. Edit the manifest, not this page. -->

# betterstack

Better Stack: logs, uptime monitors, incidents, and status pages.

## Overview

**Source:** [https://betterstack.com/docs/getting-started/integrations/mcp/](https://betterstack.com/docs/getting-started/integrations/mcp/)

Install this catalog entry with:

```bash
hermes mcp install betterstack
```

or pick it interactively with `hermes mcp`. Uninstall with `hermes mcp uninstall betterstack` (the server's config block is removed; any credentials in `~/.hermes/.env` are preserved).
...
The manifest below is the source of truth. It lives at `optional-mcps/betterstack/manifest.yaml` in the hermes-agent repo.
...
name: betterstack
connector_slug: better_stack_mcp
description: 'Better Stack: logs, uptime monitors, incidents, and status pages.'
