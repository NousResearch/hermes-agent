...
<!-- This page is auto-generated from optional-mcps/cloudflare/manifest.yaml by website/scripts/generate-mcp-catalog-docs.py. Edit the manifest, not this page. -->

# cloudflare

Full Cloudflare API access via the official remote MCP.

## Overview

**Source:** [https://developers.cloudflare.com/agents/model-context-protocol/cloudflare/servers-for-cloudflare/](https://developers.cloudflare.com/agents/model-context-protocol/cloudflare/servers-for-cloudflare/)
...
or pick it interactively with `hermes mcp`. Uninstall with `hermes mcp uninstall cloudflare` (the server's config block is removed; any credentials in `~/.hermes/.env` are preserved).
...
The manifest below is the source of truth. It lives at `optional-mcps/cloudflare/manifest.yaml` in the hermes-agent repo.
