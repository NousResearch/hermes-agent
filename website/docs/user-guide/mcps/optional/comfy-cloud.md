...
id: comfy-cloud
title: "comfy-cloud"
sidebar_label: "comfy-cloud"
description: "Generate images, video, audio, and 3D on Comfy Cloud."
---

<!-- This page is auto-generated from optional-mcps/comfy-cloud/manifest.yaml by website/scripts/generate-mcp-catalog-docs.py. Edit the manifest, not this page. -->

# comfy-cloud

Generate images, video, audio, and 3D on Comfy Cloud.

## Overview

**Source:** [https://docs.comfy.org/agent-tools/cloud](https://docs.comfy.org/agent-tools/cloud)
...
or pick it interactively with `hermes mcp`. Uninstall with `hermes mcp uninstall comfy-cloud` (the server's config block is removed; any credentials in `~/.hermes/.env` are preserved).
...
The manifest below is the source of truth. It lives at `optional-mcps/comfy-cloud/manifest.yaml` in the hermes-agent repo.
