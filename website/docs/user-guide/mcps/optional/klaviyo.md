...
<!-- This page is auto-generated from optional-mcps/klaviyo/manifest.yaml by website/scripts/generate-mcp-catalog-docs.py. Edit the manifest, not this page. -->

# klaviyo

Klaviyo marketing: campaigns, flows, segments, and reporting.

## Overview

**Source:** [https://developers.klaviyo.com/en/docs/klaviyo_mcp_server](https://developers.klaviyo.com/en/docs/klaviyo_mcp_server)

Install this catalog entry with:

```bash
hermes mcp install klaviyo
```

or pick it interactively with `hermes mcp`. Uninstall with `hermes mcp uninstall klaviyo` (the server's config block is removed; any credentials in `~/.hermes/.env` are preserved).
...
The manifest below is the source of truth. It lives at `optional-mcps/klaviyo/manifest.yaml` in the hermes-agent repo.
