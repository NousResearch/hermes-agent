...
id: n8n-official
title: "n8n-official"
sidebar_label: "n8n-official"
description: "Connect to your n8n instance's official MCP server with browser OAuth."
---

<!-- This page is auto-generated from optional-mcps/n8n-official/manifest.yaml by website/scripts/generate-mcp-catalog-docs.py. Edit the manifest, not this page. -->

# n8n-official

Connect to your n8n instance's official MCP server with browser OAuth.

## Overview

**Source:** [https://docs.n8n.io/connect/connect-to-n8n-mcp-server/](https://docs.n8n.io/connect/connect-to-n8n-mcp-server/)
...
or pick it interactively with `hermes mcp`. Uninstall with `hermes mcp uninstall n8n-official` (the server's config block is removed; any credentials in `~/.hermes/.env` are preserved).
...
The manifest below is the source of truth. It lives at `optional-mcps/n8n-official/manifest.yaml` in the hermes-agent repo.
