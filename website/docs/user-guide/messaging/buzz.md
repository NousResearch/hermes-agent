  ...
  platforms:
    buzz:
      ...
      extra:
        ...
        free_response_channels: [] # channel UUIDs where ordinary messages do not require @mention
```
  ...
  platforms:
    buzz:
      ...
      extra:
        ...
        free_response_channels: []        # exact channel UUIDs that bypass require_mention; authorization still applies
