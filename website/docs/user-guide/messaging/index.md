...
description: "Chat with Hermes from Telegram, Discord, Slack, WhatsApp, Signal, XMPP, SMS, Email, Home Assistant, Mattermost, Matrix, DingTalk, Yuanbao, Microsoft Teams, LINE, Webhooks, or any OpenAI-compatible frontend via the API server — architecture and setup overview"
---
