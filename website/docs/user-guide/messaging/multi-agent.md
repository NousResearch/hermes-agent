...
| Skills | `<home_dir>/skills/` + global `~/.hermes/skills/` | Reads global, writes local |
| Sessions | `<home_dir>/sessions/` (SQLite) | Per-agent |
| Cron jobs | `<home_dir>/cron/jobs.json` | Per-agent |
