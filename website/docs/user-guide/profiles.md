...
The name `main` is reserved for the default profile's session namespace. Existing profiles named `main` remain usable and can be renamed to a different name.
