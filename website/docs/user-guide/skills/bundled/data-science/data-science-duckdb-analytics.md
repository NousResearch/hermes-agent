---
title: "Duckdb Analytics — Run fast analytical SQL with DuckDB over Parquet, CSV, JSON, and in-process Arrow/Pandas data"
sidebar_label: "Duckdb Analytics"
description: "Run fast analytical SQL with DuckDB over Parquet, CSV, JSON, and in-process Arrow/Pandas data"
---
...
Run fast analytical SQL with DuckDB over Parquet, CSV, JSON, and in-process Arrow/Pandas data. Covers embedded OLAP, serverless-friendly local analytics, joins across files, window functions, and exporting results. Use when the user mentions DuckDB, Parquet analytics, SQL on CSV, OLAP, columnar queries, read_parquet, or lightweight ETL without a separate database server.
...
| Path | `skills/data-science\duckdb-analytics` |
| Version | `1.0.0` |
| Author | Hermes Agent |
| License | MIT |
| Platforms | linux, macos, windows |
| Tags | `duckdb`, `sql`, `parquet`, `csv`, `olap`, `analytics`, `data-science`, `embedded-database` |
| Related skills | `jupyter-live-kernel` |
