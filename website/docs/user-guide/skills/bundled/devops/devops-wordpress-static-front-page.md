---
title: "Wordpress Static Front Page — Set a WordPress static front page over XML-RPC, verified"
sidebar_label: "Wordpress Static Front Page"
...
Set a WordPress static front page over XML-RPC, verified.
...
| Path | `skills/devops/wordpress-static-front-page` |
| Version | `1.0.0` |
| Author | Hermes Agent |
| License | MIT |
