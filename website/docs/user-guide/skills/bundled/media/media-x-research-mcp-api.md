---
title: "X Research Mcp Api — X research via MCP tools and v2 API: search, user tweets, article fetch"
sidebar_label: "X Research Mcp Api"
...
X research via MCP tools and v2 API: search, user tweets, article fetch.
...
| Path | `skills/media\x-research-mcp-api` |
| Version | `1.0.0` |
| Author | Axl Ibiza, MBA |
| License | MIT |
| Platforms | linux, macos, windows |
| Tags | `x`, `twitter`, `research`, `mcp`, `api`, `search`, `osint`, `social` |
| Related skills | `x-api-publishing`, `x-profile-research`, `x-profile-interaction-research` |
