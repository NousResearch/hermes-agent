---
title: "X Video Spanish Localization — Use when localizing X/Twitter videos into Spanish with dubbing, subtitles, or both"
sidebar_label: "X Video Spanish Localization"
description: "Use when localizing X/Twitter videos into Spanish with dubbing, subtitles, or both"
---
...
Use when localizing X/Twitter videos into Spanish with dubbing, subtitles, or both. Preserves original format/framing, uses the highest practical X MP4 master, verifies audio timing visually/technically, and sends Telegram-safe deliverables.
...
| Path | `skills/media/x-video-spanish-localization` |
| Version | `1.0.0` |
| Author | Hermes Agent |
| License | MIT |
| Platforms | macos, linux |
| Tags | `x`, `twitter`, `video`, `dubbing`, `subtitles`, `ffmpeg`, `telegram` |
| Related skills | [`youtube-content`](/docs/user-guide/skills/bundled/media/media-youtube-content) |
