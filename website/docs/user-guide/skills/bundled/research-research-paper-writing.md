...
| Related skills | [`arxiv`](./research-arxiv), `ml-paper-writing`, [`subagent-driven-development`](../optional/software-development-subagent-driven-development), [`plan`](./software-development-plan) |
