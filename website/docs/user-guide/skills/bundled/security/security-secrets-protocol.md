---
title: "Secrets Protocol — All Hermes secret sources: encrypted-only cache, no leaks."
sidebar_label: "Secrets Protocol"
description: "All Hermes secret sources: encrypted-only cache, no leaks."
---

{/* This page mirrors the bundled skill's SKILL.md. Edit the source at skills/security/secrets-protocol/SKILL.md, not this page. */}
...
| Path | `skills/security/secrets-protocol` |
| Version | `1.0.0` |
| Author | Axl Ibiza |
| License | MIT |
