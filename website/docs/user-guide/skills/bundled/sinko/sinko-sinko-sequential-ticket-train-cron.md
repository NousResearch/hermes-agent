---
title: "Sinko Sequential Ticket Train Cron"
sidebar_label: "Sinko Sequential Ticket Train Cron"
description: "Create a batch of Sinko Plane tickets and a cron job that processes exactly one ticket every N minutes using Claude Code, auto-review, PR, and merge without ..."
---
...
Create a batch of Sinko Plane tickets and a cron job that processes exactly one ticket every N minutes using Claude Code, auto-review, PR, and merge without deploying.
...
| Path | `skills/sinko/sinko-sequential-ticket-train-cron` |
