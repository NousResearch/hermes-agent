---
title: "Rendered Ux Reviewer — Review rendered user-facing artifacts: UX, product copy, page comprehension"
sidebar_label: "Rendered Ux Reviewer"
description: "Review rendered user-facing artifacts: UX, product copy, page comprehension"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Rendered Ux Reviewer

Review rendered user-facing artifacts: UX, product copy, page comprehension.
...
| Path | `skills/software-development/rendered-ux-reviewer` |
| Version | `1.0.0` |
| Author | Hermes Agent |
| License | MIT |
| Platforms | linux, macos, windows |
| Tags | `ux-review`, `product-review`, `rendered-preview`, `visual-qa`, `delegation` |
| Related skills | [`requesting-code-review`](/docs/user-guide/skills/bundled/software-development/software-development-requesting-code-review), [`github-pr-workflow`](/docs/user-guide/skills/bundled/github/github-github-pr-workflow), `web-ui-deployment-access` |
