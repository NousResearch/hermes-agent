---
title: "Discrete Decision Gate — Gate agent routing with typed decision models"
sidebar_label: "Discrete Decision Gate"
description: "Gate agent routing with typed decision models"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Discrete Decision Gate

Gate agent routing with typed decision models.

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `hermes skills install official/autonomous-ai-agents/discrete-decision-gate` |
| Path | `optional-skills/autonomous-ai-agents/discrete-decision-gate` |
| Version | `0.1.0` |
| Author | Ron Malouin (rpmalouin), Hermes Agent |
| License | MIT |
| Platforms | linux, macos, windows |
| Tags | `routing`, `classification`, `gates`, `delegation`, `decision`, `offline` |
| Related skills | [`hermes-agent`](../../bundled/autonomous-ai-agents/autonomous-ai-agents-hermes-agent.md), [`dynamic-workflow`](../../optional/autonomous-ai-agents/autonomous-ai-agents-dynamic-workflow.md), [`subagent-driven-development`](../../optional/software-development/software-development-subagent-driven-development.md) |
