...
| Related skills | [`kanban-orchestrator`](../bundled/devops-kanban-orchestrator), [`kanban-worker`](../bundled/devops-kanban-worker), [`ascii-video`](../bundled/creative-ascii-video), [`manim-video`](../bundled/creative-manim-video), [`p5js`](../bundled/creative-p5js), [`comfyui`](../bundled/creative-comfyui), [`touchdesigner-mcp`](../bundled/creative-touchdesigner-mcp), [`blender-mcp`](./creative-blender-mcp), [`pixel-art`](./creative-pixel-art), [`ascii-art`](../bundled/creative-ascii-art), [`songwriting-and-ai-music`](../bundled/creative-songwriting-and-ai-music), [`heartmula`](../bundled/media-heartmula), [`songsee`](../bundled/media-songsee), `spotify`, [`youtube-content`](../bundled/media-youtube-content), [`claude-design`](../bundled/creative-claude-design), [`excalidraw`](../bundled/creative-excalidraw), [`architecture-diagram`](../bundled/creative-architecture-diagram), [`concept-diagrams`](./creative-concept-diagrams), [`baoyu-comic`](./creative-baoyu-comic), [`baoyu-infographic`](../bundled/creative-baoyu-infographic), [`humanizer`](../bundled/creative-humanizer), [`gif-search`](../bundled/media-gif-search), [`meme-generation`](./creative-meme-generation) |
