---
title: "Meshy — Generate, texture, rig and 3D-print models with Meshy"
sidebar_label: "Meshy"
...
Generate, texture, rig and 3D-print models with Meshy.

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `hermes skills install official/creative/meshy` |
| Path | `optional-skills/creative/meshy` |
| Version | `1.0.0` |
