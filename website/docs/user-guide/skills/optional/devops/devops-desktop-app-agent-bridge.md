---
title: "Desktop App Agent Bridge — Use when a desktop app's agent must run on another host"
sidebar_label: "Desktop App Agent Bridge"
description: "Use when a desktop app's agent must run on another host"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Desktop App Agent Bridge

Use when a desktop app's agent must run on another host.

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `hermes skills install official/devops/desktop-app-agent-bridge` |
| Path | `optional-skills/devops/desktop-app-agent-bridge` |
| Version | `1.1.0` |
| Author | Hermes Agent |
| License | MIT |
