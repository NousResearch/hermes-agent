---
title: "Release Feature Watcher"
sidebar_label: "Release Feature Watcher"
description: "Use when the user wants to monitor a technical feature, bugfix, model/API update, changelog, release, package version, or PR and be notified only when a spec..."
---
...
| | |
|---|---|
| Source | Optional — install with `hermes skills install official/productivity/release-feature-watcher` |
| Path | `optional-skills/productivity/release-feature-watcher` |
| Version | `1.0.0` |
| Author | Abe Diaz (@abe238) |
| License | MIT |
| Tags | `releases`, `changelogs`, `github`, `packages`, `models`, `apis`, `cron`, `watchdogs` |
| Related skills | `resource-link-decision-framework`, [`github-repo-management`](/docs/user-guide/skills/bundled/github/github-github-repo-management), [`hermes-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-hermes-agent) |
