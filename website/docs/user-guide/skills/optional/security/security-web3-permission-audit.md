---
title: "Web3 Permission Audit — Instruction-first cross-chain wallet permission audit playbook for Solana, XRPL, and Base/EVM"
sidebar_label: "Web3 Permission Audit"
description: "Instruction-first cross-chain wallet permission audit playbook for Solana, XRPL, and Base/EVM"
---
...
Instruction-first cross-chain wallet permission audit playbook for Solana, XRPL, and Base/EVM. Guides read-only review of delegates, trust lines, allowances, freeze controls, issuer exposure, and explicit coverage limits without bundling executable code.
