---
title: "Swarm Moa Approach"
sidebar_label: "Swarm Moa Approach"
description: "Use when planning or reviewing complex agentic work with a MoA-backed swarm checkpoint: run a bounded Mixture-of-Agents planning/review pass, then execute wi..."
---
...
Use when planning or reviewing complex agentic work with a MoA-backed swarm checkpoint: run a bounded Mixture-of-Agents planning/review pass, then execute with normal Hermes delegation, Kanban, worktrees, and parent-owned verification.

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `hermes skills install official/software-development/swarm-moa-approach` |
| Path | `optional-skills/software-development/swarm-moa-approach` |
| Version | `0.1.0` |
| Author | Hermes Agent |
| License | MIT |
| Platforms | linux, macos, windows |
| Tags | `swarm`, `moa`, `mixture-of-agents`, `delegation`, `planning`, `review`, `verification` |
| Related skills | [`plan`](/docs/user-guide/skills/bundled/software-development/software-development-plan), [`subagent-driven-development`](/docs/user-guide/skills/optional/software-development/software-development-subagent-driven-development), [`requesting-code-review`](/docs/user-guide/skills/bundled/software-development/software-development-requesting-code-review), [`systematic-debugging`](/docs/user-guide/skills/bundled/software-development/software-development-systematic-debugging) |
