...
sidebar_label: "Fixing Accessibility"
...
| | |
|---|---|
| Source | Optional — install with `hermes skills install official/web-development/fixing-accessibility` |
| Path | `optional-skills/web-development/fixing-accessibility` |
