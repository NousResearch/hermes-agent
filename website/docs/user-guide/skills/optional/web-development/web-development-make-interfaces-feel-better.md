---
title: "Make Interfaces Feel Better — Design engineering principles for making interfaces feel polished"
sidebar_label: "Make Interfaces Feel Better"
description: "Design engineering principles for making interfaces feel polished"
---
...
| | |
|---|---|
| Source | Optional — install with `hermes skills install official/web-development/make-interfaces-feel-better` |
| Path | `optional-skills/web-development/make-interfaces-feel-better` |
...
| --- | --- |
| [Typography](https://github.com/NousResearch/hermes-agent/blob/main/optional-skills/web-development/make-interfaces-feel-better/typography.md) | Text wrapping, font smoothing, tabular numbers |
| [Surfaces](https://github.com/NousResearch/hermes-agent/blob/main/optional-skills/web-development/make-interfaces-feel-better/surfaces.md) | Border radius, optical alignment, shadows, image outlines, hit areas |
| [Animations](https://github.com/NousResearch/hermes-agent/blob/main/optional-skills/web-development/make-interfaces-feel-better/animations.md) | Interruptible animations, enter/exit transitions, icon animations, scale on press |
| [Performance](https://github.com/NousResearch/hermes-agent/blob/main/optional-skills/web-development/make-interfaces-feel-better/performance.md) | Transition specificity, `will-change` usage |
...
- [typography.md](https://github.com/NousResearch/hermes-agent/blob/main/optional-skills/web-development/make-interfaces-feel-better/typography.md) — Text wrapping, font smoothing, tabular numbers
- [surfaces.md](https://github.com/NousResearch/hermes-agent/blob/main/optional-skills/web-development/make-interfaces-feel-better/surfaces.md) — Border radius, optical alignment, shadows, image outlines
- [animations.md](https://github.com/NousResearch/hermes-agent/blob/main/optional-skills/web-development/make-interfaces-feel-better/animations.md) — Interruptible animations, enter/exit transitions, icon animations, scale on press
- [performance.md](https://github.com/NousResearch/hermes-agent/blob/main/optional-skills/web-development/make-interfaces-feel-better/performance.md) — Transition specificity, `will-change` usage
