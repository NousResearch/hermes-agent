...
| **高级** | 构建自定义工具、创建技能、导出训练轨迹、参与项目贡献 | [架构](/developer-guide/architecture) → [添加工具](/developer-guide/adding-tools) → [创建技能](/developer-guide/creating-skills) → [轨迹格式](/developer-guide/trajectory-format) → [贡献指南](/developer-guide/contributing) | 约 4–6 小时 |
...
将 Hermes Agent 对话导出为轨迹数据，用于微调或评估。

1. [快速入门](/getting-started/quickstart)
2. [配置](/user-guide/configuration)
3. [轨迹格式](/developer-guide/trajectory-format)
4. [Provider 路由](/user-guide/features/provider-routing)
5. [架构](/developer-guide/architecture)

:::tip
当您已了解 Hermes Agent 如何处理对话和工具调用时，轨迹数据最有用。如果您是新手，请先完成初级路径。
:::
...
| **轨迹导出** | 生成用于微调或评估的数据 | [轨迹格式](/developer-guide/trajectory-format) |
