...
| `/topup` | 显示你的 Nous 余额，并在 portal 上管理账单。 |
| `/subscription`（别名：`/upgrade`） | 查看你的 Nous 套餐，并在浏览器中更改。仅限 CLI。 |
...
| `/topup` | 显示你的 Nous 余额，并提供在浏览器中打开 portal 账单页的链接。 |
...
- `/skin`、`/snapshot`、`/reload`、`/tools`、`/toolsets`、`/browser`、`/config`、`/cron`、`/platforms`、`/paste`、`/image`、`/statusbar`、`/plugins`、`/busy`、`/indicator`、`/redraw`、`/clear`、`/history`、`/save`、`/copy`、`/handoff`、`/subscription`、`/journey` 和 `/quit` 是**仅限 CLI** 的命令。
