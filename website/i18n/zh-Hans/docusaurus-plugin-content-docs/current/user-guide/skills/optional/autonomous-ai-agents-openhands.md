...
| Related skills | [`claude-code`](../bundled/autonomous-ai-agents-claude-code), [`codex`](../bundled/autonomous-ai-agents-codex), [`opencode`](../bundled/autonomous-ai-agents-opencode), [`hermes-agent`](../bundled/autonomous-ai-agents-hermes-agent) |
