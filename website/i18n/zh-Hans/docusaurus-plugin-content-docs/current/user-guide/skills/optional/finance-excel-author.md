...
| Related skills | [`pptx-author`](./finance-pptx-author), [`dcf-model`](./finance-dcf-model), [`comps-analysis`](./finance-comps-analysis), [`lbo-model`](./finance-lbo-model), [`3-statement-model`](./finance-3-statement-model) |
