...
| Related skills | [`excel-author`](./finance-excel-author), [`pptx-author`](./finance-pptx-author), [`dcf-model`](./finance-dcf-model), [`3-statement-model`](./finance-3-statement-model) |
